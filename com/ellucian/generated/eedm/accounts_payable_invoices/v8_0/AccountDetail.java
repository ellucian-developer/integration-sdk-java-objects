...
public class AccountDetail {
    ...
    @JsonPropertyDescription("An indication if budget checking should be enforced or overridden.")
    private AccountDetail.BudgetCheck budgetCheck;
    /**
     * Submitted By
     * <p>
    ...
    public AccountDetail withSequenceNumber(Double sequenceNumber) {
        this.sequenceNumber = sequenceNumber;
        return this;
    }
     ...
     */
    @JsonProperty("budgetCheck")
    public AccountDetail.BudgetCheck getBudgetCheck() {
        return budgetCheck;
    }
     ...
     */
    @JsonProperty("budgetCheck")
    public void setBudgetCheck(AccountDetail.BudgetCheck budgetCheck) {
        this.budgetCheck = budgetCheck;
    }

    public AccountDetail withBudgetCheck(AccountDetail.BudgetCheck budgetCheck) {
        this.budgetCheck = budgetCheck;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((((this.submittedBy == rhs.submittedBy)||((this.submittedBy!= null)&&this.submittedBy.equals(rhs.submittedBy)))&&((this.sequenceNumber == rhs.sequenceNumber)||((this.sequenceNumber!= null)&&this.sequenceNumber.equals(rhs.sequenceNumber))))&&((this.allocation == rhs.allocation)||((this.allocation!= null)&&this.allocation.equals(rhs.allocation))))&&((this.accountingString == rhs.accountingString)||((this.accountingString!= null)&&this.accountingString.equals(rhs.accountingString))))&&((this.budgetCheck == rhs.budgetCheck)||((this.budgetCheck!= null)&&this.budgetCheck.equals(rhs.budgetCheck))))&&((this.source == rhs.source)||((this.source!= null)&&this.source.equals(rhs.source))));
    }
    ...
    public enum BudgetCheck {
        ...
        private final static Map<String, AccountDetail.BudgetCheck> CONSTANTS = new HashMap<String, AccountDetail.BudgetCheck>();

        static {
            for (AccountDetail.BudgetCheck c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        BudgetCheck(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static AccountDetail.BudgetCheck fromValue(String value) {
            AccountDetail.BudgetCheck constant = CONSTANTS.get(value);
            if (constant == null) {
