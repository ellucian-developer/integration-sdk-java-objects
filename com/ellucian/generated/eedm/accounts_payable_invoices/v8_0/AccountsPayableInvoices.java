...
public class AccountsPayableInvoices {
    ...
    @JsonPropertyDescription("The vendor address to be used for this invoice (defaults to the vendors primary address).")
    ...
    public AccountsPayableInvoices withVendorAddress(Object vendorAddress) {
        this.vendorAddress = vendorAddress;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append('=');
        sb.append(((this.vendorAddress == null)?"<null>":this.vendorAddress));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.vendorAddress == null)? 0 :this.vendorAddress.hashCode()));
