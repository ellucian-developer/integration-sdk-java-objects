...
public class ManualVendorDetails {
    ...
    @JsonPropertyDescription("The address lines of the vendor's address, such as a street address, post office box number, or city, region, and postal code.")
    ...
    public ManualVendorDetails withPlace(Object place) {
        this.place = place;
        return this;
    }
