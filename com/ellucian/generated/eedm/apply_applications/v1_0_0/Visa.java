...
public class Visa {
    ...
    @JsonPropertyDescription("Visa type of the applicant.")
    ...
    public Visa withVisaType(Object visaType) {
        this.visaType = visaType;
        return this;
    }
    ...
    public Visa withCountryOfBirth(Object countryOfBirth) {
        this.countryOfBirth = countryOfBirth;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        Visa rhs = ((Visa) other);
        return (((((((((((((this.alienRegistrationIssueDate == rhs.alienRegistrationIssueDate)||((this.alienRegistrationIssueDate!= null)&&this.alienRegistrationIssueDate.equals(rhs.alienRegistrationIssueDate)))&&((this.visaId == rhs.visaId)||((this.visaId!= null)&&this.visaId.equals(rhs.visaId))))&&((this.employmentType == rhs.employmentType)||((this.employmentType!= null)&&this.employmentType.equals(rhs.employmentType))))&&((this.alienRegistrationExpirationDate == rhs.alienRegistrationExpirationDate)||((this.alienRegistrationExpirationDate!= null)&&this.alienRegistrationExpirationDate.equals(rhs.alienRegistrationExpirationDate))))&&((this.visaType == rhs.visaType)||((this.visaType!= null)&&this.visaType.equals(rhs.visaType))))&&((this.issuedOn == rhs.issuedOn)||((this.issuedOn!= null)&&this.issuedOn.equals(rhs.issuedOn))))&&((this.issuingAuthority == rhs.issuingAuthority)||((this.issuingAuthority!= null)&&this.issuingAuthority.equals(rhs.issuingAuthority))))&&((this.alienRegistrationNumber == rhs.alienRegistrationNumber)||((this.alienRegistrationNumber!= null)&&this.alienRegistrationNumber.equals(rhs.alienRegistrationNumber))))&&((this.countryOfBirth == rhs.countryOfBirth)||((this.countryOfBirth!= null)&&this.countryOfBirth.equals(rhs.countryOfBirth))))&&((this.portOfEntry == rhs.portOfEntry)||((this.portOfEntry!= null)&&this.portOfEntry.equals(rhs.portOfEntry))))&&((this.expiresOn == rhs.expiresOn)||((this.expiresOn!= null)&&this.expiresOn.equals(rhs.expiresOn))))&&((this.startDate == rhs.startDate)||((this.startDate!= null)&&this.startDate.equals(rhs.startDate))));
    }
