...
public class Phone {
     ...
     */
    @JsonProperty("type")
    @JsonPropertyDescription("A type of phone for an applicant. Includes a standard type (e.g. 'mobile', 'home') and an optional, custom type to further identify the type of phone.")
    private Object type;
    /**
    ...
    public Phone withType(Object type) {
        this.type = type;
        return this;
    }
