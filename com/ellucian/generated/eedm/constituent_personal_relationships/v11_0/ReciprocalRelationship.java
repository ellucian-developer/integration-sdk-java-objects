...
public class ReciprocalRelationship {
    ...
    public String toString() {
        ...
        sb.append(ReciprocalRelationship.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReciprocalRelationship) == false) {
            return false;
        }
        ReciprocalRelationship rhs = ((ReciprocalRelationship) other);
