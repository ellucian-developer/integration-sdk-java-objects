...
package com.ellucian.generated.eedm.vendor_payment_terms.v8_0;
...
public class VendorPaymentTerms {
     ...
     * ID
     * <p>
     * The global identifier of the vendor payment term.
     * (Required)
     * 
     */
    @JsonProperty("id")
     ...
     * Title
     * <p>
     * The full name of the vendor payment term.
     * (Required)
     * 
     */
    @JsonProperty("title")
    ...
    public String toString() {
        ...
        sb.append(VendorPaymentTerms.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("metadata");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VendorPaymentTerms) == false) {
            return false;
        }
        VendorPaymentTerms rhs = ((VendorPaymentTerms) other);
