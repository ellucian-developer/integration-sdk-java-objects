...
package com.ellucian.generated.eedm.rooms.v9_0;
...
public class RoomCharacteristic {
     ...
     */
    @JsonProperty("id")
    @JsonPropertyDescription("The global identifier for the Room Characteristics.")
    private String id;
    ...
    public RoomCharacteristic withId(String id) {
        this.id = id;
        return this;
    }
