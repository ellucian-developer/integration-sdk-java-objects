...
public class InstitutionPositions {
    ...
    @JsonPropertyDescription("The operational units of the institution to which the position belongs.")
    ...
    @JsonPropertyDescription("The accounting strings associated with the position.")
    ...
    @JsonPropertyDescription("The employment classification associated with the position.")
    ...
    public InstitutionPositions withAccountingStrings(List<String> accountingStrings) {
        this.accountingStrings = accountingStrings;
        return this;
    }
    ...
    public InstitutionPositions withCompensation(Compensation compensation) {
        this.compensation = compensation;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((((((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata)))&&((this.campus == rhs.campus)||((this.campus!= null)&&this.campus.equals(rhs.campus))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.reportsTo == rhs.reportsTo)||((this.reportsTo!= null)&&this.reportsTo.equals(rhs.reportsTo))))&&((this.startOn == rhs.startOn)||((this.startOn!= null)&&this.startOn.equals(rhs.startOn))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this.classification == rhs.classification)||((this.classification!= null)&&this.classification.equals(rhs.classification))))&&((this.hoursPerPeriod == rhs.hoursPerPeriod)||((this.hoursPerPeriod!= null)&&this.hoursPerPeriod.equals(rhs.hoursPerPeriod))))&&((this.endOn == rhs.endOn)||((this.endOn!= null)&&this.endOn.equals(rhs.endOn))))&&((this.fullTimeEquivalent == rhs.fullTimeEquivalent)||((this.fullTimeEquivalent!= null)&&this.fullTimeEquivalent.equals(rhs.fullTimeEquivalent))))&&((this.compensation == rhs.compensation)||((this.compensation!= null)&&this.compensation.equals(rhs.compensation))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.departments == rhs.departments)||((this.departments!= null)&&this.departments.equals(rhs.departments))))&&((this.accountingStrings == rhs.accountingStrings)||((this.accountingStrings!= null)&&this.accountingStrings.equals(rhs.accountingStrings))))&&((this.authorizedOn == rhs.authorizedOn)||((this.authorizedOn!= null)&&this.authorizedOn.equals(rhs.authorizedOn))))&&((this.exemptionType == rhs.exemptionType)||((this.exemptionType!= null)&&this.exemptionType.equals(rhs.exemptionType))))&&((this.bargainingUnit == rhs.bargainingUnit)||((this.bargainingUnit!= null)&&this.bargainingUnit.equals(rhs.bargainingUnit))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
