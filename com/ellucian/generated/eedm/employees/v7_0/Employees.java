...
package com.ellucian.generated.eedm.employees.v7_0;
...
public class Employees {
    ...
    @JsonPropertyDescription("The type of employment (Eg. Full-time or Part-time)")
    private Employees.ContractType contractType;
    /**
     * Pay Status
     * <p>
    ...
    @JsonPropertyDescription("The pay status of the employee (with pay, without pay or partial pay)")
    ...
    @JsonPropertyDescription("The benefits status of the employee. (with or without benefits)")
     ...
     */
    @JsonProperty("status")
    @JsonPropertyDescription("The employment status (active, terminated, on leave)")
     ...
     */
    @JsonProperty("contractType")
    public Employees.ContractType getContractType() {
        return contractType;
    }
     ...
     */
    @JsonProperty("contractType")
    public void setContractType(Employees.ContractType contractType) {
        this.contractType = contractType;
    }

    public Employees withContractType(Employees.ContractType contractType) {
        this.contractType = contractType;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata)))&&((this.campus == rhs.campus)||((this.campus!= null)&&this.campus.equals(rhs.campus))))&&((this.contractType == rhs.contractType)||((this.contractType!= null)&&this.contractType.equals(rhs.contractType))))&&((this.benefitsStatus == rhs.benefitsStatus)||((this.benefitsStatus!= null)&&this.benefitsStatus.equals(rhs.benefitsStatus))))&&((this.startOn == rhs.startOn)||((this.startOn!= null)&&this.startOn.equals(rhs.startOn))))&&((this.rehireableStatus == rhs.rehireableStatus)||((this.rehireableStatus!= null)&&this.rehireableStatus.equals(rhs.rehireableStatus))))&&((this.person == rhs.person)||((this.person!= null)&&this.person.equals(rhs.person))))&&((this.leaveReason == rhs.leaveReason)||((this.leaveReason!= null)&&this.leaveReason.equals(rhs.leaveReason))))&&((this.hoursPerPeriod == rhs.hoursPerPeriod)||((this.hoursPerPeriod!= null)&&this.hoursPerPeriod.equals(rhs.hoursPerPeriod))))&&((this.endOn == rhs.endOn)||((this.endOn!= null)&&this.endOn.equals(rhs.endOn))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.payStatus == rhs.payStatus)||((this.payStatus!= null)&&this.payStatus.equals(rhs.payStatus))))&&((this.terminationReason == rhs.terminationReason)||((this.terminationReason!= null)&&this.terminationReason.equals(rhs.terminationReason))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
    ...
    public enum ContractType {
        ...
        private final static Map<String, Employees.ContractType> CONSTANTS = new HashMap<String, Employees.ContractType>();

        static {
            for (Employees.ContractType c: values()) {
        ...
        @JsonCreator
        public static Employees.ContractType fromValue(String value) {
            Employees.ContractType constant = CONSTANTS.get(value);
            if (constant == null) {
