...
package com.ellucian.generated.eedm.student_cohorts.v7_0;
...
public class StudentCohorts {
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata)))&&((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code))))&&((this.endOn == rhs.endOn)||((this.endOn!= null)&&this.endOn.equals(rhs.endOn))))&&((this.finalAcademicPeriod == rhs.finalAcademicPeriod)||((this.finalAcademicPeriod!= null)&&this.finalAcademicPeriod.equals(rhs.finalAcademicPeriod))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.startOn == rhs.startOn)||((this.startOn!= null)&&this.startOn.equals(rhs.startOn))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this.initialAcademicPeriod == rhs.initialAcademicPeriod)||((this.initialAcademicPeriod!= null)&&this.initialAcademicPeriod.equals(rhs.initialAcademicPeriod))));
    }
