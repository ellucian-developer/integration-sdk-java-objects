...
public class AwardsByPeriod {
     ...
     */
    @JsonProperty("status")
    @JsonPropertyDescription("Status of the financial aid award.")
    ...
    @JsonPropertyDescription("Details of disbursements by award period.")
    private List<Disbursement> disbursements = new ArrayList<Disbursement>();
    ...
    public AwardsByPeriod withStatus(Status status) {
        this.status = status;
        return this;
    }
    ...
    public AwardsByPeriod withDisbursements(List<Disbursement> disbursements) {
        this.disbursements = disbursements;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return ((((((this.awardPeriod == rhs.awardPeriod)||((this.awardPeriod!= null)&&this.awardPeriod.equals(rhs.awardPeriod)))&&((this.academicPeriods == rhs.academicPeriods)||((this.academicPeriods!= null)&&this.academicPeriods.equals(rhs.academicPeriods))))&&((this.amounts == rhs.amounts)||((this.amounts!= null)&&this.amounts.equals(rhs.amounts))))&&((this.disbursements == rhs.disbursements)||((this.disbursements!= null)&&this.disbursements.equals(rhs.disbursements))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
