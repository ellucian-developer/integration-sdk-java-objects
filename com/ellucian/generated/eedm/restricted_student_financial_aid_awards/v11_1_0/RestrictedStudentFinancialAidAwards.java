...
public class RestrictedStudentFinancialAidAwards {
     ...
     * ID
     * <p>
     * The global identifier of the restricted student financial aid award.
     * (Required)
     * 
     */
    @JsonProperty("id")
    @JsonPropertyDescription("The global identifier of the restricted student financial aid award.")
    private String id;
    /**
     * Student
     * <p>
     * The student who will be receiving the financial aid award.
     * (Required)
     * 
     */
    @JsonProperty("student")
    @JsonPropertyDescription("The student who will be receiving the financial aid award.")
    ...
    @JsonPropertyDescription("The date of the first offer.")
    ...
    public RestrictedStudentFinancialAidAwards withMetadata(Metadata metadata) {
        this.metadata = metadata;
        return this;
    }
    ...
    public RestrictedStudentFinancialAidAwards withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public RestrictedStudentFinancialAidAwards withStudent(Student student) {
        this.student = student;
        return this;
    }
    ...
    public RestrictedStudentFinancialAidAwards withAwardFund(AwardFund awardFund) {
        this.awardFund = awardFund;
        return this;
    }
    ...
    public RestrictedStudentFinancialAidAwards withAidYear(AidYear aidYear) {
        this.aidYear = aidYear;
        return this;
    }
    ...
    public RestrictedStudentFinancialAidAwards withOriginallyOfferedOn(Object originallyOfferedOn) {
        this.originallyOfferedOn = originallyOfferedOn;
        return this;
    }
    ...
    public RestrictedStudentFinancialAidAwards withAwardsByPeriod(List<AwardsByPeriod> awardsByPeriod) {
        this.awardsByPeriod = awardsByPeriod;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RestrictedStudentFinancialAidAwards.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("metadata");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RestrictedStudentFinancialAidAwards) == false) {
            return false;
        }
        RestrictedStudentFinancialAidAwards rhs = ((RestrictedStudentFinancialAidAwards) other);
