...
public class SocialMedium {
     ...
     */
    @JsonProperty("type")
    @JsonPropertyDescription("A type of social media account for the unit. Includes a standard type (e.g. 'skype', 'facebook') and an optional, custom type to further identify the type of social media account.")
