...
package com.ellucian.generated.eedm.admission_application_supporting_item_types.v6_0;
...
public class AdmissionApplicationSupportingItemTypes {
     ...
     */
    @JsonProperty("id")
    @JsonPropertyDescription("The global identifier of the type of admission application supporting items")
    private String id;
    /**
     * Title
     * <p>
     ...
     */
    @JsonProperty("title")
    @JsonPropertyDescription("The full name of the type of admission application supporting items")
    ...
    @JsonPropertyDescription("The description of the type of admission application supporting items")
