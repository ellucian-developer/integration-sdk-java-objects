...
public class Rate {
    ...
    private Rate.Currency currency;
    ...
    public enum Currency {
        ...
        private final static Map<String, Rate.Currency> CONSTANTS = new HashMap<String, Rate.Currency>();

        static {
            for (Rate.Currency c: values()) {
        ...
        @JsonCreator
        public static Rate.Currency fromValue(String value) {
            Rate.Currency constant = CONSTANTS.get(value);
            if (constant == null) {
