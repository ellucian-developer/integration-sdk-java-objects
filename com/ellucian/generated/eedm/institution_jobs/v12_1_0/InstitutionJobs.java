...
public class InstitutionJobs {
     ...
     */
    @JsonProperty("suffix")
    @JsonPropertyDescription("Suffix is a two-character identification that distinguishes jobs. Unless otherwise specified, the first job associated with a position has a suffix of '00', the second job would be a suffix of '01, and so on.")
    ...
    public InstitutionJobs withSuffix(Object suffix) {
        this.suffix = suffix;
        return this;
    }
