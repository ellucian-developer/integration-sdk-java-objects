...
public class Phone {
     ...
     */
    @JsonProperty("type")
    @JsonPropertyDescription("A type of phone for a prospect. Includes a standard type (e.g. 'mobile', 'home') and an optional, custom type to further identify the type of phone.")
