...
public class Email {
     ...
     */
    @JsonProperty("type")
    @JsonPropertyDescription("A type of email for a prospect. Includes a standard type (e.g. 'personal', 'business') and an optional, custom type to further identify the type of email.")
    private Type type;
    /**
     * Preferred Email
     * <p>
    ...
    @JsonPropertyDescription("Specifies if the email is preferred over others of the same type or overall. Only one email should be set to primary for a prospect.")
    ...
    @JsonPropertyDescription("An email address for the prospect.")
    ...
    public Email withType(Type type) {
        this.type = type;
        return this;
    }
