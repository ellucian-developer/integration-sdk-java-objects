...
public class LedgerActivities {
    ...
    @JsonPropertyDescription("The ledger type associated with the activity (general or operating).")
     ...
     */
    @JsonProperty("ledgerType")
    public void setLedgerType(Object ledgerType) {
        this.ledgerType = ledgerType;
    }

    public LedgerActivities withLedgerType(Object ledgerType) {
        this.ledgerType = ledgerType;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append('=');
        sb.append(((this.ledgerType == null)?"<null>":this.ledgerType));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.ledgerType == null)? 0 :this.ledgerType.hashCode()));
