...
public class ConstituentPersons {
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((((((((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata)))&&((this.preferredLanguage == rhs.preferredLanguage)||((this.preferredLanguage!= null)&&this.preferredLanguage.equals(rhs.preferredLanguage))))&&((this.addresses == rhs.addresses)||((this.addresses!= null)&&this.addresses.equals(rhs.addresses))))&&((this.death == rhs.death)||((this.death!= null)&&this.death.equals(rhs.death))))&&((this.gender == rhs.gender)||((this.gender!= null)&&this.gender.equals(rhs.gender))))&&((this.credentials == rhs.credentials)||((this.credentials!= null)&&this.credentials.equals(rhs.credentials))))&&((this.birth == rhs.birth)||((this.birth!= null)&&this.birth.equals(rhs.birth))))&&((this.phones == rhs.phones)||((this.phones!= null)&&this.phones.equals(rhs.phones))))&&((this.nationalities == rhs.nationalities)||((this.nationalities!= null)&&this.nationalities.equals(rhs.nationalities))))&&((this.socialMedia == rhs.socialMedia)||((this.socialMedia!= null)&&this.socialMedia.equals(rhs.socialMedia))))&&((this.religion == rhs.religion)||((this.religion!= null)&&this.religion.equals(rhs.religion))))&&((this.ethnicCategory == rhs.ethnicCategory)||((this.ethnicCategory!= null)&&this.ethnicCategory.equals(rhs.ethnicCategory))))&&((this.vocation == rhs.vocation)||((this.vocation!= null)&&this.vocation.equals(rhs.vocation))))&&((this.emails == rhs.emails)||((this.emails!= null)&&this.emails.equals(rhs.emails))))&&((this.names == rhs.names)||((this.names!= null)&&this.names.equals(rhs.names))))&&((this.affiliation == rhs.affiliation)||((this.affiliation!= null)&&this.affiliation.equals(rhs.affiliation))))&&((this.person == rhs.person)||((this.person!= null)&&this.person.equals(rhs.person))))&&((this.races == rhs.races)||((this.races!= null)&&this.races.equals(rhs.races))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
