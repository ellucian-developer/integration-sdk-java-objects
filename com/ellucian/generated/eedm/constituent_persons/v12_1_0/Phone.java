...
public class Phone {
    ...
    @JsonPropertyDescription("The date when the phone number was first valid.")
     ...
     */
    @JsonProperty("endOn")
    @JsonPropertyDescription("The date when the phone number was last valid.")
    ...
    public Phone withType(Type__6 type) {
        this.type = type;
        return this;
    }
    ...
    public Phone withPrivacy(Object privacy) {
        this.privacy = privacy;
        return this;
    }
