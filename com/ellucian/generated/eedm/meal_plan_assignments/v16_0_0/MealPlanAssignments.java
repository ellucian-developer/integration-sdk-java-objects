...
package com.ellucian.generated.eedm.meal_plan_assignments.v16_0_0;
...
public class MealPlanAssignments {
     ...
     * Assigned Rates
     * <p>
     * The effective regular rate(s) for the meal plan assignment.
     * 
     */
    @JsonProperty("assignedRates")
    @JsonPropertyDescription("The effective regular rate(s) for the meal plan assignment.")
    private List<AssignedRate> assignedRates = new ArrayList<AssignedRate>();
    /**
     * Rate Override
     * <p>
     ...
     */
    @JsonProperty("assignedRates")
    public List<AssignedRate> getAssignedRates() {
        return assignedRates;
    }
     ...
     */
    @JsonProperty("assignedRates")
    public void setAssignedRates(List<AssignedRate> assignedRates) {
        this.assignedRates = assignedRates;
    }

    public MealPlanAssignments withAssignedRates(List<AssignedRate> assignedRates) {
        this.assignedRates = assignedRates;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("assignedRates");
        sb.append('=');
        sb.append(((this.assignedRates == null)?"<null>":this.assignedRates));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.assignedRates == null)? 0 :this.assignedRates.hashCode()));
