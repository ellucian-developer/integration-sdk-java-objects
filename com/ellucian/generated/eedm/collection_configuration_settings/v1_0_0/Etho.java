...
public class Etho {
     ...
     * Resource
     * <p>
     * The Ethos resource to which the collection configuration applies.
     * (Required)
     * 
     */
    @JsonProperty("resource")
    @JsonPropertyDescription("The Ethos resource to which the collection configuration applies.")
    private String resource;
    /**
     * Property Name
     * <p>
     * The Ethos property to which the collection configuration applies.
     * 
     */
    @JsonProperty("propertyName")
    @JsonPropertyDescription("The Ethos property to which the collection configuration applies.")
