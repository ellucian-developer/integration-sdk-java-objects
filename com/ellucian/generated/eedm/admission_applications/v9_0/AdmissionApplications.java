...
public class AdmissionApplications {
    ...
    @JsonPropertyDescription("The latest or final decision for the application")
    ...
    public AdmissionApplications withApplicant(Object applicant) {
        this.applicant = applicant;
        return this;
    }
    ...
    public AdmissionApplications withLatestDecision(Object latestDecision) {
        this.latestDecision = latestDecision;
        return this;
    }
