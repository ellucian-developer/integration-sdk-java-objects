...
public class Address {
     ...
     */
    @JsonProperty("type")
    @JsonPropertyDescription("A type of location for the organization. Includes a standard type (e.g. 'main', 'support') and an optional, custom type to further identify the type of location.")
     ...
     */
    @JsonProperty("status")
    @JsonPropertyDescription("The current status of the organization's relationship to the address")
    ...
    @JsonPropertyDescription("The earliest date that this address was valid for the organization")
     ...
     */
    @JsonProperty("endOn")
    @JsonPropertyDescription("The latest date when this address was valid for the organization")
    ...
    @JsonPropertyDescription("Specifies if the address is preferred over other addresses.")
    ...
    public Address withType(Type__3 type) {
        this.type = type;
        return this;
    }
