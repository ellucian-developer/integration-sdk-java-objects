...
public class Phone {
    ...
    @JsonPropertyDescription("The availability of the contact for this number.")
    ...
    @JsonPropertyDescription("The country calling code of the telephone and/or mobile device when dialing internationally.")
    ...
    public Phone withCountryCallingCode(String countryCallingCode) {
        this.countryCallingCode = countryCallingCode;
        return this;
    }
