...
public class Phone {
     ...
     */
    @JsonProperty("type")
    @JsonPropertyDescription("A type of phone for the institution. Includes a standard type (e.g., 'main', 'support') and an optional, custom type to further identify the type of phone.")
