...
public class Candidate {
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((this.firstName == rhs.firstName)||((this.firstName!= null)&&this.firstName.equals(rhs.firstName)))&&((this.lastName == rhs.lastName)||((this.lastName!= null)&&this.lastName.equals(rhs.lastName))))&&((this.nationality == rhs.nationality)||((this.nationality!= null)&&this.nationality.equals(rhs.nationality))))&&((this.disabilityDisclosure == rhs.disabilityDisclosure)||((this.disabilityDisclosure!= null)&&this.disabilityDisclosure.equals(rhs.disabilityDisclosure))))&&((this.englishLanguageQualification == rhs.englishLanguageQualification)||((this.englishLanguageQualification!= null)&&this.englishLanguageQualification.equals(rhs.englishLanguageQualification))))&&((this.dateOfBirth == rhs.dateOfBirth)||((this.dateOfBirth!= null)&&this.dateOfBirth.equals(rhs.dateOfBirth))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.ukResidencyStatus == rhs.ukResidencyStatus)||((this.ukResidencyStatus!= null)&&this.ukResidencyStatus.equals(rhs.ukResidencyStatus))))&&((this.englishMainLanguage == rhs.englishMainLanguage)||((this.englishMainLanguage!= null)&&this.englishMainLanguage.equals(rhs.englishMainLanguage))))&&((this.otherLanguage == rhs.otherLanguage)||((this.otherLanguage!= null)&&this.otherLanguage.equals(rhs.otherLanguage))));
    }
