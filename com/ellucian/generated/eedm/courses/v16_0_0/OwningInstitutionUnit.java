...
public class OwningInstitutionUnit {
    ...
    @JsonPropertyDescription("A School, College, Division, Department, or any other organizational unit in the institution")
    ...
    @JsonPropertyDescription("The portion of a course that is owned or allocated to a particular organization.")
