...
public class Preferred {
    ...
    public Preferred withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Preferred.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Preferred) == false) {
            return false;
        }
        Preferred rhs = ((Preferred) other);
