...
public class BudgetPhase {
     ...
     * ID
     * <p>
     * The global identifier for the Budget Phase.
     * (Required)
     * 
     */
    @JsonProperty("id")
    ...
    public String toString() {
        ...
        sb.append(BudgetPhase.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BudgetPhase) == false) {
            return false;
        }
        BudgetPhase rhs = ((BudgetPhase) other);
