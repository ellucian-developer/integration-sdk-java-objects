...
public class Type__4 {
    ...
    private Type__4 .SocialMediaType socialMediaType;
    /**
     * Detail
     * <p>
     ...
     */
    @JsonProperty("detail")
    @JsonPropertyDescription("Additional details about the type of social media.")
     ...
     */
    @JsonProperty("socialMediaType")
    public Type__4 .SocialMediaType getSocialMediaType() {
     ...
     */
    @JsonProperty("socialMediaType")
    public void setSocialMediaType(Type__4 .SocialMediaType socialMediaType) {
        this.socialMediaType = socialMediaType;
    }

    public Type__4 withSocialMediaType(Type__4 .SocialMediaType socialMediaType) {
        this.socialMediaType = socialMediaType;
        return this;
    }
    ...
    public enum SocialMediaType {
        ...
        private final static Map<String, Type__4 .SocialMediaType> CONSTANTS = new HashMap<String, Type__4 .SocialMediaType>();

        static {
            for (Type__4 .SocialMediaType c: values()) {
        ...
        @JsonCreator
        public static Type__4 .SocialMediaType fromValue(String value) {
            Type__4 .SocialMediaType constant = CONSTANTS.get(value);
            if (constant == null) {
