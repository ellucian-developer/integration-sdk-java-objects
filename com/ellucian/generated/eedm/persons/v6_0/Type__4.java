...
public class Type__4 {
    ...
    private Type__4 .EmailType emailType;
    /**
     * Detail
     * <p>
     ...
     */
    @JsonProperty("detail")
    @JsonPropertyDescription("An optional, custom email type.")
     ...
     */
    @JsonProperty("emailType")
    public Type__4 .EmailType getEmailType() {
        return emailType;
    }
     ...
     */
    @JsonProperty("emailType")
    public void setEmailType(Type__4 .EmailType emailType) {
        this.emailType = emailType;
    }

    public Type__4 withEmailType(Type__4 .EmailType emailType) {
        this.emailType = emailType;
        return this;
    }
    ...
    public enum EmailType {
        ...
        private final static Map<String, Type__4 .EmailType> CONSTANTS = new HashMap<String, Type__4 .EmailType>();

        static {
            for (Type__4 .EmailType c: values()) {
        ...
        @JsonCreator
        public static Type__4 .EmailType fromValue(String value) {
            Type__4 .EmailType constant = CONSTANTS.get(value);
            if (constant == null) {
