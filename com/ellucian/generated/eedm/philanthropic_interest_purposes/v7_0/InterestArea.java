...
public class InterestArea {
    ...
    public String toString() {
        ...
        sb.append(InterestArea.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof InterestArea) == false) {
            return false;
        }
        InterestArea rhs = ((InterestArea) other);
