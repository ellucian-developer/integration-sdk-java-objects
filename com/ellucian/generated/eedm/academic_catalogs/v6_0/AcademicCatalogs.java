...
package com.ellucian.generated.eedm.academic_catalogs.v6_0;
...
public class AcademicCatalogs {
     ...
     */
    @JsonProperty("status")
    @JsonPropertyDescription("A status of an academic catalog. ")
    private AcademicCatalogs.Status status;
    /**
     * Institution
     * <p>
     ...
     */
    @JsonProperty("status")
    public AcademicCatalogs.Status getStatus() {
        return status;
    }
     ...
     */
    @JsonProperty("status")
    public void setStatus(AcademicCatalogs.Status status) {
        this.status = status;
    }

    public AcademicCatalogs withStatus(AcademicCatalogs.Status status) {
        this.status = status;
        return this;
    }
    ...
    public enum Status {
        ...
        private final static Map<String, AcademicCatalogs.Status> CONSTANTS = new HashMap<String, AcademicCatalogs.Status>();

        static {
            for (AcademicCatalogs.Status c: values()) {
        ...
        @JsonCreator
        public static AcademicCatalogs.Status fromValue(String value) {
            AcademicCatalogs.Status constant = CONSTANTS.get(value);
            if (constant == null) {
