...
package com.ellucian.generated.eedm.currencies.v1_0_0;
...
public class Currencies {
     ...
     * ID
     * <p>
     * The global identifier of the currency.
     * (Required)
     * 
     */
    @JsonProperty("id")
    @JsonPropertyDescription("The global identifier of the currency.")
    private String id;
    /**
     * Title
     * <p>
     ...
     */
    @JsonProperty("title")
    @JsonPropertyDescription("The full name of the currency.")
     ...
     */
    @JsonProperty("code")
    @JsonPropertyDescription("The code used to identify the currency.")
    private String code;
    /**
     * ISO Code
     * <p>
    ...
    @JsonPropertyDescription("The ISO code used to identify the currency.")
    ...
    public Currencies withMetadata(Metadata metadata) {
        this.metadata = metadata;
        return this;
    }
    ...
    public Currencies withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public Currencies withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public Currencies withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public Currencies withIsoCode(String isoCode) {
        this.isoCode = isoCode;
        return this;
    }
