...
public class SourceOption {
     ...
     */
    @JsonProperty("title")
    @JsonPropertyDescription("The source title for the configuration setting option.")
     ...
     */
    @JsonProperty("value")
    @JsonPropertyDescription("The source value for the configuration setting option.")
     ...
     */
    @JsonProperty("origin")
    @JsonPropertyDescription("The origin for the source configuration setting option.")
