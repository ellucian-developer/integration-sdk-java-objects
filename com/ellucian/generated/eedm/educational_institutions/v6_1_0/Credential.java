...
public class Credential {
     ...
     */
    @JsonProperty("type")
    @JsonPropertyDescription("The type of credential, such as \"Person ID\", \"Organization ID\", \"System ID\", etc.")
     ...
     * Start On
     * <p>
     * The date when the credential becomes valid.
     * 
     */
    @JsonProperty("startOn")
    @JsonPropertyDescription("The date when the credential becomes valid.")
    private Object startOn;
    /**
     * End On
     * <p>
     * The date when the credential becomes invalid.
     * 
     */
    @JsonProperty("endOn")
    @JsonPropertyDescription("The date when the credential becomes invalid.")
