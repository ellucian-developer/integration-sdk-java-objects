...
public class Email {
     ...
     */
    @JsonProperty("type")
    @JsonPropertyDescription("A type of email for the institution. Includes a standard type (e.g. 'general', 'hr') and an optional, custom type to further identify the type of email.")
    ...
    @JsonPropertyDescription("An email address for the institution")
