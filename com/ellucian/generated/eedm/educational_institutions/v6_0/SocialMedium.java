...
public class SocialMedium {
     ...
     */
    @JsonProperty("type")
    @JsonPropertyDescription("A type of social media account for the institution. Includes a standard type (e.g. 'skype', 'facebook') and an optional, custom type to further identify the type of social media account.")
    ...
    @JsonPropertyDescription("Specifies if the social media account is preferred over others of the same type.")
    ...
    public SocialMedium withType(Type__3 type) {
        this.type = type;
        return this;
    }
