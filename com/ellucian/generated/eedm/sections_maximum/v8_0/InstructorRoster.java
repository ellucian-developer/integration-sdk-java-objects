...
public class InstructorRoster {
    ...
    private InstructorRoster.InstructorRole instructorRole;
    /**
     * Work Load
     * <p>
     ...
     */
    @JsonProperty("instructorRole")
    public InstructorRoster.InstructorRole getInstructorRole() {
     ...
     */
    @JsonProperty("instructorRole")
    public void setInstructorRole(InstructorRoster.InstructorRole instructorRole) {
        this.instructorRole = instructorRole;
    }

    public InstructorRoster withInstructorRole(InstructorRoster.InstructorRole instructorRole) {
        this.instructorRole = instructorRole;
        return this;
    }
    ...
    public enum InstructorRole {
        ...
        private final static Map<String, InstructorRoster.InstructorRole> CONSTANTS = new HashMap<String, InstructorRoster.InstructorRole>();

        static {
            for (InstructorRoster.InstructorRole c: values()) {
        ...
        public static InstructorRoster.InstructorRole fromValue(String value) {
            InstructorRoster.InstructorRole constant = CONSTANTS.get(value);
            if (constant == null) {
