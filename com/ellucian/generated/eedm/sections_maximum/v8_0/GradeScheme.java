...
public class GradeScheme {
    ...
    public GradeScheme withAcademicLevel(AcademicLevel__1 academicLevel) {
        this.academicLevel = academicLevel;
        return this;
    }
     ...
     */
    @JsonProperty("gradeMode")
    public void setGradeMode(GradeMode gradeMode) {
        this.gradeMode = gradeMode;
    }

    public GradeScheme withGradeMode(GradeMode gradeMode) {
        this.gradeMode = gradeMode;
        return this;
    }
    ...
    public GradeScheme withDetail(Detail__6 detail) {
        this.detail = detail;
        return this;
    }
