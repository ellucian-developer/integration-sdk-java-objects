...
public class Detail__9 {
    ...
    public Detail__9 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Detail__9 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Detail__9) == false) {
            return false;
        }
        Detail__9 rhs = ((Detail__9) other);
