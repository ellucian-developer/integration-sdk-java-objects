...
public class Detail__6 {
    ...
    public Detail__6 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Detail__6 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Detail__6) == false) {
            return false;
        }
        Detail__6 rhs = ((Detail__6) other);
