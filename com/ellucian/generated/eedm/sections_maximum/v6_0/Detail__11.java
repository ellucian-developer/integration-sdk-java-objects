...
public class Detail__11 {
    ...
    public Detail__11 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Detail__11 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Detail__11) == false) {
            return false;
        }
        Detail__11 rhs = ((Detail__11) other);
