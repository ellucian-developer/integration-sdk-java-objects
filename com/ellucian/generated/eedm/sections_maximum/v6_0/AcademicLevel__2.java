...
public class AcademicLevel__2 {
    ...
    public AcademicLevel__2 withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public AcademicLevel__2 withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public AcademicLevel__2 withDetail(Detail__6 detail) {
        this.detail = detail;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AcademicLevel__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("code");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AcademicLevel__2) == false) {
            return false;
        }
        AcademicLevel__2 rhs = ((AcademicLevel__2) other);
