...
public class GeneralLedgerTransactions {
    ...
    public boolean equals(Object other) {
        ...
        return ((((((this.submittedBy == rhs.submittedBy)||((this.submittedBy!= null)&&this.submittedBy.equals(rhs.submittedBy)))&&((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.processMode == rhs.processMode)||((this.processMode!= null)&&this.processMode.equals(rhs.processMode))))&&((this.transactions == rhs.transactions)||((this.transactions!= null)&&this.transactions.equals(rhs.transactions))));
    }
