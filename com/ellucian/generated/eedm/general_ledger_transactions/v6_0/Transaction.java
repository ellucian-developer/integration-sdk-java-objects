...
public class Transaction {
     ...
     * 
     */
    @JsonProperty("referenceOrganization")
    ...
    public Transaction withReferenceOrganization(String referenceOrganization) {
        this.referenceOrganization = referenceOrganization;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("referenceOrganization");
        sb.append('=');
        sb.append(((this.referenceOrganization == null)?"<null>":this.referenceOrganization));
        sb.append(',');
        sb.append("reference");
        sb.append('=');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.referenceOrganization == null)? 0 :this.referenceOrganization.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((this.transactionTypeReferenceDate == rhs.transactionTypeReferenceDate)||((this.transactionTypeReferenceDate!= null)&&this.transactionTypeReferenceDate.equals(rhs.transactionTypeReferenceDate)))&&((this.reference == rhs.reference)||((this.reference!= null)&&this.reference.equals(rhs.reference))))&&((this.ledgerDate == rhs.ledgerDate)||((this.ledgerDate!= null)&&this.ledgerDate.equals(rhs.ledgerDate))))&&((this.referenceNumber == rhs.referenceNumber)||((this.referenceNumber!= null)&&this.referenceNumber.equals(rhs.referenceNumber))))&&((this.transactionNumber == rhs.transactionNumber)||((this.transactionNumber!= null)&&this.transactionNumber.equals(rhs.transactionNumber))))&&((this.referenceOrganization == rhs.referenceOrganization)||((this.referenceOrganization!= null)&&this.referenceOrganization.equals(rhs.referenceOrganization))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.transactionDetailLines == rhs.transactionDetailLines)||((this.transactionDetailLines!= null)&&this.transactionDetailLines.equals(rhs.transactionDetailLines))));
    }
