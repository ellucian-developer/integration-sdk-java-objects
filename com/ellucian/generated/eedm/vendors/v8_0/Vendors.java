...
public class Vendors {
     ...
     * 
     */
    @JsonProperty("relatedVendor")
    @JsonPropertyDescription("The vendor assigned to receive payment for this vendor or the parent vendor.")
    private List<RelatedVendor> relatedVendor = new ArrayList<RelatedVendor>();
    /**
     * Classifications
     * <p>
    ...
    public Vendors withRelatedVendor(List<RelatedVendor> relatedVendor) {
        this.relatedVendor = relatedVendor;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("relatedVendor");
        sb.append('=');
        sb.append(((this.relatedVendor == null)?"<null>":this.relatedVendor));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.relatedVendor == null)? 0 :this.relatedVendor.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((((((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata)))&&((this.vendorDetail == rhs.vendorDetail)||((this.vendorDetail!= null)&&this.vendorDetail.equals(rhs.vendorDetail))))&&((this.startOn == rhs.startOn)||((this.startOn!= null)&&this.startOn.equals(rhs.startOn))))&&((this.classifications == rhs.classifications)||((this.classifications!= null)&&this.classifications.equals(rhs.classifications))))&&((this.paymentSources == rhs.paymentSources)||((this.paymentSources!= null)&&this.paymentSources.equals(rhs.paymentSources))))&&((this.defaultCurrency == rhs.defaultCurrency)||((this.defaultCurrency!= null)&&this.defaultCurrency.equals(rhs.defaultCurrency))))&&((this.endOn == rhs.endOn)||((this.endOn!= null)&&this.endOn.equals(rhs.endOn))))&&((this.relatedVendor == rhs.relatedVendor)||((this.relatedVendor!= null)&&this.relatedVendor.equals(rhs.relatedVendor))))&&((this.statuses == rhs.statuses)||((this.statuses!= null)&&this.statuses.equals(rhs.statuses))))&&((this.vendorHoldReasons == rhs.vendorHoldReasons)||((this.vendorHoldReasons!= null)&&this.vendorHoldReasons.equals(rhs.vendorHoldReasons))))&&((this.comment == rhs.comment)||((this.comment!= null)&&this.comment.equals(rhs.comment))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.paymentTerms == rhs.paymentTerms)||((this.paymentTerms!= null)&&this.paymentTerms.equals(rhs.paymentTerms))));
    }
