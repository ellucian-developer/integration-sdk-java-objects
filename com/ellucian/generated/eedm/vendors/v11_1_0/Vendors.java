...
package com.ellucian.generated.eedm.vendors.v11_1_0;
...
public class Vendors {
    ...
    public Vendors withTaxId(String taxId) {
        this.taxId = taxId;
        return this;
    }
    ...
    public Vendors withDefaultAddresses(List<DefaultAddress> defaultAddresses) {
        this.defaultAddresses = defaultAddresses;
        return this;
    }
    ...
    public Vendors withDefaultTaxFormComponent(Object defaultTaxFormComponent) {
        this.defaultTaxFormComponent = defaultTaxFormComponent;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((((((((((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata)))&&((this.types == rhs.types)||((this.types!= null)&&this.types.equals(rhs.types))))&&((this.vendorDetail == rhs.vendorDetail)||((this.vendorDetail!= null)&&this.vendorDetail.equals(rhs.vendorDetail))))&&((this.startOn == rhs.startOn)||((this.startOn!= null)&&this.startOn.equals(rhs.startOn))))&&((this.classifications == rhs.classifications)||((this.classifications!= null)&&this.classifications.equals(rhs.classifications))))&&((this.paymentSources == rhs.paymentSources)||((this.paymentSources!= null)&&this.paymentSources.equals(rhs.paymentSources))))&&((this.defaultAddresses == rhs.defaultAddresses)||((this.defaultAddresses!= null)&&this.defaultAddresses.equals(rhs.defaultAddresses))))&&((this.taxId == rhs.taxId)||((this.taxId!= null)&&this.taxId.equals(rhs.taxId))))&&((this.defaultCurrency == rhs.defaultCurrency)||((this.defaultCurrency!= null)&&this.defaultCurrency.equals(rhs.defaultCurrency))))&&((this.defaultTaxFormComponent == rhs.defaultTaxFormComponent)||((this.defaultTaxFormComponent!= null)&&this.defaultTaxFormComponent.equals(rhs.defaultTaxFormComponent))))&&((this.endOn == rhs.endOn)||((this.endOn!= null)&&this.endOn.equals(rhs.endOn))))&&((this.statuses == rhs.statuses)||((this.statuses!= null)&&this.statuses.equals(rhs.statuses))))&&((this.relatedVendors == rhs.relatedVendors)||((this.relatedVendors!= null)&&this.relatedVendors.equals(rhs.relatedVendors))))&&((this.vendorHoldReasons == rhs.vendorHoldReasons)||((this.vendorHoldReasons!= null)&&this.vendorHoldReasons.equals(rhs.vendorHoldReasons))))&&((this.comment == rhs.comment)||((this.comment!= null)&&this.comment.equals(rhs.comment))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.paymentTerms == rhs.paymentTerms)||((this.paymentTerms!= null)&&this.paymentTerms.equals(rhs.paymentTerms))));
    }
