...
package com.ellucian.generated.eedm.academic_programs.v7_0;
...
public class AcademicPrograms {
    ...
    private List<ProgramOwner> programOwner = new ArrayList<ProgramOwner>();
    /**
     * Sites
     * <p>
     ...
     */
    @JsonProperty("programOwner")
    public List<ProgramOwner> getProgramOwner() {
        return programOwner;
    }
     ...
     */
    @JsonProperty("programOwner")
    public void setProgramOwner(List<ProgramOwner> programOwner) {
        this.programOwner = programOwner;
    }

    public AcademicPrograms withProgramOwner(List<ProgramOwner> programOwner) {
        this.programOwner = programOwner;
        return this;
    }
    ...
    public AcademicPrograms withStartOn(Date startOn) {
        this.startOn = startOn;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata)))&&((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code))))&&((this.credentials == rhs.credentials)||((this.credentials!= null)&&this.credentials.equals(rhs.credentials))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.sites == rhs.sites)||((this.sites!= null)&&this.sites.equals(rhs.sites))))&&((this.startOn == rhs.startOn)||((this.startOn!= null)&&this.startOn.equals(rhs.startOn))))&&((this.programOwner == rhs.programOwner)||((this.programOwner!= null)&&this.programOwner.equals(rhs.programOwner))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this.academicLevel == rhs.academicLevel)||((this.academicLevel!= null)&&this.academicLevel.equals(rhs.academicLevel))))&&((this.disciplines == rhs.disciplines)||((this.disciplines!= null)&&this.disciplines.equals(rhs.disciplines))))&&((this.authorizing == rhs.authorizing)||((this.authorizing!= null)&&this.authorizing.equals(rhs.authorizing))))&&((this.endOn == rhs.endOn)||((this.endOn!= null)&&this.endOn.equals(rhs.endOn))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
