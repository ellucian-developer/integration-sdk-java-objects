...
public class Type__5 {
    ...
    private Type__5 .SocialMediaType socialMediaType;
    /**
     * Detail
     * <p>
     * 
     ...
     */
    @JsonProperty("socialMediaType")
    public Type__5 .SocialMediaType getSocialMediaType() {
     ...
     */
    @JsonProperty("socialMediaType")
    public void setSocialMediaType(Type__5 .SocialMediaType socialMediaType) {
        this.socialMediaType = socialMediaType;
    }

    public Type__5 withSocialMediaType(Type__5 .SocialMediaType socialMediaType) {
        this.socialMediaType = socialMediaType;
        return this;
    }
    ...
    public enum SocialMediaType {
        ...
        private final static Map<String, Type__5 .SocialMediaType> CONSTANTS = new HashMap<String, Type__5 .SocialMediaType>();

        static {
            for (Type__5 .SocialMediaType c: values()) {
        ...
        @JsonCreator
        public static Type__5 .SocialMediaType fromValue(String value) {
            Type__5 .SocialMediaType constant = CONSTANTS.get(value);
            if (constant == null) {
