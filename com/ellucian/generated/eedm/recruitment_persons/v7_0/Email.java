...
public class Email {
     ...
     */
    @JsonProperty("type")
    @JsonPropertyDescription("A type of email for a person. Includes a standard type (e.g. 'personal', 'business') and an optional, custom type to further identify the type of email.")
     ...
     */
    @JsonProperty("status")
    @JsonPropertyDescription("The status of the email for the person.")
    ...
    @JsonPropertyDescription("Specifies if the email is preferred over others of the same type or overall. Only one email should be set to primary for a person.")
    ...
    @JsonPropertyDescription("An email address for the person.")
    ...
    public Email withType(Type__4 type) {
        this.type = type;
        return this;
    }
