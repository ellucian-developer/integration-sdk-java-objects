...
public class RecruitmentGoalTeams {
     ...
     */
    @JsonProperty("cycle")
    @JsonPropertyDescription("The active recruiting cycle assigned to the goal team.")
    private Cycle cycle;
    /**
     * Owner
     * <p>
    ...
    public RecruitmentGoalTeams withCycle(Cycle cycle) {
        this.cycle = cycle;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((this.owner == rhs.owner)||((this.owner!= null)&&this.owner.equals(rhs.owner)))&&((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata))))&&((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this.cycle == rhs.cycle)||((this.cycle!= null)&&this.cycle.equals(rhs.cycle))));
    }
