...
public class Sections {
     ...
     * <p>
     * The methods, styles, or formats in which the section of a course is taught (for example, 'Lecture', 'Lab') and the associated hours.
     * 
     */
    @JsonProperty("instructionalMethodDetails")
    @JsonPropertyDescription("The methods, styles, or formats in which the section of a course is taught (for example, 'Lecture', 'Lab') and the associated hours.")
    ...
    public Sections withInstructionalMethodDetails(List<InstructionalMethodDetail> instructionalMethodDetails) {
        this.instructionalMethodDetails = instructionalMethodDetails;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((((((((((((((((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata)))&&((this.maxEnrollment == rhs.maxEnrollment)||((this.maxEnrollment!= null)&&this.maxEnrollment.equals(rhs.maxEnrollment))))&&((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code))))&&((this.academicLevels == rhs.academicLevels)||((this.academicLevels!= null)&&this.academicLevels.equals(rhs.academicLevels))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.startOn == rhs.startOn)||((this.startOn!= null)&&this.startOn.equals(rhs.startOn))))&&((this.academicPeriod == rhs.academicPeriod)||((this.academicPeriod!= null)&&this.academicPeriod.equals(rhs.academicPeriod))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this.billing == rhs.billing)||((this.billing!= null)&&this.billing.equals(rhs.billing))))&&((this.duration == rhs.duration)||((this.duration!= null)&&this.duration.equals(rhs.duration))))&&((this.number == rhs.number)||((this.number!= null)&&this.number.equals(rhs.number))))&&((this.owningInstitutionUnits == rhs.owningInstitutionUnits)||((this.owningInstitutionUnits!= null)&&this.owningInstitutionUnits.equals(rhs.owningInstitutionUnits))))&&((this.administrativePeriod == rhs.administrativePeriod)||((this.administrativePeriod!= null)&&this.administrativePeriod.equals(rhs.administrativePeriod))))&&((this.credits == rhs.credits)||((this.credits!= null)&&this.credits.equals(rhs.credits))))&&((this.endOn == rhs.endOn)||((this.endOn!= null)&&this.endOn.equals(rhs.endOn))))&&((this.course == rhs.course)||((this.course!= null)&&this.course.equals(rhs.course))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.censusDates == rhs.censusDates)||((this.censusDates!= null)&&this.censusDates.equals(rhs.censusDates))))&&((this.gradeSchemes == rhs.gradeSchemes)||((this.gradeSchemes!= null)&&this.gradeSchemes.equals(rhs.gradeSchemes))))&&((this.instructionalDeliveryMethod == rhs.instructionalDeliveryMethod)||((this.instructionalDeliveryMethod!= null)&&this.instructionalDeliveryMethod.equals(rhs.instructionalDeliveryMethod))))&&((this.instructionalPlatform == rhs.instructionalPlatform)||((this.instructionalPlatform!= null)&&this.instructionalPlatform.equals(rhs.instructionalPlatform))))&&((this.instructionalMethodDetails == rhs.instructionalMethodDetails)||((this.instructionalMethodDetails!= null)&&this.instructionalMethodDetails.equals(rhs.instructionalMethodDetails))))&&((this.site == rhs.site)||((this.site!= null)&&this.site.equals(rhs.site))))&&((this.courseLevels == rhs.courseLevels)||((this.courseLevels!= null)&&this.courseLevels.equals(rhs.courseLevels))))&&((this.courseCategories == rhs.courseCategories)||((this.courseCategories!= null)&&this.courseCategories.equals(rhs.courseCategories))))&&((this.waitlist == rhs.waitlist)||((this.waitlist!= null)&&this.waitlist.equals(rhs.waitlist))))&&((this.reservedSeatsMaximum == rhs.reservedSeatsMaximum)||((this.reservedSeatsMaximum!= null)&&this.reservedSeatsMaximum.equals(rhs.reservedSeatsMaximum))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
