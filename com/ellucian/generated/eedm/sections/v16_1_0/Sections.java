...
public class Sections {
     ...
     * 
     */
    @JsonProperty("catalogDisplay")
    @JsonPropertyDescription("Describes whether the section is visible in the course catalog.")
    private Object catalogDisplay;
     ...
     */
    @JsonProperty("catalogDisplay")
    public Object getCatalogDisplay() {
     ...
     */
    @JsonProperty("catalogDisplay")
    public void setCatalogDisplay(Object catalogDisplay) {
        this.catalogDisplay = catalogDisplay;
    }

    public Sections withCatalogDisplay(Object catalogDisplay) {
        this.catalogDisplay = catalogDisplay;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("catalogDisplay");
        sb.append('=');
        sb.append(((this.catalogDisplay == null)?"<null>":this.catalogDisplay));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.catalogDisplay == null)? 0 :this.catalogDisplay.hashCode()));
