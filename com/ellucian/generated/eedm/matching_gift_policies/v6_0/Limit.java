...
public class Limit {
    ...
    private Limit.Currency currency;
    ...
    public Limit withValue(Double value) {
        this.value = value;
        return this;
    }
     ...
     */
    @JsonProperty("currency")
    public Limit.Currency getCurrency() {
        return currency;
    }
     ...
     */
    @JsonProperty("currency")
    public void setCurrency(Limit.Currency currency) {
        this.currency = currency;
    }

    public Limit withCurrency(Limit.Currency currency) {
        this.currency = currency;
        return this;
    }
    ...
    public enum Currency {
        ...
        private final static Map<String, Limit.Currency> CONSTANTS = new HashMap<String, Limit.Currency>();

        static {
            for (Limit.Currency c: values()) {
        ...
        @JsonCreator
        public static Limit.Currency fromValue(String value) {
            Limit.Currency constant = CONSTANTS.get(value);
            if (constant == null) {
