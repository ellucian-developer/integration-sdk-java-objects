...
public class Limit__1 {
    ...
    private Limit__1 .Currency currency;
    ...
    public Limit__1 withValue(Double value) {
        this.value = value;
        return this;
    }
     ...
     */
    @JsonProperty("currency")
    public Limit__1 .Currency getCurrency() {
        return currency;
    }
     ...
     */
    @JsonProperty("currency")
    public void setCurrency(Limit__1 .Currency currency) {
        this.currency = currency;
    }

    public Limit__1 withCurrency(Limit__1 .Currency currency) {
        this.currency = currency;
        return this;
    }
    ...
    public enum Currency {
        ...
        private final static Map<String, Limit__1 .Currency> CONSTANTS = new HashMap<String, Limit__1 .Currency>();

        static {
            for (Limit__1 .Currency c: values()) {
        ...
        @JsonCreator
        public static Limit__1 .Currency fromValue(String value) {
            Limit__1 .Currency constant = CONSTANTS.get(value);
            if (constant == null) {
