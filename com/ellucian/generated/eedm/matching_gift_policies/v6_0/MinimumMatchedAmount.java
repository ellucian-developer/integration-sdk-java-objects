...
public class MinimumMatchedAmount {
    ...
    private MinimumMatchedAmount.Currency currency;
    ...
    public String toString() {
        ...
        sb.append(MinimumMatchedAmount.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("value");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MinimumMatchedAmount) == false) {
            return false;
        }
        MinimumMatchedAmount rhs = ((MinimumMatchedAmount) other);
    ...
    public enum Currency {
        ...
        private final static Map<String, MinimumMatchedAmount.Currency> CONSTANTS = new HashMap<String, MinimumMatchedAmount.Currency>();

        static {
            for (MinimumMatchedAmount.Currency c: values()) {
        ...
        @JsonCreator
        public static MinimumMatchedAmount.Currency fromValue(String value) {
            MinimumMatchedAmount.Currency constant = CONSTANTS.get(value);
            if (constant == null) {
