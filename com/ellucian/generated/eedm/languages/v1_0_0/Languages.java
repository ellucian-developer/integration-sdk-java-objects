...
package com.ellucian.generated.eedm.languages.v1_0_0;
...
public class Languages {
     ...
     * ID
     * <p>
     * The global identifier of the language.
     * (Required)
     * 
     */
    @JsonProperty("id")
    @JsonPropertyDescription("The global identifier of the language.")
    private String id;
    /**
     * Title
     * <p>
     ...
     */
    @JsonProperty("title")
    @JsonPropertyDescription("The full name of the language.")
     ...
     */
    @JsonProperty("code")
    @JsonPropertyDescription("The code used to identify the language.")
    private String code;
    /**
     * ISO Code
     * <p>
    ...
    @JsonPropertyDescription("The ISO code used to identify the language.")
    ...
    public Languages withMetadata(Metadata metadata) {
        this.metadata = metadata;
        return this;
    }
    ...
    public Languages withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public Languages withIsoCode(String isoCode) {
        this.isoCode = isoCode;
        return this;
    }
