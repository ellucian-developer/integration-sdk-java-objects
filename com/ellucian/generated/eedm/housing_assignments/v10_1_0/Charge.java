...
package com.ellucian.generated.eedm.housing_assignments.v10_1_0;
...
public class Charge {
     ...
     */
    @JsonProperty("currency")
    public Charge.Currency getCurrency() {
        return currency;
    }
     ...
     */
    @JsonProperty("currency")
    public void setCurrency(Charge.Currency currency) {
        this.currency = currency;
    }

    public Charge withCurrency(Charge.Currency currency) {
        this.currency = currency;
        return this;
    }
    ...
    public enum Currency {
        ...
        private final static Map<String, Charge.Currency> CONSTANTS = new HashMap<String, Charge.Currency>();

        static {
            for (Charge.Currency c: values()) {
        ...
        @JsonCreator
        public static Charge.Currency fromValue(String value) {
            Charge.Currency constant = CONSTANTS.get(value);
            if (constant == null) {
