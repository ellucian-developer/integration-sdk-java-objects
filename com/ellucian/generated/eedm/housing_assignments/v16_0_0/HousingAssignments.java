...
public class HousingAssignments {
     ...
     * Room Rates
     * <p>
     * A reference to the charge(s) to the person for the housing assignment.
     * 
     */
    @JsonProperty("roomRates")
    @JsonPropertyDescription("A reference to the charge(s) to the person for the housing assignment.")
    ...
    public HousingAssignments withRoomRates(List<RoomRate> roomRates) {
        this.roomRates = roomRates;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("roomRates");
        sb.append('=');
        sb.append(((this.roomRates == null)?"<null>":this.roomRates));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.roomRates == null)? 0 :this.roomRates.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((((((((((this.statusDate == rhs.statusDate)||((this.statusDate!= null)&&this.statusDate.equals(rhs.statusDate)))&&((this.request == rhs.request)||((this.request!= null)&&this.request.equals(rhs.request))))&&((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata))))&&((this.ratePeriod == rhs.ratePeriod)||((this.ratePeriod!= null)&&this.ratePeriod.equals(rhs.ratePeriod))))&&((this.contractNumber == rhs.contractNumber)||((this.contractNumber!= null)&&this.contractNumber.equals(rhs.contractNumber))))&&((this.startOn == rhs.startOn)||((this.startOn!= null)&&this.startOn.equals(rhs.startOn))))&&((this.academicPeriod == rhs.academicPeriod)||((this.academicPeriod!= null)&&this.academicPeriod.equals(rhs.academicPeriod))))&&((this.room == rhs.room)||((this.room!= null)&&this.room.equals(rhs.room))))&&((this.additionalCharges == rhs.additionalCharges)||((this.additionalCharges!= null)&&this.additionalCharges.equals(rhs.additionalCharges))))&&((this.person == rhs.person)||((this.person!= null)&&this.person.equals(rhs.person))))&&((this.rateOverride == rhs.rateOverride)||((this.rateOverride!= null)&&this.rateOverride.equals(rhs.rateOverride))))&&((this.endOn == rhs.endOn)||((this.endOn!= null)&&this.endOn.equals(rhs.endOn))))&&((this.roomRates == rhs.roomRates)||((this.roomRates!= null)&&this.roomRates.equals(rhs.roomRates))))&&((this.residentType == rhs.residentType)||((this.residentType!= null)&&this.residentType.equals(rhs.residentType))))&&((this.comment == rhs.comment)||((this.comment!= null)&&this.comment.equals(rhs.comment))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
