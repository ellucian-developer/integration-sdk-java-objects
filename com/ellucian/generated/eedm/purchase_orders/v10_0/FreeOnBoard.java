...
public class FreeOnBoard {
    ...
    public String toString() {
        ...
        sb.append(FreeOnBoard.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FreeOnBoard) == false) {
            return false;
        }
        FreeOnBoard rhs = ((FreeOnBoard) other);
