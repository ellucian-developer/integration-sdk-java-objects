...
public class LineItem {
    ...
    /**
     * Fixed Asset Designation
     * <p>
     * The fixed asset designation associated with the line item.
     * 
     */
    @JsonProperty("fixedAssetDesignation")
    @JsonPropertyDescription("The fixed asset designation associated with the line item.")
    private Object fixedAssetDesignation;
    /**
     * Desired Date
     * <p>
    ...
    private TradeDiscount tradeDiscount;
    /**
     * Comments
     * <p>
     ...
     */
    @JsonProperty("fixedAssetDesignation")
    public Object getFixedAssetDesignation() {
        return fixedAssetDesignation;
    }
     ...
     */
    @JsonProperty("fixedAssetDesignation")
    public void setFixedAssetDesignation(Object fixedAssetDesignation) {
        this.fixedAssetDesignation = fixedAssetDesignation;
    }

    public LineItem withFixedAssetDesignation(Object fixedAssetDesignation) {
        this.fixedAssetDesignation = fixedAssetDesignation;
        return this;
    }
    ...
    public LineItem withStatus(Object status) {
        this.status = status;
        return this;
    }
     ...
     */
    @JsonProperty("tradeDiscount")
    public TradeDiscount getTradeDiscount() {
     ...
     */
    @JsonProperty("tradeDiscount")
    public void setTradeDiscount(TradeDiscount tradeDiscount) {
        this.tradeDiscount = tradeDiscount;
    }

    public LineItem withTradeDiscount(TradeDiscount tradeDiscount) {
        this.tradeDiscount = tradeDiscount;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("fixedAssetDesignation");
        sb.append('=');
        sb.append(((this.fixedAssetDesignation == null)?"<null>":this.fixedAssetDesignation));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.fixedAssetDesignation == null)? 0 :this.fixedAssetDesignation.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((((((((((this.unitPrice == rhs.unitPrice)||((this.unitPrice!= null)&&this.unitPrice.equals(rhs.unitPrice)))&&((this.desiredDate == rhs.desiredDate)||((this.desiredDate!= null)&&this.desiredDate.equals(rhs.desiredDate))))&&((this.quantity == rhs.quantity)||((this.quantity!= null)&&this.quantity.equals(rhs.quantity))))&&((this.comments == rhs.comments)||((this.comments!= null)&&this.comments.equals(rhs.comments))))&&((this.unitOfMeasure == rhs.unitOfMeasure)||((this.unitOfMeasure!= null)&&this.unitOfMeasure.equals(rhs.unitOfMeasure))))&&((this.additionalAmount == rhs.additionalAmount)||((this.additionalAmount!= null)&&this.additionalAmount.equals(rhs.additionalAmount))))&&((this.fixedAssetDesignation == rhs.fixedAssetDesignation)||((this.fixedAssetDesignation!= null)&&this.fixedAssetDesignation.equals(rhs.fixedAssetDesignation))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.discountAmount == rhs.discountAmount)||((this.discountAmount!= null)&&this.discountAmount.equals(rhs.discountAmount))))&&((this.tradeDiscount == rhs.tradeDiscount)||((this.tradeDiscount!= null)&&this.tradeDiscount.equals(rhs.tradeDiscount))))&&((this.reference == rhs.reference)||((this.reference!= null)&&this.reference.equals(rhs.reference))))&&((this.taxCodes == rhs.taxCodes)||((this.taxCodes!= null)&&this.taxCodes.equals(rhs.taxCodes))))&&((this.accountDetails == rhs.accountDetails)||((this.accountDetails!= null)&&this.accountDetails.equals(rhs.accountDetails))))&&((this.commodityCode == rhs.commodityCode)||((this.commodityCode!= null)&&this.commodityCode.equals(rhs.commodityCode))))&&((this.partNumber == rhs.partNumber)||((this.partNumber!= null)&&this.partNumber.equals(rhs.partNumber))))&&((this.lineItemNumber == rhs.lineItemNumber)||((this.lineItemNumber!= null)&&this.lineItemNumber.equals(rhs.lineItemNumber))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
