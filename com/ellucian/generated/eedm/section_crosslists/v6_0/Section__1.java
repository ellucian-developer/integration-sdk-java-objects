...
public class Section__1 {
    ...
    public Section__1 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Section__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Section__1) == false) {
            return false;
        }
        Section__1 rhs = ((Section__1) other);
