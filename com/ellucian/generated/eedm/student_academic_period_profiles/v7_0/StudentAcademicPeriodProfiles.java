...
package com.ellucian.generated.eedm.student_academic_period_profiles.v7_0;
...
public class StudentAcademicPeriodProfiles {
    ...
    @JsonPropertyDescription("A term within an academic year (for example, Semester).")
    ...
    private StudentAcademicPeriodProfiles.AcademicLoad academicLoad;
    /**
     * Tags
     * <p>
     ...
     */
    @JsonProperty("academicLoad")
    public StudentAcademicPeriodProfiles.AcademicLoad getAcademicLoad() {
        return academicLoad;
    }
     ...
     */
    @JsonProperty("academicLoad")
    public void setAcademicLoad(StudentAcademicPeriodProfiles.AcademicLoad academicLoad) {
        this.academicLoad = academicLoad;
    }

    public StudentAcademicPeriodProfiles withAcademicLoad(StudentAcademicPeriodProfiles.AcademicLoad academicLoad) {
        this.academicLoad = academicLoad;
        return this;
    }
    ...
    public enum AcademicLoad {
        ...
        private final static Map<String, StudentAcademicPeriodProfiles.AcademicLoad> CONSTANTS = new HashMap<String, StudentAcademicPeriodProfiles.AcademicLoad>();

        static {
            for (StudentAcademicPeriodProfiles.AcademicLoad c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        AcademicLoad(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static StudentAcademicPeriodProfiles.AcademicLoad fromValue(String value) {
            StudentAcademicPeriodProfiles.AcademicLoad constant = CONSTANTS.get(value);
            if (constant == null) {
