...
package com.ellucian.generated.eedm.student_payments.v16_0_0;
 ...
 * Student Payments
 * <p>
 * Details of payments for a student account (excluding financial aid payments).
 * 
 */
...
public class StudentPayments {
     ...
     * <p>
     * The override description associated with the payment.
     * 
     */
    @JsonProperty("overrideDescription")
    @JsonPropertyDescription("The override description associated with the payment.")
    ...
    public StudentPayments withAcademicPeriod(AcademicPeriod academicPeriod) {
        this.academicPeriod = academicPeriod;
        return this;
    }
    ...
    public StudentPayments withReportingDetail(Object reportingDetail) {
        this.reportingDetail = reportingDetail;
        return this;
    }
    ...
    public StudentPayments withOverrideDescription(String overrideDescription) {
        this.overrideDescription = overrideDescription;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata)))&&((this.fundingDestination == rhs.fundingDestination)||((this.fundingDestination!= null)&&this.fundingDestination.equals(rhs.fundingDestination))))&&((this.amount == rhs.amount)||((this.amount!= null)&&this.amount.equals(rhs.amount))))&&((this.comments == rhs.comments)||((this.comments!= null)&&this.comments.equals(rhs.comments))))&&((this.student == rhs.student)||((this.student!= null)&&this.student.equals(rhs.student))))&&((this.academicPeriod == rhs.academicPeriod)||((this.academicPeriod!= null)&&this.academicPeriod.equals(rhs.academicPeriod))))&&((this.paidOn == rhs.paidOn)||((this.paidOn!= null)&&this.paidOn.equals(rhs.paidOn))))&&((this.reportingDetail == rhs.reportingDetail)||((this.reportingDetail!= null)&&this.reportingDetail.equals(rhs.reportingDetail))))&&((this.paymentType == rhs.paymentType)||((this.paymentType!= null)&&this.paymentType.equals(rhs.paymentType))))&&((this.overrideDescription == rhs.overrideDescription)||((this.overrideDescription!= null)&&this.overrideDescription.equals(rhs.overrideDescription))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.fundingSource == rhs.fundingSource)||((this.fundingSource!= null)&&this.fundingSource.equals(rhs.fundingSource))));
    }
