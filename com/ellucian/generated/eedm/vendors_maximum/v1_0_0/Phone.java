...
public class Phone {
     ...
     * Type
     * <p>
     * A type of phone for a vendor at this address. Includes a standard type (e.g. 'mobile', 'business') and an optional, custom type to further identify the type of phone.
     * 
     */
    @JsonProperty("type")
    @JsonPropertyDescription("A type of phone for a vendor at this address. Includes a standard type (e.g. 'mobile', 'business') and an optional, custom type to further identify the type of phone.")
    ...
    public Phone withType(Type__2 type) {
        this.type = type;
        return this;
    }
