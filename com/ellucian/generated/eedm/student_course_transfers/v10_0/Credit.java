...
public class Credit {
    ...
    @JsonPropertyDescription("The category of credit associated with the transferred course.")
    ...
    @JsonPropertyDescription("The credit awarded for the transferred course.")
