...
package com.ellucian.generated.eedm.section_registration_statuses.v8_0;
...
public class SectionRegistrationStatuses {
     ...
     * 
     */
    @JsonProperty("headcountStatus")
    @JsonPropertyDescription("Indicates whether to include the registration of a section towards the head count.")
    private Object headcountStatus;
     ...
     */
    @JsonProperty("headcountStatus")
    public Object getHeadcountStatus() {
        return headcountStatus;
    }
     ...
     */
    @JsonProperty("headcountStatus")
    public void setHeadcountStatus(Object headcountStatus) {
        this.headcountStatus = headcountStatus;
    }

    public SectionRegistrationStatuses withHeadcountStatus(Object headcountStatus) {
        this.headcountStatus = headcountStatus;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("headcountStatus");
        sb.append('=');
        sb.append(((this.headcountStatus == null)?"<null>":this.headcountStatus));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.headcountStatus == null)? 0 :this.headcountStatus.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata)))&&((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code))))&&((this.headcountStatus == rhs.headcountStatus)||((this.headcountStatus!= null)&&this.headcountStatus.equals(rhs.headcountStatus))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
