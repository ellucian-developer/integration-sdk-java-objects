...
public class Requisitions {
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((((((((((((this.submittedBy == rhs.submittedBy)||((this.submittedBy!= null)&&this.submittedBy.equals(rhs.submittedBy)))&&((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata))))&&((this.requisitionNumber == rhs.requisitionNumber)||((this.requisitionNumber!= null)&&this.requisitionNumber.equals(rhs.requisitionNumber))))&&((this.deliveredBy == rhs.deliveredBy)||((this.deliveredBy!= null)&&this.deliveredBy.equals(rhs.deliveredBy))))&&((this.comments == rhs.comments)||((this.comments!= null)&&this.comments.equals(rhs.comments))))&&((this.initiator == rhs.initiator)||((this.initiator!= null)&&this.initiator.equals(rhs.initiator))))&&((this.paymentSource == rhs.paymentSource)||((this.paymentSource!= null)&&this.paymentSource.equals(rhs.paymentSource))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.transactionDate == rhs.transactionDate)||((this.transactionDate!= null)&&this.transactionDate.equals(rhs.transactionDate))))&&((this.buyer == rhs.buyer)||((this.buyer!= null)&&this.buyer.equals(rhs.buyer))))&&((this.lineItems == rhs.lineItems)||((this.lineItems!= null)&&this.lineItems.equals(rhs.lineItems))))&&((this.overrideShippingDestination == rhs.overrideShippingDestination)||((this.overrideShippingDestination!= null)&&this.overrideShippingDestination.equals(rhs.overrideShippingDestination))))&&((this.shipping == rhs.shipping)||((this.shipping!= null)&&this.shipping.equals(rhs.shipping))))&&((this.referenceNumber == rhs.referenceNumber)||((this.referenceNumber!= null)&&this.referenceNumber.equals(rhs.referenceNumber))))&&((this.vendor == rhs.vendor)||((this.vendor!= null)&&this.vendor.equals(rhs.vendor))))&&((this.requestedOn == rhs.requestedOn)||((this.requestedOn!= null)&&this.requestedOn.equals(rhs.requestedOn))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.paymentTerms == rhs.paymentTerms)||((this.paymentTerms!= null)&&this.paymentTerms.equals(rhs.paymentTerms))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
