...
package com.ellucian.generated.eedm.pay_classifications.v11_0;
...
public class PayClassifications {
    ...
    @JsonPropertyDescription("The compensation type associated with the pay classification (e.g. salary or wages).")
    private PayClassifications.CompensationType compensationType;
    /**
     * Pay Table
     * <p>
     ...
     */
    @JsonProperty("compensationType")
    public PayClassifications.CompensationType getCompensationType() {
     ...
     */
    @JsonProperty("compensationType")
    public void setCompensationType(PayClassifications.CompensationType compensationType) {
        this.compensationType = compensationType;
    }

    public PayClassifications withCompensationType(PayClassifications.CompensationType compensationType) {
        this.compensationType = compensationType;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((this.payTable == rhs.payTable)||((this.payTable!= null)&&this.payTable.equals(rhs.payTable)))&&((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata))))&&((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code))))&&((this.classificationType == rhs.classificationType)||((this.classificationType!= null)&&this.classificationType.equals(rhs.classificationType))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this.compensationType == rhs.compensationType)||((this.compensationType!= null)&&this.compensationType.equals(rhs.compensationType))))&&((this.payGroup == rhs.payGroup)||((this.payGroup!= null)&&this.payGroup.equals(rhs.payGroup))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
    ...
    public enum CompensationType {
        ...
        SALARY("salary");
        private final String value;
        private final static Map<String, PayClassifications.CompensationType> CONSTANTS = new HashMap<String, PayClassifications.CompensationType>();

        static {
            for (PayClassifications.CompensationType c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static PayClassifications.CompensationType fromValue(String value) {
            PayClassifications.CompensationType constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
