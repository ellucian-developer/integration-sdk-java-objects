...
package com.ellucian.generated.eedm.blanket_purchase_orders.v16_1_0;
...
public class OrderDetail {
     ...
     */
    @JsonProperty("status")
    @JsonPropertyDescription("The status of the order detail.")
    ...
    public OrderDetail withStatus(Object status) {
        this.status = status;
        return this;
    }
