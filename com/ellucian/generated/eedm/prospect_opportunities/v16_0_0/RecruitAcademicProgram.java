...
public class RecruitAcademicProgram {
     ...
     * ID
     * <p>
     * The global identifier for the Recruit Academic Programs.
     * (Required)
     * 
     */
    @JsonProperty("id")
    @JsonPropertyDescription("The global identifier for the Recruit Academic Programs.")
    private String id;
    ...
    public RecruitAcademicProgram withId(String id) {
        this.id = id;
        return this;
    }
