...
public class Allocation {
    ...
    @JsonPropertyDescription("The appeal communication effort associated with the donor's allocation of the contribution.")
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((this.donor == rhs.donor)||((this.donor!= null)&&this.donor.equals(rhs.donor)))&&((this.credits == rhs.credits)||((this.credits!= null)&&this.credits.equals(rhs.credits))))&&((this.appealCommunicationEffort == rhs.appealCommunicationEffort)||((this.appealCommunicationEffort!= null)&&this.appealCommunicationEffort.equals(rhs.appealCommunicationEffort))))&&((this.designatedClassYear == rhs.designatedClassYear)||((this.designatedClassYear!= null)&&this.designatedClassYear.equals(rhs.designatedClassYear))))&&((this.donorAssociationType == rhs.donorAssociationType)||((this.donorAssociationType!= null)&&this.donorAssociationType.equals(rhs.donorAssociationType))))&&((this.constituentTypes == rhs.constituentTypes)||((this.constituentTypes!= null)&&this.constituentTypes.equals(rhs.constituentTypes))))&&((this.campaign == rhs.campaign)||((this.campaign!= null)&&this.campaign.equals(rhs.campaign))))&&((this.designation == rhs.designation)||((this.designation!= null)&&this.designation.equals(rhs.designation))));
    }
