...
public class Contributions {
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((((((((((((this.proposal == rhs.proposal)||((this.proposal!= null)&&this.proposal.equals(rhs.proposal)))&&((this.paymentFor == rhs.paymentFor)||((this.paymentFor!= null)&&this.paymentFor.equals(rhs.paymentFor))))&&((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata))))&&((this.payments == rhs.payments)||((this.payments!= null)&&this.payments.equals(rhs.payments))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.activityDates == rhs.activityDates)||((this.activityDates!= null)&&this.activityDates.equals(rhs.activityDates))))&&((this.specialHandlingInstructions == rhs.specialHandlingInstructions)||((this.specialHandlingInstructions!= null)&&this.specialHandlingInstructions.equals(rhs.specialHandlingInstructions))))&&((this.communicationPlans == rhs.communicationPlans)||((this.communicationPlans!= null)&&this.communicationPlans.equals(rhs.communicationPlans))))&&((this.premiumAssignments == rhs.premiumAssignments)||((this.premiumAssignments!= null)&&this.premiumAssignments.equals(rhs.premiumAssignments))))&&((this.amounts == rhs.amounts)||((this.amounts!= null)&&this.amounts.equals(rhs.amounts))))&&((this.allocations == rhs.allocations)||((this.allocations!= null)&&this.allocations.equals(rhs.allocations))))&&((this.solicitationMethod == rhs.solicitationMethod)||((this.solicitationMethod!= null)&&this.solicitationMethod.equals(rhs.solicitationMethod))))&&((this.givingClassifications == rhs.givingClassifications)||((this.givingClassifications!= null)&&this.givingClassifications.equals(rhs.givingClassifications))))&&((this.anonymity == rhs.anonymity)||((this.anonymity!= null)&&this.anonymity.equals(rhs.anonymity))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.category == rhs.category)||((this.category!= null)&&this.category.equals(rhs.category))))&&((this.fiscalYear == rhs.fiscalYear)||((this.fiscalYear!= null)&&this.fiscalYear.equals(rhs.fiscalYear))))&&((this.solicitors == rhs.solicitors)||((this.solicitors!= null)&&this.solicitors.equals(rhs.solicitors))))&&((this.specifics == rhs.specifics)||((this.specifics!= null)&&this.specifics.equals(rhs.specifics))));
    }
