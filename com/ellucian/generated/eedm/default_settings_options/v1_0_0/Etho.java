...
public class Etho {
     ...
     * Resource
     * <p>
     * The Ethos resource name to which the default settings pertain.
     * (Required)
     * 
     */
    @JsonProperty("resource")
    @JsonPropertyDescription("The Ethos resource name to which the default settings pertain.")
    private String resource;
    /**
     * Property Name
     * <p>
     * The Ethos property name to which the default settings pertain.
     * 
     */
    @JsonProperty("propertyName")
    @JsonPropertyDescription("The Ethos property name to which the default settings pertain.")
