...
public class SectionRegistration {
     ...
     * ID
     * <p>
     * The global identifier for the Section Registration.
     * (Required)
     * 
     */
    @JsonProperty("id")
    ...
    public String toString() {
        ...
        sb.append(SectionRegistration.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SectionRegistration) == false) {
            return false;
        }
        SectionRegistration rhs = ((SectionRegistration) other);
