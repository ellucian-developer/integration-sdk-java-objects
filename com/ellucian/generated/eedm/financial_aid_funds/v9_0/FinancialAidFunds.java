...
public class FinancialAidFunds {
    ...
    private FinancialAidFunds.Source source;
    /**
     * Aid Type
     * <p>
    ...
    private FinancialAidFunds.AidType aidType;
    /**
     * Classifications
     * <p>
    ...
    private FinancialAidFunds.Privacy privacy;
    /**
     * Financials
     * <p>
     ...
     */
    @JsonProperty("source")
    public FinancialAidFunds.Source getSource() {
        return source;
    }
     ...
     */
    @JsonProperty("source")
    public void setSource(FinancialAidFunds.Source source) {
        this.source = source;
    }

    public FinancialAidFunds withSource(FinancialAidFunds.Source source) {
        this.source = source;
        return this;
    }
     ...
     */
    @JsonProperty("aidType")
    public FinancialAidFunds.AidType getAidType() {
        return aidType;
    }
     ...
     */
    @JsonProperty("aidType")
    public void setAidType(FinancialAidFunds.AidType aidType) {
        this.aidType = aidType;
    }

    public FinancialAidFunds withAidType(FinancialAidFunds.AidType aidType) {
        this.aidType = aidType;
        return this;
    }
    ...
    public FinancialAidFunds withCategory(Category category) {
        this.category = category;
        return this;
    }
     ...
     */
    @JsonProperty("privacy")
    public FinancialAidFunds.Privacy getPrivacy() {
        return privacy;
    }
     ...
     */
    @JsonProperty("privacy")
    public void setPrivacy(FinancialAidFunds.Privacy privacy) {
        this.privacy = privacy;
    }

    public FinancialAidFunds withPrivacy(FinancialAidFunds.Privacy privacy) {
        this.privacy = privacy;
        return this;
    }
    ...
    public enum AidType {
        ...
        private final static Map<String, FinancialAidFunds.AidType> CONSTANTS = new HashMap<String, FinancialAidFunds.AidType>();

        static {
            for (FinancialAidFunds.AidType c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        AidType(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static FinancialAidFunds.AidType fromValue(String value) {
            FinancialAidFunds.AidType constant = CONSTANTS.get(value);
            if (constant == null) {
    ...
    public enum Privacy {
        ...
        private final String value;
        private final static Map<String, FinancialAidFunds.Privacy> CONSTANTS = new HashMap<String, FinancialAidFunds.Privacy>();

        static {
            for (FinancialAidFunds.Privacy c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static FinancialAidFunds.Privacy fromValue(String value) {
            FinancialAidFunds.Privacy constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
    ...
    public enum Source {
        ...
        OTHER("other");
        private final String value;
        private final static Map<String, FinancialAidFunds.Source> CONSTANTS = new HashMap<String, FinancialAidFunds.Source>();

        static {
            for (FinancialAidFunds.Source c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static FinancialAidFunds.Source fromValue(String value) {
            FinancialAidFunds.Source constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
