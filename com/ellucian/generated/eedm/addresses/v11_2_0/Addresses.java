...
package com.ellucian.generated.eedm.addresses.v11_2_0;
...
public class Addresses {
    ...
    public Addresses withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((this.geographicAreas == rhs.geographicAreas)||((this.geographicAreas!= null)&&this.geographicAreas.equals(rhs.geographicAreas)))&&((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata))))&&((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code))))&&((this.latitude == rhs.latitude)||((this.latitude!= null)&&this.latitude.equals(rhs.latitude))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.addressLines == rhs.addressLines)||((this.addressLines!= null)&&this.addressLines.equals(rhs.addressLines))))&&((this.place == rhs.place)||((this.place!= null)&&this.place.equals(rhs.place))))&&((this.longitude == rhs.longitude)||((this.longitude!= null)&&this.longitude.equals(rhs.longitude))));
    }
