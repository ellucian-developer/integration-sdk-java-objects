...
package com.ellucian.generated.eedm.pay_classes.v12_1_0;
...
public class HoursPerPeriod {
     ...
     */
    @JsonProperty("period")
    @JsonPropertyDescription("The default time period (e.g. day, week, month, etc.).")
     ...
     */
    @JsonProperty("hours")
    @JsonPropertyDescription("The default work hours in the specified time period.")
