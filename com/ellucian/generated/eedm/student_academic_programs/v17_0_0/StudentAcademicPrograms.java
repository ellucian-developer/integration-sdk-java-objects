 ...
 * <p>
 * The academic programs in the home institution in which a prospect, applicant, current student or graduate has expressed interest in, or been enrolled.
 * 
 */
...
public class StudentAcademicPrograms {
    ...
    private StudentAcademicPrograms.CurriculumObjective curriculumObjective;
    /**
     * Preference
     * <p>
    ...
    @JsonPropertyDescription("The starting date of the program to be used for reporting.")
    ...
    @JsonPropertyDescription("The ending date of the program to be used for reporting.")
     ...
     * <p>
     * The associated, matriculated, or outcome curriculum record of the program.
     * 
     */
    @JsonProperty("associatedCurriculum")
    @JsonPropertyDescription("The associated, matriculated, or outcome curriculum record of the program.")
    private Object associatedCurriculum;
     ...
     */
    @JsonProperty("curriculumObjective")
    public StudentAcademicPrograms.CurriculumObjective getCurriculumObjective() {
     ...
     */
    @JsonProperty("curriculumObjective")
    public void setCurriculumObjective(StudentAcademicPrograms.CurriculumObjective curriculumObjective) {
        this.curriculumObjective = curriculumObjective;
    }

    public StudentAcademicPrograms withCurriculumObjective(StudentAcademicPrograms.CurriculumObjective curriculumObjective) {
        this.curriculumObjective = curriculumObjective;
        return this;
    }
    ...
    public StudentAcademicPrograms withStartOn(Object startOn) {
        this.startOn = startOn;
        return this;
    }
    ...
    public StudentAcademicPrograms withOverrideStartOn(Object overrideStartOn) {
        this.overrideStartOn = overrideStartOn;
        return this;
    }
    ...
    public StudentAcademicPrograms withOverrideEndOn(Object overrideEndOn) {
        this.overrideEndOn = overrideEndOn;
        return this;
    }
    ...
    public StudentAcademicPrograms withExpectedGraduationDate(Object expectedGraduationDate) {
        this.expectedGraduationDate = expectedGraduationDate;
        return this;
    }
    ...
    public StudentAcademicPrograms withAdmissionClassification(AdmissionClassification admissionClassification) {
        this.admissionClassification = admissionClassification;
        return this;
    }
     ...
     */
    @JsonProperty("associatedCurriculum")
    public Object getAssociatedCurriculum() {
        return associatedCurriculum;
    }
     ...
     */
    @JsonProperty("associatedCurriculum")
    public void setAssociatedCurriculum(Object associatedCurriculum) {
        this.associatedCurriculum = associatedCurriculum;
    }

    public StudentAcademicPrograms withAssociatedCurriculum(Object associatedCurriculum) {
        this.associatedCurriculum = associatedCurriculum;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("associatedCurriculum");
        sb.append('=');
        sb.append(((this.associatedCurriculum == null)?"<null>":this.associatedCurriculum));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.associatedCurriculum == null)? 0 :this.associatedCurriculum.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((((((((((((((this.metadata == rhs.metadata)||((this.metadata!= null)&&this.metadata.equals(rhs.metadata)))&&((this.expectedGraduationDate == rhs.expectedGraduationDate)||((this.expectedGraduationDate!= null)&&this.expectedGraduationDate.equals(rhs.expectedGraduationDate))))&&((this.student == rhs.student)||((this.student!= null)&&this.student.equals(rhs.student))))&&((this.credentials == rhs.credentials)||((this.credentials!= null)&&this.credentials.equals(rhs.credentials))))&&((this.catalog == rhs.catalog)||((this.catalog!= null)&&this.catalog.equals(rhs.catalog))))&&((this.preference == rhs.preference)||((this.preference!= null)&&this.preference.equals(rhs.preference))))&&((this.curriculumObjective == rhs.curriculumObjective)||((this.curriculumObjective!= null)&&this.curriculumObjective.equals(rhs.curriculumObjective))))&&((this.startOn == rhs.startOn)||((this.startOn!= null)&&this.startOn.equals(rhs.startOn))))&&((this.program == rhs.program)||((this.program!= null)&&this.program.equals(rhs.program))))&&((this.programOwner == rhs.programOwner)||((this.programOwner!= null)&&this.programOwner.equals(rhs.programOwner))))&&((this.associatedCurriculum == rhs.associatedCurriculum)||((this.associatedCurriculum!= null)&&this.associatedCurriculum.equals(rhs.associatedCurriculum))))&&((this.overrideStartOn == rhs.overrideStartOn)||((this.overrideStartOn!= null)&&this.overrideStartOn.equals(rhs.overrideStartOn))))&&((this.overrideEndOn == rhs.overrideEndOn)||((this.overrideEndOn!= null)&&this.overrideEndOn.equals(rhs.overrideEndOn))))&&((this.academicPeriods == rhs.academicPeriods)||((this.academicPeriods!= null)&&this.academicPeriods.equals(rhs.academicPeriods))))&&((this.admissionClassification == rhs.admissionClassification)||((this.admissionClassification!= null)&&this.admissionClassification.equals(rhs.admissionClassification))))&&((this.academicLevel == rhs.academicLevel)||((this.academicLevel!= null)&&this.academicLevel.equals(rhs.academicLevel))))&&((this.site == rhs.site)||((this.site!= null)&&this.site.equals(rhs.site))))&&((this.disciplines == rhs.disciplines)||((this.disciplines!= null)&&this.disciplines.equals(rhs.disciplines))))&&((this.enrollmentStatus == rhs.enrollmentStatus)||((this.enrollmentStatus!= null)&&this.enrollmentStatus.equals(rhs.enrollmentStatus))))&&((this.endOn == rhs.endOn)||((this.endOn!= null)&&this.endOn.equals(rhs.endOn))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))));
    }
    ...
    public enum CurriculumObjective {
        ...
        private final static Map<String, StudentAcademicPrograms.CurriculumObjective> CONSTANTS = new HashMap<String, StudentAcademicPrograms.CurriculumObjective>();

        static {
            for (StudentAcademicPrograms.CurriculumObjective c: values()) {
        ...
        @JsonCreator
        public static StudentAcademicPrograms.CurriculumObjective fromValue(String value) {
            StudentAcademicPrograms.CurriculumObjective constant = CONSTANTS.get(value);
            if (constant == null) {
