...
public class EquivalentTo {
     ...
     * ID
     * <p>
     * The global identifier for the Equivalent Grades.
     * (Required)
     * 
     */
    @JsonProperty("id")
    @JsonPropertyDescription("The global identifier for the Equivalent Grades.")
    private String id;
    ...
    public EquivalentTo withId(String id) {
        this.id = id;
        return this;
    }
