...
public class Fgbcshh {
    ...
    public Fgbcshh withCollectTaxDesc(String collectTaxDesc) {
        this.collectTaxDesc = collectTaxDesc;
        return this;
    }
    ...
    public Fgbcshh withTransDate(Date transDate) {
        this.transDate = transDate;
        return this;
    }
    ...
    public Fgbcshh withNsfOnOffInd(String nsfOnOffInd) {
        this.nsfOnOffInd = nsfOnOffInd;
        return this;
    }
    ...
    public Fgbcshh withDisplayCollectTax(String displayCollectTax) {
        this.displayCollectTax = displayCollectTax;
        return this;
    }
    ...
    public Fgbcshh withDocAmt(Double docAmt) {
        this.docAmt = docAmt;
        return this;
    }
    ...
    public Fgbcshh withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Fgbcshh.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fgbcshh) == false) {
            return false;
        }
        Fgbcshh rhs = ((Fgbcshh) other);
