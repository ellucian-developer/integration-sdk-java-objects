...
public class PersonSkills100PutResponse {
    ...
    public PersonSkills100PutResponse withKeyBlock(List<KeyBlock__2> keyBlock) {
        this.keyBlock = keyBlock;
        return this;
    }

    @JsonProperty("pprskil")
    public List<Pprskil__2> getPprskil() {
        return pprskil;
    }

    @JsonProperty("pprskil")
    public void setPprskil(List<Pprskil__2> pprskil) {
        this.pprskil = pprskil;
    }

    public PersonSkills100PutResponse withPprskil(List<Pprskil__2> pprskil) {
        this.pprskil = pprskil;
        return this;
    }
    ...
    public PersonSkills100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PersonSkills100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("keyBlock");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PersonSkills100PutResponse) == false) {
            return false;
        }
        PersonSkills100PutResponse rhs = ((PersonSkills100PutResponse) other);
