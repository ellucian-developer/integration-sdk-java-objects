...
public class Pprskil__2 {
    ...
    public Pprskil__2 withComments(String comments) {
        this.comments = comments;
        return this;
    }
    ...
    public Pprskil__2 withSklvCode(String sklvCode) {
        this.sklvCode = sklvCode;
        return this;
    }
    ...
    public Pprskil__2 withEndDate(Date endDate) {
        this.endDate = endDate;
        return this;
    }
    ...
    public Pprskil__2 withSkillDesc(String skillDesc) {
        this.skillDesc = skillDesc;
        return this;
    }
    ...
    public Pprskil__2 withSkilCode(String skilCode) {
        this.skilCode = skilCode;
        return this;
    }
    ...
    public Pprskil__2 withReadInd(String readInd) {
        this.readInd = readInd;
        return this;
    }
    ...
    public Pprskil__2 withTeachInd(String teachInd) {
        this.teachInd = teachInd;
        return this;
    }
    ...
    public Pprskil__2 withSpeakInd(String speakInd) {
        this.speakInd = speakInd;
        return this;
    }
    ...
    public Pprskil__2 withNativeInd(String nativeInd) {
        this.nativeInd = nativeInd;
        return this;
    }
    ...
    public Pprskil__2 withTransInd(String transInd) {
        this.transInd = transInd;
        return this;
    }
    ...
    public Pprskil__2 withWriteInd(String writeInd) {
        this.writeInd = writeInd;
        return this;
    }
    ...
    public Pprskil__2 withLevelDesc(String levelDesc) {
        this.levelDesc = levelDesc;
        return this;
    }
    ...
    public Pprskil__2 withStartDate(Date startDate) {
        this.startDate = startDate;
        return this;
    }
    ...
    public Pprskil__2 withLastDate(Date lastDate) {
        this.lastDate = lastDate;
        return this;
    }
    ...
    public Pprskil__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Pprskil__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("comments");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pprskil__2) == false) {
            return false;
        }
        Pprskil__2 rhs = ((Pprskil__2) other);
