...
public class PositionBudgetPositionBudget100PutResponse {
    ...
    public PositionBudgetPositionBudget100PutResponse withBeginDate(Date beginDate) {
        this.beginDate = beginDate;
        return this;
    }
    ...
    public PositionBudgetPositionBudget100PutResponse withPremiumRollInd(String premiumRollInd) {
        this.premiumRollInd = premiumRollInd;
        return this;
    }
    ...
    public PositionBudgetPositionBudget100PutResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public PositionBudgetPositionBudget100PutResponse withEndDate(Date endDate) {
        this.endDate = endDate;
        return this;
    }
    ...
    public PositionBudgetPositionBudget100PutResponse withRollInd(String rollInd) {
        this.rollInd = rollInd;
        return this;
    }
    ...
    public PositionBudgetPositionBudget100PutResponse withAuthNumber(String authNumber) {
        this.authNumber = authNumber;
        return this;
    }
    ...
    public PositionBudgetPositionBudget100PutResponse withBproCode(String bproCode) {
        this.bproCode = bproCode;
        return this;
    }
    ...
    public PositionBudgetPositionBudget100PutResponse withCoasCode(String coasCode) {
        this.coasCode = coasCode;
        return this;
    }
    ...
    public PositionBudgetPositionBudget100PutResponse withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public PositionBudgetPositionBudget100PutResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public PositionBudgetPositionBudget100PutResponse withBproDesc(String bproDesc) {
        this.bproDesc = bproDesc;
        return this;
    }
    ...
    public PositionBudgetPositionBudget100PutResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public PositionBudgetPositionBudget100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PositionBudgetPositionBudget100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("beginDate");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PositionBudgetPositionBudget100PutResponse) == false) {
            return false;
        }
        PositionBudgetPositionBudget100PutResponse rhs = ((PositionBudgetPositionBudget100PutResponse) other);
