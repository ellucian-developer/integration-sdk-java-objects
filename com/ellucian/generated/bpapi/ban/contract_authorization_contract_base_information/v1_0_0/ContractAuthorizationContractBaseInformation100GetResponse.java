...
public class ContractAuthorizationContractBaseInformation100GetResponse {
    ...
    public ContractAuthorizationContractBaseInformation100GetResponse withDetailChgCode(String detailChgCode) {
        this.detailChgCode = detailChgCode;
        return this;
    }
    ...
    public ContractAuthorizationContractBaseInformation100GetResponse withExpTermDesc(String expTermDesc) {
        this.expTermDesc = expTermDesc;
        return this;
    }
    ...
    public ContractAuthorizationContractBaseInformation100GetResponse withTbbdetcPayDesc(String tbbdetcPayDesc) {
        this.tbbdetcPayDesc = tbbdetcPayDesc;
        return this;
    }
    ...
    public ContractAuthorizationContractBaseInformation100GetResponse withRuleDesc(String ruleDesc) {
        this.ruleDesc = ruleDesc;
        return this;
    }
    ...
    public ContractAuthorizationContractBaseInformation100GetResponse withContractRollInd(String contractRollInd) {
        this.contractRollInd = contractRollInd;
        return this;
    }
    ...
    public ContractAuthorizationContractBaseInformation100GetResponse withStudentContRollInd(String studentContRollInd) {
        this.studentContRollInd = studentContRollInd;
        return this;
    }
    ...
    public ContractAuthorizationContractBaseInformation100GetResponse withTermCodeExpiration(String termCodeExpiration) {
        this.termCodeExpiration = termCodeExpiration;
        return this;
    }
    ...
    public ContractAuthorizationContractBaseInformation100GetResponse withTbbdetcChgDesc(String tbbdetcChgDesc) {
        this.tbbdetcChgDesc = tbbdetcChgDesc;
        return this;
    }
    ...
    public ContractAuthorizationContractBaseInformation100GetResponse withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public ContractAuthorizationContractBaseInformation100GetResponse withDetailPayCode(String detailPayCode) {
        this.detailPayCode = detailPayCode;
        return this;
    }
    ...
    public ContractAuthorizationContractBaseInformation100GetResponse withTprlCode(String tprlCode) {
        this.tprlCode = tprlCode;
        return this;
    }
    ...
    public ContractAuthorizationContractBaseInformation100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ContractAuthorizationContractBaseInformation100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ContractAuthorizationContractBaseInformation100GetResponse) == false) {
            return false;
        }
        ContractAuthorizationContractBaseInformation100GetResponse rhs = ((ContractAuthorizationContractBaseInformation100GetResponse) other);
