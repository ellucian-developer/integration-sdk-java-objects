...
public class Sarappd__1 {
    ...
    public Sarappd__1 withStvapdcStdnAccInd(String stvapdcStdnAccInd) {
        this.stvapdcStdnAccInd = stvapdcStdnAccInd;
        return this;
    }
    ...
    public Sarappd__1 withStvapdcSignfInd(String stvapdcSignfInd) {
        this.stvapdcSignfInd = stvapdcSignfInd;
        return this;
    }
    ...
    public Sarappd__1 withStvapdcApplInact(String stvapdcApplInact) {
        this.stvapdcApplInact = stvapdcApplInact;
        return this;
    }
    ...
    public Sarappd__1 withStvapdcDesc(String stvapdcDesc) {
        this.stvapdcDesc = stvapdcDesc;
        return this;
    }
    ...
    public Sarappd__1 withMaintDesc(String maintDesc) {
        this.maintDesc = maintDesc;
        return this;
    }
    ...
    public Sarappd__1 withApdcCode(String apdcCode) {
        this.apdcCode = apdcCode;
        return this;
    }
    ...
    public Sarappd__1 withApdcDate(Date apdcDate) {
        this.apdcDate = apdcDate;
        return this;
    }
    ...
    public Sarappd__1 withMaintInd(String maintInd) {
        this.maintInd = maintInd;
        return this;
    }
    ...
    public Sarappd__1 withStvapdcInstAccInd(String stvapdcInstAccInd) {
        this.stvapdcInstAccInd = stvapdcInstAccInd;
        return this;
    }
    ...
    public Sarappd__1 withStvapdcRejectInd(String stvapdcRejectInd) {
        this.stvapdcRejectInd = stvapdcRejectInd;
        return this;
    }
    ...
    public Sarappd__1 withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public Sarappd__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sarappd__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sarappd__1) == false) {
            return false;
        }
        Sarappd__1 rhs = ((Sarappd__1) other);
