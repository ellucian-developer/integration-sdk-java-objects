...
public class ApplicantEntryByRequisitionOrPositionStatusLog100QapiPost {
    ...
    public ApplicantEntryByRequisitionOrPositionStatusLog100QapiPost withReqNo(String reqNo) {
        this.reqNo = reqNo;
        return this;
    }
    ...
    public ApplicantEntryByRequisitionOrPositionStatusLog100QapiPost withPosn(String posn) {
        this.posn = posn;
        return this;
    }
    ...
    public ApplicantEntryByRequisitionOrPositionStatusLog100QapiPost withPclsCode(String pclsCode) {
        this.pclsCode = pclsCode;
        return this;
    }
    ...
    public ApplicantEntryByRequisitionOrPositionStatusLog100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ApplicantEntryByRequisitionOrPositionStatusLog100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("reqNo");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ApplicantEntryByRequisitionOrPositionStatusLog100QapiPost) == false) {
            return false;
        }
        ApplicantEntryByRequisitionOrPositionStatusLog100QapiPost rhs = ((ApplicantEntryByRequisitionOrPositionStatusLog100QapiPost) other);
