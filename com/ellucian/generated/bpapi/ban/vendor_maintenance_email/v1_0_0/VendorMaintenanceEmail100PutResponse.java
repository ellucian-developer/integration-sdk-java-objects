...
public class VendorMaintenanceEmail100PutResponse {
    ...
    public VendorMaintenanceEmail100PutResponse withEmailAddress(String emailAddress) {
        this.emailAddress = emailAddress;
        return this;
    }
    ...
    public VendorMaintenanceEmail100PutResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public VendorMaintenanceEmail100PutResponse withEmailDesc(String emailDesc) {
        this.emailDesc = emailDesc;
        return this;
    }
    ...
    public VendorMaintenanceEmail100PutResponse withEmalCode(String emalCode) {
        this.emalCode = emalCode;
        return this;
    }
    ...
    public VendorMaintenanceEmail100PutResponse withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public VendorMaintenanceEmail100PutResponse withDispWebInd(String dispWebInd) {
        this.dispWebInd = dispWebInd;
        return this;
    }
    ...
    public VendorMaintenanceEmail100PutResponse withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public VendorMaintenanceEmail100PutResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public VendorMaintenanceEmail100PutResponse withPreferredInd(String preferredInd) {
        this.preferredInd = preferredInd;
        return this;
    }
    ...
    public VendorMaintenanceEmail100PutResponse withUrlInd(String urlInd) {
        this.urlInd = urlInd;
        return this;
    }
    ...
    public VendorMaintenanceEmail100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(VendorMaintenanceEmail100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VendorMaintenanceEmail100PutResponse) == false) {
            return false;
        }
        VendorMaintenanceEmail100PutResponse rhs = ((VendorMaintenanceEmail100PutResponse) other);
