...
public class Slrrfcr {
    ...
    public Slrrfcr withFromDate(Date fromDate) {
        this.fromDate = fromDate;
        return this;
    }
    ...
    public Slrrfcr withToDate(Date toDate) {
        this.toDate = toDate;
        return this;
    }
    ...
    public Slrrfcr withAscdCode(String ascdCode) {
        this.ascdCode = ascdCode;
        return this;
    }
    ...
    public Slrrfcr withRefund(Double refund) {
        this.refund = refund;
        return this;
    }
    ...
    public Slrrfcr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Slrrfcr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("fromDate");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Slrrfcr) == false) {
            return false;
        }
        Slrrfcr rhs = ((Slrrfcr) other);
