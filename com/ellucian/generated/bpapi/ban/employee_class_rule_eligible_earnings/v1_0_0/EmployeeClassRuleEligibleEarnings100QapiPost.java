...
public class EmployeeClassRuleEligibleEarnings100QapiPost {
    ...
    public EmployeeClassRuleEligibleEarnings100QapiPost withEcls(String ecls) {
        this.ecls = ecls;
        return this;
    }
    ...
    public EmployeeClassRuleEligibleEarnings100QapiPost withEarnCode(String earnCode) {
        this.earnCode = earnCode;
        return this;
    }
    ...
    public EmployeeClassRuleEligibleEarnings100QapiPost withReduceRegPayInd(String reduceRegPayInd) {
        this.reduceRegPayInd = reduceRegPayInd;
        return this;
    }
    ...
    public EmployeeClassRuleEligibleEarnings100QapiPost withAtndInd(String atndInd) {
        this.atndInd = atndInd;
        return this;
    }
    ...
    public EmployeeClassRuleEligibleEarnings100QapiPost withTsEntrySeq(Double tsEntrySeq) {
        this.tsEntrySeq = tsEntrySeq;
        return this;
    }
    ...
    public EmployeeClassRuleEligibleEarnings100QapiPost withTsPrintSeq(Double tsPrintSeq) {
        this.tsPrintSeq = tsPrintSeq;
        return this;
    }
    ...
    public EmployeeClassRuleEligibleEarnings100QapiPost withEaApproversInd(String eaApproversInd) {
        this.eaApproversInd = eaApproversInd;
        return this;
    }
    ...
    public EmployeeClassRuleEligibleEarnings100QapiPost withClockInOutInd(String clockInOutInd) {
        this.clockInOutInd = clockInOutInd;
        return this;
    }
    ...
    public EmployeeClassRuleEligibleEarnings100QapiPost withAccrueSeniorityInd(String accrueSeniorityInd) {
        this.accrueSeniorityInd = accrueSeniorityInd;
        return this;
    }
    ...
    public EmployeeClassRuleEligibleEarnings100QapiPost withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public EmployeeClassRuleEligibleEarnings100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EmployeeClassRuleEligibleEarnings100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("ecls");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EmployeeClassRuleEligibleEarnings100QapiPost) == false) {
            return false;
        }
        EmployeeClassRuleEligibleEarnings100QapiPost rhs = ((EmployeeClassRuleEligibleEarnings100QapiPost) other);
        return ((((((((((((this.reduceRegPayInd == rhs.reduceRegPayInd)||((this.reduceRegPayInd!= null)&&this.reduceRegPayInd.equals(rhs.reduceRegPayInd)))&&((this.activityDate == rhs.activityDate)||((this.activityDate!= null)&&this.activityDate.equals(rhs.activityDate))))&&((this.clockInOutInd == rhs.clockInOutInd)||((this.clockInOutInd!= null)&&this.clockInOutInd.equals(rhs.clockInOutInd))))&&((this.tsEntrySeq == rhs.tsEntrySeq)||((this.tsEntrySeq!= null)&&this.tsEntrySeq.equals(rhs.tsEntrySeq))))&&((this.ecls == rhs.ecls)||((this.ecls!= null)&&this.ecls.equals(rhs.ecls))))&&((this.accrueSeniorityInd == rhs.accrueSeniorityInd)||((this.accrueSeniorityInd!= null)&&this.accrueSeniorityInd.equals(rhs.accrueSeniorityInd))))&&((this.tsPrintSeq == rhs.tsPrintSeq)||((this.tsPrintSeq!= null)&&this.tsPrintSeq.equals(rhs.tsPrintSeq))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.earnCode == rhs.earnCode)||((this.earnCode!= null)&&this.earnCode.equals(rhs.earnCode))))&&((this.eaApproversInd == rhs.eaApproversInd)||((this.eaApproversInd!= null)&&this.eaApproversInd.equals(rhs.eaApproversInd))))&&((this.atndInd == rhs.atndInd)||((this.atndInd!= null)&&this.atndInd.equals(rhs.atndInd))));
    }
