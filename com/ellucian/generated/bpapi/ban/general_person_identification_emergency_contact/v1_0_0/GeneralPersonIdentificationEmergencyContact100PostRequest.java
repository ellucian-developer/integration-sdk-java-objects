...
public class GeneralPersonIdentificationEmergencyContact100PostRequest {
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withStreetLine2(String streetLine2) {
        this.streetLine2 = streetLine2;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withZip(String zip) {
        this.zip = zip;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withReltCode(String reltCode) {
        this.reltCode = reltCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withLastName(String lastName) {
        this.lastName = lastName;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withStreetLine1(String streetLine1) {
        this.streetLine1 = streetLine1;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withPhoneExt(String phoneExt) {
        this.phoneExt = phoneExt;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withSurnamePrefix(String surnamePrefix) {
        this.surnamePrefix = surnamePrefix;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withStatCode(String statCode) {
        this.statCode = statCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withNatnCode(String natnCode) {
        this.natnCode = natnCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withStreetLine4(String streetLine4) {
        this.streetLine4 = streetLine4;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withStreetLine3(String streetLine3) {
        this.streetLine3 = streetLine3;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withHouseNumber(String houseNumber) {
        this.houseNumber = houseNumber;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withPriority(String priority) {
        this.priority = priority;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withCtryCodePhone(String ctryCodePhone) {
        this.ctryCodePhone = ctryCodePhone;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withFirstName(String firstName) {
        this.firstName = firstName;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withPhoneNumber(String phoneNumber) {
        this.phoneNumber = phoneNumber;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withPhoneArea(String phoneArea) {
        this.phoneArea = phoneArea;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withId(Object id) {
        this.id = id;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withMi(String mi) {
        this.mi = mi;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withAtypCode(String atypCode) {
        this.atypCode = atypCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmergencyContact100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralPersonIdentificationEmergencyContact100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralPersonIdentificationEmergencyContact100PostRequest) == false) {
            return false;
        }
        GeneralPersonIdentificationEmergencyContact100PostRequest rhs = ((GeneralPersonIdentificationEmergencyContact100PostRequest) other);
        return (((((((((((((((((((((((this.streetLine2 == rhs.streetLine2)||((this.streetLine2 != null)&&this.streetLine2 .equals(rhs.streetLine2)))&&((this.zip == rhs.zip)||((this.zip!= null)&&this.zip.equals(rhs.zip))))&&((this.reltCode == rhs.reltCode)||((this.reltCode!= null)&&this.reltCode.equals(rhs.reltCode))))&&((this.lastName == rhs.lastName)||((this.lastName!= null)&&this.lastName.equals(rhs.lastName))))&&((this.streetLine1 == rhs.streetLine1)||((this.streetLine1 != null)&&this.streetLine1 .equals(rhs.streetLine1))))&&((this.phoneExt == rhs.phoneExt)||((this.phoneExt!= null)&&this.phoneExt.equals(rhs.phoneExt))))&&((this.surnamePrefix == rhs.surnamePrefix)||((this.surnamePrefix!= null)&&this.surnamePrefix.equals(rhs.surnamePrefix))))&&((this.statCode == rhs.statCode)||((this.statCode!= null)&&this.statCode.equals(rhs.statCode))))&&((this.natnCode == rhs.natnCode)||((this.natnCode!= null)&&this.natnCode.equals(rhs.natnCode))))&&((this.city == rhs.city)||((this.city!= null)&&this.city.equals(rhs.city))))&&((this.streetLine4 == rhs.streetLine4)||((this.streetLine4 != null)&&this.streetLine4 .equals(rhs.streetLine4))))&&((this.streetLine3 == rhs.streetLine3)||((this.streetLine3 != null)&&this.streetLine3 .equals(rhs.streetLine3))))&&((this.houseNumber == rhs.houseNumber)||((this.houseNumber!= null)&&this.houseNumber.equals(rhs.houseNumber))))&&((this.priority == rhs.priority)||((this.priority!= null)&&this.priority.equals(rhs.priority))))&&((this.ctryCodePhone == rhs.ctryCodePhone)||((this.ctryCodePhone!= null)&&this.ctryCodePhone.equals(rhs.ctryCodePhone))))&&((this.firstName == rhs.firstName)||((this.firstName!= null)&&this.firstName.equals(rhs.firstName))))&&((this.phoneNumber == rhs.phoneNumber)||((this.phoneNumber!= null)&&this.phoneNumber.equals(rhs.phoneNumber))))&&((this.phoneArea == rhs.phoneArea)||((this.phoneArea!= null)&&this.phoneArea.equals(rhs.phoneArea))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.mi == rhs.mi)||((this.mi!= null)&&this.mi.equals(rhs.mi))))&&((this.atypCode == rhs.atypCode)||((this.atypCode!= null)&&this.atypCode.equals(rhs.atypCode))));
    }
