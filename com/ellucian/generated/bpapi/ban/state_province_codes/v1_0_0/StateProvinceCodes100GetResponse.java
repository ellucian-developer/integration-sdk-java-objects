...
public class StateProvinceCodes100GetResponse {
    ...
    public StateProvinceCodes100GetResponse withIpedsCde(String ipedsCde) {
        this.ipedsCde = ipedsCde;
        return this;
    }
    ...
    public StateProvinceCodes100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public StateProvinceCodes100GetResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public StateProvinceCodes100GetResponse withScodCodeIso(String scodCodeIso) {
        this.scodCodeIso = scodCodeIso;
        return this;
    }
    ...
    public StateProvinceCodes100GetResponse withStatscanCde(String statscanCde) {
        this.statscanCde = statscanCde;
        return this;
    }
    ...
    public StateProvinceCodes100GetResponse withEdiEquiv(String ediEquiv) {
        this.ediEquiv = ediEquiv;
        return this;
    }
    ...
    public StateProvinceCodes100GetResponse withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public StateProvinceCodes100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StateProvinceCodes100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("ipedsCde");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StateProvinceCodes100GetResponse) == false) {
            return false;
        }
        StateProvinceCodes100GetResponse rhs = ((StateProvinceCodes100GetResponse) other);
        return (((((((((this.ipedsCde == rhs.ipedsCde)||((this.ipedsCde!= null)&&this.ipedsCde.equals(rhs.ipedsCde)))&&((this.activityDate == rhs.activityDate)||((this.activityDate!= null)&&this.activityDate.equals(rhs.activityDate))))&&((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code))))&&((this.scodCodeIso == rhs.scodCodeIso)||((this.scodCodeIso!= null)&&this.scodCodeIso.equals(rhs.scodCodeIso))))&&((this.statscanCde == rhs.statscanCde)||((this.statscanCde!= null)&&this.statscanCde.equals(rhs.statscanCde))))&&((this.ediEquiv == rhs.ediEquiv)||((this.ediEquiv!= null)&&this.ediEquiv.equals(rhs.ediEquiv))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.desc == rhs.desc)||((this.desc!= null)&&this.desc.equals(rhs.desc))));
    }
