...
public class ElectronicDocumentStatusCodes100GetResponse {
    ...
    public ElectronicDocumentStatusCodes100GetResponse withArchInd(String archInd) {
        this.archInd = archInd;
        return this;
    }
    ...
    public ElectronicDocumentStatusCodes100GetResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public ElectronicDocumentStatusCodes100GetResponse withAcrecUdeInd(String acrecUdeInd) {
        this.acrecUdeInd = acrecUdeInd;
        return this;
    }
    ...
    public ElectronicDocumentStatusCodes100GetResponse withImmunizationInd(String immunizationInd) {
        this.immunizationInd = immunizationInd;
        return this;
    }
    ...
    public ElectronicDocumentStatusCodes100GetResponse withStudentUdeInd(String studentUdeInd) {
        this.studentUdeInd = studentUdeInd;
        return this;
    }
    ...
    public ElectronicDocumentStatusCodes100GetResponse withMainUdeInd(String mainUdeInd) {
        this.mainUdeInd = mainUdeInd;
        return this;
    }
    ...
    public ElectronicDocumentStatusCodes100GetResponse withCourseUdeInd(String courseUdeInd) {
        this.courseUdeInd = courseUdeInd;
        return this;
    }
    ...
    public ElectronicDocumentStatusCodes100GetResponse withTaInd(String taInd) {
        this.taInd = taInd;
        return this;
    }
    ...
    public ElectronicDocumentStatusCodes100GetResponse withTestsInd(String testsInd) {
        this.testsInd = testsInd;
        return this;
    }
    ...
    public ElectronicDocumentStatusCodes100GetResponse withDefPriority(Double defPriority) {
        this.defPriority = defPriority;
        return this;
    }
    ...
    public ElectronicDocumentStatusCodes100GetResponse withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public ElectronicDocumentStatusCodes100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ElectronicDocumentStatusCodes100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("archInd");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElectronicDocumentStatusCodes100GetResponse) == false) {
            return false;
        }
        ElectronicDocumentStatusCodes100GetResponse rhs = ((ElectronicDocumentStatusCodes100GetResponse) other);
