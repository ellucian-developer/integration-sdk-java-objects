...
public class AdditionalStudentInformationAttribute100GetResponse {
    ...
    public AdditionalStudentInformationAttribute100GetResponse withSgastdnKeyBlock(List<SgastdnKeyBlock> sgastdnKeyBlock) {
        this.sgastdnKeyBlock = sgastdnKeyBlock;
        return this;
    }
    ...
    public AdditionalStudentInformationAttribute100GetResponse withAttrCtrlBlock(List<AttrCtrlBlock> attrCtrlBlock) {
        this.attrCtrlBlock = attrCtrlBlock;
        return this;
    }
    ...
    public AdditionalStudentInformationAttribute100GetResponse withSgrsatt(List<Sgrsatt> sgrsatt) {
        this.sgrsatt = sgrsatt;
        return this;
    }
    ...
    public AdditionalStudentInformationAttribute100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AdditionalStudentInformationAttribute100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AdditionalStudentInformationAttribute100GetResponse) == false) {
            return false;
        }
        AdditionalStudentInformationAttribute100GetResponse rhs = ((AdditionalStudentInformationAttribute100GetResponse) other);
