...
public class Sgrsatt__1 {
    ...
    public Sgrsatt__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sgrsatt__1 withStspKeySequence(Double stspKeySequence) {
        this.stspKeySequence = stspKeySequence;
        return this;
    }
    ...
    public Sgrsatt__1 withAttsCode(String attsCode) {
        this.attsCode = attsCode;
        return this;
    }
    ...
    public Sgrsatt__1 withSgvstspDesc(String sgvstspDesc) {
        this.sgvstspDesc = sgvstspDesc;
        return this;
    }
    ...
    public Sgrsatt__1 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sgrsatt__1 withAttrDesc(String attrDesc) {
        this.attrDesc = attrDesc;
        return this;
    }
    ...
    public Sgrsatt__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sgrsatt__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sgrsatt__1) == false) {
            return false;
        }
        Sgrsatt__1 rhs = ((Sgrsatt__1) other);
