...
public class EuHesaVenueDetails100GetRequest {
    ...
    public EuHesaVenueDetails100GetRequest withOwnvenueid(String ownvenueid) {
        this.ownvenueid = ownvenueid;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetRequest withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetRequest withSsdtCodeVenuetype(String ssdtCodeVenuetype) {
        this.ssdtCodeVenuetype = ssdtCodeVenuetype;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetRequest withUkprn(String ukprn) {
        this.ukprn = ukprn;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetRequest withSsdtCodeVenuetypeSt(String ssdtCodeVenuetypeSt) {
        this.ssdtCodeVenuetypeSt = ssdtCodeVenuetypeSt;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetRequest withPostcode(String postcode) {
        this.postcode = postcode;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetRequest withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EuHesaVenueDetails100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EuHesaVenueDetails100GetRequest) == false) {
            return false;
        }
        EuHesaVenueDetails100GetRequest rhs = ((EuHesaVenueDetails100GetRequest) other);
