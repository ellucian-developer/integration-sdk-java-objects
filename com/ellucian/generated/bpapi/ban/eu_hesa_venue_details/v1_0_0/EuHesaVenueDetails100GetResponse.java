...
public class EuHesaVenueDetails100GetResponse {
    ...
    public EuHesaVenueDetails100GetResponse withOwnvenueid(String ownvenueid) {
        this.ownvenueid = ownvenueid;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetResponse withSsdtCodeVenuetype(String ssdtCodeVenuetype) {
        this.ssdtCodeVenuetype = ssdtCodeVenuetype;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetResponse withUkprn(String ukprn) {
        this.ukprn = ukprn;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetResponse withPostcode(String postcode) {
        this.postcode = postcode;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetResponse withSsdtCodeVenuetypeSt(String ssdtCodeVenuetypeSt) {
        this.ssdtCodeVenuetypeSt = ssdtCodeVenuetypeSt;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public EuHesaVenueDetails100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EuHesaVenueDetails100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EuHesaVenueDetails100GetResponse) == false) {
            return false;
        }
        EuHesaVenueDetails100GetResponse rhs = ((EuHesaVenueDetails100GetResponse) other);
        return (((((((((((this.ownvenueid == rhs.ownvenueid)||((this.ownvenueid!= null)&&this.ownvenueid.equals(rhs.ownvenueid)))&&((this.activityDate == rhs.activityDate)||((this.activityDate!= null)&&this.activityDate.equals(rhs.activityDate))))&&((this.ssdtCodeVenuetype == rhs.ssdtCodeVenuetype)||((this.ssdtCodeVenuetype!= null)&&this.ssdtCodeVenuetype.equals(rhs.ssdtCodeVenuetype))))&&((this.ukprn == rhs.ukprn)||((this.ukprn!= null)&&this.ukprn.equals(rhs.ukprn))))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.postcode == rhs.postcode)||((this.postcode!= null)&&this.postcode.equals(rhs.postcode))))&&((this.ssdtCodeVenuetypeSt == rhs.ssdtCodeVenuetypeSt)||((this.ssdtCodeVenuetypeSt!= null)&&this.ssdtCodeVenuetypeSt.equals(rhs.ssdtCodeVenuetypeSt))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.userId == rhs.userId)||((this.userId!= null)&&this.userId.equals(rhs.userId))));
    }
