...
public class CourseRegistrationClassAndLevelRestrictions100QapiPost {
    ...
    public CourseRegistrationClassAndLevelRestrictions100QapiPost withScacrseSubjCode(String scacrseSubjCode) {
        this.scacrseSubjCode = scacrseSubjCode;
        return this;
    }
    ...
    public CourseRegistrationClassAndLevelRestrictions100QapiPost withScacrseCrseNumb(String scacrseCrseNumb) {
        this.scacrseCrseNumb = scacrseCrseNumb;
        return this;
    }
    ...
    public CourseRegistrationClassAndLevelRestrictions100QapiPost withScacrseTermCodeEff(String scacrseTermCodeEff) {
        this.scacrseTermCodeEff = scacrseTermCodeEff;
        return this;
    }
    ...
    public CourseRegistrationClassAndLevelRestrictions100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CourseRegistrationClassAndLevelRestrictions100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseRegistrationClassAndLevelRestrictions100QapiPost) == false) {
            return false;
        }
        CourseRegistrationClassAndLevelRestrictions100QapiPost rhs = ((CourseRegistrationClassAndLevelRestrictions100QapiPost) other);
