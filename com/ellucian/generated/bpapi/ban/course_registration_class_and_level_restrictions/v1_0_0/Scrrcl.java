...
public class Scrrcl {
    ...
    public Scrrcl withClasCode(String clasCode) {
        this.clasCode = clasCode;
        return this;
    }
    ...
    public Scrrcl withClassDescription(String classDescription) {
        this.classDescription = classDescription;
        return this;
    }
    ...
    public Scrrcl withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrcl.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("clasCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrcl) == false) {
            return false;
        }
        Scrrcl rhs = ((Scrrcl) other);
