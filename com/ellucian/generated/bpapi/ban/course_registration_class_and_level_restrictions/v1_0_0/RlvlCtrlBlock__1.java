...
public class RlvlCtrlBlock__1 {
    ...
    public RlvlCtrlBlock__1 withScrrlvlTermCodeFrom(String scrrlvlTermCodeFrom) {
        this.scrrlvlTermCodeFrom = scrrlvlTermCodeFrom;
        return this;
    }
    ...
    public RlvlCtrlBlock__1 withScrrlvlLevlInd(String scrrlvlLevlInd) {
        this.scrrlvlLevlInd = scrrlvlLevlInd;
        return this;
    }
    ...
    public RlvlCtrlBlock__1 withScrrlvlTermCodeTo(String scrrlvlTermCodeTo) {
        this.scrrlvlTermCodeTo = scrrlvlTermCodeTo;
        return this;
    }
    ...
    public RlvlCtrlBlock__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RlvlCtrlBlock__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RlvlCtrlBlock__1) == false) {
            return false;
        }
        RlvlCtrlBlock__1 rhs = ((RlvlCtrlBlock__1) other);
