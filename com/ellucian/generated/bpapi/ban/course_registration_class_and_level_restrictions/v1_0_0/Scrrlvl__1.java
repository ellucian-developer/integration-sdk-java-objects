...
public class Scrrlvl__1 {
    ...
    public Scrrlvl__1 withLevlDescription(String levlDescription) {
        this.levlDescription = levlDescription;
        return this;
    }
    ...
    public Scrrlvl__1 withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public Scrrlvl__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrlvl__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrlvl__1) == false) {
            return false;
        }
        Scrrlvl__1 rhs = ((Scrrlvl__1) other);
