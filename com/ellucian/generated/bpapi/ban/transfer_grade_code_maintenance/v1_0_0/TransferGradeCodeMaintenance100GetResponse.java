...
public class TransferGradeCodeMaintenance100GetResponse {
    ...
    public TransferGradeCodeMaintenance100GetResponse withCompletedInd(String completedInd) {
        this.completedInd = completedInd;
        return this;
    }
    ...
    public TransferGradeCodeMaintenance100GetResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public TransferGradeCodeMaintenance100GetResponse withGmodCode(String gmodCode) {
        this.gmodCode = gmodCode;
        return this;
    }
    ...
    public TransferGradeCodeMaintenance100GetResponse withPassedInd(String passedInd) {
        this.passedInd = passedInd;
        return this;
    }
    ...
    public TransferGradeCodeMaintenance100GetResponse withQualityPoints(Double qualityPoints) {
        this.qualityPoints = qualityPoints;
        return this;
    }
    ...
    public TransferGradeCodeMaintenance100GetResponse withNumericValue(Double numericValue) {
        this.numericValue = numericValue;
        return this;
    }
    ...
    public TransferGradeCodeMaintenance100GetResponse withGrdeCode(String grdeCode) {
        this.grdeCode = grdeCode;
        return this;
    }
    ...
    public TransferGradeCodeMaintenance100GetResponse withGrdeStatusInd(String grdeStatusInd) {
        this.grdeStatusInd = grdeStatusInd;
        return this;
    }
    ...
    public TransferGradeCodeMaintenance100GetResponse withAttemptedInd(String attemptedInd) {
        this.attemptedInd = attemptedInd;
        return this;
    }
    ...
    public TransferGradeCodeMaintenance100GetResponse withAbbrev(String abbrev) {
        this.abbrev = abbrev;
        return this;
    }
    ...
    public TransferGradeCodeMaintenance100GetResponse withTermCodeEffective(String termCodeEffective) {
        this.termCodeEffective = termCodeEffective;
        return this;
    }
    ...
    public TransferGradeCodeMaintenance100GetResponse withGpaInd(String gpaInd) {
        this.gpaInd = gpaInd;
        return this;
    }
    ...
    public TransferGradeCodeMaintenance100GetResponse withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public TransferGradeCodeMaintenance100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TransferGradeCodeMaintenance100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TransferGradeCodeMaintenance100GetResponse) == false) {
            return false;
        }
        TransferGradeCodeMaintenance100GetResponse rhs = ((TransferGradeCodeMaintenance100GetResponse) other);
