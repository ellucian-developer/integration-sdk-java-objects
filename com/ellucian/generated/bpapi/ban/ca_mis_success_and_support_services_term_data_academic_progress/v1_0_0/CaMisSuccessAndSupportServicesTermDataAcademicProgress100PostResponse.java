...
public class CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse {
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withSeqNo(Double seqNo) {
        this.seqNo = seqNo;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withServiceDate(Date serviceDate) {
        this.serviceDate = serviceDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withSsstDesc(String ssstDesc) {
        this.ssstDesc = ssstDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withOrigDesc(String origDesc) {
        this.origDesc = origDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withSsgpCode(String ssgpCode) {
        this.ssgpCode = ssgpCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withRwname(String rwname) {
        this.rwname = rwname;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withDataOrigin(String dataOrigin) {
        this.dataOrigin = dataOrigin;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withPrstCode(String prstCode) {
        this.prstCode = prstCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withSsgpDesc(String ssgpDesc) {
        this.ssgpDesc = ssgpDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withSsstCode(String ssstCode) {
        this.ssstCode = ssstCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withPrstDesc(String prstDesc) {
        this.prstDesc = prstDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("seqNo");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse) == false) {
            return false;
        }
        CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse rhs = ((CaMisSuccessAndSupportServicesTermDataAcademicProgress100PostResponse) other);
