...
public class ChrtCtrlBlock__1 {
    ...
    public ChrtCtrlBlock__1 withSgrchrtTermCodeFrom(String sgrchrtTermCodeFrom) {
        this.sgrchrtTermCodeFrom = sgrchrtTermCodeFrom;
        return this;
    }
    ...
    public ChrtCtrlBlock__1 withSgrchrtTermCodeTo(String sgrchrtTermCodeTo) {
        this.sgrchrtTermCodeTo = sgrchrtTermCodeTo;
        return this;
    }
    ...
    public ChrtCtrlBlock__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ChrtCtrlBlock__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChrtCtrlBlock__1) == false) {
            return false;
        }
        ChrtCtrlBlock__1 rhs = ((ChrtCtrlBlock__1) other);
