...
public class ChrtCtrlBlock__2 {
    ...
    public ChrtCtrlBlock__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ChrtCtrlBlock__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChrtCtrlBlock__2) == false) {
            return false;
        }
        ChrtCtrlBlock__2 rhs = ((ChrtCtrlBlock__2) other);
