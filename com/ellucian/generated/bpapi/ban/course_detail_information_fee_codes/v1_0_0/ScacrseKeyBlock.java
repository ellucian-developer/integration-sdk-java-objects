...
public class ScacrseKeyBlock {
    ...
    @JsonPropertyDescription("Lineage reference object : crseTitle")
    ...
    public ScacrseKeyBlock withCrseTitle(String crseTitle) {
        this.crseTitle = crseTitle;
        return this;
    }
    ...
    public ScacrseKeyBlock withScacrseTermCodeEff(String scacrseTermCodeEff) {
        this.scacrseTermCodeEff = scacrseTermCodeEff;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((((this.crseTitle == rhs.crseTitle)||((this.crseTitle!= null)&&this.crseTitle.equals(rhs.crseTitle)))&&((this.scacrseCrseNumb == rhs.scacrseCrseNumb)||((this.scacrseCrseNumb!= null)&&this.scacrseCrseNumb.equals(rhs.scacrseCrseNumb))))&&((this.subjDescription == rhs.subjDescription)||((this.subjDescription!= null)&&this.subjDescription.equals(rhs.subjDescription))))&&((this.scacrseSubjCode == rhs.scacrseSubjCode)||((this.scacrseSubjCode!= null)&&this.scacrseSubjCode.equals(rhs.scacrseSubjCode))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.scacrseTermCodeEff == rhs.scacrseTermCodeEff)||((this.scacrseTermCodeEff!= null)&&this.scacrseTermCodeEff.equals(rhs.scacrseTermCodeEff))));
    }
