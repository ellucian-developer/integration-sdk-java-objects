...
public class Sovlcur__2 {
    ...
    public Sovlcur__2 withTermCodeCtlg(String termCodeCtlg) {
        this.termCodeCtlg = termCodeCtlg;
        return this;
    }
    ...
    public Sovlcur__2 withCampCode(String campCode) {
        this.campCode = campCode;
        return this;
    }
    ...
    public Sovlcur__2 withPriorityNo(Double priorityNo) {
        this.priorityNo = priorityNo;
        return this;
    }
    ...
    public Sovlcur__2 withDegcCode(String degcCode) {
        this.degcCode = degcCode;
        return this;
    }
    ...
    public Sovlcur__2 withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public Sovlcur__2 withCollCode(String collCode) {
        this.collCode = collCode;
        return this;
    }
    ...
    public Sovlcur__2 withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public Sovlcur__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sovlcur__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sovlcur__2) == false) {
            return false;
        }
        Sovlcur__2 rhs = ((Sovlcur__2) other);
