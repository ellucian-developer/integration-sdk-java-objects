...
public class Sovlcur__1 {
    ...
    public Sovlcur__1 withTermCodeCtlg(String termCodeCtlg) {
        this.termCodeCtlg = termCodeCtlg;
        return this;
    }
    ...
    public Sovlcur__1 withCampCode(String campCode) {
        this.campCode = campCode;
        return this;
    }
    ...
    public Sovlcur__1 withPriorityNo(Double priorityNo) {
        this.priorityNo = priorityNo;
        return this;
    }
    ...
    public Sovlcur__1 withDegcCode(String degcCode) {
        this.degcCode = degcCode;
        return this;
    }
    ...
    public Sovlcur__1 withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public Sovlcur__1 withCollCode(String collCode) {
        this.collCode = collCode;
        return this;
    }
    ...
    public Sovlcur__1 withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public Sovlcur__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sovlcur__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sovlcur__1) == false) {
            return false;
        }
        Sovlcur__1 rhs = ((Sovlcur__1) other);
