...
public class Sovlfo {
    ...
    public Sovlfo withLfstCode(String lfstCode) {
        this.lfstCode = lfstCode;
        return this;
    }
    ...
    public Sovlfo withMajrCode(String majrCode) {
        this.majrCode = majrCode;
        return this;
    }
    ...
    public Sovlfo withDeptCode(String deptCode) {
        this.deptCode = deptCode;
        return this;
    }
    ...
    public Sovlfo withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sovlfo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("lfstCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sovlfo) == false) {
            return false;
        }
        Sovlfo rhs = ((Sovlfo) other);
