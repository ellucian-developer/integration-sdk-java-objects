...
public class ApplicationQuestionsOrAnswers100PostResponse {

    @JsonProperty("saradap")
    private List<Saradap__1> saradap = new ArrayList<Saradap__1>();
    @JsonProperty("sovlfos")
    private List<Sovlfo__1> sovlfos = new ArrayList<Sovlfo__1>();
    @JsonProperty("sovlcur")
    private List<Sovlcur__1> sovlcur = new ArrayList<Sovlcur__1>();
    @JsonProperty("sarquan")
    private List<Sarquan__1> sarquan = new ArrayList<Sarquan__1>();
    @JsonIgnore
    ...
    public ApplicationQuestionsOrAnswers100PostResponse withSaradap(List<Saradap__1> saradap) {
        this.saradap = saradap;
        return this;
    }

    @JsonProperty("sovlfos")
    public List<Sovlfo__1> getSovlfos() {
        return sovlfos;
    }

    @JsonProperty("sovlfos")
    public void setSovlfos(List<Sovlfo__1> sovlfos) {
        this.sovlfos = sovlfos;
    }

    public ApplicationQuestionsOrAnswers100PostResponse withSovlfos(List<Sovlfo__1> sovlfos) {
        this.sovlfos = sovlfos;
        return this;
    }

    @JsonProperty("sovlcur")
    public List<Sovlcur__1> getSovlcur() {
        return sovlcur;
    }

    @JsonProperty("sovlcur")
    public void setSovlcur(List<Sovlcur__1> sovlcur) {
        this.sovlcur = sovlcur;
    }

    public ApplicationQuestionsOrAnswers100PostResponse withSovlcur(List<Sovlcur__1> sovlcur) {
        this.sovlcur = sovlcur;
        return this;
    }

    @JsonProperty("sarquan")
    public List<Sarquan__1> getSarquan() {
        return sarquan;
    }

    @JsonProperty("sarquan")
    public void setSarquan(List<Sarquan__1> sarquan) {
        this.sarquan = sarquan;
    }

    public ApplicationQuestionsOrAnswers100PostResponse withSarquan(List<Sarquan__1> sarquan) {
        this.sarquan = sarquan;
        return this;
    }
    ...
    public ApplicationQuestionsOrAnswers100PostResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ApplicationQuestionsOrAnswers100PostResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("saradap");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ApplicationQuestionsOrAnswers100PostResponse) == false) {
            return false;
        }
        ApplicationQuestionsOrAnswers100PostResponse rhs = ((ApplicationQuestionsOrAnswers100PostResponse) other);
