...
public class Sovlfo__1 {
    ...
    public Sovlfo__1 withLfstCode(String lfstCode) {
        this.lfstCode = lfstCode;
        return this;
    }
    ...
    public Sovlfo__1 withMajrCode(String majrCode) {
        this.majrCode = majrCode;
        return this;
    }
    ...
    public Sovlfo__1 withDeptCode(String deptCode) {
        this.deptCode = deptCode;
        return this;
    }
    ...
    public Sovlfo__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sovlfo__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("lfstCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sovlfo__1) == false) {
            return false;
        }
        Sovlfo__1 rhs = ((Sovlfo__1) other);
