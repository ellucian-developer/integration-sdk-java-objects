...
public class CommentCentral100QapiPost {
    ...
    public CommentCentral100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CommentCentral100QapiPost withCommentCode(String commentCode) {
        this.commentCode = commentCode;
        return this;
    }
    ...
    public CommentCentral100QapiPost withRestrictUpdateInd(String restrictUpdateInd) {
        this.restrictUpdateInd = restrictUpdateInd;
        return this;
    }
    ...
    public CommentCentral100QapiPost withCreatedBy(String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
    ...
    public CommentCentral100QapiPost withCreatedDate(Date createdDate) {
        this.createdDate = createdDate;
        return this;
    }
    ...
    public CommentCentral100QapiPost withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public CommentCentral100QapiPost withPurgeInd(String purgeInd) {
        this.purgeInd = purgeInd;
        return this;
    }
    ...
    public CommentCentral100QapiPost withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public CommentCentral100QapiPost withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CommentCentral100QapiPost withTerm(String term) {
        this.term = term;
        return this;
    }
    ...
    public CommentCentral100QapiPost withEnddate(Date enddate) {
        this.enddate = enddate;
        return this;
    }
    ...
    public CommentCentral100QapiPost withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public CommentCentral100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CommentCentral100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CommentCentral100QapiPost) == false) {
            return false;
        }
        CommentCentral100QapiPost rhs = ((CommentCentral100QapiPost) other);
        return ((((((((((((((this.restrictUpdateInd == rhs.restrictUpdateInd)||((this.restrictUpdateInd!= null)&&this.restrictUpdateInd.equals(rhs.restrictUpdateInd)))&&((this.purgeInd == rhs.purgeInd)||((this.purgeInd!= null)&&this.purgeInd.equals(rhs.purgeInd))))&&((this.origCode == rhs.origCode)||((this.origCode!= null)&&this.origCode.equals(rhs.origCode))))&&((this.createdDate == rhs.createdDate)||((this.createdDate!= null)&&this.createdDate.equals(rhs.createdDate))))&&((this.activityDate == rhs.activityDate)||((this.activityDate!= null)&&this.activityDate.equals(rhs.activityDate))))&&((this.enddate == rhs.enddate)||((this.enddate!= null)&&this.enddate.equals(rhs.enddate))))&&((this.commentCode == rhs.commentCode)||((this.commentCode!= null)&&this.commentCode.equals(rhs.commentCode))))&&((this.createdBy == rhs.createdBy)||((this.createdBy!= null)&&this.createdBy.equals(rhs.createdBy))))&&((this.term == rhs.term)||((this.term!= null)&&this.term.equals(rhs.term))))&&((this.comment == rhs.comment)||((this.comment!= null)&&this.comment.equals(rhs.comment))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.user == rhs.user)||((this.user!= null)&&this.user.equals(rhs.user))));
    }
