...
public class CommentCentral100PutResponse {
    ...
    public CommentCentral100PutResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CommentCentral100PutResponse withCreatedDate(Date createdDate) {
        this.createdDate = createdDate;
        return this;
    }
    ...
    public CommentCentral100PutResponse withEnddate(Date enddate) {
        this.enddate = enddate;
        return this;
    }
    ...
    public CommentCentral100PutResponse withCommentCode(String commentCode) {
        this.commentCode = commentCode;
        return this;
    }
    ...
    public CommentCentral100PutResponse withCreatedBy(String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
    ...
    public CommentCentral100PutResponse withRestrictUpdateInd(String restrictUpdateInd) {
        this.restrictUpdateInd = restrictUpdateInd;
        return this;
    }
    ...
    public CommentCentral100PutResponse withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public CommentCentral100PutResponse withTerm(String term) {
        this.term = term;
        return this;
    }
    ...
    public CommentCentral100PutResponse withPurgeInd(String purgeInd) {
        this.purgeInd = purgeInd;
        return this;
    }
    ...
    public CommentCentral100PutResponse withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public CommentCentral100PutResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public CommentCentral100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CommentCentral100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CommentCentral100PutResponse) == false) {
            return false;
        }
        CommentCentral100PutResponse rhs = ((CommentCentral100PutResponse) other);
