...
public class RefundReviewStudents100GetRequest {
    ...
    public RefundReviewStudents100GetRequest withT4Refund(Double t4Refund) {
        this.t4Refund = t4Refund;
        return this;
    }
    ...
    public RefundReviewStudents100GetRequest withAllRefund(Double allRefund) {
        this.allRefund = allRefund;
        return this;
    }
    ...
    public RefundReviewStudents100GetRequest withPending(Double pending) {
        this.pending = pending;
        return this;
    }
    ...
    public RefundReviewStudents100GetRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public RefundReviewStudents100GetRequest withRefundInd(String refundInd) {
        this.refundInd = refundInd;
        return this;
    }
    ...
    public RefundReviewStudents100GetRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public RefundReviewStudents100GetRequest withAccountBalance(Double accountBalance) {
        this.accountBalance = accountBalance;
        return this;
    }
    ...
    public RefundReviewStudents100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RefundReviewStudents100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("t4Refund");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RefundReviewStudents100GetRequest) == false) {
            return false;
        }
        RefundReviewStudents100GetRequest rhs = ((RefundReviewStudents100GetRequest) other);
