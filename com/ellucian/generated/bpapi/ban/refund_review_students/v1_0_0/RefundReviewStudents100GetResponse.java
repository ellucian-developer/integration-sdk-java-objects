...
public class RefundReviewStudents100GetResponse {
    ...
    public RefundReviewStudents100GetResponse withT4Refund(Double t4Refund) {
        this.t4Refund = t4Refund;
        return this;
    }
    ...
    public RefundReviewStudents100GetResponse withAllRefund(Double allRefund) {
        this.allRefund = allRefund;
        return this;
    }
    ...
    public RefundReviewStudents100GetResponse withPidm(Double pidm) {
        this.pidm = pidm;
        return this;
    }
    ...
    public RefundReviewStudents100GetResponse withPending(Double pending) {
        this.pending = pending;
        return this;
    }
    ...
    public RefundReviewStudents100GetResponse withRwname(String rwname) {
        this.rwname = rwname;
        return this;
    }
    ...
    public RefundReviewStudents100GetResponse withRefundInd(String refundInd) {
        this.refundInd = refundInd;
        return this;
    }
    ...
    public RefundReviewStudents100GetResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public RefundReviewStudents100GetResponse withAccountBalance(Double accountBalance) {
        this.accountBalance = accountBalance;
        return this;
    }
    ...
    public RefundReviewStudents100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RefundReviewStudents100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("t4Refund");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RefundReviewStudents100GetResponse) == false) {
            return false;
        }
        RefundReviewStudents100GetResponse rhs = ((RefundReviewStudents100GetResponse) other);
