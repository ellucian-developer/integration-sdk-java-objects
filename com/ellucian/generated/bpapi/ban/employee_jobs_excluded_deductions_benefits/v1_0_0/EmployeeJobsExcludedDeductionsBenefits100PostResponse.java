...
public class EmployeeJobsExcludedDeductionsBenefits100PostResponse {
    ...
    public EmployeeJobsExcludedDeductionsBenefits100PostResponse withBdcaCode(String bdcaCode) {
        this.bdcaCode = bdcaCode;
        return this;
    }
    ...
    public EmployeeJobsExcludedDeductionsBenefits100PostResponse withBdcaDesc(String bdcaDesc) {
        this.bdcaDesc = bdcaDesc;
        return this;
    }
    ...
    public EmployeeJobsExcludedDeductionsBenefits100PostResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EmployeeJobsExcludedDeductionsBenefits100PostResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("bdcaCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EmployeeJobsExcludedDeductionsBenefits100PostResponse) == false) {
            return false;
        }
        EmployeeJobsExcludedDeductionsBenefits100PostResponse rhs = ((EmployeeJobsExcludedDeductionsBenefits100PostResponse) other);
