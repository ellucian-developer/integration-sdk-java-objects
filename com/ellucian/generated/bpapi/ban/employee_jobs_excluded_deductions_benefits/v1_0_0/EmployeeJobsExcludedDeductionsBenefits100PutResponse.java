...
public class EmployeeJobsExcludedDeductionsBenefits100PutResponse {
    ...
    public EmployeeJobsExcludedDeductionsBenefits100PutResponse withBdcaCode(String bdcaCode) {
        this.bdcaCode = bdcaCode;
        return this;
    }
    ...
    public EmployeeJobsExcludedDeductionsBenefits100PutResponse withBdcaDesc(String bdcaDesc) {
        this.bdcaDesc = bdcaDesc;
        return this;
    }
    ...
    public EmployeeJobsExcludedDeductionsBenefits100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EmployeeJobsExcludedDeductionsBenefits100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("bdcaCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EmployeeJobsExcludedDeductionsBenefits100PutResponse) == false) {
            return false;
        }
        EmployeeJobsExcludedDeductionsBenefits100PutResponse rhs = ((EmployeeJobsExcludedDeductionsBenefits100PutResponse) other);
