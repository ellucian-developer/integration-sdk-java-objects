...
public class ElectronicPersonnelActionRouting100QapiPost {
    ...
    public ElectronicPersonnelActionRouting100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ElectronicPersonnelActionRouting100QapiPost withTransNo(String transNo) {
        this.transNo = transNo;
        return this;
    }
    ...
    public ElectronicPersonnelActionRouting100QapiPost withEffectiveDate(String effectiveDate) {
        this.effectiveDate = effectiveDate;
        return this;
    }
    ...
    public ElectronicPersonnelActionRouting100QapiPost withAcatCode(String acatCode) {
        this.acatCode = acatCode;
        return this;
    }
    ...
    public ElectronicPersonnelActionRouting100QapiPost withAptyCode(String aptyCode) {
        this.aptyCode = aptyCode;
        return this;
    }
    ...
    public ElectronicPersonnelActionRouting100QapiPost withProxyForUserId(String proxyForUserId) {
        this.proxyForUserId = proxyForUserId;
        return this;
    }
    ...
    public ElectronicPersonnelActionRouting100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ElectronicPersonnelActionRouting100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElectronicPersonnelActionRouting100QapiPost) == false) {
            return false;
        }
        ElectronicPersonnelActionRouting100QapiPost rhs = ((ElectronicPersonnelActionRouting100QapiPost) other);
