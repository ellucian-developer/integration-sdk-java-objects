...
public class Sgrcatt {
    ...
    public Sgrcatt withAttsCode(String attsCode) {
        this.attsCode = attsCode;
        return this;
    }
    ...
    public Sgrcatt withAttrDesc(String attrDesc) {
        this.attrDesc = attrDesc;
        return this;
    }
    ...
    public Sgrcatt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sgrcatt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attsCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sgrcatt) == false) {
            return false;
        }
        Sgrcatt rhs = ((Sgrcatt) other);
