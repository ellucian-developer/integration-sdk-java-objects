...
public class Scrcorq {
    ...
    public Scrcorq withCrseNumbCorq(String crseNumbCorq) {
        this.crseNumbCorq = crseNumbCorq;
        return this;
    }
    ...
    public Scrcorq withEndcopy(String endcopy) {
        this.endcopy = endcopy;
        return this;
    }
    ...
    public Scrcorq withSubjCodeCorq(String subjCodeCorq) {
        this.subjCodeCorq = subjCodeCorq;
        return this;
    }
    ...
    public Scrcorq withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrcorq.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrcorq) == false) {
            return false;
        }
        Scrcorq rhs = ((Scrcorq) other);
