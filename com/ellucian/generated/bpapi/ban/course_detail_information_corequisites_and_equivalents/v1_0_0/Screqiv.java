...
public class Screqiv {
    ...
    public Screqiv withEndTerm(String endTerm) {
        this.endTerm = endTerm;
        return this;
    }
    ...
    public Screqiv withCrseNumbEqiv(String crseNumbEqiv) {
        this.crseNumbEqiv = crseNumbEqiv;
        return this;
    }
    ...
    public Screqiv withEndcopy(String endcopy) {
        this.endcopy = endcopy;
        return this;
    }
    ...
    public Screqiv withStartTerm(String startTerm) {
        this.startTerm = startTerm;
        return this;
    }
    ...
    public Screqiv withSubjCodeEqiv(String subjCodeEqiv) {
        this.subjCodeEqiv = subjCodeEqiv;
        return this;
    }
    ...
    public Screqiv withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Screqiv.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("endTerm");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Screqiv) == false) {
            return false;
        }
        Screqiv rhs = ((Screqiv) other);
