...
@JsonPropertyOrder({
    ...
    "subjCodeEqiv",
    "subjCodeCorq",
    "criteria.subjCodeCorq"
})
@Generated("jsonschema2pojo")
public class CourseDetailInformationCorequisitesAndEquivalents100PutRequest {
     ...
     * 
     */
    @JsonProperty("criteria.subjCodeCorq")
    @JsonPropertyDescription("Lineage reference object : SCRCORQ_SUBJ_CODE_CORQ, Lookup lineage reference object : scbcrse,scbcrky")
    private String criteriaSubjCodeCorq;
    @JsonIgnore
     ...
     */
    @JsonProperty("criteria.subjCodeEqiv")
    public String getCriteriaSubjCodeEqiv() {
        return criteriaSubjCodeEqiv;
    }
     ...
     */
    @JsonProperty("criteria.subjCodeEqiv")
    public void setCriteriaSubjCodeEqiv(String criteriaSubjCodeEqiv) {
        this.criteriaSubjCodeEqiv = criteriaSubjCodeEqiv;
    }

    public CourseDetailInformationCorequisitesAndEquivalents100PutRequest withCriteriaSubjCodeEqiv(String criteriaSubjCodeEqiv) {
        this.criteriaSubjCodeEqiv = criteriaSubjCodeEqiv;
        return this;
    }
    ...
    public CourseDetailInformationCorequisitesAndEquivalents100PutRequest withCrseNumb(Object crseNumb) {
        this.crseNumb = crseNumb;
        return this;
    }
    ...
    public CourseDetailInformationCorequisitesAndEquivalents100PutRequest withTermCodeEff(Object termCodeEff) {
        this.termCodeEff = termCodeEff;
        return this;
    }
    ...
    public CourseDetailInformationCorequisitesAndEquivalents100PutRequest withEndTerm(String endTerm) {
        this.endTerm = endTerm;
        return this;
    }
    ...
    public CourseDetailInformationCorequisitesAndEquivalents100PutRequest withCrseNumbEqiv(String crseNumbEqiv) {
        this.crseNumbEqiv = crseNumbEqiv;
        return this;
    }
    ...
    public CourseDetailInformationCorequisitesAndEquivalents100PutRequest withSubjCode(Object subjCode) {
        this.subjCode = subjCode;
        return this;
    }
    ...
    public CourseDetailInformationCorequisitesAndEquivalents100PutRequest withCrseNumbCorq(String crseNumbCorq) {
        this.crseNumbCorq = crseNumbCorq;
        return this;
    }
    ...
    public CourseDetailInformationCorequisitesAndEquivalents100PutRequest withStartTerm(String startTerm) {
        this.startTerm = startTerm;
        return this;
    }
    ...
    public CourseDetailInformationCorequisitesAndEquivalents100PutRequest withSubjCodeEqiv(String subjCodeEqiv) {
        this.subjCodeEqiv = subjCodeEqiv;
        return this;
    }
    ...
    public CourseDetailInformationCorequisitesAndEquivalents100PutRequest withSubjCodeCorq(String subjCodeCorq) {
        this.subjCodeCorq = subjCodeCorq;
        return this;
    }
     ...
     */
    @JsonProperty("criteria.subjCodeCorq")
    public String getCriteriaSubjCodeCorq() {
        return criteriaSubjCodeCorq;
    }
     ...
     */
    @JsonProperty("criteria.subjCodeCorq")
    public void setCriteriaSubjCodeCorq(String criteriaSubjCodeCorq) {
        this.criteriaSubjCodeCorq = criteriaSubjCodeCorq;
    }

    public CourseDetailInformationCorequisitesAndEquivalents100PutRequest withCriteriaSubjCodeCorq(String criteriaSubjCodeCorq) {
        this.criteriaSubjCodeCorq = criteriaSubjCodeCorq;
        return this;
    }
    ...
    public CourseDetailInformationCorequisitesAndEquivalents100PutRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CourseDetailInformationCorequisitesAndEquivalents100PutRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("criteriaSubjCodeEqiv");
        sb.append('=');
        sb.append(((this.criteriaSubjCodeEqiv == null)?"<null>":this.criteriaSubjCodeEqiv));
        sb.append(',');
        sb.append("crseNumb");
        sb.append('=');
        ...
        sb.append(',');
        sb.append("criteriaSubjCodeCorq");
        sb.append('=');
        sb.append(((this.criteriaSubjCodeCorq == null)?"<null>":this.criteriaSubjCodeCorq));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.criteriaSubjCodeEqiv == null)? 0 :this.criteriaSubjCodeEqiv.hashCode()));
        ...
        result = ((result* 31)+((this.criteriaSubjCodeCorq == null)? 0 :this.criteriaSubjCodeCorq.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseDetailInformationCorequisitesAndEquivalents100PutRequest) == false) {
            return false;
        }
        CourseDetailInformationCorequisitesAndEquivalents100PutRequest rhs = ((CourseDetailInformationCorequisitesAndEquivalents100PutRequest) other);
        return (((((((((((((this.termCodeEff == rhs.termCodeEff)||((this.termCodeEff!= null)&&this.termCodeEff.equals(rhs.termCodeEff)))&&((this.criteriaSubjCodeEqiv == rhs.criteriaSubjCodeEqiv)||((this.criteriaSubjCodeEqiv!= null)&&this.criteriaSubjCodeEqiv.equals(rhs.criteriaSubjCodeEqiv))))&&((this.subjCode == rhs.subjCode)||((this.subjCode!= null)&&this.subjCode.equals(rhs.subjCode))))&&((this.crseNumbCorq == rhs.crseNumbCorq)||((this.crseNumbCorq!= null)&&this.crseNumbCorq.equals(rhs.crseNumbCorq))))&&((this.criteriaSubjCodeCorq == rhs.criteriaSubjCodeCorq)||((this.criteriaSubjCodeCorq!= null)&&this.criteriaSubjCodeCorq.equals(rhs.criteriaSubjCodeCorq))))&&((this.subjCodeEqiv == rhs.subjCodeEqiv)||((this.subjCodeEqiv!= null)&&this.subjCodeEqiv.equals(rhs.subjCodeEqiv))))&&((this.crseNumb == rhs.crseNumb)||((this.crseNumb!= null)&&this.crseNumb.equals(rhs.crseNumb))))&&((this.endTerm == rhs.endTerm)||((this.endTerm!= null)&&this.endTerm.equals(rhs.endTerm))))&&((this.crseNumbEqiv == rhs.crseNumbEqiv)||((this.crseNumbEqiv!= null)&&this.crseNumbEqiv.equals(rhs.crseNumbEqiv))))&&((this.startTerm == rhs.startTerm)||((this.startTerm!= null)&&this.startTerm.equals(rhs.startTerm))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.subjCodeCorq == rhs.subjCodeCorq)||((this.subjCodeCorq!= null)&&this.subjCodeCorq.equals(rhs.subjCodeCorq))));
    }
