...
public class BorrowerBasedAcademicYearTypes100QapiPost {
    ...
    public BorrowerBasedAcademicYearTypes100QapiPost withActiveInd(String activeInd) {
        this.activeInd = activeInd;
        return this;
    }
    ...
    public BorrowerBasedAcademicYearTypes100QapiPost withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public BorrowerBasedAcademicYearTypes100QapiPost withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public BorrowerBasedAcademicYearTypes100QapiPost withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public BorrowerBasedAcademicYearTypes100QapiPost withSysReqInd(String sysReqInd) {
        this.sysReqInd = sysReqInd;
        return this;
    }
    ...
    public BorrowerBasedAcademicYearTypes100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(BorrowerBasedAcademicYearTypes100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("activeInd");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BorrowerBasedAcademicYearTypes100QapiPost) == false) {
            return false;
        }
        BorrowerBasedAcademicYearTypes100QapiPost rhs = ((BorrowerBasedAcademicYearTypes100QapiPost) other);
