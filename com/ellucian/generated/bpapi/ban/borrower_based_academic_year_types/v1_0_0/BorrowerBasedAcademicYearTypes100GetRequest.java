...
public class BorrowerBasedAcademicYearTypes100GetRequest {
    ...
    public BorrowerBasedAcademicYearTypes100GetRequest withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public BorrowerBasedAcademicYearTypes100GetRequest withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public BorrowerBasedAcademicYearTypes100GetRequest withActiveInd(String activeInd) {
        this.activeInd = activeInd;
        return this;
    }
    ...
    public BorrowerBasedAcademicYearTypes100GetRequest withSysReqInd(String sysReqInd) {
        this.sysReqInd = sysReqInd;
        return this;
    }
    ...
    public BorrowerBasedAcademicYearTypes100GetRequest withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public BorrowerBasedAcademicYearTypes100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(BorrowerBasedAcademicYearTypes100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BorrowerBasedAcademicYearTypes100GetRequest) == false) {
            return false;
        }
        BorrowerBasedAcademicYearTypes100GetRequest rhs = ((BorrowerBasedAcademicYearTypes100GetRequest) other);
