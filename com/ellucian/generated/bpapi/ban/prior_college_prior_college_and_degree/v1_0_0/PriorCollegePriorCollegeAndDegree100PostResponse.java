...
public class PriorCollegePriorCollegeAndDegree100PostResponse {
    ...
    public PriorCollegePriorCollegeAndDegree100PostResponse withSordegr(List<Sordegr__1> sordegr) {
        this.sordegr = sordegr;
        return this;
    }
    ...
    public PriorCollegePriorCollegeAndDegree100PostResponse withSorpcol(List<Sorpcol__1> sorpcol) {
        this.sorpcol = sorpcol;
        return this;
    }
    ...
    public PriorCollegePriorCollegeAndDegree100PostResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PriorCollegePriorCollegeAndDegree100PostResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sordegr");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PriorCollegePriorCollegeAndDegree100PostResponse) == false) {
            return false;
        }
        PriorCollegePriorCollegeAndDegree100PostResponse rhs = ((PriorCollegePriorCollegeAndDegree100PostResponse) other);
