...
public class Sordegr__1 {
    ...
    public Sordegr__1 withHoursTransferred(Double hoursTransferred) {
        this.hoursTransferred = hoursTransferred;
        return this;
    }
    ...
    public Sordegr__1 withGpaTransferred(Double gpaTransferred) {
        this.gpaTransferred = gpaTransferred;
        return this;
    }
    ...
    public Sordegr__1 withEgolDesc(String egolDesc) {
        this.egolDesc = egolDesc;
        return this;
    }
    ...
    public Sordegr__1 withDegrDesc(String degrDesc) {
        this.degrDesc = degrDesc;
        return this;
    }
    ...
    public Sordegr__1 withDegcDate(Date degcDate) {
        this.degcDate = degcDate;
        return this;
    }
    ...
    public Sordegr__1 withDegcCode(String degcCode) {
        this.degcCode = degcCode;
        return this;
    }
    ...
    public Sordegr__1 withAttendTo(Date attendTo) {
        this.attendTo = attendTo;
        return this;
    }
    ...
    public Sordegr__1 withAttendFrom(Date attendFrom) {
        this.attendFrom = attendFrom;
        return this;
    }
    ...
    public Sordegr__1 withDegcYear(String degcYear) {
        this.degcYear = degcYear;
        return this;
    }
    ...
    public Sordegr__1 withHonrCode(String honrCode) {
        this.honrCode = honrCode;
        return this;
    }
    ...
    public Sordegr__1 withHonrDesc(String honrDesc) {
        this.honrDesc = honrDesc;
        return this;
    }
    ...
    public Sordegr__1 withCollDesc(String collDesc) {
        this.collDesc = collDesc;
        return this;
    }
    ...
    public Sordegr__1 withEgolCode(String egolCode) {
        this.egolCode = egolCode;
        return this;
    }
    ...
    public Sordegr__1 withCollCode(String collCode) {
        this.collCode = collCode;
        return this;
    }
    ...
    public Sordegr__1 withPrimaryInd(String primaryInd) {
        this.primaryInd = primaryInd;
        return this;
    }
    ...
    public Sordegr__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sordegr__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sordegr__1) == false) {
            return false;
        }
        Sordegr__1 rhs = ((Sordegr__1) other);
