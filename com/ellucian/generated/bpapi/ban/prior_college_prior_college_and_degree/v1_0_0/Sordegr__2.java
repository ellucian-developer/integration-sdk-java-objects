...
public class Sordegr__2 {
    ...
    public Sordegr__2 withHoursTransferred(Double hoursTransferred) {
        this.hoursTransferred = hoursTransferred;
        return this;
    }
    ...
    public Sordegr__2 withGpaTransferred(Double gpaTransferred) {
        this.gpaTransferred = gpaTransferred;
        return this;
    }
    ...
    public Sordegr__2 withEgolDesc(String egolDesc) {
        this.egolDesc = egolDesc;
        return this;
    }
    ...
    public Sordegr__2 withDegrDesc(String degrDesc) {
        this.degrDesc = degrDesc;
        return this;
    }
    ...
    public Sordegr__2 withDegcDate(Date degcDate) {
        this.degcDate = degcDate;
        return this;
    }
    ...
    public Sordegr__2 withDegcCode(String degcCode) {
        this.degcCode = degcCode;
        return this;
    }
    ...
    public Sordegr__2 withAttendTo(Date attendTo) {
        this.attendTo = attendTo;
        return this;
    }
    ...
    public Sordegr__2 withAttendFrom(Date attendFrom) {
        this.attendFrom = attendFrom;
        return this;
    }
    ...
    public Sordegr__2 withDegcYear(String degcYear) {
        this.degcYear = degcYear;
        return this;
    }
    ...
    public Sordegr__2 withHonrCode(String honrCode) {
        this.honrCode = honrCode;
        return this;
    }
    ...
    public Sordegr__2 withHonrDesc(String honrDesc) {
        this.honrDesc = honrDesc;
        return this;
    }
    ...
    public Sordegr__2 withCollDesc(String collDesc) {
        this.collDesc = collDesc;
        return this;
    }
    ...
    public Sordegr__2 withEgolCode(String egolCode) {
        this.egolCode = egolCode;
        return this;
    }
    ...
    public Sordegr__2 withCollCode(String collCode) {
        this.collCode = collCode;
        return this;
    }
    ...
    public Sordegr__2 withPrimaryInd(String primaryInd) {
        this.primaryInd = primaryInd;
        return this;
    }
    ...
    public Sordegr__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sordegr__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sordegr__2) == false) {
            return false;
        }
        Sordegr__2 rhs = ((Sordegr__2) other);
