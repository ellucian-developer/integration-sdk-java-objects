...
public class Smrstpv__2 {
    ...
    public Smrstpv__2 withProgramDesc(String programDesc) {
        this.programDesc = programDesc;
        return this;
    }
    ...
    public Smrstpv__2 withMaint(String maint) {
        this.maint = maint;
        return this;
    }
    ...
    public Smrstpv__2 withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public Smrstpv__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Smrstpv__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Smrstpv__2) == false) {
            return false;
        }
        Smrstpv__2 rhs = ((Smrstpv__2) other);
