...
public class Smrstpv {
    ...
    public Smrstpv withProgramDesc(String programDesc) {
        this.programDesc = programDesc;
        return this;
    }
    ...
    public Smrstpv withMaint(String maint) {
        this.maint = maint;
        return this;
    }
    ...
    public Smrstpv withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public Smrstpv withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Smrstpv.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Smrstpv) == false) {
            return false;
        }
        Smrstpv rhs = ((Smrstpv) other);
