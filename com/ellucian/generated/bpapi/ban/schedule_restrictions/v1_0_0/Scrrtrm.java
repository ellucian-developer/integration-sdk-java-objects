...
public class Scrrtrm {
    ...
    public Scrrtrm withTermDescription(String termDescription) {
        this.termDescription = termDescription;
        return this;
    }
    ...
    public Scrrtrm withRtrmCode(String rtrmCode) {
        this.rtrmCode = rtrmCode;
        return this;
    }
    ...
    public Scrrtrm withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrtrm.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrtrm) == false) {
            return false;
        }
        Scrrtrm rhs = ((Scrrtrm) other);
