...
public class Scrsbgi {
    ...
    public Scrsbgi withSbgiDescription(String sbgiDescription) {
        this.sbgiDescription = sbgiDescription;
        return this;
    }
    ...
    public Scrsbgi withAgreementDate(Date agreementDate) {
        this.agreementDate = agreementDate;
        return this;
    }
    ...
    public Scrsbgi withSbgiCode(String sbgiCode) {
        this.sbgiCode = sbgiCode;
        return this;
    }
    ...
    public Scrsbgi withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrsbgi.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrsbgi) == false) {
            return false;
        }
        Scrsbgi rhs = ((Scrsbgi) other);
