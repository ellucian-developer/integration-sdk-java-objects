...
public class MedicalInformation100PostRequest {
    ...
    public MedicalInformation100PostRequest withMdeqCode(String mdeqCode) {
        this.mdeqCode = mdeqCode;
        return this;
    }
    ...
    public MedicalInformation100PostRequest withDisbInd(String disbInd) {
        this.disbInd = disbInd;
        return this;
    }
    ...
    public MedicalInformation100PostRequest withDisaCode(String disaCode) {
        this.disaCode = disaCode;
        return this;
    }
    ...
    public MedicalInformation100PostRequest withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public MedicalInformation100PostRequest withMediCode(String mediCode) {
        this.mediCode = mediCode;
        return this;
    }
    ...
    public MedicalInformation100PostRequest withSpsrCode(String spsrCode) {
        this.spsrCode = spsrCode;
        return this;
    }
    ...
    public MedicalInformation100PostRequest withMediCodeDate(Date mediCodeDate) {
        this.mediCodeDate = mediCodeDate;
        return this;
    }
    ...
    public MedicalInformation100PostRequest withOnsetAge(Double onsetAge) {
        this.onsetAge = onsetAge;
        return this;
    }
    ...
    public MedicalInformation100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(MedicalInformation100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("mdeqCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MedicalInformation100PostRequest) == false) {
            return false;
        }
        MedicalInformation100PostRequest rhs = ((MedicalInformation100PostRequest) other);
        return (((((((((((this.mdeqCode == rhs.mdeqCode)||((this.mdeqCode!= null)&&this.mdeqCode.equals(rhs.mdeqCode)))&&((this.disbInd == rhs.disbInd)||((this.disbInd!= null)&&this.disbInd.equals(rhs.disbInd))))&&((this.disaCode == rhs.disaCode)||((this.disaCode!= null)&&this.disaCode.equals(rhs.disaCode))))&&((this.comment == rhs.comment)||((this.comment!= null)&&this.comment.equals(rhs.comment))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.mediCode == rhs.mediCode)||((this.mediCode!= null)&&this.mediCode.equals(rhs.mediCode))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.spsrCode == rhs.spsrCode)||((this.spsrCode!= null)&&this.spsrCode.equals(rhs.spsrCode))))&&((this.mediCodeDate == rhs.mediCodeDate)||((this.mediCodeDate!= null)&&this.mediCodeDate.equals(rhs.mediCodeDate))))&&((this.onsetAge == rhs.onsetAge)||((this.onsetAge!= null)&&this.onsetAge.equals(rhs.onsetAge))));
    }
