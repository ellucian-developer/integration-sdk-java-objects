...
public class Ssrrlvl {
    ...
    @JsonPropertyDescription("Lineage reference object : SSRRLVL_LEVL_CODE, Lookup lineage reference object : stvlevl")
    ...
    public Ssrrlvl withLevlDescription(String levlDescription) {
        this.levlDescription = levlDescription;
        return this;
    }
    ...
    public Ssrrlvl withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public Ssrrlvl withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssrrlvl.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssrrlvl) == false) {
            return false;
        }
        Ssrrlvl rhs = ((Ssrrlvl) other);
