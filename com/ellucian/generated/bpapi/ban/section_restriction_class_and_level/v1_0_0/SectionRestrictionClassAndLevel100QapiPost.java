...
public class SectionRestrictionClassAndLevel100QapiPost {
    ...
    public SectionRestrictionClassAndLevel100QapiPost withSsasectTermCode(String ssasectTermCode) {
        this.ssasectTermCode = ssasectTermCode;
        return this;
    }
    ...
    public SectionRestrictionClassAndLevel100QapiPost withSsasectCrn(String ssasectCrn) {
        this.ssasectCrn = ssasectCrn;
        return this;
    }
    ...
    public SectionRestrictionClassAndLevel100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SectionRestrictionClassAndLevel100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SectionRestrictionClassAndLevel100QapiPost) == false) {
            return false;
        }
        SectionRestrictionClassAndLevel100QapiPost rhs = ((SectionRestrictionClassAndLevel100QapiPost) other);
