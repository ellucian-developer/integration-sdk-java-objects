...
public class Ssrrcl {
    ...
    @JsonPropertyDescription("Lineage reference object : SSRRCLS_CLAS_CODE, Lookup lineage reference object : stvclas")
    ...
    public Ssrrcl withClasCode(String clasCode) {
        this.clasCode = clasCode;
        return this;
    }
    ...
    public Ssrrcl withClassDescription(String classDescription) {
        this.classDescription = classDescription;
        return this;
    }
    ...
    public Ssrrcl withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssrrcl.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("clasCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssrrcl) == false) {
            return false;
        }
        Ssrrcl rhs = ((Ssrrcl) other);
