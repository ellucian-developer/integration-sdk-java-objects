...
public class TermCourseMaintenanceTermHeaderInformation010QapiPost {
    ...
    public TermCourseMaintenanceTermHeaderInformation010QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public TermCourseMaintenanceTermHeaderInformation010QapiPost withKeyblckTermCode(String keyblckTermCode) {
        this.keyblckTermCode = keyblckTermCode;
        return this;
    }
    ...
    public TermCourseMaintenanceTermHeaderInformation010QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TermCourseMaintenanceTermHeaderInformation010QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TermCourseMaintenanceTermHeaderInformation010QapiPost) == false) {
            return false;
        }
        TermCourseMaintenanceTermHeaderInformation010QapiPost rhs = ((TermCourseMaintenanceTermHeaderInformation010QapiPost) other);
