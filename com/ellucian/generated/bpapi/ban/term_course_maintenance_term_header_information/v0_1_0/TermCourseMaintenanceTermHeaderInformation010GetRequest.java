...
public class TermCourseMaintenanceTermHeaderInformation010GetRequest {
    ...
    public TermCourseMaintenanceTermHeaderInformation010GetRequest withKeyblckTermCode(String keyblckTermCode) {
        this.keyblckTermCode = keyblckTermCode;
        return this;
    }
    ...
    public TermCourseMaintenanceTermHeaderInformation010GetRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public TermCourseMaintenanceTermHeaderInformation010GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TermCourseMaintenanceTermHeaderInformation010GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TermCourseMaintenanceTermHeaderInformation010GetRequest) == false) {
            return false;
        }
        TermCourseMaintenanceTermHeaderInformation010GetRequest rhs = ((TermCourseMaintenanceTermHeaderInformation010GetRequest) other);
