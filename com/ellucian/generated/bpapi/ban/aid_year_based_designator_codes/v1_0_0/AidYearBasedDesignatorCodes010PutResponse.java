...
public class AidYearBasedDesignatorCodes010PutResponse {
    ...
    public AidYearBasedDesignatorCodes010PutResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public AidYearBasedDesignatorCodes010PutResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public AidYearBasedDesignatorCodes010PutResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public AidYearBasedDesignatorCodes010PutResponse withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public AidYearBasedDesignatorCodes010PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AidYearBasedDesignatorCodes010PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AidYearBasedDesignatorCodes010PutResponse) == false) {
            return false;
        }
        AidYearBasedDesignatorCodes010PutResponse rhs = ((AidYearBasedDesignatorCodes010PutResponse) other);
