...
public class AidYearBasedDesignatorCodes100GetResponse {
    ...
    public AidYearBasedDesignatorCodes100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public AidYearBasedDesignatorCodes100GetResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public AidYearBasedDesignatorCodes100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public AidYearBasedDesignatorCodes100GetResponse withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public AidYearBasedDesignatorCodes100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AidYearBasedDesignatorCodes100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AidYearBasedDesignatorCodes100GetResponse) == false) {
            return false;
        }
        AidYearBasedDesignatorCodes100GetResponse rhs = ((AidYearBasedDesignatorCodes100GetResponse) other);
