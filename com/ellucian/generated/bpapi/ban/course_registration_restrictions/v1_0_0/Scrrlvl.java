...
public class Scrrlvl {
    ...
    public Scrrlvl withLevlDescription(String levlDescription) {
        this.levlDescription = levlDescription;
        return this;
    }
    ...
    public Scrrlvl withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public Scrrlvl withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrlvl.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrlvl) == false) {
            return false;
        }
        Scrrlvl rhs = ((Scrrlvl) other);
