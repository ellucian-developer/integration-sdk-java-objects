...
public class Scrrcol {
    ...
    public Scrrcol withCollDescription(String collDescription) {
        this.collDescription = collDescription;
        return this;
    }
    ...
    public Scrrcol withCollCode(String collCode) {
        this.collCode = collCode;
        return this;
    }
    ...
    public Scrrcol withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrcol.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrcol) == false) {
            return false;
        }
        Scrrcol rhs = ((Scrrcol) other);
