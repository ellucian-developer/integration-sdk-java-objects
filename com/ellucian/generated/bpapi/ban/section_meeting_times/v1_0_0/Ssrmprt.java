...
public class Ssrmprt {
    ...
    public Ssrmprt withParsCode(String parsCode) {
        this.parsCode = parsCode;
        return this;
    }
    ...
    public Ssrmprt withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Ssrmprt withMprtParsDesc(String mprtParsDesc) {
        this.mprtParsDesc = mprtParsDesc;
        return this;
    }
    ...
    public Ssrmprt withParsPrefNumber(Double parsPrefNumber) {
        this.parsPrefNumber = parsPrefNumber;
        return this;
    }
    ...
    public Ssrmprt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssrmprt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("parsCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssrmprt) == false) {
            return false;
        }
        Ssrmprt rhs = ((Ssrmprt) other);
