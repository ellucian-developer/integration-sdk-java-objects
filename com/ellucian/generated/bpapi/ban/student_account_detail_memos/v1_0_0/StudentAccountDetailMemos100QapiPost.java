...
public class StudentAccountDetailMemos100QapiPost {
    ...
    public StudentAccountDetailMemos100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public StudentAccountDetailMemos100QapiPost withHoldPassword(String holdPassword) {
        this.holdPassword = holdPassword;
        return this;
    }
    ...
    public StudentAccountDetailMemos100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StudentAccountDetailMemos100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StudentAccountDetailMemos100QapiPost) == false) {
            return false;
        }
        StudentAccountDetailMemos100QapiPost rhs = ((StudentAccountDetailMemos100QapiPost) other);
