...
public class StudentAccountDetailMemos100GetRequest {
    ...
    public StudentAccountDetailMemos100GetRequest withHoldPassword(String holdPassword) {
        this.holdPassword = holdPassword;
        return this;
    }
    ...
    public StudentAccountDetailMemos100GetRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public StudentAccountDetailMemos100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StudentAccountDetailMemos100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StudentAccountDetailMemos100GetRequest) == false) {
            return false;
        }
        StudentAccountDetailMemos100GetRequest rhs = ((StudentAccountDetailMemos100GetRequest) other);
