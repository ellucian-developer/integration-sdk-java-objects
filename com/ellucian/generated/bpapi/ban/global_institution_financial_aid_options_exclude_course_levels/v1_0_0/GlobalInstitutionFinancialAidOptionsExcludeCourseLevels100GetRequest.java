...
public class GlobalInstitutionFinancialAidOptionsExcludeCourseLevels100GetRequest {
    ...
    public GlobalInstitutionFinancialAidOptionsExcludeCourseLevels100GetRequest withStuLevlCode(String stuLevlCode) {
        this.stuLevlCode = stuLevlCode;
        return this;
    }
    ...
    public GlobalInstitutionFinancialAidOptionsExcludeCourseLevels100GetRequest withCrseLevlCode(String crseLevlCode) {
        this.crseLevlCode = crseLevlCode;
        return this;
    }
    ...
    public GlobalInstitutionFinancialAidOptionsExcludeCourseLevels100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GlobalInstitutionFinancialAidOptionsExcludeCourseLevels100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GlobalInstitutionFinancialAidOptionsExcludeCourseLevels100GetRequest) == false) {
            return false;
        }
        GlobalInstitutionFinancialAidOptionsExcludeCourseLevels100GetRequest rhs = ((GlobalInstitutionFinancialAidOptionsExcludeCourseLevels100GetRequest) other);
