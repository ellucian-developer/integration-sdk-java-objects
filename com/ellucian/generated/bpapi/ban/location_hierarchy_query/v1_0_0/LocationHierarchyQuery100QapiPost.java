...
public class LocationHierarchyQuery100QapiPost {
    ...
    public LocationHierarchyQuery100QapiPost withFtxlochCoasCode(String ftxlochCoasCode) {
        this.ftxlochCoasCode = ftxlochCoasCode;
        return this;
    }
    ...
    public LocationHierarchyQuery100QapiPost withFtxlochLocnCode(String ftxlochLocnCode) {
        this.ftxlochLocnCode = ftxlochLocnCode;
        return this;
    }
    ...
    public LocationHierarchyQuery100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(LocationHierarchyQuery100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LocationHierarchyQuery100QapiPost) == false) {
            return false;
        }
        LocationHierarchyQuery100QapiPost rhs = ((LocationHierarchyQuery100QapiPost) other);
