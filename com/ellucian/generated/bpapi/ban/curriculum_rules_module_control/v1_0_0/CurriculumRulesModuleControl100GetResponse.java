...
public class CurriculumRulesModuleControl100GetResponse {
    ...
    public CurriculumRulesModuleControl100GetResponse withSorcmnrCtrl(List<SorcmnrCtrl> sorcmnrCtrl) {
        this.sorcmnrCtrl = sorcmnrCtrl;
        return this;
    }
    ...
    public CurriculumRulesModuleControl100GetResponse withSorcmnr(List<Sorcmnr> sorcmnr) {
        this.sorcmnr = sorcmnr;
        return this;
    }
    ...
    public CurriculumRulesModuleControl100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CurriculumRulesModuleControl100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CurriculumRulesModuleControl100GetResponse) == false) {
            return false;
        }
        CurriculumRulesModuleControl100GetResponse rhs = ((CurriculumRulesModuleControl100GetResponse) other);
