...
public class Rorstat {
    ...
    /**
     * Active CSS Transaction Number
     * <p>
     * 
     * 
     */
    @JsonProperty("displayTransactionNumber")
    private Double displayTransactionNumber;
    /**
    ...
    public Rorstat withDisplayImLock(String displayImLock) {
        this.displayImLock = displayImLock;
        return this;
    }
    ...
    public Rorstat withRcrapp1InfcCode(String rcrapp1InfcCode) {
        this.rcrapp1InfcCode = rcrapp1InfcCode;
        return this;
    }
    ...
    public Rorstat withRcrapp1VerificationMsg(String rcrapp1VerificationMsg) {
        this.rcrapp1VerificationMsg = rcrapp1VerificationMsg;
        return this;
    }
    ...
    public Rorstat withRcrapp1SeqNo(Double rcrapp1SeqNo) {
        this.rcrapp1SeqNo = rcrapp1SeqNo;
        return this;
    }
    ...
    public Rorstat withDisplayVerifyMsgDesc(String displayVerifyMsgDesc) {
        this.displayVerifyMsgDesc = displayVerifyMsgDesc;
        return this;
    }
    ...
    public Rorstat withDisplaySeqNo(Double displaySeqNo) {
        this.displaySeqNo = displaySeqNo;
        return this;
    }
     ...
     */
    @JsonProperty("displayTransactionNumber")
    public Double getDisplayTransactionNumber() {
     ...
     */
    @JsonProperty("displayTransactionNumber")
    public void setDisplayTransactionNumber(Double displayTransactionNumber) {
        this.displayTransactionNumber = displayTransactionNumber;
    }

    public Rorstat withDisplayTransactionNumber(Double displayTransactionNumber) {
        this.displayTransactionNumber = displayTransactionNumber;
        return this;
    }
    ...
    public Rorstat withDisplayInfcCode(String displayInfcCode) {
        this.displayInfcCode = displayInfcCode;
        return this;
    }
    ...
    public Rorstat withDisplayLockCurrentInd(String displayLockCurrentInd) {
        this.displayLockCurrentInd = displayLockCurrentInd;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("displayTransactionNumber");
        sb.append('=');
        sb.append(((this.displayTransactionNumber == null)?"<null>":this.displayTransactionNumber));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.displayTransactionNumber == null)? 0 :this.displayTransactionNumber.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((this.displayImLock == rhs.displayImLock)||((this.displayImLock!= null)&&this.displayImLock.equals(rhs.displayImLock)))&&((this.rcrapp1InfcCode == rhs.rcrapp1InfcCode)||((this.rcrapp1InfcCode!= null)&&this.rcrapp1InfcCode.equals(rhs.rcrapp1InfcCode))))&&((this.rcrapp1VerificationMsg == rhs.rcrapp1VerificationMsg)||((this.rcrapp1VerificationMsg!= null)&&this.rcrapp1VerificationMsg.equals(rhs.rcrapp1VerificationMsg))))&&((this.rcrapp1SeqNo == rhs.rcrapp1SeqNo)||((this.rcrapp1SeqNo!= null)&&this.rcrapp1SeqNo.equals(rhs.rcrapp1SeqNo))))&&((this.displayVerifyMsgDesc == rhs.displayVerifyMsgDesc)||((this.displayVerifyMsgDesc!= null)&&this.displayVerifyMsgDesc.equals(rhs.displayVerifyMsgDesc))))&&((this.displaySeqNo == rhs.displaySeqNo)||((this.displaySeqNo!= null)&&this.displaySeqNo.equals(rhs.displaySeqNo))))&&((this.displayTransactionNumber == rhs.displayTransactionNumber)||((this.displayTransactionNumber!= null)&&this.displayTransactionNumber.equals(rhs.displayTransactionNumber))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.displayInfcCode == rhs.displayInfcCode)||((this.displayInfcCode!= null)&&this.displayInfcCode.equals(rhs.displayInfcCode))))&&((this.displayLockCurrentInd == rhs.displayLockCurrentInd)||((this.displayLockCurrentInd!= null)&&this.displayLockCurrentInd.equals(rhs.displayLockCurrentInd))));
    }
