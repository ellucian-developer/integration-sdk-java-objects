...
public class HighSchoolInformationHighSchoolDetails100PostRequest {
    ...
    public HighSchoolInformationHighSchoolDetails100PostRequest withDplmCode(String dplmCode) {
        this.dplmCode = dplmCode;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100PostRequest withClassSize(Double classSize) {
        this.classSize = classSize;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100PostRequest withAdmrCode(String admrCode) {
        this.admrCode = admrCode;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100PostRequest withPercentile(Double percentile) {
        this.percentile = percentile;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100PostRequest withCollPrepInd(String collPrepInd) {
        this.collPrepInd = collPrepInd;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100PostRequest withGraduationDate(Date graduationDate) {
        this.graduationDate = graduationDate;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100PostRequest withGpa(String gpa) {
        this.gpa = gpa;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100PostRequest withSbgiCode(String sbgiCode) {
        this.sbgiCode = sbgiCode;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100PostRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100PostRequest withClassRank(Double classRank) {
        this.classRank = classRank;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100PostRequest withTransRecvDate(Date transRecvDate) {
        this.transRecvDate = transRecvDate;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HighSchoolInformationHighSchoolDetails100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dplmCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HighSchoolInformationHighSchoolDetails100PostRequest) == false) {
            return false;
        }
        HighSchoolInformationHighSchoolDetails100PostRequest rhs = ((HighSchoolInformationHighSchoolDetails100PostRequest) other);
