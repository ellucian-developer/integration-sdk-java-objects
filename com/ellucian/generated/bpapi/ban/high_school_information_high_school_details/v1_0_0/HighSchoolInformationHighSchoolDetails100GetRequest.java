...
public class HighSchoolInformationHighSchoolDetails100GetRequest {
    ...
    public HighSchoolInformationHighSchoolDetails100GetRequest withDplmCode(String dplmCode) {
        this.dplmCode = dplmCode;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100GetRequest withClassSize(Double classSize) {
        this.classSize = classSize;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100GetRequest withAdmrCode(String admrCode) {
        this.admrCode = admrCode;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100GetRequest withPercentile(Double percentile) {
        this.percentile = percentile;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100GetRequest withCollPrepInd(String collPrepInd) {
        this.collPrepInd = collPrepInd;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100GetRequest withGraduationDate(Date graduationDate) {
        this.graduationDate = graduationDate;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100GetRequest withGpa(String gpa) {
        this.gpa = gpa;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100GetRequest withSbgiCode(String sbgiCode) {
        this.sbgiCode = sbgiCode;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100GetRequest withClassRank(Double classRank) {
        this.classRank = classRank;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100GetRequest withTransRecvDate(Date transRecvDate) {
        this.transRecvDate = transRecvDate;
        return this;
    }
    ...
    public HighSchoolInformationHighSchoolDetails100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HighSchoolInformationHighSchoolDetails100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dplmCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HighSchoolInformationHighSchoolDetails100GetRequest) == false) {
            return false;
        }
        HighSchoolInformationHighSchoolDetails100GetRequest rhs = ((HighSchoolInformationHighSchoolDetails100GetRequest) other);
