...
public class CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse {
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withSeqNo(Double seqNo) {
        this.seqNo = seqNo;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withServiceDate(Date serviceDate) {
        this.serviceDate = serviceDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withEpstOptDesc(String epstOptDesc) {
        this.epstOptDesc = epstOptDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withEpstCode(String epstCode) {
        this.epstCode = epstCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withDuplOverrideInd(String duplOverrideInd) {
        this.duplOverrideInd = duplOverrideInd;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withEpstDesc(String epstDesc) {
        this.epstDesc = epstDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withOrigDesc(String origDesc) {
        this.origDesc = origDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withSsgpCode(String ssgpCode) {
        this.ssgpCode = ssgpCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withRwname(String rwname) {
        this.rwname = rwname;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withDataOrigin(String dataOrigin) {
        this.dataOrigin = dataOrigin;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withSsgpDesc(String ssgpDesc) {
        this.ssgpDesc = ssgpDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("seqNo");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse) == false) {
            return false;
        }
        CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse rhs = ((CaMisSuccessAndSupportServicesTermDataEducationPlan100GetResponse) other);
