...
public class CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse {
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withSeqNo(Double seqNo) {
        this.seqNo = seqNo;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withServiceDate(Date serviceDate) {
        this.serviceDate = serviceDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withEpstOptDesc(String epstOptDesc) {
        this.epstOptDesc = epstOptDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withEpstCode(String epstCode) {
        this.epstCode = epstCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withDuplOverrideInd(String duplOverrideInd) {
        this.duplOverrideInd = duplOverrideInd;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withEpstDesc(String epstDesc) {
        this.epstDesc = epstDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withOrigDesc(String origDesc) {
        this.origDesc = origDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withSsgpCode(String ssgpCode) {
        this.ssgpCode = ssgpCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withRwname(String rwname) {
        this.rwname = rwname;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withDataOrigin(String dataOrigin) {
        this.dataOrigin = dataOrigin;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withSsgpDesc(String ssgpDesc) {
        this.ssgpDesc = ssgpDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("seqNo");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse) == false) {
            return false;
        }
        CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse rhs = ((CaMisSuccessAndSupportServicesTermDataEducationPlan100PutResponse) other);
