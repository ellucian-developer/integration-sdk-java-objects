...
public class Pprrefe__1 {
    ...
    public Pprrefe__1 withPhoneExt(String phoneExt) {
        this.phoneExt = phoneExt;
        return this;
    }
    ...
    public Pprrefe__1 withPhoneNumber(String phoneNumber) {
        this.phoneNumber = phoneNumber;
        return this;
    }
    ...
    public Pprrefe__1 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Pprrefe__1 withPhoneArea(String phoneArea) {
        this.phoneArea = phoneArea;
        return this;
    }
    ...
    public Pprrefe__1 withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public Pprrefe__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Pprrefe__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("phoneExt");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pprrefe__1) == false) {
            return false;
        }
        Pprrefe__1 rhs = ((Pprrefe__1) other);
