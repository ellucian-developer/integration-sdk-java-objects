...
public class Pprexpe__2 {
    ...
    public Pprexpe__2 withSuperName(String superName) {
        this.superName = superName;
        return this;
    }
    ...
    public Pprexpe__2 withEmtyCode(String emtyCode) {
        this.emtyCode = emtyCode;
        return this;
    }
    ...
    public Pprexpe__2 withStatCode(String statCode) {
        this.statCode = statCode;
        return this;
    }
    ...
    public Pprexpe__2 withNatnCode(String natnCode) {
        this.natnCode = natnCode;
        return this;
    }
    ...
    public Pprexpe__2 withEndDate(Date endDate) {
        this.endDate = endDate;
        return this;
    }
    ...
    public Pprexpe__2 withReasonLeft(String reasonLeft) {
        this.reasonLeft = reasonLeft;
        return this;
    }
    ...
    public Pprexpe__2 withEmtyDesc(String emtyDesc) {
        this.emtyDesc = emtyDesc;
        return this;
    }
    ...
    public Pprexpe__2 withHireActVerifRecInd(String hireActVerifRecInd) {
        this.hireActVerifRecInd = hireActVerifRecInd;
        return this;
    }
    ...
    public Pprexpe__2 withContactInd(String contactInd) {
        this.contactInd = contactInd;
        return this;
    }
    ...
    public Pprexpe__2 withCurrHourly(Double currHourly) {
        this.currHourly = currHourly;
        return this;
    }
    ...
    public Pprexpe__2 withHireactStartDate(Date hireactStartDate) {
        this.hireactStartDate = hireactStartDate;
        return this;
    }
    ...
    public Pprexpe__2 withSuperPhoneNumber(String superPhoneNumber) {
        this.superPhoneNumber = superPhoneNumber;
        return this;
    }
    ...
    public Pprexpe__2 withSuperPhoneExt(String superPhoneExt) {
        this.superPhoneExt = superPhoneExt;
        return this;
    }
    ...
    public Pprexpe__2 withCurrSalary(Double currSalary) {
        this.currSalary = currSalary;
        return this;
    }
    ...
    public Pprexpe__2 withPosnTitle(String posnTitle) {
        this.posnTitle = posnTitle;
        return this;
    }
    ...
    public Pprexpe__2 withPosnDuties(String posnDuties) {
        this.posnDuties = posnDuties;
        return this;
    }
    ...
    public Pprexpe__2 withSuperComment(String superComment) {
        this.superComment = superComment;
        return this;
    }
    ...
    public Pprexpe__2 withEmprName(String emprName) {
        this.emprName = emprName;
        return this;
    }
    ...
    public Pprexpe__2 withEmpsSupervise(Double empsSupervise) {
        this.empsSupervise = empsSupervise;
        return this;
    }
    ...
    public Pprexpe__2 withStartDate(Date startDate) {
        this.startDate = startDate;
        return this;
    }
    ...
    public Pprexpe__2 withSuperPhoneArea(String superPhoneArea) {
        this.superPhoneArea = superPhoneArea;
        return this;
    }
    ...
    public Pprexpe__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Pprexpe__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("superName");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pprexpe__2) == false) {
            return false;
        }
        Pprexpe__2 rhs = ((Pprexpe__2) other);
