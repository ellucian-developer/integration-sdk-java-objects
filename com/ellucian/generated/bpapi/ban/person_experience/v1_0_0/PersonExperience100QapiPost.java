...
public class PersonExperience100QapiPost {
    ...
    public PersonExperience100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public PersonExperience100QapiPost withEmprName(String emprName) {
        this.emprName = emprName;
        return this;
    }
    ...
    public PersonExperience100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PersonExperience100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PersonExperience100QapiPost) == false) {
            return false;
        }
        PersonExperience100QapiPost rhs = ((PersonExperience100QapiPost) other);
