...
public class EuSystemParameterMaintenance100QapiPost {
     ...
     */
    @JsonProperty("gkvksysCode")
    public void setGkvksysCode(String gkvksysCode) {
        this.gkvksysCode = gkvksysCode;
    }

    public EuSystemParameterMaintenance100QapiPost withGkvksysCode(String gkvksysCode) {
        this.gkvksysCode = gkvksysCode;
        return this;
    }
    ...
    public EuSystemParameterMaintenance100QapiPost withParamName(String paramName) {
        this.paramName = paramName;
        return this;
    }
    ...
    public EuSystemParameterMaintenance100QapiPost withRestrictValuesInd(String restrictValuesInd) {
        this.restrictValuesInd = restrictValuesInd;
        return this;
    }
    ...
    public EuSystemParameterMaintenance100QapiPost withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public EuSystemParameterMaintenance100QapiPost withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public EuSystemParameterMaintenance100QapiPost withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public EuSystemParameterMaintenance100QapiPost withNotes(String notes) {
        this.notes = notes;
        return this;
    }
    ...
    public EuSystemParameterMaintenance100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EuSystemParameterMaintenance100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EuSystemParameterMaintenance100QapiPost) == false) {
            return false;
        }
        EuSystemParameterMaintenance100QapiPost rhs = ((EuSystemParameterMaintenance100QapiPost) other);
