...
public class EuSystemParameterMaintenance100GetResponse {
    ...
    public EuSystemParameterMaintenance100GetResponse withNotes(String notes) {
        this.notes = notes;
        return this;
    }
    ...
    public EuSystemParameterMaintenance100GetResponse withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public EuSystemParameterMaintenance100GetResponse withRestrictValuesInd(String restrictValuesInd) {
        this.restrictValuesInd = restrictValuesInd;
        return this;
    }
    ...
    public EuSystemParameterMaintenance100GetResponse withParamName(String paramName) {
        this.paramName = paramName;
        return this;
    }
    ...
    public EuSystemParameterMaintenance100GetResponse withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public EuSystemParameterMaintenance100GetResponse withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public EuSystemParameterMaintenance100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EuSystemParameterMaintenance100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("notes");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EuSystemParameterMaintenance100GetResponse) == false) {
            return false;
        }
        EuSystemParameterMaintenance100GetResponse rhs = ((EuSystemParameterMaintenance100GetResponse) other);
        return ((((((((this.notes == rhs.notes)||((this.notes!= null)&&this.notes.equals(rhs.notes)))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.restrictValuesInd == rhs.restrictValuesInd)||((this.restrictValuesInd!= null)&&this.restrictValuesInd.equals(rhs.restrictValuesInd))))&&((this.paramName == rhs.paramName)||((this.paramName!= null)&&this.paramName.equals(rhs.paramName))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.value == rhs.value)||((this.value!= null)&&this.value.equals(rhs.value))))&&((this.group == rhs.group)||((this.group!= null)&&this.group.equals(rhs.group))));
    }
