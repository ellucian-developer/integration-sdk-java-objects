...
public class Ssbssec__1 {
    ...
    public Ssbssec__1 withReasGrdePubDate(Date reasGrdePubDate) {
        this.reasGrdePubDate = reasGrdePubDate;
        return this;
    }
    ...
    public Ssbssec__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Ssbssec__1 withDetGrdePubDate(Date detGrdePubDate) {
        this.detGrdePubDate = detGrdePubDate;
        return this;
    }
    ...
    public Ssbssec__1 withFinalGrdePubDate(Date finalGrdePubDate) {
        this.finalGrdePubDate = finalGrdePubDate;
        return this;
    }
    ...
    public Ssbssec__1 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Ssbssec__1 withReasDetGrdePubDate(Date reasDetGrdePubDate) {
        this.reasDetGrdePubDate = reasDetGrdePubDate;
        return this;
    }
    ...
    public Ssbssec__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssbssec__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssbssec__1) == false) {
            return false;
        }
        Ssbssec__1 rhs = ((Ssbssec__1) other);
