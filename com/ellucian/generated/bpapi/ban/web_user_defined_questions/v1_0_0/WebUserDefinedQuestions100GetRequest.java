...
public class WebUserDefinedQuestions100GetRequest {
    ...
    public WebUserDefinedQuestions100GetRequest withAdmrCode(String admrCode) {
        this.admrCode = admrCode;
        return this;
    }
    ...
    public WebUserDefinedQuestions100GetRequest withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public WebUserDefinedQuestions100GetRequest withSeqno(Double seqno) {
        this.seqno = seqno;
        return this;
    }
    ...
    public WebUserDefinedQuestions100GetRequest withQuestion(String question) {
        this.question = question;
        return this;
    }
    ...
    public WebUserDefinedQuestions100GetRequest withWappCode(String wappCode) {
        this.wappCode = wappCode;
        return this;
    }
    ...
    public WebUserDefinedQuestions100GetRequest withQstnCde(String qstnCde) {
        this.qstnCde = qstnCde;
        return this;
    }
    ...
    public WebUserDefinedQuestions100GetRequest withYesNoQstnInd(String yesNoQstnInd) {
        this.yesNoQstnInd = yesNoQstnInd;
        return this;
    }
    ...
    public WebUserDefinedQuestions100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(WebUserDefinedQuestions100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("admrCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WebUserDefinedQuestions100GetRequest) == false) {
            return false;
        }
        WebUserDefinedQuestions100GetRequest rhs = ((WebUserDefinedQuestions100GetRequest) other);
        return (((((((((this.admrCode == rhs.admrCode)||((this.admrCode!= null)&&this.admrCode.equals(rhs.admrCode)))&&((this.activityDate == rhs.activityDate)||((this.activityDate!= null)&&this.activityDate.equals(rhs.activityDate))))&&((this.seqno == rhs.seqno)||((this.seqno!= null)&&this.seqno.equals(rhs.seqno))))&&((this.question == rhs.question)||((this.question!= null)&&this.question.equals(rhs.question))))&&((this.wappCode == rhs.wappCode)||((this.wappCode!= null)&&this.wappCode.equals(rhs.wappCode))))&&((this.qstnCde == rhs.qstnCde)||((this.qstnCde!= null)&&this.qstnCde.equals(rhs.qstnCde))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.yesNoQstnInd == rhs.yesNoQstnInd)||((this.yesNoQstnInd!= null)&&this.yesNoQstnInd.equals(rhs.yesNoQstnInd))));
    }
