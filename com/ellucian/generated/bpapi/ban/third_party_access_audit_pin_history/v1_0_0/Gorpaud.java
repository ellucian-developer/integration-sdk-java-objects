...
public class Gorpaud {
    ...
    public Gorpaud withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Gorpaud withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public Gorpaud withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Gorpaud.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Gorpaud) == false) {
            return false;
        }
        Gorpaud rhs = ((Gorpaud) other);
