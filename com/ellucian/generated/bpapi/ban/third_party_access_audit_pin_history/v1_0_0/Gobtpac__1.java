...
public class Gobtpac__1 {
    ...
    public Gobtpac__1 withExternalUser(String externalUser) {
        this.externalUser = externalUser;
        return this;
    }
    ...
    public Gobtpac__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Gobtpac__1 withLdapUser(String ldapUser) {
        this.ldapUser = ldapUser;
        return this;
    }
    ...
    public Gobtpac__1 withPin(String pin) {
        this.pin = pin;
        return this;
    }
    ...
    public Gobtpac__1 withPinExpDate(Date pinExpDate) {
        this.pinExpDate = pinExpDate;
        return this;
    }
    ...
    public Gobtpac__1 withLastAccessDate(Date lastAccessDate) {
        this.lastAccessDate = lastAccessDate;
        return this;
    }
    ...
    public Gobtpac__1 withGobsridSourcedId(String gobsridSourcedId) {
        this.gobsridSourcedId = gobsridSourcedId;
        return this;
    }
    ...
    public Gobtpac__1 withInsertSource(String insertSource) {
        this.insertSource = insertSource;
        return this;
    }
    ...
    public Gobtpac__1 withPinDisabledInd(String pinDisabledInd) {
        this.pinDisabledInd = pinDisabledInd;
        return this;
    }
    ...
    public Gobtpac__1 withUsageAcceptInd(String usageAcceptInd) {
        this.usageAcceptInd = usageAcceptInd;
        return this;
    }
    ...
    public Gobtpac__1 withDisplayNewPinConfirm(String displayNewPinConfirm) {
        this.displayNewPinConfirm = displayNewPinConfirm;
        return this;
    }
    ...
    public Gobtpac__1 withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public Gobtpac__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Gobtpac__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Gobtpac__1) == false) {
            return false;
        }
        Gobtpac__1 rhs = ((Gobtpac__1) other);
