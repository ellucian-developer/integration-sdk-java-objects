...
public class Gorpaud__2 {
    ...
    public Gorpaud__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Gorpaud__2 withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public Gorpaud__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Gorpaud__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Gorpaud__2) == false) {
            return false;
        }
        Gorpaud__2 rhs = ((Gorpaud__2) other);
