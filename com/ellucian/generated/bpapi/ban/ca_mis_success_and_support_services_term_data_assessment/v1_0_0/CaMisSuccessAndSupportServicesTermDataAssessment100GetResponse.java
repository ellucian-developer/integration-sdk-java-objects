...
public class CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse {
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withSeqNo(Double seqNo) {
        this.seqNo = seqNo;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withServiceDate(Date serviceDate) {
        this.serviceDate = serviceDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withSsstDesc(String ssstDesc) {
        this.ssstDesc = ssstDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withOrigDesc(String origDesc) {
        this.origDesc = origDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withSvvasstNoncreditServiceInd(String svvasstNoncreditServiceInd) {
        this.svvasstNoncreditServiceInd = svvasstNoncreditServiceInd;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withSsgpCode(String ssgpCode) {
        this.ssgpCode = ssgpCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withRwname(String rwname) {
        this.rwname = rwname;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withDataOrigin(String dataOrigin) {
        this.dataOrigin = dataOrigin;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withAsstDesc(String asstDesc) {
        this.asstDesc = asstDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withSsgpDesc(String ssgpDesc) {
        this.ssgpDesc = ssgpDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withSsstCode(String ssstCode) {
        this.ssstCode = ssstCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withAsstCode(String asstCode) {
        this.asstCode = asstCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("seqNo");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse) == false) {
            return false;
        }
        CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse rhs = ((CaMisSuccessAndSupportServicesTermDataAssessment100GetResponse) other);
