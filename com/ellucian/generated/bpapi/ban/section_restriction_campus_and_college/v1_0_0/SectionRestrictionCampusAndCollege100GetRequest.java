...
public class SectionRestrictionCampusAndCollege100GetRequest {
    ...
    public SectionRestrictionCampusAndCollege100GetRequest withSsasectTermCode(String ssasectTermCode) {
        this.ssasectTermCode = ssasectTermCode;
        return this;
    }
    ...
    public SectionRestrictionCampusAndCollege100GetRequest withSsasectCrn(String ssasectCrn) {
        this.ssasectCrn = ssasectCrn;
        return this;
    }
    ...
    public SectionRestrictionCampusAndCollege100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SectionRestrictionCampusAndCollege100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SectionRestrictionCampusAndCollege100GetRequest) == false) {
            return false;
        }
        SectionRestrictionCampusAndCollege100GetRequest rhs = ((SectionRestrictionCampusAndCollege100GetRequest) other);
