...
public class Ssrrcol {
    ...
    @JsonPropertyDescription("Lineage reference object : SSRRCOL_COLL_CODE, Lookup lineage reference object : stvcoll")
    ...
    public Ssrrcol withCollDescription(String collDescription) {
        this.collDescription = collDescription;
        return this;
    }
    ...
    public Ssrrcol withCollCode(String collCode) {
        this.collCode = collCode;
        return this;
    }
    ...
    public Ssrrcol withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssrrcol.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssrrcol) == false) {
            return false;
        }
        Ssrrcol rhs = ((Ssrrcol) other);
