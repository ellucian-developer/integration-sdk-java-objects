...
public class SectionRestrictionCampusAndCollege100QapiPost {
    ...
    public SectionRestrictionCampusAndCollege100QapiPost withSsasectTermCode(String ssasectTermCode) {
        this.ssasectTermCode = ssasectTermCode;
        return this;
    }
    ...
    public SectionRestrictionCampusAndCollege100QapiPost withSsasectCrn(String ssasectCrn) {
        this.ssasectCrn = ssasectCrn;
        return this;
    }
    ...
    public SectionRestrictionCampusAndCollege100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SectionRestrictionCampusAndCollege100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SectionRestrictionCampusAndCollege100QapiPost) == false) {
            return false;
        }
        SectionRestrictionCampusAndCollege100QapiPost rhs = ((SectionRestrictionCampusAndCollege100QapiPost) other);
