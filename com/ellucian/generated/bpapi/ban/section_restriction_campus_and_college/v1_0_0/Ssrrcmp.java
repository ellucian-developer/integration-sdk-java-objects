...
public class Ssrrcmp {
    ...
    @JsonPropertyDescription("Lineage reference object : SSRRCMP_CAMP_CODE, Lookup lineage reference object : stvcamp")
    ...
    public Ssrrcmp withCampCode(String campCode) {
        this.campCode = campCode;
        return this;
    }
    ...
    public Ssrrcmp withCampDescription(String campDescription) {
        this.campDescription = campDescription;
        return this;
    }
    ...
    public Ssrrcmp withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssrrcmp.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("campCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssrrcmp) == false) {
            return false;
        }
        Ssrrcmp rhs = ((Ssrrcmp) other);
