...
public class CaEducationOpportunityProgServStatuses100QapiPost {
    ...
    public CaEducationOpportunityProgServStatuses100QapiPost withCareCodeInd(String careCodeInd) {
        this.careCodeInd = careCodeInd;
        return this;
    }
    ...
    public CaEducationOpportunityProgServStatuses100QapiPost withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CaEducationOpportunityProgServStatuses100QapiPost withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public CaEducationOpportunityProgServStatuses100QapiPost withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CaEducationOpportunityProgServStatuses100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CaEducationOpportunityProgServStatuses100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaEducationOpportunityProgServStatuses100QapiPost) == false) {
            return false;
        }
        CaEducationOpportunityProgServStatuses100QapiPost rhs = ((CaEducationOpportunityProgServStatuses100QapiPost) other);
