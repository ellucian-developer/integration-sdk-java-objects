...
public class CaEducationOpportunityProgServStatuses100GetResponse {
    ...
    public CaEducationOpportunityProgServStatuses100GetResponse withCareCodeInd(String careCodeInd) {
        this.careCodeInd = careCodeInd;
        return this;
    }
    ...
    public CaEducationOpportunityProgServStatuses100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CaEducationOpportunityProgServStatuses100GetResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CaEducationOpportunityProgServStatuses100GetResponse withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public CaEducationOpportunityProgServStatuses100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CaEducationOpportunityProgServStatuses100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaEducationOpportunityProgServStatuses100GetResponse) == false) {
            return false;
        }
        CaEducationOpportunityProgServStatuses100GetResponse rhs = ((CaEducationOpportunityProgServStatuses100GetResponse) other);
