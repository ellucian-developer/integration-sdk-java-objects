...
public class PositionBudgetSalaryBudgets100GetResponse {
    ...
    public PositionBudgetSalaryBudgets100GetResponse withObudCode(String obudCode) {
        this.obudCode = obudCode;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withSgrpCode(String sgrpCode) {
        this.sgrpCode = sgrpCode;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withObphCode(String obphCode) {
        this.obphCode = obphCode;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withEncumb(Double encumb) {
        this.encumb = encumb;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withCoasCode(String coasCode) {
        this.coasCode = coasCode;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withCreateJfteInd(String createJfteInd) {
        this.createJfteInd = createJfteInd;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withOrgnCode(String orgnCode) {
        this.orgnCode = orgnCode;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withPtotAvail(Double ptotAvail) {
        this.ptotAvail = ptotAvail;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withApptPct(Double apptPct) {
        this.apptPct = apptPct;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withBaseUnits(Double baseUnits) {
        this.baseUnits = baseUnits;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withBudgBasis(Double budgBasis) {
        this.budgBasis = budgBasis;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withExpend(Double expend) {
        this.expend = expend;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withFiscCode(String fiscCode) {
        this.fiscCode = fiscCode;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withFte(Double fte) {
        this.fte = fte;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withAnnBasis(Double annBasis) {
        this.annBasis = annBasis;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withEffectiveDate(Date effectiveDate) {
        this.effectiveDate = effectiveDate;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withBudget(Double budget) {
        this.budget = budget;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public PositionBudgetSalaryBudgets100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PositionBudgetSalaryBudgets100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("obudCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PositionBudgetSalaryBudgets100GetResponse) == false) {
            return false;
        }
        PositionBudgetSalaryBudgets100GetResponse rhs = ((PositionBudgetSalaryBudgets100GetResponse) other);
