...
public class GradeChangeCodes100GetResponse {
     ...
     * 
     */
    @JsonProperty("gcatCodeDesc")
    private String gcatCodeDesc;
    /**
    ...
    public GradeChangeCodes100GetResponse withExemptInd(String exemptInd) {
        this.exemptInd = exemptInd;
        return this;
    }
    ...
    public GradeChangeCodes100GetResponse withResitInd(String resitInd) {
        this.resitInd = resitInd;
        return this;
    }
    ...
    public GradeChangeCodes100GetResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public GradeChangeCodes100GetResponse withSystemReqInd(String systemReqInd) {
        this.systemReqInd = systemReqInd;
        return this;
    }
    ...
    public GradeChangeCodes100GetResponse withDefinitiveInd(String definitiveInd) {
        this.definitiveInd = definitiveInd;
        return this;
    }
    ...
    public GradeChangeCodes100GetResponse withAcadhistInd(String acadhistInd) {
        this.acadhistInd = acadhistInd;
        return this;
    }
    ...
    public GradeChangeCodes100GetResponse withEgbInd(String egbInd) {
        this.egbInd = egbInd;
        return this;
    }
    ...
    public GradeChangeCodes100GetResponse withCalculatedInd(String calculatedInd) {
        this.calculatedInd = calculatedInd;
        return this;
    }
    ...
    public GradeChangeCodes100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public GradeChangeCodes100GetResponse withGcatCode(String gcatCode) {
        this.gcatCode = gcatCode;
        return this;
    }
    ...
    public GradeChangeCodes100GetResponse withReasGrdeInd(String reasGrdeInd) {
        this.reasGrdeInd = reasGrdeInd;
        return this;
    }
     ...
     */
    @JsonProperty("gcatCodeDesc")
    public void setGcatCodeDesc(String gcatCodeDesc) {
        this.gcatCodeDesc = gcatCodeDesc;
    }

    public GradeChangeCodes100GetResponse withGcatCodeDesc(String gcatCodeDesc) {
        this.gcatCodeDesc = gcatCodeDesc;
        return this;
    }
    ...
    public GradeChangeCodes100GetResponse withPermitDupInd(String permitDupInd) {
        this.permitDupInd = permitDupInd;
        return this;
    }
    ...
    public GradeChangeCodes100GetResponse withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public GradeChangeCodes100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GradeChangeCodes100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("exemptInd");
        sb.append('=');
        ...
        sb.append(',');
        sb.append("gcatCodeDesc");
        sb.append('=');
        sb.append(((this.gcatCodeDesc == null)?"<null>":this.gcatCodeDesc));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.gcatCodeDesc == null)? 0 :this.gcatCodeDesc.hashCode()));
