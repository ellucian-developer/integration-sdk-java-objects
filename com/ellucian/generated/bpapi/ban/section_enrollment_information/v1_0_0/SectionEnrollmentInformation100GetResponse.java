...
public class SectionEnrollmentInformation100GetResponse {

    @JsonProperty("ssbsect")
    private List<Ssbsect> ssbsect = new ArrayList<Ssbsect>();
    @JsonProperty("ssrresv")
    private List<Ssrresv> ssrresv = new ArrayList<Ssrresv>();
    @JsonIgnore
    ...
    public SectionEnrollmentInformation100GetResponse withSsbsect(List<Ssbsect> ssbsect) {
        this.ssbsect = ssbsect;
        return this;
    }

    @JsonProperty("ssrresv")
    public List<Ssrresv> getSsrresv() {
        return ssrresv;
    }

    @JsonProperty("ssrresv")
    public void setSsrresv(List<Ssrresv> ssrresv) {
        this.ssrresv = ssrresv;
    }

    public SectionEnrollmentInformation100GetResponse withSsrresv(List<Ssrresv> ssrresv) {
        this.ssrresv = ssrresv;
        return this;
    }
    ...
    public SectionEnrollmentInformation100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SectionEnrollmentInformation100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("ssbsect");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SectionEnrollmentInformation100GetResponse) == false) {
            return false;
        }
        SectionEnrollmentInformation100GetResponse rhs = ((SectionEnrollmentInformation100GetResponse) other);
