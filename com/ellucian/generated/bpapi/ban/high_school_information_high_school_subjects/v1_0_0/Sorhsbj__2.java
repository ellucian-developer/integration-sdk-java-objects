...
public class Sorhsbj__2 {
    ...
    public Sorhsbj__2 withStvsbjcDesc(String stvsbjcDesc) {
        this.stvsbjcDesc = stvsbjcDesc;
        return this;
    }
    ...
    public Sorhsbj__2 withGrade(String grade) {
        this.grade = grade;
        return this;
    }
    ...
    public Sorhsbj__2 withSubjGpa(String subjGpa) {
        this.subjGpa = subjGpa;
        return this;
    }
    ...
    public Sorhsbj__2 withSbjcCode(String sbjcCode) {
        this.sbjcCode = sbjcCode;
        return this;
    }
    ...
    public Sorhsbj__2 withSubjYears(Double subjYears) {
        this.subjYears = subjYears;
        return this;
    }
    ...
    public Sorhsbj__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorhsbj__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorhsbj__2) == false) {
            return false;
        }
        Sorhsbj__2 rhs = ((Sorhsbj__2) other);
