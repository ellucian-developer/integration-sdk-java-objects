...
public class Sorhsbj {
    ...
    public Sorhsbj withStvsbjcDesc(String stvsbjcDesc) {
        this.stvsbjcDesc = stvsbjcDesc;
        return this;
    }
    ...
    public Sorhsbj withGrade(String grade) {
        this.grade = grade;
        return this;
    }
    ...
    public Sorhsbj withSubjGpa(String subjGpa) {
        this.subjGpa = subjGpa;
        return this;
    }
    ...
    public Sorhsbj withSbjcCode(String sbjcCode) {
        this.sbjcCode = sbjcCode;
        return this;
    }
    ...
    public Sorhsbj withSubjYears(Double subjYears) {
        this.subjYears = subjYears;
        return this;
    }
    ...
    public Sorhsbj withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorhsbj.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorhsbj) == false) {
            return false;
        }
        Sorhsbj rhs = ((Sorhsbj) other);
