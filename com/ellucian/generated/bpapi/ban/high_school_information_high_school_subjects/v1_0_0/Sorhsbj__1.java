...
public class Sorhsbj__1 {
    ...
    public Sorhsbj__1 withStvsbjcDesc(String stvsbjcDesc) {
        this.stvsbjcDesc = stvsbjcDesc;
        return this;
    }
    ...
    public Sorhsbj__1 withGrade(String grade) {
        this.grade = grade;
        return this;
    }
    ...
    public Sorhsbj__1 withSubjGpa(String subjGpa) {
        this.subjGpa = subjGpa;
        return this;
    }
    ...
    public Sorhsbj__1 withSbjcCode(String sbjcCode) {
        this.sbjcCode = sbjcCode;
        return this;
    }
    ...
    public Sorhsbj__1 withSubjYears(Double subjYears) {
        this.subjYears = subjYears;
        return this;
    }
    ...
    public Sorhsbj__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorhsbj__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorhsbj__1) == false) {
            return false;
        }
        Sorhsbj__1 rhs = ((Sorhsbj__1) other);
