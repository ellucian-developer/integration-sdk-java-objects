...
public class GeneralPersonIdentificationAdditionalInformation100PutResponse {
    ...
    public GeneralPersonIdentificationAdditionalInformation100PutResponse withAdidDesc(String adidDesc) {
        this.adidDesc = adidDesc;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalInformation100PutResponse withAdditionalId(String additionalId) {
        this.additionalId = additionalId;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalInformation100PutResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalInformation100PutResponse withAdidCode(String adidCode) {
        this.adidCode = adidCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalInformation100PutResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalInformation100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralPersonIdentificationAdditionalInformation100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("adidDesc");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralPersonIdentificationAdditionalInformation100PutResponse) == false) {
            return false;
        }
        GeneralPersonIdentificationAdditionalInformation100PutResponse rhs = ((GeneralPersonIdentificationAdditionalInformation100PutResponse) other);
