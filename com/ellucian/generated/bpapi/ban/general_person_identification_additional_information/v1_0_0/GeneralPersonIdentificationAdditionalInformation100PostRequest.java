...
public class GeneralPersonIdentificationAdditionalInformation100PostRequest {
    ...
    public GeneralPersonIdentificationAdditionalInformation100PostRequest withAdditionalId(String additionalId) {
        this.additionalId = additionalId;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalInformation100PostRequest withAdidCode(String adidCode) {
        this.adidCode = adidCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalInformation100PostRequest withId(Object id) {
        this.id = id;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalInformation100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralPersonIdentificationAdditionalInformation100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralPersonIdentificationAdditionalInformation100PostRequest) == false) {
            return false;
        }
        GeneralPersonIdentificationAdditionalInformation100PostRequest rhs = ((GeneralPersonIdentificationAdditionalInformation100PostRequest) other);
