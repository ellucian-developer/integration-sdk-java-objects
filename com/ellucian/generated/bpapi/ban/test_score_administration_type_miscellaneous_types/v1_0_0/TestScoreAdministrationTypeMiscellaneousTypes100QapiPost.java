...
public class TestScoreAdministrationTypeMiscellaneousTypes100QapiPost {
    ...
    public TestScoreAdministrationTypeMiscellaneousTypes100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public TestScoreAdministrationTypeMiscellaneousTypes100QapiPost withStvtermTermCode(String stvtermTermCode) {
        this.stvtermTermCode = stvtermTermCode;
        return this;
    }
    ...
    public TestScoreAdministrationTypeMiscellaneousTypes100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TestScoreAdministrationTypeMiscellaneousTypes100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TestScoreAdministrationTypeMiscellaneousTypes100QapiPost) == false) {
            return false;
        }
        TestScoreAdministrationTypeMiscellaneousTypes100QapiPost rhs = ((TestScoreAdministrationTypeMiscellaneousTypes100QapiPost) other);
