...
public class ShipToCodes100GetResponse {
    ...
    public ShipToCodes100GetResponse withFtvshipBuilding(String ftvshipBuilding) {
        this.ftvshipBuilding = ftvshipBuilding;
        return this;
    }
    ...
    public ShipToCodes100GetResponse withFtvshipPhoneExt(String ftvshipPhoneExt) {
        this.ftvshipPhoneExt = ftvshipPhoneExt;
        return this;
    }
    ...
    public ShipToCodes100GetResponse withFtvshipPhoneArea(String ftvshipPhoneArea) {
        this.ftvshipPhoneArea = ftvshipPhoneArea;
        return this;
    }
    ...
    public ShipToCodes100GetResponse withFtvshipCode(String ftvshipCode) {
        this.ftvshipCode = ftvshipCode;
        return this;
    }
    ...
    public ShipToCodes100GetResponse withFtvshipTermDate(Date ftvshipTermDate) {
        this.ftvshipTermDate = ftvshipTermDate;
        return this;
    }
    ...
    public ShipToCodes100GetResponse withFtvshipContact(String ftvshipContact) {
        this.ftvshipContact = ftvshipContact;
        return this;
    }
    ...
    public ShipToCodes100GetResponse withFtvshipFloor(String ftvshipFloor) {
        this.ftvshipFloor = ftvshipFloor;
        return this;
    }
    ...
    public ShipToCodes100GetResponse withFtvshipEffDate(Date ftvshipEffDate) {
        this.ftvshipEffDate = ftvshipEffDate;
        return this;
    }
    ...
    public ShipToCodes100GetResponse withFtvshipPhoneNum(String ftvshipPhoneNum) {
        this.ftvshipPhoneNum = ftvshipPhoneNum;
        return this;
    }
    ...
    public ShipToCodes100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ShipToCodes100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ShipToCodes100GetResponse) == false) {
            return false;
        }
        ShipToCodes100GetResponse rhs = ((ShipToCodes100GetResponse) other);
        return (((((((((((this.ftvshipBuilding == rhs.ftvshipBuilding)||((this.ftvshipBuilding!= null)&&this.ftvshipBuilding.equals(rhs.ftvshipBuilding)))&&((this.ftvshipPhoneExt == rhs.ftvshipPhoneExt)||((this.ftvshipPhoneExt!= null)&&this.ftvshipPhoneExt.equals(rhs.ftvshipPhoneExt))))&&((this.ftvshipPhoneArea == rhs.ftvshipPhoneArea)||((this.ftvshipPhoneArea!= null)&&this.ftvshipPhoneArea.equals(rhs.ftvshipPhoneArea))))&&((this.ftvshipCode == rhs.ftvshipCode)||((this.ftvshipCode!= null)&&this.ftvshipCode.equals(rhs.ftvshipCode))))&&((this.ftvshipTermDate == rhs.ftvshipTermDate)||((this.ftvshipTermDate!= null)&&this.ftvshipTermDate.equals(rhs.ftvshipTermDate))))&&((this.ftvshipContact == rhs.ftvshipContact)||((this.ftvshipContact!= null)&&this.ftvshipContact.equals(rhs.ftvshipContact))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.ftvshipFloor == rhs.ftvshipFloor)||((this.ftvshipFloor!= null)&&this.ftvshipFloor.equals(rhs.ftvshipFloor))))&&((this.ftvshipEffDate == rhs.ftvshipEffDate)||((this.ftvshipEffDate!= null)&&this.ftvshipEffDate.equals(rhs.ftvshipEffDate))))&&((this.ftvshipPhoneNum == rhs.ftvshipPhoneNum)||((this.ftvshipPhoneNum!= null)&&this.ftvshipPhoneNum.equals(rhs.ftvshipPhoneNum))));
    }
