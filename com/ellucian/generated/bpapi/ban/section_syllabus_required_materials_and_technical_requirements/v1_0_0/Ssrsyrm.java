...
public class Ssrsyrm {
    ...
    public Ssrsyrm withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Ssrsyrm withRequiredMaterials(Object requiredMaterials) {
        this.requiredMaterials = requiredMaterials;
        return this;
    }
    ...
    public Ssrsyrm withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssrsyrm.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssrsyrm) == false) {
            return false;
        }
        Ssrsyrm rhs = ((Ssrsyrm) other);
