...
public class ElectronicApprovalSummaryOtherInformationAndComments100PostRequest {
    ...
    public ElectronicApprovalSummaryOtherInformationAndComments100PostRequest withComments(String comments) {
        this.comments = comments;
        return this;
    }
    ...
    public ElectronicApprovalSummaryOtherInformationAndComments100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ElectronicApprovalSummaryOtherInformationAndComments100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElectronicApprovalSummaryOtherInformationAndComments100PostRequest) == false) {
            return false;
        }
        ElectronicApprovalSummaryOtherInformationAndComments100PostRequest rhs = ((ElectronicApprovalSummaryOtherInformationAndComments100PostRequest) other);
        return ((((((((this.transactionToDate == rhs.transactionToDate)||((this.transactionToDate!= null)&&this.transactionToDate.equals(rhs.transactionToDate)))&&((this.comments == rhs.comments)||((this.comments!= null)&&this.comments.equals(rhs.comments))))&&((this.transactionStatus == rhs.transactionStatus)||((this.transactionStatus!= null)&&this.transactionStatus.equals(rhs.transactionStatus))))&&((this.queueStatus == rhs.queueStatus)||((this.queueStatus!= null)&&this.queueStatus.equals(rhs.queueStatus))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.proxyFor == rhs.proxyFor)||((this.proxyFor!= null)&&this.proxyFor.equals(rhs.proxyFor))))&&((this.transactionFromDate == rhs.transactionFromDate)||((this.transactionFromDate!= null)&&this.transactionFromDate.equals(rhs.transactionFromDate))));
    }
