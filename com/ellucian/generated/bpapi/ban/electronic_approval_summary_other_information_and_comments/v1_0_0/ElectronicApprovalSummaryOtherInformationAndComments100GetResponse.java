...
public class ElectronicApprovalSummaryOtherInformationAndComments100GetResponse {
    ...
    public ElectronicApprovalSummaryOtherInformationAndComments100GetResponse withNorcmnt(List<Norcmnt> norcmnt) {
        this.norcmnt = norcmnt;
        return this;
    }
    ...
    public ElectronicApprovalSummaryOtherInformationAndComments100GetResponse withNobtranInfo1(List<NobtranInfo1> nobtranInfo1) {
        this.nobtranInfo1 = nobtranInfo1;
        return this;
    }
    ...
    public ElectronicApprovalSummaryOtherInformationAndComments100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ElectronicApprovalSummaryOtherInformationAndComments100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("norcmnt");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElectronicApprovalSummaryOtherInformationAndComments100GetResponse) == false) {
            return false;
        }
        ElectronicApprovalSummaryOtherInformationAndComments100GetResponse rhs = ((ElectronicApprovalSummaryOtherInformationAndComments100GetResponse) other);
