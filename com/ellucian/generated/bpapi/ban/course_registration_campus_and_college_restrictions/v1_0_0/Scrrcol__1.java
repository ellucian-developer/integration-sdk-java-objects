...
public class Scrrcol__1 {
    ...
    public Scrrcol__1 withCollDescription(String collDescription) {
        this.collDescription = collDescription;
        return this;
    }
    ...
    public Scrrcol__1 withCollCode(String collCode) {
        this.collCode = collCode;
        return this;
    }
    ...
    public Scrrcol__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrcol__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrcol__1) == false) {
            return false;
        }
        Scrrcol__1 rhs = ((Scrrcol__1) other);
