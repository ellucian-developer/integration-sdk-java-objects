...
public class Scrrcam {
    ...
    public Scrrcam withCampCode(String campCode) {
        this.campCode = campCode;
        return this;
    }
    ...
    public Scrrcam withCampDescription(String campDescription) {
        this.campDescription = campDescription;
        return this;
    }
    ...
    public Scrrcam withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrcam.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("campCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrcam) == false) {
            return false;
        }
        Scrrcam rhs = ((Scrrcam) other);
