...
public class RcolCtrlBlock__1 {
    ...
    public RcolCtrlBlock__1 withScrrcolTermCodeTo(String scrrcolTermCodeTo) {
        this.scrrcolTermCodeTo = scrrcolTermCodeTo;
        return this;
    }
    ...
    public RcolCtrlBlock__1 withScrrcolCollInd(String scrrcolCollInd) {
        this.scrrcolCollInd = scrrcolCollInd;
        return this;
    }
    ...
    public RcolCtrlBlock__1 withRcolCtrlEndcopy(String rcolCtrlEndcopy) {
        this.rcolCtrlEndcopy = rcolCtrlEndcopy;
        return this;
    }
    ...
    public RcolCtrlBlock__1 withScrrcolTermCodeFrom(String scrrcolTermCodeFrom) {
        this.scrrcolTermCodeFrom = scrrcolTermCodeFrom;
        return this;
    }
    ...
    public RcolCtrlBlock__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RcolCtrlBlock__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RcolCtrlBlock__1) == false) {
            return false;
        }
        RcolCtrlBlock__1 rhs = ((RcolCtrlBlock__1) other);
