...
public class CourseRegistrationCampusAndCollegeRestrictions100PostRequest {
    ...
    public CourseRegistrationCampusAndCollegeRestrictions100PostRequest withScacrseCrseNumb(Object scacrseCrseNumb) {
        this.scacrseCrseNumb = scacrseCrseNumb;
        return this;
    }
    ...
    public CourseRegistrationCampusAndCollegeRestrictions100PostRequest withCampCode(String campCode) {
        this.campCode = campCode;
        return this;
    }
    ...
    public CourseRegistrationCampusAndCollegeRestrictions100PostRequest withScacrseSubjCode(Object scacrseSubjCode) {
        this.scacrseSubjCode = scacrseSubjCode;
        return this;
    }
    ...
    public CourseRegistrationCampusAndCollegeRestrictions100PostRequest withCollCode(String collCode) {
        this.collCode = collCode;
        return this;
    }
    ...
    public CourseRegistrationCampusAndCollegeRestrictions100PostRequest withScacrseTermCodeEff(Object scacrseTermCodeEff) {
        this.scacrseTermCodeEff = scacrseTermCodeEff;
        return this;
    }
    ...
    public CourseRegistrationCampusAndCollegeRestrictions100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CourseRegistrationCampusAndCollegeRestrictions100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseRegistrationCampusAndCollegeRestrictions100PostRequest) == false) {
            return false;
        }
        CourseRegistrationCampusAndCollegeRestrictions100PostRequest rhs = ((CourseRegistrationCampusAndCollegeRestrictions100PostRequest) other);
        return (((((((this.scacrseCrseNumb == rhs.scacrseCrseNumb)||((this.scacrseCrseNumb!= null)&&this.scacrseCrseNumb.equals(rhs.scacrseCrseNumb)))&&((this.campCode == rhs.campCode)||((this.campCode!= null)&&this.campCode.equals(rhs.campCode))))&&((this.scacrseSubjCode == rhs.scacrseSubjCode)||((this.scacrseSubjCode!= null)&&this.scacrseSubjCode.equals(rhs.scacrseSubjCode))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.collCode == rhs.collCode)||((this.collCode!= null)&&this.collCode.equals(rhs.collCode))))&&((this.scacrseTermCodeEff == rhs.scacrseTermCodeEff)||((this.scacrseTermCodeEff!= null)&&this.scacrseTermCodeEff.equals(rhs.scacrseTermCodeEff))));
    }
