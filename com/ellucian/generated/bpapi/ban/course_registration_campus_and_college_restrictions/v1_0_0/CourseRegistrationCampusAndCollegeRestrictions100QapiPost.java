...
public class CourseRegistrationCampusAndCollegeRestrictions100QapiPost {
    ...
    public CourseRegistrationCampusAndCollegeRestrictions100QapiPost withScacrseSubjCode(String scacrseSubjCode) {
        this.scacrseSubjCode = scacrseSubjCode;
        return this;
    }
    ...
    public CourseRegistrationCampusAndCollegeRestrictions100QapiPost withScacrseCrseNumb(String scacrseCrseNumb) {
        this.scacrseCrseNumb = scacrseCrseNumb;
        return this;
    }
    ...
    public CourseRegistrationCampusAndCollegeRestrictions100QapiPost withScacrseTermCodeEff(String scacrseTermCodeEff) {
        this.scacrseTermCodeEff = scacrseTermCodeEff;
        return this;
    }
    ...
    public CourseRegistrationCampusAndCollegeRestrictions100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CourseRegistrationCampusAndCollegeRestrictions100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseRegistrationCampusAndCollegeRestrictions100QapiPost) == false) {
            return false;
        }
        CourseRegistrationCampusAndCollegeRestrictions100QapiPost rhs = ((CourseRegistrationCampusAndCollegeRestrictions100QapiPost) other);
