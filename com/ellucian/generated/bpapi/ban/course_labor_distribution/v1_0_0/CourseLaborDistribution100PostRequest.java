...
public class CourseLaborDistribution100PostRequest {
    ...
    public CourseLaborDistribution100PostRequest withProjCode(String projCode) {
        this.projCode = projCode;
        return this;
    }
    ...
    public CourseLaborDistribution100PostRequest withScacrseCrseNumb(String scacrseCrseNumb) {
        this.scacrseCrseNumb = scacrseCrseNumb;
        return this;
    }
    ...
    public CourseLaborDistribution100PostRequest withScacrseSubjCode(String scacrseSubjCode) {
        this.scacrseSubjCode = scacrseSubjCode;
        return this;
    }
    ...
    public CourseLaborDistribution100PostRequest withAcciCode(String acciCode) {
        this.acciCode = acciCode;
        return this;
    }
    ...
    public CourseLaborDistribution100PostRequest withCoasCode(String coasCode) {
        this.coasCode = coasCode;
        return this;
    }
    ...
    public CourseLaborDistribution100PostRequest withLocnCode(String locnCode) {
        this.locnCode = locnCode;
        return this;
    }
    ...
    public CourseLaborDistribution100PostRequest withOrgnCode(String orgnCode) {
        this.orgnCode = orgnCode;
        return this;
    }
    ...
    public CourseLaborDistribution100PostRequest withAcctCode(String acctCode) {
        this.acctCode = acctCode;
        return this;
    }
    ...
    public CourseLaborDistribution100PostRequest withPercent(Double percent) {
        this.percent = percent;
        return this;
    }
    ...
    public CourseLaborDistribution100PostRequest withFundCode(String fundCode) {
        this.fundCode = fundCode;
        return this;
    }
    ...
    public CourseLaborDistribution100PostRequest withProgCode(String progCode) {
        this.progCode = progCode;
        return this;
    }
    ...
    public CourseLaborDistribution100PostRequest withCtypCode(String ctypCode) {
        this.ctypCode = ctypCode;
        return this;
    }
    ...
    public CourseLaborDistribution100PostRequest withScacrseTermCodeEff(String scacrseTermCodeEff) {
        this.scacrseTermCodeEff = scacrseTermCodeEff;
        return this;
    }
    ...
    public CourseLaborDistribution100PostRequest withActvCode(String actvCode) {
        this.actvCode = actvCode;
        return this;
    }
    ...
    public CourseLaborDistribution100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CourseLaborDistribution100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("projCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseLaborDistribution100PostRequest) == false) {
            return false;
        }
        CourseLaborDistribution100PostRequest rhs = ((CourseLaborDistribution100PostRequest) other);
        return ((((((((((((((((this.projCode == rhs.projCode)||((this.projCode!= null)&&this.projCode.equals(rhs.projCode)))&&((this.scacrseCrseNumb == rhs.scacrseCrseNumb)||((this.scacrseCrseNumb!= null)&&this.scacrseCrseNumb.equals(rhs.scacrseCrseNumb))))&&((this.scacrseSubjCode == rhs.scacrseSubjCode)||((this.scacrseSubjCode!= null)&&this.scacrseSubjCode.equals(rhs.scacrseSubjCode))))&&((this.acciCode == rhs.acciCode)||((this.acciCode!= null)&&this.acciCode.equals(rhs.acciCode))))&&((this.coasCode == rhs.coasCode)||((this.coasCode!= null)&&this.coasCode.equals(rhs.coasCode))))&&((this.locnCode == rhs.locnCode)||((this.locnCode!= null)&&this.locnCode.equals(rhs.locnCode))))&&((this.orgnCode == rhs.orgnCode)||((this.orgnCode!= null)&&this.orgnCode.equals(rhs.orgnCode))))&&((this.acctCode == rhs.acctCode)||((this.acctCode!= null)&&this.acctCode.equals(rhs.acctCode))))&&((this.percent == rhs.percent)||((this.percent!= null)&&this.percent.equals(rhs.percent))))&&((this.fundCode == rhs.fundCode)||((this.fundCode!= null)&&this.fundCode.equals(rhs.fundCode))))&&((this.progCode == rhs.progCode)||((this.progCode!= null)&&this.progCode.equals(rhs.progCode))))&&((this.ctypCode == rhs.ctypCode)||((this.ctypCode!= null)&&this.ctypCode.equals(rhs.ctypCode))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.scacrseTermCodeEff == rhs.scacrseTermCodeEff)||((this.scacrseTermCodeEff!= null)&&this.scacrseTermCodeEff.equals(rhs.scacrseTermCodeEff))))&&((this.actvCode == rhs.actvCode)||((this.actvCode!= null)&&this.actvCode.equals(rhs.actvCode))));
    }
