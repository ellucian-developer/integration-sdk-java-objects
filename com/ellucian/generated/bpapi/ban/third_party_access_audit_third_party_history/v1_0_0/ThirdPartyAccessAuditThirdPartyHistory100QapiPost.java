...
public class ThirdPartyAccessAuditThirdPartyHistory100QapiPost {
    ...
    public ThirdPartyAccessAuditThirdPartyHistory100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ThirdPartyAccessAuditThirdPartyHistory100QapiPost withGorpaudExternalUser(String gorpaudExternalUser) {
        this.gorpaudExternalUser = gorpaudExternalUser;
        return this;
    }
    ...
    public ThirdPartyAccessAuditThirdPartyHistory100QapiPost withGorpaudUser(String gorpaudUser) {
        this.gorpaudUser = gorpaudUser;
        return this;
    }
    ...
    public ThirdPartyAccessAuditThirdPartyHistory100QapiPost withGorpaudActivityDate(Date gorpaudActivityDate) {
        this.gorpaudActivityDate = gorpaudActivityDate;
        return this;
    }
    ...
    public ThirdPartyAccessAuditThirdPartyHistory100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ThirdPartyAccessAuditThirdPartyHistory100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ThirdPartyAccessAuditThirdPartyHistory100QapiPost) == false) {
            return false;
        }
        ThirdPartyAccessAuditThirdPartyHistory100QapiPost rhs = ((ThirdPartyAccessAuditThirdPartyHistory100QapiPost) other);
        return ((((((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id)))&&((this.gorpaudExternalUser == rhs.gorpaudExternalUser)||((this.gorpaudExternalUser!= null)&&this.gorpaudExternalUser.equals(rhs.gorpaudExternalUser))))&&((this.gorpaudUser == rhs.gorpaudUser)||((this.gorpaudUser!= null)&&this.gorpaudUser.equals(rhs.gorpaudUser))))&&((this.gorpaudActivityDate == rhs.gorpaudActivityDate)||((this.gorpaudActivityDate!= null)&&this.gorpaudActivityDate.equals(rhs.gorpaudActivityDate))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
