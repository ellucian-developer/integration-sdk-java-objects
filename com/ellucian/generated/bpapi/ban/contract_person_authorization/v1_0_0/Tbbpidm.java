...
public class Tbbpidm {
    ...
    public Tbbpidm withMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public Tbbpidm withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Tbbpidm.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("message");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tbbpidm) == false) {
            return false;
        }
        Tbbpidm rhs = ((Tbbpidm) other);
