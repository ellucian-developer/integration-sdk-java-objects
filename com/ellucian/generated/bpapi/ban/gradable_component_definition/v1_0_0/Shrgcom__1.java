...
public class Shrgcom__1 {
    ...
    public Shrgcom__1 withDate(Date date) {
        this.date = date;
        return this;
    }
    ...
    public Shrgcom__1 withCompLateRule(String compLateRule) {
        this.compLateRule = compLateRule;
        return this;
    }
    ...
    public Shrgcom__1 withCompResitRule(String compResitRule) {
        this.compResitRule = compResitRule;
        return this;
    }
    ...
    public Shrgcom__1 withSeqNo(Double seqNo) {
        this.seqNo = seqNo;
        return this;
    }
    ...
    public Shrgcom__1 withAndorSeqNo(Double andorSeqNo) {
        this.andorSeqNo = andorSeqNo;
        return this;
    }
    ...
    public Shrgcom__1 withAnonymousInd(String anonymousInd) {
        this.anonymousInd = anonymousInd;
        return this;
    }
    ...
    public Shrgcom__1 withShrscomExists(String shrscomExists) {
        this.shrscomExists = shrscomExists;
        return this;
    }
    ...
    public Shrgcom__1 withSubsetOfSub(Double subsetOfSub) {
        this.subsetOfSub = subsetOfSub;
        return this;
    }
    ...
    public Shrgcom__1 withMinPassScore(Double minPassScore) {
        this.minPassScore = minPassScore;
        return this;
    }
    ...
    public Shrgcom__1 withGradeScale(String gradeScale) {
        this.gradeScale = gradeScale;
        return this;
    }
    ...
    public Shrgcom__1 withBestOfSub(Double bestOfSub) {
        this.bestOfSub = bestOfSub;
        return this;
    }
    ...
    public Shrgcom__1 withInclInd(String inclInd) {
        this.inclInd = inclInd;
        return this;
    }
    ...
    public Shrgcom__1 withSubSet(String subSet) {
        this.subSet = subSet;
        return this;
    }
