...
public class GeneralPersonIdentificationAdditionalIdentification100GetResponse {
    ...
    public GeneralPersonIdentificationAdditionalIdentification100GetResponse withAdidDesc(String adidDesc) {
        this.adidDesc = adidDesc;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalIdentification100GetResponse withAdditionalId(String additionalId) {
        this.additionalId = additionalId;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalIdentification100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalIdentification100GetResponse withAdidCode(String adidCode) {
        this.adidCode = adidCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalIdentification100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalIdentification100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralPersonIdentificationAdditionalIdentification100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("adidDesc");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralPersonIdentificationAdditionalIdentification100GetResponse) == false) {
            return false;
        }
        GeneralPersonIdentificationAdditionalIdentification100GetResponse rhs = ((GeneralPersonIdentificationAdditionalIdentification100GetResponse) other);
