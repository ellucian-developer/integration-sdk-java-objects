...
public class GeneralPersonIdentificationAdditionalIdentification100PostRequest {
    ...
    public GeneralPersonIdentificationAdditionalIdentification100PostRequest withAdditionalId(String additionalId) {
        this.additionalId = additionalId;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalIdentification100PostRequest withAdidCode(String adidCode) {
        this.adidCode = adidCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalIdentification100PostRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GeneralPersonIdentificationAdditionalIdentification100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralPersonIdentificationAdditionalIdentification100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralPersonIdentificationAdditionalIdentification100PostRequest) == false) {
            return false;
        }
        GeneralPersonIdentificationAdditionalIdentification100PostRequest rhs = ((GeneralPersonIdentificationAdditionalIdentification100PostRequest) other);
