...
public class ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest {
    ...
    public ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest withDesiredHourly(Double desiredHourly) {
        this.desiredHourly = desiredHourly;
        return this;
    }
    ...
    public ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest withReqNo(String reqNo) {
        this.reqNo = reqNo;
        return this;
    }
    ...
    public ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest withAsrcCode(String asrcCode) {
        this.asrcCode = asrcCode;
        return this;
    }
    ...
    public ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest withPclsCode(String pclsCode) {
        this.pclsCode = pclsCode;
        return this;
    }
    ...
    public ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest withCriteriaId(String criteriaId) {
        this.criteriaId = criteriaId;
        return this;
    }
    ...
    public ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest withPosn(String posn) {
        this.posn = posn;
        return this;
    }
    ...
    public ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest withFullPartInd(String fullPartInd) {
        this.fullPartInd = fullPartInd;
        return this;
    }
    ...
    public ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest withDesiredSalary(Double desiredSalary) {
        this.desiredSalary = desiredSalary;
        return this;
    }
    ...
    public ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest) == false) {
            return false;
        }
        ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest rhs = ((ApplicantEntryByRequisitionOrPositionApplicantInformation100PutRequest) other);
        return (((((((((((this.desiredHourly == rhs.desiredHourly)||((this.desiredHourly!= null)&&this.desiredHourly.equals(rhs.desiredHourly)))&&((this.criteriaId == rhs.criteriaId)||((this.criteriaId!= null)&&this.criteriaId.equals(rhs.criteriaId))))&&((this.reqNo == rhs.reqNo)||((this.reqNo!= null)&&this.reqNo.equals(rhs.reqNo))))&&((this.asrcCode == rhs.asrcCode)||((this.asrcCode!= null)&&this.asrcCode.equals(rhs.asrcCode))))&&((this.pclsCode == rhs.pclsCode)||((this.pclsCode!= null)&&this.pclsCode.equals(rhs.pclsCode))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.posn == rhs.posn)||((this.posn!= null)&&this.posn.equals(rhs.posn))))&&((this.fullPartInd == rhs.fullPartInd)||((this.fullPartInd!= null)&&this.fullPartInd.equals(rhs.fullPartInd))))&&((this.desiredSalary == rhs.desiredSalary)||((this.desiredSalary!= null)&&this.desiredSalary.equals(rhs.desiredSalary))));
    }
