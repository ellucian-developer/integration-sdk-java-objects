...
public class ListOfTransactionHistory100GetResponse {
    ...
    @JsonPropertyDescription("Lineage reference object : FGVTRNH_ACTIVITY_DATE")
    ...
    public ListOfTransactionHistory100GetResponse withDisplayDocType(String displayDocType) {
        this.displayDocType = displayDocType;
        return this;
    }
    ...
    public ListOfTransactionHistory100GetResponse withSubmissionNumber(Double submissionNumber) {
        this.submissionNumber = submissionNumber;
        return this;
    }
    ...
    public ListOfTransactionHistory100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public ListOfTransactionHistory100GetResponse withCmtType(String cmtType) {
        this.cmtType = cmtType;
        return this;
    }
    ...
    public ListOfTransactionHistory100GetResponse withTransDesc(String transDesc) {
        this.transDesc = transDesc;
        return this;
    }
    ...
    public ListOfTransactionHistory100GetResponse withTransDate(Date transDate) {
        this.transDate = transDate;
        return this;
    }
    ...
    public ListOfTransactionHistory100GetResponse withDocCode(String docCode) {
        this.docCode = docCode;
        return this;
    }
    ...
    public ListOfTransactionHistory100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ListOfTransactionHistory100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ListOfTransactionHistory100GetResponse) == false) {
            return false;
        }
        ListOfTransactionHistory100GetResponse rhs = ((ListOfTransactionHistory100GetResponse) other);
        return (((((((((this.displayDocType == rhs.displayDocType)||((this.displayDocType!= null)&&this.displayDocType.equals(rhs.displayDocType)))&&((this.submissionNumber == rhs.submissionNumber)||((this.submissionNumber!= null)&&this.submissionNumber.equals(rhs.submissionNumber))))&&((this.activityDate == rhs.activityDate)||((this.activityDate!= null)&&this.activityDate.equals(rhs.activityDate))))&&((this.cmtType == rhs.cmtType)||((this.cmtType!= null)&&this.cmtType.equals(rhs.cmtType))))&&((this.transDesc == rhs.transDesc)||((this.transDesc!= null)&&this.transDesc.equals(rhs.transDesc))))&&((this.transDate == rhs.transDate)||((this.transDate!= null)&&this.transDate.equals(rhs.transDate))))&&((this.docCode == rhs.docCode)||((this.docCode!= null)&&this.docCode.equals(rhs.docCode))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
