...
public class AccountHierarchy100QapiPost {
    ...
    public AccountHierarchy100QapiPost withCoasCode(String coasCode) {
        this.coasCode = coasCode;
        return this;
    }
    ...
    public AccountHierarchy100QapiPost withProgCode(String progCode) {
        this.progCode = progCode;
        return this;
    }
    ...
    public AccountHierarchy100QapiPost withProgTitle(String progTitle) {
        this.progTitle = progTitle;
        return this;
    }
    ...
    public AccountHierarchy100QapiPost withEffDateYmdhms(String effDateYmdhms) {
        this.effDateYmdhms = effDateYmdhms;
        return this;
    }
    ...
    public AccountHierarchy100QapiPost withProgCodePredTitle(String progCodePredTitle) {
        this.progCodePredTitle = progCodePredTitle;
        return this;
    }
    ...
    public AccountHierarchy100QapiPost withProgCodePred(String progCodePred) {
        this.progCodePred = progCodePred;
        return this;
    }
    ...
    public AccountHierarchy100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AccountHierarchy100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("coasCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AccountHierarchy100QapiPost) == false) {
            return false;
        }
        AccountHierarchy100QapiPost rhs = ((AccountHierarchy100QapiPost) other);
