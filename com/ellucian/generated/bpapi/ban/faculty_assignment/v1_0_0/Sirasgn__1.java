...
public class Sirasgn__1 {
    ...
    public Sirasgn__1 withPercentResponse(Double percentResponse) {
        this.percentResponse = percentResponse;
        return this;
    }
    ...
    public Sirasgn__1 withAddInst(String addInst) {
        this.addInst = addInst;
        return this;
    }
    ...
    public Sirasgn__1 withCompensationAppliedCbox(String compensationAppliedCbox) {
        this.compensationAppliedCbox = compensationAppliedCbox;
        return this;
    }
    ...
    public Sirasgn__1 withWorkloadAdjust(Double workloadAdjust) {
        this.workloadAdjust = workloadAdjust;
        return this;
    }
    ...
    public Sirasgn__1 withSessHrs(Double sessHrs) {
        this.sessHrs = sessHrs;
        return this;
    }
    ...
    public Sirasgn__1 withGeneratedCredits(Double generatedCredits) {
        this.generatedCredits = generatedCredits;
        return this;
    }
    ...
    public Sirasgn__1 withSuff(String suff) {
        this.suff = suff;
        return this;
    }
    ...
    public Sirasgn__1 withCrn(String crn) {
        this.crn = crn;
        return this;
    }
    ...
    public Sirasgn__1 withOverRide(String overRide) {
        this.overRide = overRide;
        return this;
    }
    ...
    public Sirasgn__1 withAssignFte(Double assignFte) {
        this.assignFte = assignFte;
        return this;
    }
    ...
    public Sirasgn__1 withSubjCode(String subjCode) {
        this.subjCode = subjCode;
        return this;
    }
    ...
    public Sirasgn__1 withFcntCode(String fcntCode) {
        this.fcntCode = fcntCode;
        return this;
    }
    ...
    public Sirasgn__1 withWorkload(Double workload) {
        this.workload = workload;
        return this;
    }
    ...
    public Sirasgn__1 withCalcWorkload(Double calcWorkload) {
        this.calcWorkload = calcWorkload;
        return this;
    }
    ...
    public Sirasgn__1 withCompensationExtractedCbox(String compensationExtractedCbox) {
        this.compensationExtractedCbox = compensationExtractedCbox;
        return this;
    }
    ...
    public Sirasgn__1 withPosn(String posn) {
        this.posn = posn;
        return this;
    }
    ...
    public Sirasgn__1 withTotalContact(Double totalContact) {
        this.totalContact = totalContact;
        return this;
    }
    ...
    public Sirasgn__1 withCrseNumb(String crseNumb) {
        this.crseNumb = crseNumb;
        return this;
    }
    ...
    public Sirasgn__1 withSeqNumb(String seqNumb) {
        this.seqNumb = seqNumb;
        return this;
    }
    ...
    public Sirasgn__1 withWeeklyContact(Double weeklyContact) {
        this.weeklyContact = weeklyContact;
        return this;
    }
    ...
    public Sirasgn__1 withCategory(String category) {
        this.category = category;
        return this;
    }
    ...
    public Sirasgn__1 withInstCred(Double instCred) {
        this.instCred = instCred;
        return this;
    }
    ...
    public Sirasgn__1 withAstyCode(String astyCode) {
        this.astyCode = astyCode;
        return this;
    }
    ...
    public Sirasgn__1 withPercentSess(Double percentSess) {
        this.percentSess = percentSess;
        return this;
    }
