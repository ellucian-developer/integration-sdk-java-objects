...
public class AccountIndexCodeMaintenance100GetRequest {
    ...
    public AccountIndexCodeMaintenance100GetRequest withLocnOverride(String locnOverride) {
        this.locnOverride = locnOverride;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withAcctOverride(String acctOverride) {
        this.acctOverride = acctOverride;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withProgOverride(String progOverride) {
        this.progOverride = progOverride;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withAcciCode(String acciCode) {
        this.acciCode = acciCode;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withCoasCode(String coasCode) {
        this.coasCode = coasCode;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withLocnCode(String locnCode) {
        this.locnCode = locnCode;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withOrgnCode(String orgnCode) {
        this.orgnCode = orgnCode;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withAcctCode(String acctCode) {
        this.acctCode = acctCode;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withEffDate(Date effDate) {
        this.effDate = effDate;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withOrgnOverride(String orgnOverride) {
        this.orgnOverride = orgnOverride;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withActvOverride(String actvOverride) {
        this.actvOverride = actvOverride;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withFundCode(String fundCode) {
        this.fundCode = fundCode;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withFundOverride(String fundOverride) {
        this.fundOverride = fundOverride;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withProgCode(String progCode) {
        this.progCode = progCode;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withTermDate(Date termDate) {
        this.termDate = termDate;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withActvCode(String actvCode) {
        this.actvCode = actvCode;
        return this;
    }
    ...
    public AccountIndexCodeMaintenance100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AccountIndexCodeMaintenance100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AccountIndexCodeMaintenance100GetRequest) == false) {
            return false;
        }
        AccountIndexCodeMaintenance100GetRequest rhs = ((AccountIndexCodeMaintenance100GetRequest) other);
        return (((((((((((((((((((((this.locnOverride == rhs.locnOverride)||((this.locnOverride!= null)&&this.locnOverride.equals(rhs.locnOverride)))&&((this.acctOverride == rhs.acctOverride)||((this.acctOverride!= null)&&this.acctOverride.equals(rhs.acctOverride))))&&((this.progOverride == rhs.progOverride)||((this.progOverride!= null)&&this.progOverride.equals(rhs.progOverride))))&&((this.acciCode == rhs.acciCode)||((this.acciCode!= null)&&this.acciCode.equals(rhs.acciCode))))&&((this.coasCode == rhs.coasCode)||((this.coasCode!= null)&&this.coasCode.equals(rhs.coasCode))))&&((this.locnCode == rhs.locnCode)||((this.locnCode!= null)&&this.locnCode.equals(rhs.locnCode))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this.orgnCode == rhs.orgnCode)||((this.orgnCode!= null)&&this.orgnCode.equals(rhs.orgnCode))))&&((this.acctCode == rhs.acctCode)||((this.acctCode!= null)&&this.acctCode.equals(rhs.acctCode))))&&((this.effDate == rhs.effDate)||((this.effDate!= null)&&this.effDate.equals(rhs.effDate))))&&((this.orgnOverride == rhs.orgnOverride)||((this.orgnOverride!= null)&&this.orgnOverride.equals(rhs.orgnOverride))))&&((this.activityDate == rhs.activityDate)||((this.activityDate!= null)&&this.activityDate.equals(rhs.activityDate))))&&((this.actvOverride == rhs.actvOverride)||((this.actvOverride!= null)&&this.actvOverride.equals(rhs.actvOverride))))&&((this.fundCode == rhs.fundCode)||((this.fundCode!= null)&&this.fundCode.equals(rhs.fundCode))))&&((this.statusInd == rhs.statusInd)||((this.statusInd!= null)&&this.statusInd.equals(rhs.statusInd))))&&((this.fundOverride == rhs.fundOverride)||((this.fundOverride!= null)&&this.fundOverride.equals(rhs.fundOverride))))&&((this.progCode == rhs.progCode)||((this.progCode!= null)&&this.progCode.equals(rhs.progCode))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.termDate == rhs.termDate)||((this.termDate!= null)&&this.termDate.equals(rhs.termDate))))&&((this.actvCode == rhs.actvCode)||((this.actvCode!= null)&&this.actvCode.equals(rhs.actvCode))));
    }
