...
public class Scrtext {
    ...
    public Scrtext withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public Scrtext withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrtext.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("text");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrtext) == false) {
            return false;
        }
        Scrtext rhs = ((Scrtext) other);
