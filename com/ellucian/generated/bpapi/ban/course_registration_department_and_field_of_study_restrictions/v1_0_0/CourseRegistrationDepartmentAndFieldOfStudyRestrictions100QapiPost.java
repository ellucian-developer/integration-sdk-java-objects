...
public class CourseRegistrationDepartmentAndFieldOfStudyRestrictions100QapiPost {
    ...
    public CourseRegistrationDepartmentAndFieldOfStudyRestrictions100QapiPost withScacrseSubjCode(String scacrseSubjCode) {
        this.scacrseSubjCode = scacrseSubjCode;
        return this;
    }
    ...
    public CourseRegistrationDepartmentAndFieldOfStudyRestrictions100QapiPost withScacrseCrseNumb(String scacrseCrseNumb) {
        this.scacrseCrseNumb = scacrseCrseNumb;
        return this;
    }
    ...
    public CourseRegistrationDepartmentAndFieldOfStudyRestrictions100QapiPost withScacrseTermCodeEff(String scacrseTermCodeEff) {
        this.scacrseTermCodeEff = scacrseTermCodeEff;
        return this;
    }
    ...
    public CourseRegistrationDepartmentAndFieldOfStudyRestrictions100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CourseRegistrationDepartmentAndFieldOfStudyRestrictions100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseRegistrationDepartmentAndFieldOfStudyRestrictions100QapiPost) == false) {
            return false;
        }
        CourseRegistrationDepartmentAndFieldOfStudyRestrictions100QapiPost rhs = ((CourseRegistrationDepartmentAndFieldOfStudyRestrictions100QapiPost) other);
