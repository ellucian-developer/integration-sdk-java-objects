...
public class Scrrmaj__2 {
    ...
    public Scrrmaj__2 withMajorDescription(String majorDescription) {
        this.majorDescription = majorDescription;
        return this;
    }
    ...
    public Scrrmaj__2 withMajrCode(String majrCode) {
        this.majrCode = majrCode;
        return this;
    }
    ...
    public Scrrmaj__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrmaj__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrmaj__2) == false) {
            return false;
        }
        Scrrmaj__2 rhs = ((Scrrmaj__2) other);
