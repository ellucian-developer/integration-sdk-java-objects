...
public class Scrrmaj {
    ...
    public Scrrmaj withMajorDescription(String majorDescription) {
        this.majorDescription = majorDescription;
        return this;
    }
    ...
    public Scrrmaj withMajrCode(String majrCode) {
        this.majrCode = majrCode;
        return this;
    }
    ...
    public Scrrmaj withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrmaj.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrmaj) == false) {
            return false;
        }
        Scrrmaj rhs = ((Scrrmaj) other);
