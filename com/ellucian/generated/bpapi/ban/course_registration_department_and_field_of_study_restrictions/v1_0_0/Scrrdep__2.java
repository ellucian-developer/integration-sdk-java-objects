...
public class Scrrdep__2 {
    ...
    public Scrrdep__2 withDeptDescription(String deptDescription) {
        this.deptDescription = deptDescription;
        return this;
    }
    ...
    public Scrrdep__2 withDeptCode(String deptCode) {
        this.deptCode = deptCode;
        return this;
    }
    ...
    public Scrrdep__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrdep__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrdep__2) == false) {
            return false;
        }
        Scrrdep__2 rhs = ((Scrrdep__2) other);
