...
public class Scrrdep {
    ...
    public Scrrdep withDeptDescription(String deptDescription) {
        this.deptDescription = deptDescription;
        return this;
    }
    ...
    public Scrrdep withDeptCode(String deptCode) {
        this.deptCode = deptCode;
        return this;
    }
    ...
    public Scrrdep withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrdep.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrdep) == false) {
            return false;
        }
        Scrrdep rhs = ((Scrrdep) other);
