...
public class CourseRegistrationDepartmentAndFieldOfStudyRestrictions100PutRequest {
    ...
    public CourseRegistrationDepartmentAndFieldOfStudyRestrictions100PutRequest withLfstCode(String lfstCode) {
        this.lfstCode = lfstCode;
        return this;
    }
    ...
    public CourseRegistrationDepartmentAndFieldOfStudyRestrictions100PutRequest withScacrseCrseNumb(String scacrseCrseNumb) {
        this.scacrseCrseNumb = scacrseCrseNumb;
        return this;
    }
    ...
    public CourseRegistrationDepartmentAndFieldOfStudyRestrictions100PutRequest withScacrseSubjCode(String scacrseSubjCode) {
        this.scacrseSubjCode = scacrseSubjCode;
        return this;
    }
    ...
    public CourseRegistrationDepartmentAndFieldOfStudyRestrictions100PutRequest withCriteriaDeptCode(String criteriaDeptCode) {
        this.criteriaDeptCode = criteriaDeptCode;
        return this;
    }
    ...
    public CourseRegistrationDepartmentAndFieldOfStudyRestrictions100PutRequest withScacrseTermCodeEff(String scacrseTermCodeEff) {
        this.scacrseTermCodeEff = scacrseTermCodeEff;
        return this;
    }
    ...
    public CourseRegistrationDepartmentAndFieldOfStudyRestrictions100PutRequest withMajrCode(String majrCode) {
        this.majrCode = majrCode;
        return this;
    }
    ...
    public CourseRegistrationDepartmentAndFieldOfStudyRestrictions100PutRequest withDeptCode(String deptCode) {
        this.deptCode = deptCode;
        return this;
    }
    ...
    public CourseRegistrationDepartmentAndFieldOfStudyRestrictions100PutRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CourseRegistrationDepartmentAndFieldOfStudyRestrictions100PutRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("lfstCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseRegistrationDepartmentAndFieldOfStudyRestrictions100PutRequest) == false) {
            return false;
        }
        CourseRegistrationDepartmentAndFieldOfStudyRestrictions100PutRequest rhs = ((CourseRegistrationDepartmentAndFieldOfStudyRestrictions100PutRequest) other);
        return (((((((((this.lfstCode == rhs.lfstCode)||((this.lfstCode!= null)&&this.lfstCode.equals(rhs.lfstCode)))&&((this.scacrseCrseNumb == rhs.scacrseCrseNumb)||((this.scacrseCrseNumb!= null)&&this.scacrseCrseNumb.equals(rhs.scacrseCrseNumb))))&&((this.scacrseSubjCode == rhs.scacrseSubjCode)||((this.scacrseSubjCode!= null)&&this.scacrseSubjCode.equals(rhs.scacrseSubjCode))))&&((this.criteriaDeptCode == rhs.criteriaDeptCode)||((this.criteriaDeptCode!= null)&&this.criteriaDeptCode.equals(rhs.criteriaDeptCode))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.scacrseTermCodeEff == rhs.scacrseTermCodeEff)||((this.scacrseTermCodeEff!= null)&&this.scacrseTermCodeEff.equals(rhs.scacrseTermCodeEff))))&&((this.majrCode == rhs.majrCode)||((this.majrCode!= null)&&this.majrCode.equals(rhs.majrCode))))&&((this.deptCode == rhs.deptCode)||((this.deptCode!= null)&&this.deptCode.equals(rhs.deptCode))));
    }
