...
public class Saracmt__2 {
    ...
    public Saracmt__2 withCommentText(String commentText) {
        this.commentText = commentText;
        return this;
    }
    ...
    public Saracmt__2 withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public Saracmt__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Saracmt__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Saracmt__2) == false) {
            return false;
        }
        Saracmt__2 rhs = ((Saracmt__2) other);
