...
public class Sarrsrc__1 {
    ...
    public Sarrsrc__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sarrsrc__1 withStvsbgiDesc(String stvsbgiDesc) {
        this.stvsbgiDesc = stvsbgiDesc;
        return this;
    }
    ...
    public Sarrsrc__1 withPrimarySrceInd(String primarySrceInd) {
        this.primarySrceInd = primarySrceInd;
        return this;
    }
    ...
    public Sarrsrc__1 withSbgiCode(String sbgiCode) {
        this.sbgiCode = sbgiCode;
        return this;
    }
    ...
    public Sarrsrc__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sarrsrc__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sarrsrc__1) == false) {
            return false;
        }
        Sarrsrc__1 rhs = ((Sarrsrc__1) other);
