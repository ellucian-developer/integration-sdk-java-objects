...
public class AdmissionsApplicationSourcesInterestsComments100QapiPost {
    ...
    public AdmissionsApplicationSourcesInterestsComments100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public AdmissionsApplicationSourcesInterestsComments100QapiPost withKbentryTermCode(String kbentryTermCode) {
        this.kbentryTermCode = kbentryTermCode;
        return this;
    }
    ...
    public AdmissionsApplicationSourcesInterestsComments100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AdmissionsApplicationSourcesInterestsComments100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AdmissionsApplicationSourcesInterestsComments100QapiPost) == false) {
            return false;
        }
        AdmissionsApplicationSourcesInterestsComments100QapiPost rhs = ((AdmissionsApplicationSourcesInterestsComments100QapiPost) other);
