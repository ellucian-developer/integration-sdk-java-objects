...
public class Saracmt__1 {
    ...
    public Saracmt__1 withCommentText(String commentText) {
        this.commentText = commentText;
        return this;
    }
    ...
    public Saracmt__1 withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public Saracmt__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Saracmt__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Saracmt__1) == false) {
            return false;
        }
        Saracmt__1 rhs = ((Saracmt__1) other);
