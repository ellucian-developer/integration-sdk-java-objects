...
public class Sarrsrc__2 {
    ...
    public Sarrsrc__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sarrsrc__2 withStvsbgiDesc(String stvsbgiDesc) {
        this.stvsbgiDesc = stvsbgiDesc;
        return this;
    }
    ...
    public Sarrsrc__2 withPrimarySrceInd(String primarySrceInd) {
        this.primarySrceInd = primarySrceInd;
        return this;
    }
    ...
    public Sarrsrc__2 withSbgiCode(String sbgiCode) {
        this.sbgiCode = sbgiCode;
        return this;
    }
    ...
    public Sarrsrc__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sarrsrc__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sarrsrc__2) == false) {
            return false;
        }
        Sarrsrc__2 rhs = ((Sarrsrc__2) other);
