...
public class CaMajorMinorConcentrationCodes100GetRequest {
    ...
    public CaMajorMinorConcentrationCodes100GetRequest withOccupationInd(String occupationInd) {
        this.occupationInd = occupationInd;
        return this;
    }
    ...
    public CaMajorMinorConcentrationCodes100GetRequest withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CaMajorMinorConcentrationCodes100GetRequest withSystemReqInd(String systemReqInd) {
        this.systemReqInd = systemReqInd;
        return this;
    }
    ...
    public CaMajorMinorConcentrationCodes100GetRequest withTopsCode(String topsCode) {
        this.topsCode = topsCode;
        return this;
    }
    ...
    public CaMajorMinorConcentrationCodes100GetRequest withAidEligibilityInd(String aidEligibilityInd) {
        this.aidEligibilityInd = aidEligibilityInd;
        return this;
    }
    ...
    public CaMajorMinorConcentrationCodes100GetRequest withCipcCode(String cipcCode) {
        this.cipcCode = cipcCode;
        return this;
    }
    ...
    public CaMajorMinorConcentrationCodes100GetRequest withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CaMajorMinorConcentrationCodes100GetRequest withValidMajorInd(String validMajorInd) {
        this.validMajorInd = validMajorInd;
        return this;
    }
    ...
    public CaMajorMinorConcentrationCodes100GetRequest withValidConcentratnInd(String validConcentratnInd) {
        this.validConcentratnInd = validConcentratnInd;
        return this;
    }
    ...
    public CaMajorMinorConcentrationCodes100GetRequest withVrMsgNo(Double vrMsgNo) {
        this.vrMsgNo = vrMsgNo;
        return this;
    }
    ...
    public CaMajorMinorConcentrationCodes100GetRequest withSevisEquiv(String sevisEquiv) {
        this.sevisEquiv = sevisEquiv;
        return this;
    }
    ...
    public CaMajorMinorConcentrationCodes100GetRequest withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public CaMajorMinorConcentrationCodes100GetRequest withValidMinorInd(String validMinorInd) {
        this.validMinorInd = validMinorInd;
        return this;
    }
    ...
    public CaMajorMinorConcentrationCodes100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CaMajorMinorConcentrationCodes100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaMajorMinorConcentrationCodes100GetRequest) == false) {
            return false;
        }
        CaMajorMinorConcentrationCodes100GetRequest rhs = ((CaMajorMinorConcentrationCodes100GetRequest) other);
