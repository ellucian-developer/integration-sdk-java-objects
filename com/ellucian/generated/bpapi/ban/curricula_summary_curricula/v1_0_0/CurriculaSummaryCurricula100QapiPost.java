...
public class CurriculaSummaryCurricula100QapiPost {
    ...
    public CurriculaSummaryCurricula100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CurriculaSummaryCurricula100QapiPost withDgmrSeqNo(String dgmrSeqNo) {
        this.dgmrSeqNo = dgmrSeqNo;
        return this;
    }
    ...
    public CurriculaSummaryCurricula100QapiPost withViewCurrent(String viewCurrent) {
        this.viewCurrent = viewCurrent;
        return this;
    }
    ...
    public CurriculaSummaryCurricula100QapiPost withDegsCode(String degsCode) {
        this.degsCode = degsCode;
        return this;
    }
    ...
    public CurriculaSummaryCurricula100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CurriculaSummaryCurricula100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CurriculaSummaryCurricula100QapiPost) == false) {
            return false;
        }
        CurriculaSummaryCurricula100QapiPost rhs = ((CurriculaSummaryCurricula100QapiPost) other);
