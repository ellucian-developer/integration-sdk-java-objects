...
public class DocumentRetrievalInquiry100GetResponse {
    ...
    @JsonPropertyDescription("Lineage reference object : FGBTRNH_ACCRUAL_IND")
    ...
    @JsonPropertyDescription("Lineage reference object : FGBTRNH_ABAL_OVERRIDE")
    ...
    public DocumentRetrievalInquiry100GetResponse withSubmissionNumber(Double submissionNumber) {
        this.submissionNumber = submissionNumber;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withBankCode(String bankCode) {
        this.bankCode = bankCode;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withPrjdCode(String prjdCode) {
        this.prjdCode = prjdCode;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withAccrualInd(String accrualInd) {
        this.accrualInd = accrualInd;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withSeqNum(Double seqNum) {
        this.seqNum = seqNum;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withAcciCode(String acciCode) {
        this.acciCode = acciCode;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withCoasCode(String coasCode) {
        this.coasCode = coasCode;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withLocnCode(String locnCode) {
        this.locnCode = locnCode;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withAcctCode(String acctCode) {
        this.acctCode = acctCode;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withOrgnCode(String orgnCode) {
        this.orgnCode = orgnCode;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withItemNum(Double itemNum) {
        this.itemNum = itemNum;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withFundCode(String fundCode) {
        this.fundCode = fundCode;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withTransDesc(String transDesc) {
        this.transDesc = transDesc;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withAbalOverride(String abalOverride) {
        this.abalOverride = abalOverride;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withProgCode(String progCode) {
        this.progCode = progCode;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withTransAmt(Double transAmt) {
        this.transAmt = transAmt;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withDocRefNum(String docRefNum) {
        this.docRefNum = docRefNum;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withRuclCode(String ruclCode) {
        this.ruclCode = ruclCode;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withDisplayCurrency(String displayCurrency) {
        this.displayCurrency = displayCurrency;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withActvCode(String actvCode) {
        this.actvCode = actvCode;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withDrCrInd(String drCrInd) {
        this.drCrInd = drCrInd;
        return this;
    }
    ...
    public DocumentRetrievalInquiry100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(DocumentRetrievalInquiry100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        ...
        sb.append('=');
        sb.append(((this.displayCurrency == null)?"<null>":this.displayCurrency));
        sb.append(',');
        sb.append("actvCode");
        sb.append('=');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.displayCurrency == null)? 0 :this.displayCurrency.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DocumentRetrievalInquiry100GetResponse) == false) {
            return false;
        }
        DocumentRetrievalInquiry100GetResponse rhs = ((DocumentRetrievalInquiry100GetResponse) other);
        return (((((((((((((((((((((((this.submissionNumber == rhs.submissionNumber)||((this.submissionNumber!= null)&&this.submissionNumber.equals(rhs.submissionNumber)))&&((this.bankCode == rhs.bankCode)||((this.bankCode!= null)&&this.bankCode.equals(rhs.bankCode))))&&((this.prjdCode == rhs.prjdCode)||((this.prjdCode!= null)&&this.prjdCode.equals(rhs.prjdCode))))&&((this.accrualInd == rhs.accrualInd)||((this.accrualInd!= null)&&this.accrualInd.equals(rhs.accrualInd))))&&((this.seqNum == rhs.seqNum)||((this.seqNum!= null)&&this.seqNum.equals(rhs.seqNum))))&&((this.acciCode == rhs.acciCode)||((this.acciCode!= null)&&this.acciCode.equals(rhs.acciCode))))&&((this.coasCode == rhs.coasCode)||((this.coasCode!= null)&&this.coasCode.equals(rhs.coasCode))))&&((this.locnCode == rhs.locnCode)||((this.locnCode!= null)&&this.locnCode.equals(rhs.locnCode))))&&((this.acctCode == rhs.acctCode)||((this.acctCode!= null)&&this.acctCode.equals(rhs.acctCode))))&&((this.orgnCode == rhs.orgnCode)||((this.orgnCode!= null)&&this.orgnCode.equals(rhs.orgnCode))))&&((this.itemNum == rhs.itemNum)||((this.itemNum!= null)&&this.itemNum.equals(rhs.itemNum))))&&((this.fundCode == rhs.fundCode)||((this.fundCode!= null)&&this.fundCode.equals(rhs.fundCode))))&&((this.transDesc == rhs.transDesc)||((this.transDesc!= null)&&this.transDesc.equals(rhs.transDesc))))&&((this.abalOverride == rhs.abalOverride)||((this.abalOverride!= null)&&this.abalOverride.equals(rhs.abalOverride))))&&((this.progCode == rhs.progCode)||((this.progCode!= null)&&this.progCode.equals(rhs.progCode))))&&((this.transAmt == rhs.transAmt)||((this.transAmt!= null)&&this.transAmt.equals(rhs.transAmt))))&&((this.docRefNum == rhs.docRefNum)||((this.docRefNum!= null)&&this.docRefNum.equals(rhs.docRefNum))))&&((this.ruclCode == rhs.ruclCode)||((this.ruclCode!= null)&&this.ruclCode.equals(rhs.ruclCode))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.displayCurrency == rhs.displayCurrency)||((this.displayCurrency!= null)&&this.displayCurrency.equals(rhs.displayCurrency))))&&((this.actvCode == rhs.actvCode)||((this.actvCode!= null)&&this.actvCode.equals(rhs.actvCode))))&&((this.drCrInd == rhs.drCrInd)||((this.drCrInd!= null)&&this.drCrInd.equals(rhs.drCrInd))));
    }
