...
public class GeneralInformationHonorsAndAwards100GetRequest {
    ...
    public GeneralInformationHonorsAndAwards100GetRequest withSbgiCode(String sbgiCode) {
        this.sbgiCode = sbgiCode;
        return this;
    }
    ...
    public GeneralInformationHonorsAndAwards100GetRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GeneralInformationHonorsAndAwards100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralInformationHonorsAndAwards100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sbgiCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralInformationHonorsAndAwards100GetRequest) == false) {
            return false;
        }
        GeneralInformationHonorsAndAwards100GetRequest rhs = ((GeneralInformationHonorsAndAwards100GetRequest) other);
