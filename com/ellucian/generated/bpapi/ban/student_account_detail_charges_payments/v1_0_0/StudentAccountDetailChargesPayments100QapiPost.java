...
public class StudentAccountDetailChargesPayments100QapiPost {
    ...
    public StudentAccountDetailChargesPayments100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public StudentAccountDetailChargesPayments100QapiPost withHoldPassword(String holdPassword) {
        this.holdPassword = holdPassword;
        return this;
    }
    ...
    public StudentAccountDetailChargesPayments100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StudentAccountDetailChargesPayments100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StudentAccountDetailChargesPayments100QapiPost) == false) {
            return false;
        }
        StudentAccountDetailChargesPayments100QapiPost rhs = ((StudentAccountDetailChargesPayments100QapiPost) other);
