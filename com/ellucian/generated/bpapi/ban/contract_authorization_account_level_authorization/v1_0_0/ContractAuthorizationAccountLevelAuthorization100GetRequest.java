...
public class ContractAuthorizationAccountLevelAuthorization100GetRequest {
    ...
    public ContractAuthorizationAccountLevelAuthorization100GetRequest withKeyblocTermCode(String keyblocTermCode) {
        this.keyblocTermCode = keyblocTermCode;
        return this;
    }
    ...
    public ContractAuthorizationAccountLevelAuthorization100GetRequest withContractNumber(Double contractNumber) {
        this.contractNumber = contractNumber;
        return this;
    }
    ...
    public ContractAuthorizationAccountLevelAuthorization100GetRequest withId(String id) {
        this.id = id;
        return this;
    }
