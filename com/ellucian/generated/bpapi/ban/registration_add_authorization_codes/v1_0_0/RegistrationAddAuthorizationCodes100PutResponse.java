...
public class RegistrationAddAuthorizationCodes100PutResponse {
    ...
    public RegistrationAddAuthorizationCodes100PutResponse withSpridenId(String spridenId) {
        this.spridenId = spridenId;
        return this;
    }
    ...
    public RegistrationAddAuthorizationCodes100PutResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public RegistrationAddAuthorizationCodes100PutResponse withAssignDate(Date assignDate) {
        this.assignDate = assignDate;
        return this;
    }
    ...
    public RegistrationAddAuthorizationCodes100PutResponse withGenerateDate(Date generateDate) {
        this.generateDate = generateDate;
        return this;
    }
    ...
    public RegistrationAddAuthorizationCodes100PutResponse withActiveInd(String activeInd) {
        this.activeInd = activeInd;
        return this;
    }
    ...
    public RegistrationAddAuthorizationCodes100PutResponse withDataOrigin(String dataOrigin) {
        this.dataOrigin = dataOrigin;
        return this;
    }
    ...
    public RegistrationAddAuthorizationCodes100PutResponse withAuthCde(String authCde) {
        this.authCde = authCde;
        return this;
    }
    ...
    public RegistrationAddAuthorizationCodes100PutResponse withSpridenName(String spridenName) {
        this.spridenName = spridenName;
        return this;
    }
    ...
    public RegistrationAddAuthorizationCodes100PutResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public RegistrationAddAuthorizationCodes100PutResponse withCrn(String crn) {
        this.crn = crn;
        return this;
    }
    ...
    public RegistrationAddAuthorizationCodes100PutResponse withTermCode(String termCode) {
        this.termCode = termCode;
        return this;
    }
    ...
    public RegistrationAddAuthorizationCodes100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RegistrationAddAuthorizationCodes100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("spridenId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegistrationAddAuthorizationCodes100PutResponse) == false) {
            return false;
        }
        RegistrationAddAuthorizationCodes100PutResponse rhs = ((RegistrationAddAuthorizationCodes100PutResponse) other);
