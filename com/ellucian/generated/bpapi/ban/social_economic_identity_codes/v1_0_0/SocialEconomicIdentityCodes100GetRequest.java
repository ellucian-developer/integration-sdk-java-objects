...
public class SocialEconomicIdentityCodes100GetRequest {
    ...
    public SocialEconomicIdentityCodes100GetRequest withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public SocialEconomicIdentityCodes100GetRequest withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public SocialEconomicIdentityCodes100GetRequest withSurrogateId(Double surrogateId) {
        this.surrogateId = surrogateId;
        return this;
    }
    ...
    public SocialEconomicIdentityCodes100GetRequest withDataOrigin(String dataOrigin) {
        this.dataOrigin = dataOrigin;
        return this;
    }
    ...
    public SocialEconomicIdentityCodes100GetRequest withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public SocialEconomicIdentityCodes100GetRequest withVpdiCode(String vpdiCode) {
        this.vpdiCode = vpdiCode;
        return this;
    }
    ...
    public SocialEconomicIdentityCodes100GetRequest withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public SocialEconomicIdentityCodes100GetRequest withVersion(Double version) {
        this.version = version;
        return this;
    }
    ...
    public SocialEconomicIdentityCodes100GetRequest withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public SocialEconomicIdentityCodes100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SocialEconomicIdentityCodes100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SocialEconomicIdentityCodes100GetRequest) == false) {
            return false;
        }
        SocialEconomicIdentityCodes100GetRequest rhs = ((SocialEconomicIdentityCodes100GetRequest) other);
