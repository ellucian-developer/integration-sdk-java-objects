...
public class FinanceApplicationDistributionSinglePayment100GetResponse {
    ...
    public FinanceApplicationDistributionSinglePayment100GetResponse withTbrcrcp(List<Tbrcrcp> tbrcrcp) {
        this.tbrcrcp = tbrcrcp;
        return this;
    }
    ...
    public FinanceApplicationDistributionSinglePayment100GetResponse withTbraccd(List<Tbraccd> tbraccd) {
        this.tbraccd = tbraccd;
        return this;
    }
    ...
    public FinanceApplicationDistributionSinglePayment100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(FinanceApplicationDistributionSinglePayment100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tbrcrcp");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FinanceApplicationDistributionSinglePayment100GetResponse) == false) {
            return false;
        }
        FinanceApplicationDistributionSinglePayment100GetResponse rhs = ((FinanceApplicationDistributionSinglePayment100GetResponse) other);
