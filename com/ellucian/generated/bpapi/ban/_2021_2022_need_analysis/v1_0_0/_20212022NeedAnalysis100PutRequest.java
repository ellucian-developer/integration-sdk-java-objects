...
public class _20212022NeedAnalysis100PutRequest {
    ...
    public _20212022NeedAnalysis100PutRequest withLastName(String lastName) {
        this.lastName = lastName;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withCitzInd(String citzInd) {
        this.citzInd = citzInd;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withKeyblckInfcCode(Object keyblckInfcCode) {
        this.keyblckInfcCode = keyblckInfcCode;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withDegreeByJuly(String degreeByJuly) {
        this.degreeByJuly = degreeByJuly;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withPhoneNo(String phoneNo) {
        this.phoneNo = phoneNo;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withSsn(String ssn) {
        this.ssn = ssn;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withDisplaySResDateMo(String displaySResDateMo) {
        this.displaySResDateMo = displaySResDateMo;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withKeyblckStudentId(Object keyblckStudentId) {
        this.keyblckStudentId = keyblckStudentId;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withMi(String mi) {
        this.mi = mi;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withAddr(String addr) {
        this.addr = addr;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withDisplaySResDateYr(Double displaySResDateYr) {
        this.displaySResDateYr = displaySResDateYr;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withRcrapp3SMarMthYr(String rcrapp3SMarMthYr) {
        this.rcrapp3SMarMthYr = rcrapp3SMarMthYr;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withZip(String zip) {
        this.zip = zip;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withRcrapp4EmailAddress(String rcrapp4EmailAddress) {
        this.rcrapp4EmailAddress = rcrapp4EmailAddress;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withStatCode(String statCode) {
        this.statCode = statCode;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withRcrapp4DrugOffenseConvic(String rcrapp4DrugOffenseConvic) {
        this.rcrapp4DrugOffenseConvic = rcrapp4DrugOffenseConvic;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withStatCodeRes(String statCodeRes) {
        this.statCodeRes = statCodeRes;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withKeyblckSeqNo(Object keyblckSeqNo) {
        this.keyblckSeqNo = keyblckSeqNo;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withBirthDate(Date birthDate) {
        this.birthDate = birthDate;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withStatCodeLic(String statCodeLic) {
        this.statCodeLic = statCodeLic;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withKeyblckPellInd(Object keyblckPellInd) {
        this.keyblckPellInd = keyblckPellInd;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withFirstName(String firstName) {
        this.firstName = firstName;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withMrtlStatus(String mrtlStatus) {
        this.mrtlStatus = mrtlStatus;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withRcrapp4LegalResInd(String rcrapp4LegalResInd) {
        this.rcrapp4LegalResInd = rcrapp4LegalResInd;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withPhoneArea(String phoneArea) {
        this.phoneArea = phoneArea;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withDriverLicNo(String driverLicNo) {
        this.driverLicNo = driverLicNo;
        return this;
    }
    ...
    public _20212022NeedAnalysis100PutRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(_20212022NeedAnalysis100PutRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("lastName");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _20212022NeedAnalysis100PutRequest) == false) {
            return false;
        }
        _20212022NeedAnalysis100PutRequest rhs = ((_20212022NeedAnalysis100PutRequest) other);
        return ((((((((((((((((((((((((((((((this.lastName == rhs.lastName)||((this.lastName!= null)&&this.lastName.equals(rhs.lastName)))&&((this.citzInd == rhs.citzInd)||((this.citzInd!= null)&&this.citzInd.equals(rhs.citzInd))))&&((this.city == rhs.city)||((this.city!= null)&&this.city.equals(rhs.city))))&&((this.keyblckInfcCode == rhs.keyblckInfcCode)||((this.keyblckInfcCode!= null)&&this.keyblckInfcCode.equals(rhs.keyblckInfcCode))))&&((this.degreeByJuly == rhs.degreeByJuly)||((this.degreeByJuly!= null)&&this.degreeByJuly.equals(rhs.degreeByJuly))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this.phoneNo == rhs.phoneNo)||((this.phoneNo!= null)&&this.phoneNo.equals(rhs.phoneNo))))&&((this.ssn == rhs.ssn)||((this.ssn!= null)&&this.ssn.equals(rhs.ssn))))&&((this.displaySResDateMo == rhs.displaySResDateMo)||((this.displaySResDateMo!= null)&&this.displaySResDateMo.equals(rhs.displaySResDateMo))))&&((this.keyblckStudentId == rhs.keyblckStudentId)||((this.keyblckStudentId!= null)&&this.keyblckStudentId.equals(rhs.keyblckStudentId))))&&((this.mi == rhs.mi)||((this.mi!= null)&&this.mi.equals(rhs.mi))))&&((this.addr == rhs.addr)||((this.addr!= null)&&this.addr.equals(rhs.addr))))&&((this.displaySResDateYr == rhs.displaySResDateYr)||((this.displaySResDateYr!= null)&&this.displaySResDateYr.equals(rhs.displaySResDateYr))))&&((this.rcrapp3SMarMthYr == rhs.rcrapp3SMarMthYr)||((this.rcrapp3SMarMthYr!= null)&&this.rcrapp3SMarMthYr.equals(rhs.rcrapp3SMarMthYr))))&&((this.zip == rhs.zip)||((this.zip!= null)&&this.zip.equals(rhs.zip))))&&((this.rcrapp4EmailAddress == rhs.rcrapp4EmailAddress)||((this.rcrapp4EmailAddress!= null)&&this.rcrapp4EmailAddress.equals(rhs.rcrapp4EmailAddress))))&&((this.statCode == rhs.statCode)||((this.statCode!= null)&&this.statCode.equals(rhs.statCode))))&&((this.rcrapp4DrugOffenseConvic == rhs.rcrapp4DrugOffenseConvic)||((this.rcrapp4DrugOffenseConvic!= null)&&this.rcrapp4DrugOffenseConvic.equals(rhs.rcrapp4DrugOffenseConvic))))&&((this.statCodeRes == rhs.statCodeRes)||((this.statCodeRes!= null)&&this.statCodeRes.equals(rhs.statCodeRes))))&&((this.keyblckSeqNo == rhs.keyblckSeqNo)||((this.keyblckSeqNo!= null)&&this.keyblckSeqNo.equals(rhs.keyblckSeqNo))))&&((this.birthDate == rhs.birthDate)||((this.birthDate!= null)&&this.birthDate.equals(rhs.birthDate))))&&((this.statCodeLic == rhs.statCodeLic)||((this.statCodeLic!= null)&&this.statCodeLic.equals(rhs.statCodeLic))))&&((this.keyblckPellInd == rhs.keyblckPellInd)||((this.keyblckPellInd!= null)&&this.keyblckPellInd.equals(rhs.keyblckPellInd))))&&((this.firstName == rhs.firstName)||((this.firstName!= null)&&this.firstName.equals(rhs.firstName))))&&((this.mrtlStatus == rhs.mrtlStatus)||((this.mrtlStatus!= null)&&this.mrtlStatus.equals(rhs.mrtlStatus))))&&((this.rcrapp4LegalResInd == rhs.rcrapp4LegalResInd)||((this.rcrapp4LegalResInd!= null)&&this.rcrapp4LegalResInd.equals(rhs.rcrapp4LegalResInd))))&&((this.phoneArea == rhs.phoneArea)||((this.phoneArea!= null)&&this.phoneArea.equals(rhs.phoneArea))))&&((this.driverLicNo == rhs.driverLicNo)||((this.driverLicNo!= null)&&this.driverLicNo.equals(rhs.driverLicNo))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
