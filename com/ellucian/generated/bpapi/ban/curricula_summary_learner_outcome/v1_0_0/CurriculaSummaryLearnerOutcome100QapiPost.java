...
public class CurriculaSummaryLearnerOutcome100QapiPost {
    ...
    public CurriculaSummaryLearnerOutcome100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CurriculaSummaryLearnerOutcome100QapiPost withDgmrSeqNo(String dgmrSeqNo) {
        this.dgmrSeqNo = dgmrSeqNo;
        return this;
    }
    ...
    public CurriculaSummaryLearnerOutcome100QapiPost withViewCurrent(String viewCurrent) {
        this.viewCurrent = viewCurrent;
        return this;
    }
    ...
    public CurriculaSummaryLearnerOutcome100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CurriculaSummaryLearnerOutcome100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CurriculaSummaryLearnerOutcome100QapiPost) == false) {
            return false;
        }
        CurriculaSummaryLearnerOutcome100QapiPost rhs = ((CurriculaSummaryLearnerOutcome100QapiPost) other);
