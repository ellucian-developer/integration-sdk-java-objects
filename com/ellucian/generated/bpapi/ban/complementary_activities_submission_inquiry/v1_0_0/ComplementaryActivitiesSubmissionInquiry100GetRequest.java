...
public class ComplementaryActivitiesSubmissionInquiry100GetRequest {
    ...
    public ComplementaryActivitiesSubmissionInquiry100GetRequest withActivityCode(String activityCode) {
        this.activityCode = activityCode;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionInquiry100GetRequest withSequenceNumber(Double sequenceNumber) {
        this.sequenceNumber = sequenceNumber;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionInquiry100GetRequest withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionInquiry100GetRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionInquiry100GetRequest withCategoryCode(String categoryCode) {
        this.categoryCode = categoryCode;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionInquiry100GetRequest withCollCode(String collCode) {
        this.collCode = collCode;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionInquiry100GetRequest withTermCode(String termCode) {
        this.termCode = termCode;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionInquiry100GetRequest withCasvDesc(String casvDesc) {
        this.casvDesc = casvDesc;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionInquiry100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ComplementaryActivitiesSubmissionInquiry100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ComplementaryActivitiesSubmissionInquiry100GetRequest) == false) {
            return false;
        }
        ComplementaryActivitiesSubmissionInquiry100GetRequest rhs = ((ComplementaryActivitiesSubmissionInquiry100GetRequest) other);
