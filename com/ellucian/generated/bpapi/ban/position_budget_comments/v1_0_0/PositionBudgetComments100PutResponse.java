...
public class PositionBudgetComments100PutResponse {
    ...
    public PositionBudgetComments100PutResponse withObudCode(String obudCode) {
        this.obudCode = obudCode;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withSgrpCode(String sgrpCode) {
        this.sgrpCode = sgrpCode;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withObphCode(String obphCode) {
        this.obphCode = obphCode;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withEncumb(Double encumb) {
        this.encumb = encumb;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withCoasCode(String coasCode) {
        this.coasCode = coasCode;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withCreateJfteInd(String createJfteInd) {
        this.createJfteInd = createJfteInd;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withOrgnCode(String orgnCode) {
        this.orgnCode = orgnCode;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withPtotAvail(Double ptotAvail) {
        this.ptotAvail = ptotAvail;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withApptPct(Double apptPct) {
        this.apptPct = apptPct;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withBaseUnits(Double baseUnits) {
        this.baseUnits = baseUnits;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withBudgBasis(Double budgBasis) {
        this.budgBasis = budgBasis;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withExpend(Double expend) {
        this.expend = expend;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withFiscCode(String fiscCode) {
        this.fiscCode = fiscCode;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withFte(Double fte) {
        this.fte = fte;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withAnnBasis(Double annBasis) {
        this.annBasis = annBasis;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withEffectiveDate(Date effectiveDate) {
        this.effectiveDate = effectiveDate;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withBudget(Double budget) {
        this.budget = budget;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public PositionBudgetComments100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PositionBudgetComments100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("obudCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PositionBudgetComments100PutResponse) == false) {
            return false;
        }
        PositionBudgetComments100PutResponse rhs = ((PositionBudgetComments100PutResponse) other);
