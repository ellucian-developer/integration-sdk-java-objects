...
public class ScheduleDetailsContractAndBlockScheduleInformation100QapiPost {
    ...
    public ScheduleDetailsContractAndBlockScheduleInformation100QapiPost withSsasectTermCode(String ssasectTermCode) {
        this.ssasectTermCode = ssasectTermCode;
        return this;
    }
    ...
    public ScheduleDetailsContractAndBlockScheduleInformation100QapiPost withSsasectCrn(String ssasectCrn) {
        this.ssasectCrn = ssasectCrn;
        return this;
    }
    ...
    public ScheduleDetailsContractAndBlockScheduleInformation100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ScheduleDetailsContractAndBlockScheduleInformation100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ScheduleDetailsContractAndBlockScheduleInformation100QapiPost) == false) {
            return false;
        }
        ScheduleDetailsContractAndBlockScheduleInformation100QapiPost rhs = ((ScheduleDetailsContractAndBlockScheduleInformation100QapiPost) other);
