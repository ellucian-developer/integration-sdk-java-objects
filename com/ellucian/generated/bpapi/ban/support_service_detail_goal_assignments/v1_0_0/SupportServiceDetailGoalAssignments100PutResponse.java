...
public class SupportServiceDetailGoalAssignments100PutResponse {
    ...
    public SupportServiceDetailGoalAssignments100PutResponse withGoalDescription(String goalDescription) {
        this.goalDescription = goalDescription;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PutResponse withGoalCode(String goalCode) {
        this.goalCode = goalCode;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PutResponse withSsgpCode(String ssgpCode) {
        this.ssgpCode = ssgpCode;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PutResponse withTreqCode(String treqCode) {
        this.treqCode = treqCode;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PutResponse withActualDate(Date actualDate) {
        this.actualDate = actualDate;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PutResponse withEndcopy(String endcopy) {
        this.endcopy = endcopy;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PutResponse withPriorityNbr(Double priorityNbr) {
        this.priorityNbr = priorityNbr;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PutResponse withSsrsCode(String ssrsCode) {
        this.ssrsCode = ssrsCode;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PutResponse withEstimateDate(Date estimateDate) {
        this.estimateDate = estimateDate;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PutResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SupportServiceDetailGoalAssignments100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SupportServiceDetailGoalAssignments100PutResponse) == false) {
            return false;
        }
        SupportServiceDetailGoalAssignments100PutResponse rhs = ((SupportServiceDetailGoalAssignments100PutResponse) other);
