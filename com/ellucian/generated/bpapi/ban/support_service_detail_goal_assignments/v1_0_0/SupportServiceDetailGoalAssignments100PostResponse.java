...
public class SupportServiceDetailGoalAssignments100PostResponse {
    ...
    public SupportServiceDetailGoalAssignments100PostResponse withGoalDescription(String goalDescription) {
        this.goalDescription = goalDescription;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PostResponse withGoalCode(String goalCode) {
        this.goalCode = goalCode;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PostResponse withSsgpCode(String ssgpCode) {
        this.ssgpCode = ssgpCode;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PostResponse withTreqCode(String treqCode) {
        this.treqCode = treqCode;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PostResponse withActualDate(Date actualDate) {
        this.actualDate = actualDate;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PostResponse withEndcopy(String endcopy) {
        this.endcopy = endcopy;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PostResponse withPriorityNbr(Double priorityNbr) {
        this.priorityNbr = priorityNbr;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PostResponse withSsrsCode(String ssrsCode) {
        this.ssrsCode = ssrsCode;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PostResponse withEstimateDate(Date estimateDate) {
        this.estimateDate = estimateDate;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PostResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public SupportServiceDetailGoalAssignments100PostResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SupportServiceDetailGoalAssignments100PostResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SupportServiceDetailGoalAssignments100PostResponse) == false) {
            return false;
        }
        SupportServiceDetailGoalAssignments100PostResponse rhs = ((SupportServiceDetailGoalAssignments100PostResponse) other);
