...
public class Scrrare {
    ...
    public Scrrare withArea(String area) {
        this.area = area;
        return this;
    }
    ...
    public Scrrare withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Scrrare withMaint(String maint) {
        this.maint = maint;
        return this;
    }
    ...
    public Scrrare withAreaDesc(String areaDesc) {
        this.areaDesc = areaDesc;
        return this;
    }
    ...
    public Scrrare withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrare.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("area");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrare) == false) {
            return false;
        }
        Scrrare rhs = ((Scrrare) other);
