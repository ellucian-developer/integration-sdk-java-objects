...
public class CourseSectionInformationCopyCrn100PutResponse {
    ...
    public CourseSectionInformationCopyCrn100PutResponse withKeyBlock(List<KeyBlock> keyBlock) {
        this.keyBlock = keyBlock;
        return this;
    }
    ...
    public CourseSectionInformationCopyCrn100PutResponse withSsbsect(List<Ssbsect> ssbsect) {
        this.ssbsect = ssbsect;
        return this;
    }
    ...
    public CourseSectionInformationCopyCrn100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CourseSectionInformationCopyCrn100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("keyBlock");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseSectionInformationCopyCrn100PutResponse) == false) {
            return false;
        }
        CourseSectionInformationCopyCrn100PutResponse rhs = ((CourseSectionInformationCopyCrn100PutResponse) other);
