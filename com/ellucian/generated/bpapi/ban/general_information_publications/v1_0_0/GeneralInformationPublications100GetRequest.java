...
public class GeneralInformationPublications100GetRequest {
    ...
    public GeneralInformationPublications100GetRequest withSbgiCode(String sbgiCode) {
        this.sbgiCode = sbgiCode;
        return this;
    }
    ...
    public GeneralInformationPublications100GetRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GeneralInformationPublications100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralInformationPublications100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sbgiCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralInformationPublications100GetRequest) == false) {
            return false;
        }
        GeneralInformationPublications100GetRequest rhs = ((GeneralInformationPublications100GetRequest) other);
