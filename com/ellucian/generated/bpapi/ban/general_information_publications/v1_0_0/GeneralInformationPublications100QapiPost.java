...
public class GeneralInformationPublications100QapiPost {
    ...
    public GeneralInformationPublications100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GeneralInformationPublications100QapiPost withSbgiCode(String sbgiCode) {
        this.sbgiCode = sbgiCode;
        return this;
    }
    ...
    public GeneralInformationPublications100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralInformationPublications100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralInformationPublications100QapiPost) == false) {
            return false;
        }
        GeneralInformationPublications100QapiPost rhs = ((GeneralInformationPublications100QapiPost) other);
