...
public class ApplicantMessages100GetResponse {
    ...
    public ApplicantMessages100GetResponse withKeyBlock(List<KeyBlock> keyBlock) {
        this.keyBlock = keyBlock;
        return this;
    }

    @JsonProperty("rormesg")
    public List<Rormesg> getRormesg() {
        return rormesg;
    }

    @JsonProperty("rormesg")
    public void setRormesg(List<Rormesg> rormesg) {
        this.rormesg = rormesg;
    }

    public ApplicantMessages100GetResponse withRormesg(List<Rormesg> rormesg) {
        this.rormesg = rormesg;
        return this;
    }
    ...
    public ApplicantMessages100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ApplicantMessages100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("keyBlock");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ApplicantMessages100GetResponse) == false) {
            return false;
        }
        ApplicantMessages100GetResponse rhs = ((ApplicantMessages100GetResponse) other);
