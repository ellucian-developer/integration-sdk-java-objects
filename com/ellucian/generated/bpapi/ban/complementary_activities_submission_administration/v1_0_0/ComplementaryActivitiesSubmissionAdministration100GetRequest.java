...
public class ComplementaryActivitiesSubmissionAdministration100GetRequest {
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withSequenceNumber(Double sequenceNumber) {
        this.sequenceNumber = sequenceNumber;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withDocSubmitInd(String docSubmitInd) {
        this.docSubmitInd = docSubmitInd;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withStuComment(String stuComment) {
        this.stuComment = stuComment;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withCasvCode(String casvCode) {
        this.casvCode = casvCode;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withActivityCde(String activityCde) {
        this.activityCde = activityCde;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withSubmitDate(Date submitDate) {
        this.submitDate = submitDate;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withCategoryCde(String categoryCde) {
        this.categoryCde = categoryCde;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withApprovedDate(Date approvedDate) {
        this.approvedDate = approvedDate;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withApprovalComment(String approvalComment) {
        this.approvalComment = approvalComment;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withSubmitHrs(Double submitHrs) {
        this.submitHrs = submitHrs;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withApprovedHrs(Double approvedHrs) {
        this.approvedHrs = approvedHrs;
        return this;
    }
    ...
    public ComplementaryActivitiesSubmissionAdministration100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ComplementaryActivitiesSubmissionAdministration100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ComplementaryActivitiesSubmissionAdministration100GetRequest) == false) {
            return false;
        }
        ComplementaryActivitiesSubmissionAdministration100GetRequest rhs = ((ComplementaryActivitiesSubmissionAdministration100GetRequest) other);
