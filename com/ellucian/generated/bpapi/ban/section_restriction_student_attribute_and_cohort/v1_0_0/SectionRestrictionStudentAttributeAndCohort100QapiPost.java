...
public class SectionRestrictionStudentAttributeAndCohort100QapiPost {
    ...
    public SectionRestrictionStudentAttributeAndCohort100QapiPost withSsasectTermCode(String ssasectTermCode) {
        this.ssasectTermCode = ssasectTermCode;
        return this;
    }
    ...
    public SectionRestrictionStudentAttributeAndCohort100QapiPost withSsasectCrn(String ssasectCrn) {
        this.ssasectCrn = ssasectCrn;
        return this;
    }
    ...
    public SectionRestrictionStudentAttributeAndCohort100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SectionRestrictionStudentAttributeAndCohort100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SectionRestrictionStudentAttributeAndCohort100QapiPost) == false) {
            return false;
        }
        SectionRestrictionStudentAttributeAndCohort100QapiPost rhs = ((SectionRestrictionStudentAttributeAndCohort100QapiPost) other);
