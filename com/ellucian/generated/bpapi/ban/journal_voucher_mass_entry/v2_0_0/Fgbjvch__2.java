...
public class Fgbjvch__2 {
    ...
    public Fgbjvch__2 withDefRuclCode(String defRuclCode) {
        this.defRuclCode = defRuclCode;
        return this;
    }
    ...
    public Fgbjvch__2 withEditDeferInd(String editDeferInd) {
        this.editDeferInd = editDeferInd;
        return this;
    }
    ...
    public Fgbjvch__2 withDefDepNum(String defDepNum) {
        this.defDepNum = defDepNum;
        return this;
    }
    ...
    public Fgbjvch__2 withDefTransDesc(String defTransDesc) {
        this.defTransDesc = defTransDesc;
        return this;
    }
    ...
    public Fgbjvch__2 withDefBankCode(String defBankCode) {
        this.defBankCode = defBankCode;
        return this;
    }
    ...
    public Fgbjvch__2 withTransDate(Date transDate) {
        this.transDate = transDate;
        return this;
    }
    ...
    public Fgbjvch__2 withDefBudgetPeriod(String defBudgetPeriod) {
        this.defBudgetPeriod = defBudgetPeriod;
        return this;
    }
    ...
    public Fgbjvch__2 withNsfOnOffInd(String nsfOnOffInd) {
        this.nsfOnOffInd = nsfOnOffInd;
        return this;
    }
    ...
    public Fgbjvch__2 withDefCurrCode(String defCurrCode) {
        this.defCurrCode = defCurrCode;
        return this;
    }
    ...
    public Fgbjvch__2 withDocAmt(Double docAmt) {
        this.docAmt = docAmt;
        return this;
    }
    ...
    public Fgbjvch__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Fgbjvch__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fgbjvch__2) == false) {
            return false;
        }
        Fgbjvch__2 rhs = ((Fgbjvch__2) other);
