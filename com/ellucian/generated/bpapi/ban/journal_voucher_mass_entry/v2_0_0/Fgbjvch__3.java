...
public class Fgbjvch__3 {
    ...
    public Fgbjvch__3 withDefRuclCode(String defRuclCode) {
        this.defRuclCode = defRuclCode;
        return this;
    }
    ...
    public Fgbjvch__3 withEditDeferInd(String editDeferInd) {
        this.editDeferInd = editDeferInd;
        return this;
    }
    ...
    public Fgbjvch__3 withDefDepNum(String defDepNum) {
        this.defDepNum = defDepNum;
        return this;
    }
    ...
    public Fgbjvch__3 withDefTransDesc(String defTransDesc) {
        this.defTransDesc = defTransDesc;
        return this;
    }
    ...
    public Fgbjvch__3 withDefBankCode(String defBankCode) {
        this.defBankCode = defBankCode;
        return this;
    }
    ...
    public Fgbjvch__3 withTransDate(Date transDate) {
        this.transDate = transDate;
        return this;
    }
    ...
    public Fgbjvch__3 withDefBudgetPeriod(String defBudgetPeriod) {
        this.defBudgetPeriod = defBudgetPeriod;
        return this;
    }
    ...
    public Fgbjvch__3 withNsfOnOffInd(String nsfOnOffInd) {
        this.nsfOnOffInd = nsfOnOffInd;
        return this;
    }
    ...
    public Fgbjvch__3 withDefCurrCode(String defCurrCode) {
        this.defCurrCode = defCurrCode;
        return this;
    }
    ...
    public Fgbjvch__3 withDocAmt(Double docAmt) {
        this.docAmt = docAmt;
        return this;
    }
    ...
    public Fgbjvch__3 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Fgbjvch__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fgbjvch__3) == false) {
            return false;
        }
        Fgbjvch__3 rhs = ((Fgbjvch__3) other);
