...
public class Fgbjvch__1 {
    ...
    public Fgbjvch__1 withDefRuclCode(String defRuclCode) {
        this.defRuclCode = defRuclCode;
        return this;
    }
    ...
    public Fgbjvch__1 withEditDeferInd(String editDeferInd) {
        this.editDeferInd = editDeferInd;
        return this;
    }
    ...
    public Fgbjvch__1 withDefDepNum(String defDepNum) {
        this.defDepNum = defDepNum;
        return this;
    }
    ...
    public Fgbjvch__1 withDefTransDesc(String defTransDesc) {
        this.defTransDesc = defTransDesc;
        return this;
    }
    ...
    public Fgbjvch__1 withDefBankCode(String defBankCode) {
        this.defBankCode = defBankCode;
        return this;
    }
    ...
    public Fgbjvch__1 withTransDate(Date transDate) {
        this.transDate = transDate;
        return this;
    }
    ...
    public Fgbjvch__1 withDefBudgetPeriod(String defBudgetPeriod) {
        this.defBudgetPeriod = defBudgetPeriod;
        return this;
    }
    ...
    public Fgbjvch__1 withNsfOnOffInd(String nsfOnOffInd) {
        this.nsfOnOffInd = nsfOnOffInd;
        return this;
    }
    ...
    public Fgbjvch__1 withDefCurrCode(String defCurrCode) {
        this.defCurrCode = defCurrCode;
        return this;
    }
    ...
    public Fgbjvch__1 withDocAmt(Double docAmt) {
        this.docAmt = docAmt;
        return this;
    }
    ...
    public Fgbjvch__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Fgbjvch__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fgbjvch__1) == false) {
            return false;
        }
        Fgbjvch__1 rhs = ((Fgbjvch__1) other);
