...
public class Fgbjvcd__2 {
    ...
    public Fgbjvcd__2 withBankCode(String bankCode) {
        this.bankCode = bankCode;
        return this;
    }
    ...
    public Fgbjvcd__2 withCurrCode(String currCode) {
        this.currCode = currCode;
        return this;
    }
    ...
    public Fgbjvcd__2 withPrjdCode(String prjdCode) {
        this.prjdCode = prjdCode;
        return this;
    }
    ...
    public Fgbjvcd__2 withGiftDate(Date giftDate) {
        this.giftDate = giftDate;
        return this;
    }
    ...
    public Fgbjvcd__2 withSeqNum(Double seqNum) {
        this.seqNum = seqNum;
        return this;
    }
    ...
    public Fgbjvcd__2 withAcciCode(String acciCode) {
        this.acciCode = acciCode;
        return this;
    }
    ...
    public Fgbjvcd__2 withCoasCode(String coasCode) {
        this.coasCode = coasCode;
        return this;
    }
    ...
    public Fgbjvcd__2 withLocnCode(String locnCode) {
        this.locnCode = locnCode;
        return this;
    }
    ...
    public Fgbjvcd__2 withAcctCode(String acctCode) {
        this.acctCode = acctCode;
        return this;
    }
    ...
    public Fgbjvcd__2 withOrgnCode(String orgnCode) {
        this.orgnCode = orgnCode;
        return this;
    }
    ...
    public Fgbjvcd__2 withFundCode(String fundCode) {
        this.fundCode = fundCode;
        return this;
    }
    ...
    public Fgbjvcd__2 withBudgetPeriod(String budgetPeriod) {
        this.budgetPeriod = budgetPeriod;
        return this;
    }
    ...
    public Fgbjvcd__2 withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public Fgbjvcd__2 withTransDesc(String transDesc) {
        this.transDesc = transDesc;
        return this;
    }
    ...
    public Fgbjvcd__2 withAbalOverride(String abalOverride) {
        this.abalOverride = abalOverride;
        return this;
    }
    ...
    public Fgbjvcd__2 withProgCode(String progCode) {
        this.progCode = progCode;
        return this;
    }
    ...
    public Fgbjvcd__2 withTransAmt(Double transAmt) {
        this.transAmt = transAmt;
        return this;
    }
    ...
    public Fgbjvcd__2 withRuclCode(String ruclCode) {
        this.ruclCode = ruclCode;
        return this;
    }
    ...
    public Fgbjvcd__2 withEmcUnits(Double emcUnits) {
        this.emcUnits = emcUnits;
        return this;
    }
    ...
    public Fgbjvcd__2 withActvCode(String actvCode) {
        this.actvCode = actvCode;
        return this;
    }
    ...
    public Fgbjvcd__2 withDistPct(Double distPct) {
        this.distPct = distPct;
        return this;
    }
    ...
    public Fgbjvcd__2 withDrCrInd(String drCrInd) {
        this.drCrInd = drCrInd;
        return this;
    }
    ...
    public Fgbjvcd__2 withDepNum(String depNum) {
        this.depNum = depNum;
        return this;
    }
    ...
    public Fgbjvcd__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Fgbjvcd__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("bankCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fgbjvcd__2) == false) {
            return false;
        }
        Fgbjvcd__2 rhs = ((Fgbjvcd__2) other);
