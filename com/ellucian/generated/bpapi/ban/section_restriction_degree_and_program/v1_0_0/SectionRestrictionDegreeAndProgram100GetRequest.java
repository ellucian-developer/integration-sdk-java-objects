...
public class SectionRestrictionDegreeAndProgram100GetRequest {
    ...
    public SectionRestrictionDegreeAndProgram100GetRequest withSsasectTermCode(String ssasectTermCode) {
        this.ssasectTermCode = ssasectTermCode;
        return this;
    }
    ...
    public SectionRestrictionDegreeAndProgram100GetRequest withSsasectCrn(String ssasectCrn) {
        this.ssasectCrn = ssasectCrn;
        return this;
    }
    ...
    public SectionRestrictionDegreeAndProgram100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SectionRestrictionDegreeAndProgram100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SectionRestrictionDegreeAndProgram100GetRequest) == false) {
            return false;
        }
        SectionRestrictionDegreeAndProgram100GetRequest rhs = ((SectionRestrictionDegreeAndProgram100GetRequest) other);
