...
public class SectionRestrictionDegreeAndProgram100QapiPost {
    ...
    public SectionRestrictionDegreeAndProgram100QapiPost withSsasectTermCode(String ssasectTermCode) {
        this.ssasectTermCode = ssasectTermCode;
        return this;
    }
    ...
    public SectionRestrictionDegreeAndProgram100QapiPost withSsasectCrn(String ssasectCrn) {
        this.ssasectCrn = ssasectCrn;
        return this;
    }
    ...
    public SectionRestrictionDegreeAndProgram100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SectionRestrictionDegreeAndProgram100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SectionRestrictionDegreeAndProgram100QapiPost) == false) {
            return false;
        }
        SectionRestrictionDegreeAndProgram100QapiPost rhs = ((SectionRestrictionDegreeAndProgram100QapiPost) other);
