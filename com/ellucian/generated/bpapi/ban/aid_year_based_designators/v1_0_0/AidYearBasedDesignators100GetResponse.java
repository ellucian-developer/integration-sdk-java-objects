...
public class AidYearBasedDesignators100GetResponse {
    ...
    public AidYearBasedDesignators100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public AidYearBasedDesignators100GetResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public AidYearBasedDesignators100GetResponse withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public AidYearBasedDesignators100GetResponse withShortDesc(String shortDesc) {
        this.shortDesc = shortDesc;
        return this;
    }
    ...
    public AidYearBasedDesignators100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public AidYearBasedDesignators100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AidYearBasedDesignators100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AidYearBasedDesignators100GetResponse) == false) {
            return false;
        }
        AidYearBasedDesignators100GetResponse rhs = ((AidYearBasedDesignators100GetResponse) other);
