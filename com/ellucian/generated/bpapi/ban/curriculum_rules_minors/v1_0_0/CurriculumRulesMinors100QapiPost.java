...
public class CurriculumRulesMinors100QapiPost {
    ...
    public CurriculumRulesMinors100QapiPost withTermCode(String termCode) {
        this.termCode = termCode;
        return this;
    }
    ...
    public CurriculumRulesMinors100QapiPost withCurrRule(String currRule) {
        this.currRule = currRule;
        return this;
    }
    ...
    public CurriculumRulesMinors100QapiPost withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public CurriculumRulesMinors100QapiPost withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public CurriculumRulesMinors100QapiPost withCampCode(String campCode) {
        this.campCode = campCode;
        return this;
    }
    ...
    public CurriculumRulesMinors100QapiPost withTermCodeInit(String termCodeInit) {
        this.termCodeInit = termCodeInit;
        return this;
    }
    ...
    public CurriculumRulesMinors100QapiPost withCollCode(String collCode) {
        this.collCode = collCode;
        return this;
    }
    ...
    public CurriculumRulesMinors100QapiPost withDegcCode(String degcCode) {
        this.degcCode = degcCode;
        return this;
    }
    ...
    public CurriculumRulesMinors100QapiPost withPrimRollInd(String primRollInd) {
        this.primRollInd = primRollInd;
        return this;
    }
    ...
    public CurriculumRulesMinors100QapiPost withSecdRollInd(String secdRollInd) {
        this.secdRollInd = secdRollInd;
        return this;
    }
    ...
    public CurriculumRulesMinors100QapiPost withLockInd(String lockInd) {
        this.lockInd = lockInd;
        return this;
    }
    ...
    public CurriculumRulesMinors100QapiPost withStudyPathInd(String studyPathInd) {
        this.studyPathInd = studyPathInd;
        return this;
    }
    ...
    public CurriculumRulesMinors100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CurriculumRulesMinors100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("termCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CurriculumRulesMinors100QapiPost) == false) {
            return false;
        }
        CurriculumRulesMinors100QapiPost rhs = ((CurriculumRulesMinors100QapiPost) other);
