...
public class WebVariableCodes100GetRequest {
    ...
    public WebVariableCodes100GetRequest withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public WebVariableCodes100GetRequest withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public WebVariableCodes100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(WebVariableCodes100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("code");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WebVariableCodes100GetRequest) == false) {
            return false;
        }
        WebVariableCodes100GetRequest rhs = ((WebVariableCodes100GetRequest) other);
