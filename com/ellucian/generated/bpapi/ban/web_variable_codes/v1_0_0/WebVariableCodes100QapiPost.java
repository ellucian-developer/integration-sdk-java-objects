...
public class WebVariableCodes100QapiPost {
    ...
    public WebVariableCodes100QapiPost withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public WebVariableCodes100QapiPost withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public WebVariableCodes100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(WebVariableCodes100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("code");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WebVariableCodes100QapiPost) == false) {
            return false;
        }
        WebVariableCodes100QapiPost rhs = ((WebVariableCodes100QapiPost) other);
