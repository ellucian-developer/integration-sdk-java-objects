...
public class CurriculaSummaryTransferCourses100QapiPost {
    ...
    public CurriculaSummaryTransferCourses100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CurriculaSummaryTransferCourses100QapiPost withDgmrSeqNo(String dgmrSeqNo) {
        this.dgmrSeqNo = dgmrSeqNo;
        return this;
    }
    ...
    public CurriculaSummaryTransferCourses100QapiPost withViewCurrent(String viewCurrent) {
        this.viewCurrent = viewCurrent;
        return this;
    }
    ...
    public CurriculaSummaryTransferCourses100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CurriculaSummaryTransferCourses100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CurriculaSummaryTransferCourses100QapiPost) == false) {
            return false;
        }
        CurriculaSummaryTransferCourses100QapiPost rhs = ((CurriculaSummaryTransferCourses100QapiPost) other);
