...
public class Sorextn__1 {
    ...
    public Sorextn__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sorextn__1 withExtensionFeeAmt(Double extensionFeeAmt) {
        this.extensionFeeAmt = extensionFeeAmt;
        return this;
    }
    ...
    public Sorextn__1 withDetlCode(String detlCode) {
        this.detlCode = detlCode;
        return this;
    }
    ...
    public Sorextn__1 withExtensionPct(Double extensionPct) {
        this.extensionPct = extensionPct;
        return this;
    }
    ...
    public Sorextn__1 withFtypCode(String ftypCode) {
        this.ftypCode = ftypCode;
        return this;
    }
    ...
    public Sorextn__1 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sorextn__1 withOverrideInd(String overrideInd) {
        this.overrideInd = overrideInd;
        return this;
    }
    ...
    public Sorextn__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorextn__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorextn__1) == false) {
            return false;
        }
        Sorextn__1 rhs = ((Sorextn__1) other);
