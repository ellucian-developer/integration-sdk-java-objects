...
public class Sorrfnd__1 {
    ...
    public Sorrfnd__1 withTuitionRefundPct(Double tuitionRefundPct) {
        this.tuitionRefundPct = tuitionRefundPct;
        return this;
    }
    ...
    public Sorrfnd__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sorrfnd__1 withExtensionRefundPct(Double extensionRefundPct) {
        this.extensionRefundPct = extensionRefundPct;
        return this;
    }
    ...
    public Sorrfnd__1 withFeeRefundPct(Double feeRefundPct) {
        this.feeRefundPct = feeRefundPct;
        return this;
    }
    ...
    public Sorrfnd__1 withRefundPctComplete(Double refundPctComplete) {
        this.refundPctComplete = refundPctComplete;
        return this;
    }
    ...
    public Sorrfnd__1 withOverrideInd(String overrideInd) {
        this.overrideInd = overrideInd;
        return this;
    }
    ...
    public Sorrfnd__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorrfnd__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorrfnd__1) == false) {
            return false;
        }
        Sorrfnd__1 rhs = ((Sorrfnd__1) other);
