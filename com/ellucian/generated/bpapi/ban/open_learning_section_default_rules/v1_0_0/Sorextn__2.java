...
public class Sorextn__2 {
    ...
    public Sorextn__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sorextn__2 withExtensionFeeAmt(Double extensionFeeAmt) {
        this.extensionFeeAmt = extensionFeeAmt;
        return this;
    }
    ...
    public Sorextn__2 withDetlCode(String detlCode) {
        this.detlCode = detlCode;
        return this;
    }
    ...
    public Sorextn__2 withExtensionPct(Double extensionPct) {
        this.extensionPct = extensionPct;
        return this;
    }
    ...
    public Sorextn__2 withFtypCode(String ftypCode) {
        this.ftypCode = ftypCode;
        return this;
    }
    ...
    public Sorextn__2 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sorextn__2 withOverrideInd(String overrideInd) {
        this.overrideInd = overrideInd;
        return this;
    }
    ...
    public Sorextn__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorextn__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorextn__2) == false) {
            return false;
        }
        Sorextn__2 rhs = ((Sorextn__2) other);
