...
public class Sorrst__2 {
    ...
    public Sorrst__2 withRstsEnterableInd(String rstsEnterableInd) {
        this.rstsEnterableInd = rstsEnterableInd;
        return this;
    }
    ...
    public Sorrst__2 withUsageCutoffPctFrom(Double usageCutoffPctFrom) {
        this.usageCutoffPctFrom = usageCutoffPctFrom;
        return this;
    }
    ...
    public Sorrst__2 withRstsExtensionInd(String rstsExtensionInd) {
        this.rstsExtensionInd = rstsExtensionInd;
        return this;
    }
    ...
    public Sorrst__2 withRstsWithdrawInd(String rstsWithdrawInd) {
        this.rstsWithdrawInd = rstsWithdrawInd;
        return this;
    }
    ...
    public Sorrst__2 withRstsInclSectEnrl(String rstsInclSectEnrl) {
        this.rstsInclSectEnrl = rstsInclSectEnrl;
        return this;
    }
    ...
    public Sorrst__2 withUsageCutoffPctTo(Double usageCutoffPctTo) {
        this.usageCutoffPctTo = usageCutoffPctTo;
        return this;
    }
    ...
    public Sorrst__2 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sorrst__2 withRstsWebInd(String rstsWebInd) {
        this.rstsWebInd = rstsWebInd;
        return this;
    }
    ...
    public Sorrst__2 withRstsSbPrintInd(String rstsSbPrintInd) {
        this.rstsSbPrintInd = rstsSbPrintInd;
        return this;
    }
    ...
    public Sorrst__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sorrst__2 withRstsCode(String rstsCode) {
        this.rstsCode = rstsCode;
        return this;
    }
    ...
    public Sorrst__2 withRstsVoiceType(String rstsVoiceType) {
        this.rstsVoiceType = rstsVoiceType;
        return this;
    }
    ...
    public Sorrst__2 withEffByStuStatInd(String effByStuStatInd) {
        this.effByStuStatInd = effByStuStatInd;
        return this;
    }
    ...
    public Sorrst__2 withRstsDescription(String rstsDescription) {
        this.rstsDescription = rstsDescription;
        return this;
    }
    ...
    public Sorrst__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorrst__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorrst__2) == false) {
            return false;
        }
        Sorrst__2 rhs = ((Sorrst__2) other);
