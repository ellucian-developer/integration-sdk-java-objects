...
public class ScheduleDetailsDegreeProgramAttributes100QapiPost {
    ...
    public ScheduleDetailsDegreeProgramAttributes100QapiPost withSsasectTermCode(String ssasectTermCode) {
        this.ssasectTermCode = ssasectTermCode;
        return this;
    }
    ...
    public ScheduleDetailsDegreeProgramAttributes100QapiPost withSsasectCrn(String ssasectCrn) {
        this.ssasectCrn = ssasectCrn;
        return this;
    }
    ...
    public ScheduleDetailsDegreeProgramAttributes100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ScheduleDetailsDegreeProgramAttributes100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ScheduleDetailsDegreeProgramAttributes100QapiPost) == false) {
            return false;
        }
        ScheduleDetailsDegreeProgramAttributes100QapiPost rhs = ((ScheduleDetailsDegreeProgramAttributes100QapiPost) other);
