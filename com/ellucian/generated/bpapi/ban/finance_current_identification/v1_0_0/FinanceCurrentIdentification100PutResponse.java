...
public class FinanceCurrentIdentification100PutResponse {
    ...
    public FinanceCurrentIdentification100PutResponse withSpridenCurrent(List<SpridenCurrent__1> spridenCurrent) {
        this.spridenCurrent = spridenCurrent;
        return this;
    }
    ...
    public FinanceCurrentIdentification100PutResponse withSpridenPrevious(List<SpridenPreviou__1> spridenPrevious) {
        this.spridenPrevious = spridenPrevious;
        return this;
    }
    ...
    public FinanceCurrentIdentification100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(FinanceCurrentIdentification100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FinanceCurrentIdentification100PutResponse) == false) {
            return false;
        }
        FinanceCurrentIdentification100PutResponse rhs = ((FinanceCurrentIdentification100PutResponse) other);
