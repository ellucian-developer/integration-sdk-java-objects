...
public class Ssbxlst__1 {
    ...
    public Ssbxlst__1 withSeatsAvail(Double seatsAvail) {
        this.seatsAvail = seatsAvail;
        return this;
    }
    ...
    public Ssbxlst__1 withEnrl(Double enrl) {
        this.enrl = enrl;
        return this;
    }
    ...
    public Ssbxlst__1 withMaxEnrl(Double maxEnrl) {
        this.maxEnrl = maxEnrl;
        return this;
    }
    ...
    public Ssbxlst__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssbxlst__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssbxlst__1) == false) {
            return false;
        }
        Ssbxlst__1 rhs = ((Ssbxlst__1) other);
