...
public class Ssbxlst__2 {
    ...
    public Ssbxlst__2 withSeatsAvail(Double seatsAvail) {
        this.seatsAvail = seatsAvail;
        return this;
    }
    ...
    public Ssbxlst__2 withEnrl(Double enrl) {
        this.enrl = enrl;
        return this;
    }
    ...
    public Ssbxlst__2 withMaxEnrl(Double maxEnrl) {
        this.maxEnrl = maxEnrl;
        return this;
    }
    ...
    public Ssbxlst__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssbxlst__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssbxlst__2) == false) {
            return false;
        }
        Ssbxlst__2 rhs = ((Ssbxlst__2) other);
