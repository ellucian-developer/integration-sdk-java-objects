...
public class Fprpoda {
     ...
     * 
     */
    @JsonProperty("displayActgNetAmt")
    private Double displayActgNetAmt;
    @JsonIgnore
    ...
    public Fprpoda withAddlChrgAmt(Double addlChrgAmt) {
        this.addlChrgAmt = addlChrgAmt;
        return this;
    }
    ...
    public Fprpoda withAddlPct(String addlPct) {
        this.addlPct = addlPct;
        return this;
    }
    ...
    public Fprpoda withProjCode(String projCode) {
        this.projCode = projCode;
        return this;
    }
    ...
    public Fprpoda withDiscountPct(String discountPct) {
        this.discountPct = discountPct;
        return this;
    }
    ...
    public Fprpoda withNsfSuspInd(String nsfSuspInd) {
        this.nsfSuspInd = nsfSuspInd;
        return this;
    }
    ...
    public Fprpoda withSeqNum(Double seqNum) {
        this.seqNum = seqNum;
        return this;
    }
    ...
    public Fprpoda withApprovedPct(String approvedPct) {
        this.approvedPct = approvedPct;
        return this;
    }
    ...
    public Fprpoda withAcciCode(String acciCode) {
        this.acciCode = acciCode;
        return this;
    }
    ...
    public Fprpoda withAmt(Double amt) {
        this.amt = amt;
        return this;
    }
    ...
    public Fprpoda withCoasCode(String coasCode) {
        this.coasCode = coasCode;
        return this;
    }
    ...
    public Fprpoda withLocnCode(String locnCode) {
        this.locnCode = locnCode;
        return this;
    }
    ...
    public Fprpoda withAcctCode(String acctCode) {
        this.acctCode = acctCode;
        return this;
    }
    ...
    public Fprpoda withDiscAmt(Double discAmt) {
        this.discAmt = discAmt;
        return this;
    }
    ...
    public Fprpoda withOrgnCode(String orgnCode) {
        this.orgnCode = orgnCode;
        return this;
    }
    ...
    public Fprpoda withNsfOverrideInd(String nsfOverrideInd) {
        this.nsfOverrideInd = nsfOverrideInd;
        return this;
    }
    ...
    public Fprpoda withFundCode(String fundCode) {
        this.fundCode = fundCode;
        return this;
    }
    ...
    public Fprpoda withFsyrCode(String fsyrCode) {
        this.fsyrCode = fsyrCode;
        return this;
    }
    ...
    public Fprpoda withTaxPct(String taxPct) {
        this.taxPct = taxPct;
        return this;
    }
    ...
    public Fprpoda withProgCode(String progCode) {
        this.progCode = progCode;
        return this;
    }
    ...
    public Fprpoda withActvCode(String actvCode) {
        this.actvCode = actvCode;
        return this;
    }
    ...
    public Fprpoda withTaxAmt(Double taxAmt) {
        this.taxAmt = taxAmt;
        return this;
    }
     ...
     */
    @JsonProperty("displayActgNetAmt")
    public Double getDisplayActgNetAmt() {
        return displayActgNetAmt;
    }
     ...
     */
    @JsonProperty("displayActgNetAmt")
    public void setDisplayActgNetAmt(Double displayActgNetAmt) {
        this.displayActgNetAmt = displayActgNetAmt;
    }

    public Fprpoda withDisplayActgNetAmt(Double displayActgNetAmt) {
        this.displayActgNetAmt = displayActgNetAmt;
        return this;
    }
    ...
    public Fprpoda withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Fprpoda.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        ...
        sb.append(',');
        sb.append("displayActgNetAmt");
        sb.append('=');
        sb.append(((this.displayActgNetAmt == null)?"<null>":this.displayActgNetAmt));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.displayActgNetAmt == null)? 0 :this.displayActgNetAmt.hashCode()));
        return result;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fprpoda) == false) {
            return false;
        }
        Fprpoda rhs = ((Fprpoda) other);
        return ((((((((((((((((((((((((this.addlChrgAmt == rhs.addlChrgAmt)||((this.addlChrgAmt!= null)&&this.addlChrgAmt.equals(rhs.addlChrgAmt)))&&((this.addlPct == rhs.addlPct)||((this.addlPct!= null)&&this.addlPct.equals(rhs.addlPct))))&&((this.projCode == rhs.projCode)||((this.projCode!= null)&&this.projCode.equals(rhs.projCode))))&&((this.discountPct == rhs.discountPct)||((this.discountPct!= null)&&this.discountPct.equals(rhs.discountPct))))&&((this.nsfSuspInd == rhs.nsfSuspInd)||((this.nsfSuspInd!= null)&&this.nsfSuspInd.equals(rhs.nsfSuspInd))))&&((this.seqNum == rhs.seqNum)||((this.seqNum!= null)&&this.seqNum.equals(rhs.seqNum))))&&((this.approvedPct == rhs.approvedPct)||((this.approvedPct!= null)&&this.approvedPct.equals(rhs.approvedPct))))&&((this.acciCode == rhs.acciCode)||((this.acciCode!= null)&&this.acciCode.equals(rhs.acciCode))))&&((this.amt == rhs.amt)||((this.amt!= null)&&this.amt.equals(rhs.amt))))&&((this.coasCode == rhs.coasCode)||((this.coasCode!= null)&&this.coasCode.equals(rhs.coasCode))))&&((this.locnCode == rhs.locnCode)||((this.locnCode!= null)&&this.locnCode.equals(rhs.locnCode))))&&((this.acctCode == rhs.acctCode)||((this.acctCode!= null)&&this.acctCode.equals(rhs.acctCode))))&&((this.discAmt == rhs.discAmt)||((this.discAmt!= null)&&this.discAmt.equals(rhs.discAmt))))&&((this.orgnCode == rhs.orgnCode)||((this.orgnCode!= null)&&this.orgnCode.equals(rhs.orgnCode))))&&((this.nsfOverrideInd == rhs.nsfOverrideInd)||((this.nsfOverrideInd!= null)&&this.nsfOverrideInd.equals(rhs.nsfOverrideInd))))&&((this.fundCode == rhs.fundCode)||((this.fundCode!= null)&&this.fundCode.equals(rhs.fundCode))))&&((this.fsyrCode == rhs.fsyrCode)||((this.fsyrCode!= null)&&this.fsyrCode.equals(rhs.fsyrCode))))&&((this.taxPct == rhs.taxPct)||((this.taxPct!= null)&&this.taxPct.equals(rhs.taxPct))))&&((this.progCode == rhs.progCode)||((this.progCode!= null)&&this.progCode.equals(rhs.progCode))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.actvCode == rhs.actvCode)||((this.actvCode!= null)&&this.actvCode.equals(rhs.actvCode))))&&((this.taxAmt == rhs.taxAmt)||((this.taxAmt!= null)&&this.taxAmt.equals(rhs.taxAmt))))&&((this.displayActgNetAmt == rhs.displayActgNetAmt)||((this.displayActgNetAmt!= null)&&this.displayActgNetAmt.equals(rhs.displayActgNetAmt))));
    }
