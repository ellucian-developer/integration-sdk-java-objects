...
public class ApplicantMail100PostResponse {
    ...
    public ApplicantMail100PostResponse withModuleCode(String moduleCode) {
        this.moduleCode = moduleCode;
        return this;
    }
    ...
    public ApplicantMail100PostResponse withAidyCode(String aidyCode) {
        this.aidyCode = aidyCode;
        return this;
    }
    ...
    public ApplicantMail100PostResponse withWaitDays(Double waitDays) {
        this.waitDays = waitDays;
        return this;
    }
    ...
    public ApplicantMail100PostResponse withInitCode(String initCode) {
        this.initCode = initCode;
        return this;
    }
    ...
    public ApplicantMail100PostResponse withDatePrinted(Date datePrinted) {
        this.datePrinted = datePrinted;
        return this;
    }
    ...
    public ApplicantMail100PostResponse withDateInit(Date dateInit) {
        this.dateInit = dateInit;
        return this;
    }
    ...
    public ApplicantMail100PostResponse withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public ApplicantMail100PostResponse withLetrCode(String letrCode) {
        this.letrCode = letrCode;
        return this;
    }
    ...
    public ApplicantMail100PostResponse withSystemInd(String systemInd) {
        this.systemInd = systemInd;
        return this;
    }
    ...
    public ApplicantMail100PostResponse withOrigInd(String origInd) {
        this.origInd = origInd;
        return this;
    }
    ...
    public ApplicantMail100PostResponse withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public ApplicantMail100PostResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ApplicantMail100PostResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ApplicantMail100PostResponse) == false) {
            return false;
        }
        ApplicantMail100PostResponse rhs = ((ApplicantMail100PostResponse) other);
