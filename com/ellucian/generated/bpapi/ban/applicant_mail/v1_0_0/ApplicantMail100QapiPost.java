...
public class ApplicantMail100QapiPost {
    ...
    public ApplicantMail100QapiPost withKeyblckAidyCode(String keyblckAidyCode) {
        this.keyblckAidyCode = keyblckAidyCode;
        return this;
    }
    ...
    public ApplicantMail100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ApplicantMail100QapiPost withSystemInd(String systemInd) {
        this.systemInd = systemInd;
        return this;
    }
    ...
    public ApplicantMail100QapiPost withAidyCode(String aidyCode) {
        this.aidyCode = aidyCode;
        return this;
    }
    ...
    public ApplicantMail100QapiPost withModuleCode(String moduleCode) {
        this.moduleCode = moduleCode;
        return this;
    }
    ...
    public ApplicantMail100QapiPost withLetrCode(String letrCode) {
        this.letrCode = letrCode;
        return this;
    }
    ...
    public ApplicantMail100QapiPost withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public ApplicantMail100QapiPost withDateInit(Date dateInit) {
        this.dateInit = dateInit;
        return this;
    }
    ...
    public ApplicantMail100QapiPost withDatePrinted(Date datePrinted) {
        this.datePrinted = datePrinted;
        return this;
    }
    ...
    public ApplicantMail100QapiPost withWaitDays(Double waitDays) {
        this.waitDays = waitDays;
        return this;
    }
    ...
    public ApplicantMail100QapiPost withOrigInd(String origInd) {
        this.origInd = origInd;
        return this;
    }
    ...
    public ApplicantMail100QapiPost withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public ApplicantMail100QapiPost withInitCode(String initCode) {
        this.initCode = initCode;
        return this;
    }
    ...
    public ApplicantMail100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ApplicantMail100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ApplicantMail100QapiPost) == false) {
            return false;
        }
        ApplicantMail100QapiPost rhs = ((ApplicantMail100QapiPost) other);
