...
public class Gurmail {
    ...
    public Gurmail withModuleCode(String moduleCode) {
        this.moduleCode = moduleCode;
        return this;
    }
    ...
    public Gurmail withAidyCode(String aidyCode) {
        this.aidyCode = aidyCode;
        return this;
    }
    ...
    public Gurmail withDatePrinted(Date datePrinted) {
        this.datePrinted = datePrinted;
        return this;
    }
    ...
    public Gurmail withDateInit(Date dateInit) {
        this.dateInit = dateInit;
        return this;
    }
    ...
    public Gurmail withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public Gurmail withSystemInd(String systemInd) {
        this.systemInd = systemInd;
        return this;
    }
    ...
    public Gurmail withOrigInd(String origInd) {
        this.origInd = origInd;
        return this;
    }
    ...
    public Gurmail withUser(String user) {
        this.user = user;
        return this;
    }
