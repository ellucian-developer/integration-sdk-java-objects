...
public class CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse {
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withSeqNo(Double seqNo) {
        this.seqNo = seqNo;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withServiceDate(Date serviceDate) {
        this.serviceDate = serviceDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withSsstDesc(String ssstDesc) {
        this.ssstDesc = ssstDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withSvvosstNoncreditServiceInd(String svvosstNoncreditServiceInd) {
        this.svvosstNoncreditServiceInd = svvosstNoncreditServiceInd;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withOrigDesc(String origDesc) {
        this.origDesc = origDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withSsgpCode(String ssgpCode) {
        this.ssgpCode = ssgpCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withRwname(String rwname) {
        this.rwname = rwname;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withOsstDesc(String osstDesc) {
        this.osstDesc = osstDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withDataOrigin(String dataOrigin) {
        this.dataOrigin = dataOrigin;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withSsgpDesc(String ssgpDesc) {
        this.ssgpDesc = ssgpDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withOsstCode(String osstCode) {
        this.osstCode = osstCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withSsstCode(String ssstCode) {
        this.ssstCode = ssstCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("seqNo");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse) == false) {
            return false;
        }
        CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse rhs = ((CaMisSuccessAndSupportServicesTermDataOrientation100PutResponse) other);
