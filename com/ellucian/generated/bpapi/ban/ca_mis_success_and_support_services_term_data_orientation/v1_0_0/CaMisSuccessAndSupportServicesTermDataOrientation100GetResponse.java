...
public class CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse {
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withSeqNo(Double seqNo) {
        this.seqNo = seqNo;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withServiceDate(Date serviceDate) {
        this.serviceDate = serviceDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withSsstDesc(String ssstDesc) {
        this.ssstDesc = ssstDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withSvvosstNoncreditServiceInd(String svvosstNoncreditServiceInd) {
        this.svvosstNoncreditServiceInd = svvosstNoncreditServiceInd;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withOrigDesc(String origDesc) {
        this.origDesc = origDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withSsgpCode(String ssgpCode) {
        this.ssgpCode = ssgpCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withRwname(String rwname) {
        this.rwname = rwname;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withOsstDesc(String osstDesc) {
        this.osstDesc = osstDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withDataOrigin(String dataOrigin) {
        this.dataOrigin = dataOrigin;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withSsgpDesc(String ssgpDesc) {
        this.ssgpDesc = ssgpDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withOsstCode(String osstCode) {
        this.osstCode = osstCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withSsstCode(String ssstCode) {
        this.ssstCode = ssstCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("seqNo");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse) == false) {
            return false;
        }
        CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse rhs = ((CaMisSuccessAndSupportServicesTermDataOrientation100GetResponse) other);
