...
public class StudentPayment100GetResponse {

    @JsonProperty("account_ctrl")
    private List<AccountCtrl> accountCtrl = new ArrayList<AccountCtrl>();
    ...
    @JsonProperty("account_ctrl")
    public List<AccountCtrl> getAccountCtrl() {
        return accountCtrl;
    }

    @JsonProperty("account_ctrl")
    public void setAccountCtrl(List<AccountCtrl> accountCtrl) {
        this.accountCtrl = accountCtrl;
    }

    public StudentPayment100GetResponse withAccountCtrl(List<AccountCtrl> accountCtrl) {
        this.accountCtrl = accountCtrl;
        return this;
    }
    ...
    public StudentPayment100GetResponse withTbraccd(List<Tbraccd> tbraccd) {
        this.tbraccd = tbraccd;
        return this;
    }
    ...
    public StudentPayment100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StudentPayment100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StudentPayment100GetResponse) == false) {
            return false;
        }
        StudentPayment100GetResponse rhs = ((StudentPayment100GetResponse) other);
