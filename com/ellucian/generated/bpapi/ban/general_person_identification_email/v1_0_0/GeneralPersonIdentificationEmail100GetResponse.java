...
public class GeneralPersonIdentificationEmail100GetResponse {
    ...
    public GeneralPersonIdentificationEmail100GetResponse withEmailAddress(String emailAddress) {
        this.emailAddress = emailAddress;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmail100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmail100GetResponse withEmailDesc(String emailDesc) {
        this.emailDesc = emailDesc;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmail100GetResponse withEmalCode(String emalCode) {
        this.emalCode = emalCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmail100GetResponse withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmail100GetResponse withDispWebInd(String dispWebInd) {
        this.dispWebInd = dispWebInd;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmail100GetResponse withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmail100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmail100GetResponse withPreferredInd(String preferredInd) {
        this.preferredInd = preferredInd;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmail100GetResponse withUrlInd(String urlInd) {
        this.urlInd = urlInd;
        return this;
    }
    ...
    public GeneralPersonIdentificationEmail100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralPersonIdentificationEmail100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralPersonIdentificationEmail100GetResponse) == false) {
            return false;
        }
        GeneralPersonIdentificationEmail100GetResponse rhs = ((GeneralPersonIdentificationEmail100GetResponse) other);
