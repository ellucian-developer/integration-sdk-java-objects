...
public class Tbrcmi {
    ...
    public Tbrcmi withMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public Tbrcmi withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Tbrcmi.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("message");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tbrcmi) == false) {
            return false;
        }
        Tbrcmi rhs = ((Tbrcmi) other);
