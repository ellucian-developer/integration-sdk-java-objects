...
public class Scrprt {
    ...
    public Scrprt withTescCode(String tescCode) {
        this.tescCode = tescCode;
        return this;
    }
    ...
    public Scrprt withConcurrencyCde(String concurrencyCde) {
        this.concurrencyCde = concurrencyCde;
        return this;
    }
    ...
    public Scrprt withCrseNumbPreq(String crseNumbPreq) {
        this.crseNumbPreq = crseNumbPreq;
        return this;
    }
    ...
    public Scrprt withConnector(String connector) {
        this.connector = connector;
        return this;
    }
    ...
    public Scrprt withInProgram(String inProgram) {
        this.inProgram = inProgram;
        return this;
    }
    ...
    public Scrprt withSubjCodePreq(String subjCodePreq) {
        this.subjCodePreq = subjCodePreq;
        return this;
    }
    ...
    public Scrprt withRparen(String rparen) {
        this.rparen = rparen;
        return this;
    }
    ...
    public Scrprt withTestScore(String testScore) {
        this.testScore = testScore;
        return this;
    }
    ...
    public Scrprt withMinGrde(String minGrde) {
        this.minGrde = minGrde;
        return this;
    }
    ...
    public Scrprt withLparen(String lparen) {
        this.lparen = lparen;
        return this;
    }
    ...
    public Scrprt withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public Scrprt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrprt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tescCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrprt) == false) {
            return false;
        }
        Scrprt rhs = ((Scrprt) other);
