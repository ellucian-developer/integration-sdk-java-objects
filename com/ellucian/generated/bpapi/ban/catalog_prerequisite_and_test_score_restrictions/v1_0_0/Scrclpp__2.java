...
public class Scrclpp__2 {
    ...
    public Scrclpp__2 withCrseNumb(String crseNumb) {
        this.crseNumb = crseNumb;
        return this;
    }
    ...
    public Scrclpp__2 withPrereqChkMethodCde(String prereqChkMethodCde) {
        this.prereqChkMethodCde = prereqChkMethodCde;
        return this;
    }
    ...
    public Scrclpp__2 withInProgram(String inProgram) {
        this.inProgram = inProgram;
        return this;
    }
    ...
    public Scrclpp__2 withSubjCode(String subjCode) {
        this.subjCode = subjCode;
        return this;
    }
    ...
    public Scrclpp__2 withSubjDescription(String subjDescription) {
        this.subjDescription = subjDescription;
        return this;
    }
    ...
    public Scrclpp__2 withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public Scrclpp__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrclpp__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("crseNumb");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrclpp__2) == false) {
            return false;
        }
        Scrclpp__2 rhs = ((Scrclpp__2) other);
