...
public class Telephone100GetRequest {
    ...
    public Telephone100GetRequest withPhoneExt(String phoneExt) {
        this.phoneExt = phoneExt;
        return this;
    }
    ...
    public Telephone100GetRequest withUnlistInd(String unlistInd) {
        this.unlistInd = unlistInd;
        return this;
    }
    ...
    public Telephone100GetRequest withCtryCodePhone(String ctryCodePhone) {
        this.ctryCodePhone = ctryCodePhone;
        return this;
    }
    ...
    public Telephone100GetRequest withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Telephone100GetRequest withTeleCode(String teleCode) {
        this.teleCode = teleCode;
        return this;
    }
    ...
    public Telephone100GetRequest withPhoneNumber(String phoneNumber) {
        this.phoneNumber = phoneNumber;
        return this;
    }
    ...
    public Telephone100GetRequest withAddrSeqno(Double addrSeqno) {
        this.addrSeqno = addrSeqno;
        return this;
    }
    ...
    public Telephone100GetRequest withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Telephone100GetRequest withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public Telephone100GetRequest withPhoneArea(String phoneArea) {
        this.phoneArea = phoneArea;
        return this;
    }
    ...
    public Telephone100GetRequest withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public Telephone100GetRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public Telephone100GetRequest withIntlAccess(String intlAccess) {
        this.intlAccess = intlAccess;
        return this;
    }
    ...
    public Telephone100GetRequest withAtypCode(String atypCode) {
        this.atypCode = atypCode;
        return this;
    }
    ...
    public Telephone100GetRequest withPrimaryInd(String primaryInd) {
        this.primaryInd = primaryInd;
        return this;
    }
    ...
    public Telephone100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Telephone100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("phoneExt");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Telephone100GetRequest) == false) {
            return false;
        }
        Telephone100GetRequest rhs = ((Telephone100GetRequest) other);
