...
public class EmployeeJobsJobLaborDistribution100QapiPost {
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withPosn(String posn) {
        this.posn = posn;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withSuff(String suff) {
        this.suff = suff;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withQueryDate(String queryDate) {
        this.queryDate = queryDate;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withCoasCode(String coasCode) {
        this.coasCode = coasCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withAcciCode(String acciCode) {
        this.acciCode = acciCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withFundCode(String fundCode) {
        this.fundCode = fundCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withOrgnCode(String orgnCode) {
        this.orgnCode = orgnCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withAcctCode(String acctCode) {
        this.acctCode = acctCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withProgCode(String progCode) {
        this.progCode = progCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withActvCode(String actvCode) {
        this.actvCode = actvCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withLocnCode(String locnCode) {
        this.locnCode = locnCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withProjCode(String projCode) {
        this.projCode = projCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withCtypCode(String ctypCode) {
        this.ctypCode = ctypCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withAcctCodeExternal(String acctCodeExternal) {
        this.acctCodeExternal = acctCodeExternal;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withPercent(Double percent) {
        this.percent = percent;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withEncOverrideEndDate(Date encOverrideEndDate) {
        this.encOverrideEndDate = encOverrideEndDate;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EmployeeJobsJobLaborDistribution100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EmployeeJobsJobLaborDistribution100QapiPost) == false) {
            return false;
        }
        EmployeeJobsJobLaborDistribution100QapiPost rhs = ((EmployeeJobsJobLaborDistribution100QapiPost) other);
