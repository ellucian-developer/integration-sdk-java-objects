...
public class EmployeeJobsJobLaborDistribution100GetResponse {
    ...
    public EmployeeJobsJobLaborDistribution100GetResponse withEncOverrideEndDate(Date encOverrideEndDate) {
        this.encOverrideEndDate = encOverrideEndDate;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100GetResponse withProjCode(String projCode) {
        this.projCode = projCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100GetResponse withAcctCodeExternal(String acctCodeExternal) {
        this.acctCodeExternal = acctCodeExternal;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100GetResponse withAcciCode(String acciCode) {
        this.acciCode = acciCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100GetResponse withCoasCode(String coasCode) {
        this.coasCode = coasCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100GetResponse withLocnCode(String locnCode) {
        this.locnCode = locnCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100GetResponse withAcctCode(String acctCode) {
        this.acctCode = acctCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100GetResponse withOrgnCode(String orgnCode) {
        this.orgnCode = orgnCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100GetResponse withPercent(Double percent) {
        this.percent = percent;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100GetResponse withFundCode(String fundCode) {
        this.fundCode = fundCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100GetResponse withProgCode(String progCode) {
        this.progCode = progCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100GetResponse withCtypCode(String ctypCode) {
        this.ctypCode = ctypCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100GetResponse withActvCode(String actvCode) {
        this.actvCode = actvCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EmployeeJobsJobLaborDistribution100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EmployeeJobsJobLaborDistribution100GetResponse) == false) {
            return false;
        }
        EmployeeJobsJobLaborDistribution100GetResponse rhs = ((EmployeeJobsJobLaborDistribution100GetResponse) other);
