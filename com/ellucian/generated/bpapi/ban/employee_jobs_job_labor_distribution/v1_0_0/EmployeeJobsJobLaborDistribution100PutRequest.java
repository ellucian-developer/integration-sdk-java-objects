...
public class EmployeeJobsJobLaborDistribution100PutRequest {
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withCriteriaFundCode(String criteriaFundCode) {
        this.criteriaFundCode = criteriaFundCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withCriteriaAcctCode(String criteriaAcctCode) {
        this.criteriaAcctCode = criteriaAcctCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withCriteriaLocnCode(String criteriaLocnCode) {
        this.criteriaLocnCode = criteriaLocnCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withCriteriaActvCode(String criteriaActvCode) {
        this.criteriaActvCode = criteriaActvCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withCriteriaProgCode(String criteriaProgCode) {
        this.criteriaProgCode = criteriaProgCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withCriteriaCtypCode(String criteriaCtypCode) {
        this.criteriaCtypCode = criteriaCtypCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withCriteriaAcctCodeExternal(String criteriaAcctCodeExternal) {
        this.criteriaAcctCodeExternal = criteriaAcctCodeExternal;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withOrgnCode(String orgnCode) {
        this.orgnCode = orgnCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withAcctCode(String acctCode) {
        this.acctCode = acctCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withPercent(Double percent) {
        this.percent = percent;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withPosn(Object posn) {
        this.posn = posn;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withQueryDate(Object queryDate) {
        this.queryDate = queryDate;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withSuff(Object suff) {
        this.suff = suff;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withCriteriaAcciCode(String criteriaAcciCode) {
        this.criteriaAcciCode = criteriaAcciCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withFundCode(String fundCode) {
        this.fundCode = fundCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withCriteriaPercent(Double criteriaPercent) {
        this.criteriaPercent = criteriaPercent;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withCriteriaCoasCode(String criteriaCoasCode) {
        this.criteriaCoasCode = criteriaCoasCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withId(Object id) {
        this.id = id;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withCriteriaEncOverrideEndDate(Date criteriaEncOverrideEndDate) {
        this.criteriaEncOverrideEndDate = criteriaEncOverrideEndDate;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withCriteriaOrgnCode(String criteriaOrgnCode) {
        this.criteriaOrgnCode = criteriaOrgnCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withCriteriaProjCode(String criteriaProjCode) {
        this.criteriaProjCode = criteriaProjCode;
        return this;
    }
    ...
    public EmployeeJobsJobLaborDistribution100PutRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EmployeeJobsJobLaborDistribution100PutRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EmployeeJobsJobLaborDistribution100PutRequest) == false) {
            return false;
        }
        EmployeeJobsJobLaborDistribution100PutRequest rhs = ((EmployeeJobsJobLaborDistribution100PutRequest) other);
        return (((((((((((((((((((((((this.criteriaFundCode == rhs.criteriaFundCode)||((this.criteriaFundCode!= null)&&this.criteriaFundCode.equals(rhs.criteriaFundCode)))&&((this.criteriaLocnCode == rhs.criteriaLocnCode)||((this.criteriaLocnCode!= null)&&this.criteriaLocnCode.equals(rhs.criteriaLocnCode))))&&((this.criteriaCtypCode == rhs.criteriaCtypCode)||((this.criteriaCtypCode!= null)&&this.criteriaCtypCode.equals(rhs.criteriaCtypCode))))&&((this.criteriaActvCode == rhs.criteriaActvCode)||((this.criteriaActvCode!= null)&&this.criteriaActvCode.equals(rhs.criteriaActvCode))))&&((this.criteriaCoasCode == rhs.criteriaCoasCode)||((this.criteriaCoasCode!= null)&&this.criteriaCoasCode.equals(rhs.criteriaCoasCode))))&&((this.criteriaAcctCode == rhs.criteriaAcctCode)||((this.criteriaAcctCode!= null)&&this.criteriaAcctCode.equals(rhs.criteriaAcctCode))))&&((this.criteriaAcciCode == rhs.criteriaAcciCode)||((this.criteriaAcciCode!= null)&&this.criteriaAcciCode.equals(rhs.criteriaAcciCode))))&&((this.criteriaPercent == rhs.criteriaPercent)||((this.criteriaPercent!= null)&&this.criteriaPercent.equals(rhs.criteriaPercent))))&&((this.orgnCode == rhs.orgnCode)||((this.orgnCode!= null)&&this.orgnCode.equals(rhs.orgnCode))))&&((this.acctCode == rhs.acctCode)||((this.acctCode!= null)&&this.acctCode.equals(rhs.acctCode))))&&((this.percent == rhs.percent)||((this.percent!= null)&&this.percent.equals(rhs.percent))))&&((this.posn == rhs.posn)||((this.posn!= null)&&this.posn.equals(rhs.posn))))&&((this.criteriaProgCode == rhs.criteriaProgCode)||((this.criteriaProgCode!= null)&&this.criteriaProgCode.equals(rhs.criteriaProgCode))))&&((this.criteriaAcctCodeExternal == rhs.criteriaAcctCodeExternal)||((this.criteriaAcctCodeExternal!= null)&&this.criteriaAcctCodeExternal.equals(rhs.criteriaAcctCodeExternal))))&&((this.criteriaOrgnCode == rhs.criteriaOrgnCode)||((this.criteriaOrgnCode!= null)&&this.criteriaOrgnCode.equals(rhs.criteriaOrgnCode))))&&((this.queryDate == rhs.queryDate)||((this.queryDate!= null)&&this.queryDate.equals(rhs.queryDate))))&&((this.suff == rhs.suff)||((this.suff!= null)&&this.suff.equals(rhs.suff))))&&((this.fundCode == rhs.fundCode)||((this.fundCode!= null)&&this.fundCode.equals(rhs.fundCode))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.criteriaEncOverrideEndDate == rhs.criteriaEncOverrideEndDate)||((this.criteriaEncOverrideEndDate!= null)&&this.criteriaEncOverrideEndDate.equals(rhs.criteriaEncOverrideEndDate))))&&((this.criteriaProjCode == rhs.criteriaProjCode)||((this.criteriaProjCode!= null)&&this.criteriaProjCode.equals(rhs.criteriaProjCode))));
    }
