...
public class TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest {
    ...
    public TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest withKeyblckOrigCode(String keyblckOrigCode) {
        this.keyblckOrigCode = keyblckOrigCode;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest withKeyblckLevlCode(String keyblckLevlCode) {
        this.keyblckLevlCode = keyblckLevlCode;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest withKeyblckTermCode(String keyblckTermCode) {
        this.keyblckTermCode = keyblckTermCode;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest withEffectiveDate(Date effectiveDate) {
        this.effectiveDate = effectiveDate;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest withTermCode(String termCode) {
        this.termCode = termCode;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest) == false) {
            return false;
        }
        TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest rhs = ((TranscriptEventsAndCommentsTranscriptCommentsByTerm100GetRequest) other);
