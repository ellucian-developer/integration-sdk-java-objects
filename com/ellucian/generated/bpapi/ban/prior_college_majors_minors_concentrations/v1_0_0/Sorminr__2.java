...
public class Sorminr__2 {
    ...
    public Sorminr__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sorminr__2 withMinorDesc(String minorDesc) {
        this.minorDesc = minorDesc;
        return this;
    }
    ...
    public Sorminr__2 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sorminr__2 withMajrCodeMinor(String majrCodeMinor) {
        this.majrCodeMinor = majrCodeMinor;
        return this;
    }
    ...
    public Sorminr__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorminr__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorminr__2) == false) {
            return false;
        }
        Sorminr__2 rhs = ((Sorminr__2) other);
