...
public class Sorminr__1 {
    ...
    public Sorminr__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sorminr__1 withMinorDesc(String minorDesc) {
        this.minorDesc = minorDesc;
        return this;
    }
    ...
    public Sorminr__1 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sorminr__1 withMajrCodeMinor(String majrCodeMinor) {
        this.majrCodeMinor = majrCodeMinor;
        return this;
    }
    ...
    public Sorminr__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorminr__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorminr__1) == false) {
            return false;
        }
        Sorminr__1 rhs = ((Sorminr__1) other);
