...
public class PriorCollegeMajorsMinorsConcentrations100PostRequest {
    ...
    public PriorCollegeMajorsMinorsConcentrations100PostRequest withMajrCodeConc(String majrCodeConc) {
        this.majrCodeConc = majrCodeConc;
        return this;
    }
    ...
    public PriorCollegeMajorsMinorsConcentrations100PostRequest withMajrCodeMajor(String majrCodeMajor) {
        this.majrCodeMajor = majrCodeMajor;
        return this;
    }
    ...
    public PriorCollegeMajorsMinorsConcentrations100PostRequest withMajrCodeMinor(String majrCodeMinor) {
        this.majrCodeMinor = majrCodeMinor;
        return this;
    }
    ...
    public PriorCollegeMajorsMinorsConcentrations100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PriorCollegeMajorsMinorsConcentrations100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PriorCollegeMajorsMinorsConcentrations100PostRequest) == false) {
            return false;
        }
        PriorCollegeMajorsMinorsConcentrations100PostRequest rhs = ((PriorCollegeMajorsMinorsConcentrations100PostRequest) other);
        return ((((((this.majrCodeConc == rhs.majrCodeConc)||((this.majrCodeConc!= null)&&this.majrCodeConc.equals(rhs.majrCodeConc)))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.majrCodeMajor == rhs.majrCodeMajor)||((this.majrCodeMajor!= null)&&this.majrCodeMajor.equals(rhs.majrCodeMajor))))&&((this.majrCodeMinor == rhs.majrCodeMinor)||((this.majrCodeMinor!= null)&&this.majrCodeMinor.equals(rhs.majrCodeMinor))));
    }
