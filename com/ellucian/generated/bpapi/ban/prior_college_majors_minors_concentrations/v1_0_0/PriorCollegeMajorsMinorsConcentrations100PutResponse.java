...
public class PriorCollegeMajorsMinorsConcentrations100PutResponse {
    ...
    private List<Sorminr__2> sorminr = new ArrayList<Sorminr__2>();
    @JsonIgnore
    ...
    public PriorCollegeMajorsMinorsConcentrations100PutResponse withSorconc(List<Sorconc__2> sorconc) {
        this.sorconc = sorconc;
        return this;
    }
    ...
    public PriorCollegeMajorsMinorsConcentrations100PutResponse withSormajr(List<Sormajr__2> sormajr) {
        this.sormajr = sormajr;
        return this;
    }

    @JsonProperty("sorminr")
    public List<Sorminr__2> getSorminr() {
        return sorminr;
    }

    @JsonProperty("sorminr")
    public void setSorminr(List<Sorminr__2> sorminr) {
        this.sorminr = sorminr;
    }

    public PriorCollegeMajorsMinorsConcentrations100PutResponse withSorminr(List<Sorminr__2> sorminr) {
        this.sorminr = sorminr;
        return this;
    }
    ...
    public PriorCollegeMajorsMinorsConcentrations100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PriorCollegeMajorsMinorsConcentrations100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sorconc");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PriorCollegeMajorsMinorsConcentrations100PutResponse) == false) {
            return false;
        }
        PriorCollegeMajorsMinorsConcentrations100PutResponse rhs = ((PriorCollegeMajorsMinorsConcentrations100PutResponse) other);
