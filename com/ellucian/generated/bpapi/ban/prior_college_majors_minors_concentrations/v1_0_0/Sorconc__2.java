...
public class Sorconc__2 {
    ...
    public Sorconc__2 withConcDesc(String concDesc) {
        this.concDesc = concDesc;
        return this;
    }
    ...
    public Sorconc__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sorconc__2 withMajrCodeConc(String majrCodeConc) {
        this.majrCodeConc = majrCodeConc;
        return this;
    }
    ...
    public Sorconc__2 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sorconc__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorconc__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("concDesc");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorconc__2) == false) {
            return false;
        }
        Sorconc__2 rhs = ((Sorconc__2) other);
