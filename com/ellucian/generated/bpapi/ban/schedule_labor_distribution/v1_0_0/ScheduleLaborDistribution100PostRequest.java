...
public class ScheduleLaborDistribution100PostRequest {
    ...
    public ScheduleLaborDistribution100PostRequest withProjCode(String projCode) {
        this.projCode = projCode;
        return this;
    }
    ...
    public ScheduleLaborDistribution100PostRequest withSsasectCrn(Object ssasectCrn) {
        this.ssasectCrn = ssasectCrn;
        return this;
    }
    ...
    public ScheduleLaborDistribution100PostRequest withAcciCode(String acciCode) {
        this.acciCode = acciCode;
        return this;
    }
    ...
    public ScheduleLaborDistribution100PostRequest withCoasCode(String coasCode) {
        this.coasCode = coasCode;
        return this;
    }
    ...
    public ScheduleLaborDistribution100PostRequest withLocnCode(String locnCode) {
        this.locnCode = locnCode;
        return this;
    }
    ...
    public ScheduleLaborDistribution100PostRequest withOrgnCode(String orgnCode) {
        this.orgnCode = orgnCode;
        return this;
    }
    ...
    public ScheduleLaborDistribution100PostRequest withAcctCode(String acctCode) {
        this.acctCode = acctCode;
        return this;
    }
    ...
    public ScheduleLaborDistribution100PostRequest withPercent(Double percent) {
        this.percent = percent;
        return this;
    }
    ...
    public ScheduleLaborDistribution100PostRequest withSsasectTermCode(Object ssasectTermCode) {
        this.ssasectTermCode = ssasectTermCode;
        return this;
    }
    ...
    public ScheduleLaborDistribution100PostRequest withFundCode(String fundCode) {
        this.fundCode = fundCode;
        return this;
    }
    ...
    public ScheduleLaborDistribution100PostRequest withProgCode(String progCode) {
        this.progCode = progCode;
        return this;
    }
    ...
    public ScheduleLaborDistribution100PostRequest withCtypCode(String ctypCode) {
        this.ctypCode = ctypCode;
        return this;
    }
    ...
    public ScheduleLaborDistribution100PostRequest withActvCode(String actvCode) {
        this.actvCode = actvCode;
        return this;
    }
    ...
    public ScheduleLaborDistribution100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ScheduleLaborDistribution100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("projCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ScheduleLaborDistribution100PostRequest) == false) {
            return false;
        }
        ScheduleLaborDistribution100PostRequest rhs = ((ScheduleLaborDistribution100PostRequest) other);
        return (((((((((((((((this.projCode == rhs.projCode)||((this.projCode!= null)&&this.projCode.equals(rhs.projCode)))&&((this.ssasectCrn == rhs.ssasectCrn)||((this.ssasectCrn!= null)&&this.ssasectCrn.equals(rhs.ssasectCrn))))&&((this.acciCode == rhs.acciCode)||((this.acciCode!= null)&&this.acciCode.equals(rhs.acciCode))))&&((this.coasCode == rhs.coasCode)||((this.coasCode!= null)&&this.coasCode.equals(rhs.coasCode))))&&((this.locnCode == rhs.locnCode)||((this.locnCode!= null)&&this.locnCode.equals(rhs.locnCode))))&&((this.orgnCode == rhs.orgnCode)||((this.orgnCode!= null)&&this.orgnCode.equals(rhs.orgnCode))))&&((this.acctCode == rhs.acctCode)||((this.acctCode!= null)&&this.acctCode.equals(rhs.acctCode))))&&((this.percent == rhs.percent)||((this.percent!= null)&&this.percent.equals(rhs.percent))))&&((this.ssasectTermCode == rhs.ssasectTermCode)||((this.ssasectTermCode!= null)&&this.ssasectTermCode.equals(rhs.ssasectTermCode))))&&((this.fundCode == rhs.fundCode)||((this.fundCode!= null)&&this.fundCode.equals(rhs.fundCode))))&&((this.progCode == rhs.progCode)||((this.progCode!= null)&&this.progCode.equals(rhs.progCode))))&&((this.ctypCode == rhs.ctypCode)||((this.ctypCode!= null)&&this.ctypCode.equals(rhs.ctypCode))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.actvCode == rhs.actvCode)||((this.actvCode!= null)&&this.actvCode.equals(rhs.actvCode))));
    }
