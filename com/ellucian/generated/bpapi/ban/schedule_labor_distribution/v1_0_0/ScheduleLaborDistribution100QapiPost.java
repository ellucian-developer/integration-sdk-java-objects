...
public class ScheduleLaborDistribution100QapiPost {
    ...
    public ScheduleLaborDistribution100QapiPost withSsasectTermCode(String ssasectTermCode) {
        this.ssasectTermCode = ssasectTermCode;
        return this;
    }
    ...
    public ScheduleLaborDistribution100QapiPost withSsasectCrn(String ssasectCrn) {
        this.ssasectCrn = ssasectCrn;
        return this;
    }
    ...
    public ScheduleLaborDistribution100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ScheduleLaborDistribution100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ScheduleLaborDistribution100QapiPost) == false) {
            return false;
        }
        ScheduleLaborDistribution100QapiPost rhs = ((ScheduleLaborDistribution100QapiPost) other);
