...
public class TaskStatusCodes100QapiPost {
    ...
    public TaskStatusCodes100QapiPost withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public TaskStatusCodes100QapiPost withComplInd(String complInd) {
        this.complInd = complInd;
        return this;
    }
    ...
    public TaskStatusCodes100QapiPost withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public TaskStatusCodes100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TaskStatusCodes100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("code");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TaskStatusCodes100QapiPost) == false) {
            return false;
        }
        TaskStatusCodes100QapiPost rhs = ((TaskStatusCodes100QapiPost) other);
