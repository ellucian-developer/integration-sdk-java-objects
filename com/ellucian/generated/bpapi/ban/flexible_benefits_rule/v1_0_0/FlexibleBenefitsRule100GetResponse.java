...
public class FlexibleBenefitsRule100GetResponse {
    ...
    public FlexibleBenefitsRule100GetResponse withAvailInd(String availInd) {
        this.availInd = availInd;
        return this;
    }
    ...
    public FlexibleBenefitsRule100GetResponse withFlexAmt(Double flexAmt) {
        this.flexAmt = flexAmt;
        return this;
    }
    ...
    public FlexibleBenefitsRule100GetResponse withBdcaCode(String bdcaCode) {
        this.bdcaCode = bdcaCode;
        return this;
    }
    ...
    public FlexibleBenefitsRule100GetResponse withEmplAmt(Double emplAmt) {
        this.emplAmt = emplAmt;
        return this;
    }
    ...
    public FlexibleBenefitsRule100GetResponse withBdcaDesc(String bdcaDesc) {
        this.bdcaDesc = bdcaDesc;
        return this;
    }
    ...
    public FlexibleBenefitsRule100GetResponse withPremAmt(Double premAmt) {
        this.premAmt = premAmt;
        return this;
    }
    ...
    public FlexibleBenefitsRule100GetResponse withFsaInd(String fsaInd) {
        this.fsaInd = fsaInd;
        return this;
    }
    ...
    public FlexibleBenefitsRule100GetResponse withDednFreq(Double dednFreq) {
        this.dednFreq = dednFreq;
        return this;
    }
    ...
    public FlexibleBenefitsRule100GetResponse withFsaGracePeriodInd(String fsaGracePeriodInd) {
        this.fsaGracePeriodInd = fsaGracePeriodInd;
        return this;
    }
    ...
    public FlexibleBenefitsRule100GetResponse withPlanCode(String planCode) {
        this.planCode = planCode;
        return this;
    }
    ...
    public FlexibleBenefitsRule100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(FlexibleBenefitsRule100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("availInd");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FlexibleBenefitsRule100GetResponse) == false) {
            return false;
        }
        FlexibleBenefitsRule100GetResponse rhs = ((FlexibleBenefitsRule100GetResponse) other);
        return ((((((((((((this.availInd == rhs.availInd)||((this.availInd!= null)&&this.availInd.equals(rhs.availInd)))&&((this.flexAmt == rhs.flexAmt)||((this.flexAmt!= null)&&this.flexAmt.equals(rhs.flexAmt))))&&((this.bdcaCode == rhs.bdcaCode)||((this.bdcaCode!= null)&&this.bdcaCode.equals(rhs.bdcaCode))))&&((this.emplAmt == rhs.emplAmt)||((this.emplAmt!= null)&&this.emplAmt.equals(rhs.emplAmt))))&&((this.bdcaDesc == rhs.bdcaDesc)||((this.bdcaDesc!= null)&&this.bdcaDesc.equals(rhs.bdcaDesc))))&&((this.premAmt == rhs.premAmt)||((this.premAmt!= null)&&this.premAmt.equals(rhs.premAmt))))&&((this.fsaInd == rhs.fsaInd)||((this.fsaInd!= null)&&this.fsaInd.equals(rhs.fsaInd))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.dednFreq == rhs.dednFreq)||((this.dednFreq!= null)&&this.dednFreq.equals(rhs.dednFreq))))&&((this.fsaGracePeriodInd == rhs.fsaGracePeriodInd)||((this.fsaGracePeriodInd!= null)&&this.fsaGracePeriodInd.equals(rhs.fsaGracePeriodInd))))&&((this.planCode == rhs.planCode)||((this.planCode!= null)&&this.planCode.equals(rhs.planCode))));
    }
