...
public class TranscriptEventsAndCommentsAcademicEvents100GetResponse {
    ...
    public TranscriptEventsAndCommentsAcademicEvents100GetResponse withDecision(String decision) {
        this.decision = decision;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100GetResponse withDescNondb(String descNondb) {
        this.descNondb = descNondb;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100GetResponse withGrade(String grade) {
        this.grade = grade;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100GetResponse withEvenCode(String evenCode) {
        this.evenCode = evenCode;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100GetResponse withEffectiveDate(Date effectiveDate) {
        this.effectiveDate = effectiveDate;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100GetResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100GetResponse withStvevenTransInd(String stvevenTransInd) {
        this.stvevenTransInd = stvevenTransInd;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TranscriptEventsAndCommentsAcademicEvents100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("decision");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TranscriptEventsAndCommentsAcademicEvents100GetResponse) == false) {
            return false;
        }
        TranscriptEventsAndCommentsAcademicEvents100GetResponse rhs = ((TranscriptEventsAndCommentsAcademicEvents100GetResponse) other);
