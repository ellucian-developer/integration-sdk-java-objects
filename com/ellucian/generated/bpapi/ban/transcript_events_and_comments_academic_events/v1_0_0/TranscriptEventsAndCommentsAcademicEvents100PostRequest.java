...
public class TranscriptEventsAndCommentsAcademicEvents100PostRequest {
    ...
    public TranscriptEventsAndCommentsAcademicEvents100PostRequest withKeyblckOrigCode(String keyblckOrigCode) {
        this.keyblckOrigCode = keyblckOrigCode;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100PostRequest withKeyblckLevlCode(String keyblckLevlCode) {
        this.keyblckLevlCode = keyblckLevlCode;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100PostRequest withDecision(String decision) {
        this.decision = decision;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100PostRequest withDescNondb(String descNondb) {
        this.descNondb = descNondb;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100PostRequest withGrade(String grade) {
        this.grade = grade;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100PostRequest withKeyblckTermCode(String keyblckTermCode) {
        this.keyblckTermCode = keyblckTermCode;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100PostRequest withEvenCode(String evenCode) {
        this.evenCode = evenCode;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100PostRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100PostRequest withEffectiveDate(Date effectiveDate) {
        this.effectiveDate = effectiveDate;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100PostRequest withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public TranscriptEventsAndCommentsAcademicEvents100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TranscriptEventsAndCommentsAcademicEvents100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TranscriptEventsAndCommentsAcademicEvents100PostRequest) == false) {
            return false;
        }
        TranscriptEventsAndCommentsAcademicEvents100PostRequest rhs = ((TranscriptEventsAndCommentsAcademicEvents100PostRequest) other);
