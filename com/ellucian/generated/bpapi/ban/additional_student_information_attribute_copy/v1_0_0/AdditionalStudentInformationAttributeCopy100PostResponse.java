...
public class AdditionalStudentInformationAttributeCopy100PostResponse {
    ...
    public AdditionalStudentInformationAttributeCopy100PostResponse withSgastdnKeyBlock(List<SgastdnKeyBlock> sgastdnKeyBlock) {
        this.sgastdnKeyBlock = sgastdnKeyBlock;
        return this;
    }
    ...
    public AdditionalStudentInformationAttributeCopy100PostResponse withAttrCtrlBlock(List<AttrCtrlBlock> attrCtrlBlock) {
        this.attrCtrlBlock = attrCtrlBlock;
        return this;
    }
    ...
    public AdditionalStudentInformationAttributeCopy100PostResponse withSgrsatt(List<Sgrsatt> sgrsatt) {
        this.sgrsatt = sgrsatt;
        return this;
    }
    ...
    public AdditionalStudentInformationAttributeCopy100PostResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AdditionalStudentInformationAttributeCopy100PostResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AdditionalStudentInformationAttributeCopy100PostResponse) == false) {
            return false;
        }
        AdditionalStudentInformationAttributeCopy100PostResponse rhs = ((AdditionalStudentInformationAttributeCopy100PostResponse) other);
