...
public class AdditionalStudentInformationAttributeCopy100PostRequest {
    ...
    public AdditionalStudentInformationAttributeCopy100PostRequest withSgastdnId(String sgastdnId) {
        this.sgastdnId = sgastdnId;
        return this;
    }
    ...
    public AdditionalStudentInformationAttributeCopy100PostRequest withSgastdnTermCodeEff(String sgastdnTermCodeEff) {
        this.sgastdnTermCodeEff = sgastdnTermCodeEff;
        return this;
    }
    ...
    public AdditionalStudentInformationAttributeCopy100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AdditionalStudentInformationAttributeCopy100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sgastdnId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AdditionalStudentInformationAttributeCopy100PostRequest) == false) {
            return false;
        }
        AdditionalStudentInformationAttributeCopy100PostRequest rhs = ((AdditionalStudentInformationAttributeCopy100PostRequest) other);
