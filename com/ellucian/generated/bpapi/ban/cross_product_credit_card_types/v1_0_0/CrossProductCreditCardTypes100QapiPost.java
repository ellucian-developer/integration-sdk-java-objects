...
public class CrossProductCreditCardTypes100QapiPost {
    ...
    public CrossProductCreditCardTypes100QapiPost withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CrossProductCreditCardTypes100QapiPost withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CrossProductCreditCardTypes100QapiPost withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public CrossProductCreditCardTypes100QapiPost withExternalMerchantId(String externalMerchantId) {
        this.externalMerchantId = externalMerchantId;
        return this;
    }
    ...
    public CrossProductCreditCardTypes100QapiPost withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public CrossProductCreditCardTypes100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CrossProductCreditCardTypes100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CrossProductCreditCardTypes100QapiPost) == false) {
            return false;
        }
        CrossProductCreditCardTypes100QapiPost rhs = ((CrossProductCreditCardTypes100QapiPost) other);
