...
public class CrossProductCreditCardTypes100GetRequest {
    ...
    public CrossProductCreditCardTypes100GetRequest withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CrossProductCreditCardTypes100GetRequest withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CrossProductCreditCardTypes100GetRequest withExternalMerchantId(String externalMerchantId) {
        this.externalMerchantId = externalMerchantId;
        return this;
    }
    ...
    public CrossProductCreditCardTypes100GetRequest withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public CrossProductCreditCardTypes100GetRequest withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public CrossProductCreditCardTypes100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CrossProductCreditCardTypes100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CrossProductCreditCardTypes100GetRequest) == false) {
            return false;
        }
        CrossProductCreditCardTypes100GetRequest rhs = ((CrossProductCreditCardTypes100GetRequest) other);
