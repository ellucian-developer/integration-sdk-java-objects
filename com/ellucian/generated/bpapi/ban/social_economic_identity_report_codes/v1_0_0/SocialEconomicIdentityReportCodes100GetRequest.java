...
public class SocialEconomicIdentityReportCodes100GetRequest {
    ...
    public SocialEconomicIdentityReportCodes100GetRequest withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public SocialEconomicIdentityReportCodes100GetRequest withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public SocialEconomicIdentityReportCodes100GetRequest withSurrogateId(Double surrogateId) {
        this.surrogateId = surrogateId;
        return this;
    }
    ...
    public SocialEconomicIdentityReportCodes100GetRequest withDataOrigin(String dataOrigin) {
        this.dataOrigin = dataOrigin;
        return this;
    }
    ...
    public SocialEconomicIdentityReportCodes100GetRequest withVpdiCode(String vpdiCode) {
        this.vpdiCode = vpdiCode;
        return this;
    }
    ...
    public SocialEconomicIdentityReportCodes100GetRequest withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public SocialEconomicIdentityReportCodes100GetRequest withVersion(Double version) {
        this.version = version;
        return this;
    }
    ...
    public SocialEconomicIdentityReportCodes100GetRequest withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public SocialEconomicIdentityReportCodes100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SocialEconomicIdentityReportCodes100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SocialEconomicIdentityReportCodes100GetRequest) == false) {
            return false;
        }
        SocialEconomicIdentityReportCodes100GetRequest rhs = ((SocialEconomicIdentityReportCodes100GetRequest) other);
