...
public class AttributeTypesSelection100GetResponse {
    ...
    public AttributeTypesSelection100GetResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public AttributeTypesSelection100GetResponse withValidLocnInd(String validLocnInd) {
        this.validLocnInd = validLocnInd;
        return this;
    }
    ...
    public AttributeTypesSelection100GetResponse withValidActvInd(String validActvInd) {
        this.validActvInd = validActvInd;
        return this;
    }
    ...
    public AttributeTypesSelection100GetResponse withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public AttributeTypesSelection100GetResponse withValidOrgnInd(String validOrgnInd) {
        this.validOrgnInd = validOrgnInd;
        return this;
    }
    ...
    public AttributeTypesSelection100GetResponse withValidAcctInd(String validAcctInd) {
        this.validAcctInd = validAcctInd;
        return this;
    }
    ...
    public AttributeTypesSelection100GetResponse withValidFundInd(String validFundInd) {
        this.validFundInd = validFundInd;
        return this;
    }
    ...
    public AttributeTypesSelection100GetResponse withValidProgInd(String validProgInd) {
        this.validProgInd = validProgInd;
        return this;
    }
    ...
    public AttributeTypesSelection100GetResponse withAddInd(String addInd) {
        this.addInd = addInd;
        return this;
    }
    ...
    public AttributeTypesSelection100GetResponse withValidAllInd(String validAllInd) {
        this.validAllInd = validAllInd;
        return this;
    }
    ...
    public AttributeTypesSelection100GetResponse withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public AttributeTypesSelection100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AttributeTypesSelection100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("code");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeTypesSelection100GetResponse) == false) {
            return false;
        }
        AttributeTypesSelection100GetResponse rhs = ((AttributeTypesSelection100GetResponse) other);
        return (((((((((((((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code)))&&((this.validLocnInd == rhs.validLocnInd)||((this.validLocnInd!= null)&&this.validLocnInd.equals(rhs.validLocnInd))))&&((this.validAcctInd == rhs.validAcctInd)||((this.validAcctInd!= null)&&this.validAcctInd.equals(rhs.validAcctInd))))&&((this.addInd == rhs.addInd)||((this.addInd!= null)&&this.addInd.equals(rhs.addInd))))&&((this.validAllInd == rhs.validAllInd)||((this.validAllInd!= null)&&this.validAllInd.equals(rhs.validAllInd))))&&((this.validActvInd == rhs.validActvInd)||((this.validActvInd!= null)&&this.validActvInd.equals(rhs.validActvInd))))&&((this.statusInd == rhs.statusInd)||((this.statusInd!= null)&&this.statusInd.equals(rhs.statusInd))))&&((this.validOrgnInd == rhs.validOrgnInd)||((this.validOrgnInd!= null)&&this.validOrgnInd.equals(rhs.validOrgnInd))))&&((this.validFundInd == rhs.validFundInd)||((this.validFundInd!= null)&&this.validFundInd.equals(rhs.validFundInd))))&&((this.validProgInd == rhs.validProgInd)||((this.validProgInd!= null)&&this.validProgInd.equals(rhs.validProgInd))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.desc == rhs.desc)||((this.desc!= null)&&this.desc.equals(rhs.desc))));
    }
