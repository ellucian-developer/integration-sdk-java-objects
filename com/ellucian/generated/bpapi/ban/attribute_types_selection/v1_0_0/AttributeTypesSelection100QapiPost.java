...
public class AttributeTypesSelection100QapiPost {

    @JsonProperty("coasCode")
    private String coasCode;
    @JsonProperty("attsCode")
    private String attsCode;
    @JsonProperty("foapalInd")
    private String foapalInd;
    /**
     * Ftvattt Code
     * <p>
    ...
    public AttributeTypesSelection100QapiPost withCoasCode(String coasCode) {
        this.coasCode = coasCode;
        return this;
    }
    ...
    public AttributeTypesSelection100QapiPost withAttsCode(String attsCode) {
        this.attsCode = attsCode;
        return this;
    }

    @JsonProperty("foapalInd")
    public String getFoapalInd() {
        return foapalInd;
    }

    @JsonProperty("foapalInd")
    public void setFoapalInd(String foapalInd) {
        this.foapalInd = foapalInd;
    }

    public AttributeTypesSelection100QapiPost withFoapalInd(String foapalInd) {
        this.foapalInd = foapalInd;
        return this;
    }
    ...
    public AttributeTypesSelection100QapiPost withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public AttributeTypesSelection100QapiPost withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public AttributeTypesSelection100QapiPost withValidAllInd(String validAllInd) {
        this.validAllInd = validAllInd;
        return this;
    }
    ...
    public AttributeTypesSelection100QapiPost withValidFundInd(String validFundInd) {
        this.validFundInd = validFundInd;
        return this;
    }
    ...
    public AttributeTypesSelection100QapiPost withValidOrgnInd(String validOrgnInd) {
        this.validOrgnInd = validOrgnInd;
        return this;
    }
    ...
    public AttributeTypesSelection100QapiPost withValidAcctInd(String validAcctInd) {
        this.validAcctInd = validAcctInd;
        return this;
    }
    ...
    public AttributeTypesSelection100QapiPost withValidProgInd(String validProgInd) {
        this.validProgInd = validProgInd;
        return this;
    }
    ...
    public AttributeTypesSelection100QapiPost withValidActvInd(String validActvInd) {
        this.validActvInd = validActvInd;
        return this;
    }
    ...
    public AttributeTypesSelection100QapiPost withValidLocnInd(String validLocnInd) {
        this.validLocnInd = validLocnInd;
        return this;
    }
    ...
    public AttributeTypesSelection100QapiPost withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public AttributeTypesSelection100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AttributeTypesSelection100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("coasCode");
        sb.append('=');
        ...
        sb.append("foapalInd");
        sb.append('=');
        sb.append(((this.foapalInd == null)?"<null>":this.foapalInd));
        sb.append(',');
        sb.append("code");
        sb.append('=');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.foapalInd == null)? 0 :this.foapalInd.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AttributeTypesSelection100QapiPost) == false) {
            return false;
        }
        AttributeTypesSelection100QapiPost rhs = ((AttributeTypesSelection100QapiPost) other);
        return (((((((((((((((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code)))&&((this.validLocnInd == rhs.validLocnInd)||((this.validLocnInd!= null)&&this.validLocnInd.equals(rhs.validLocnInd))))&&((this.coasCode == rhs.coasCode)||((this.coasCode!= null)&&this.coasCode.equals(rhs.coasCode))))&&((this.validAcctInd == rhs.validAcctInd)||((this.validAcctInd!= null)&&this.validAcctInd.equals(rhs.validAcctInd))))&&((this.validAllInd == rhs.validAllInd)||((this.validAllInd!= null)&&this.validAllInd.equals(rhs.validAllInd))))&&((this.attsCode == rhs.attsCode)||((this.attsCode!= null)&&this.attsCode.equals(rhs.attsCode))))&&((this.validActvInd == rhs.validActvInd)||((this.validActvInd!= null)&&this.validActvInd.equals(rhs.validActvInd))))&&((this.foapalInd == rhs.foapalInd)||((this.foapalInd!= null)&&this.foapalInd.equals(rhs.foapalInd))))&&((this.statusInd == rhs.statusInd)||((this.statusInd!= null)&&this.statusInd.equals(rhs.statusInd))))&&((this.validOrgnInd == rhs.validOrgnInd)||((this.validOrgnInd!= null)&&this.validOrgnInd.equals(rhs.validOrgnInd))))&&((this.validFundInd == rhs.validFundInd)||((this.validFundInd!= null)&&this.validFundInd.equals(rhs.validFundInd))))&&((this.validProgInd == rhs.validProgInd)||((this.validProgInd!= null)&&this.validProgInd.equals(rhs.validProgInd))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.desc == rhs.desc)||((this.desc!= null)&&this.desc.equals(rhs.desc))));
    }
