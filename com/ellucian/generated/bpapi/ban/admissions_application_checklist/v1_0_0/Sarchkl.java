...
public class Sarchkl {
    ...
    public Sarchkl withReqCount(Double reqCount) {
        this.reqCount = reqCount;
        return this;
    }
    ...
    public Sarchkl withMandatoryInd(String mandatoryInd) {
        this.mandatoryInd = mandatoryInd;
        return this;
    }
    ...
    public Sarchkl withDeadlineDate(Date deadlineDate) {
        this.deadlineDate = deadlineDate;
        return this;
    }
    ...
    public Sarchkl withCksrCode(String cksrCode) {
        this.cksrCode = cksrCode;
        return this;
    }
    ...
    public Sarchkl withPrintInd(String printInd) {
        this.printInd = printInd;
        return this;
    }
    ...
    public Sarchkl withReceiveDate(Date receiveDate) {
        this.receiveDate = receiveDate;
        return this;
    }
    ...
    public Sarchkl withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public Sarchkl withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sarchkl withCodeValue(String codeValue) {
        this.codeValue = codeValue;
        return this;
    }
    ...
    public Sarchkl withSourceDate(Date sourceDate) {
        this.sourceDate = sourceDate;
        return this;
    }
    ...
    public Sarchkl withAdmrCode(String admrCode) {
        this.admrCode = admrCode;
        return this;
    }
    ...
    public Sarchkl withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sarchkl withCkstCode(String ckstCode) {
        this.ckstCode = ckstCode;
        return this;
    }
    ...
    public Sarchkl withStvadmrDesc(String stvadmrDesc) {
        this.stvadmrDesc = stvadmrDesc;
        return this;
    }
    ...
    public Sarchkl withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public Sarchkl withReqDate2(Date reqDate2) {
        this.reqDate2 = reqDate2;
        return this;
    }
    ...
    public Sarchkl withReqDate1(Date reqDate1) {
        this.reqDate1 = reqDate1;
        return this;
    }
    ...
    public Sarchkl withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sarchkl.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("reqCount");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sarchkl) == false) {
            return false;
        }
        Sarchkl rhs = ((Sarchkl) other);
