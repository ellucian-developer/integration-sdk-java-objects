...
public class AdmissionsApplicationChecklist100PostResponse {

    @JsonProperty("saradap")
    private List<Saradap__1> saradap = new ArrayList<Saradap__1>();
    @JsonProperty("sarchkl")
    private List<Sarchkl__1> sarchkl = new ArrayList<Sarchkl__1>();
    @JsonIgnore
    ...
    public AdmissionsApplicationChecklist100PostResponse withSaradap(List<Saradap__1> saradap) {
        this.saradap = saradap;
        return this;
    }

    @JsonProperty("sarchkl")
    public List<Sarchkl__1> getSarchkl() {
        return sarchkl;
    }

    @JsonProperty("sarchkl")
    public void setSarchkl(List<Sarchkl__1> sarchkl) {
        this.sarchkl = sarchkl;
    }

    public AdmissionsApplicationChecklist100PostResponse withSarchkl(List<Sarchkl__1> sarchkl) {
        this.sarchkl = sarchkl;
        return this;
    }
    ...
    public AdmissionsApplicationChecklist100PostResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AdmissionsApplicationChecklist100PostResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("saradap");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AdmissionsApplicationChecklist100PostResponse) == false) {
            return false;
        }
        AdmissionsApplicationChecklist100PostResponse rhs = ((AdmissionsApplicationChecklist100PostResponse) other);
