...
public class Gobintl {
    ...
    public Gobintl withCertDateIssue(Date certDateIssue) {
        this.certDateIssue = certDateIssue;
        return this;
    }
    ...
    public Gobintl withChildNumber(Double childNumber) {
        this.childNumber = childNumber;
        return this;
    }
    ...
    public Gobintl withEmptCode(String emptCode) {
        this.emptCode = emptCode;
        return this;
    }
    ...
    public Gobintl withLangCode(String langCode) {
        this.langCode = langCode;
        return this;
    }
    ...
    public Gobintl withIssueNatnDesc(String issueNatnDesc) {
        this.issueNatnDesc = issueNatnDesc;
        return this;
    }
    ...
    public Gobintl withForeignSsn(String foreignSsn) {
        this.foreignSsn = foreignSsn;
        return this;
    }
    ...
    public Gobintl withPassportExpDate(Date passportExpDate) {
        this.passportExpDate = passportExpDate;
        return this;
    }
    ...
    public Gobintl withCelgDesc(String celgDesc) {
        this.celgDesc = celgDesc;
        return this;
    }
    ...
    public Gobintl withDuration(String duration) {
        this.duration = duration;
        return this;
    }
    ...
    public Gobintl withAdmrDesc(String admrDesc) {
        this.admrDesc = admrDesc;
        return this;
    }
    ...
    public Gobintl withRegNumber(String regNumber) {
        this.regNumber = regNumber;
        return this;
    }
    ...
    public Gobintl withSponDesc(String sponDesc) {
        this.sponDesc = sponDesc;
        return this;
    }
    ...
    public Gobintl withNatnCodeBirth(String natnCodeBirth) {
        this.natnCodeBirth = natnCodeBirth;
        return this;
    }
    ...
    public Gobintl withBirthNatnDesc(String birthNatnDesc) {
        this.birthNatnDesc = birthNatnDesc;
        return this;
    }
    ...
    public Gobintl withSignatureInd(String signatureInd) {
        this.signatureInd = signatureInd;
        return this;
    }
    ...
    public Gobintl withPassportId(String passportId) {
        this.passportId = passportId;
        return this;
    }
    ...
    public Gobintl withNatnCodeLegal(String natnCodeLegal) {
        this.natnCodeLegal = natnCodeLegal;
        return this;
    }
    ...
    public Gobintl withEmptDesc(String emptDesc) {
        this.emptDesc = emptDesc;
        return this;
    }
    ...
    public Gobintl withLangDesc(String langDesc) {
        this.langDesc = langDesc;
        return this;
    }
    ...
    public Gobintl withNatnCodeIssue(String natnCodeIssue) {
        this.natnCodeIssue = natnCodeIssue;
        return this;
    }
    ...
    public Gobintl withCelgCode(String celgCode) {
        this.celgCode = celgCode;
        return this;
    }
    ...
    public Gobintl withCertNumber(String certNumber) {
        this.certNumber = certNumber;
        return this;
    }
    ...
    public Gobintl withSponCode(String sponCode) {
        this.sponCode = sponCode;
        return this;
    }
    ...
    public Gobintl withAdmrCode(String admrCode) {
        this.admrCode = admrCode;
        return this;
    }
    ...
    public Gobintl withSpouseInd(String spouseInd) {
        this.spouseInd = spouseInd;
        return this;
    }
    ...
    public Gobintl withLegalNatnDesc(String legalNatnDesc) {
        this.legalNatnDesc = legalNatnDesc;
        return this;
    }
    ...
    public Gobintl withI94Date(Date i94Date) {
        this.i94Date = i94Date;
        return this;
    }
    ...
    public Gobintl withI94Status(String i94Status) {
        this.i94Status = i94Status;
        return this;
    }
    ...
    public Gobintl withCertDateReceipt(Date certDateReceipt) {
        this.certDateReceipt = certDateReceipt;
        return this;
    }
    ...
    public Gobintl withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Gobintl.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Gobintl) == false) {
            return false;
        }
        Gobintl rhs = ((Gobintl) other);
