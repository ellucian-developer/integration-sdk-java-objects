...
public class ZipPostalCodes100GetResponse {
     ...
     * 
     */
    @JsonProperty("gtvzipcActivityDate")
    @JsonPropertyDescription("Lineage reference object : GTVZIPC_ACTIVITY_DATE")
    private Date gtvzipcActivityDate;
    /**
     * State or Province
     * <p>
    ...
    public ZipPostalCodes100GetResponse withGtvzipcCity(String gtvzipcCity) {
        this.gtvzipcCity = gtvzipcCity;
        return this;
    }
    ...
    public ZipPostalCodes100GetResponse withGtvzipcNatnCode(String gtvzipcNatnCode) {
        this.gtvzipcNatnCode = gtvzipcNatnCode;
        return this;
    }
    ...
    public ZipPostalCodes100GetResponse withGtvzipcCntyCode(String gtvzipcCntyCode) {
        this.gtvzipcCntyCode = gtvzipcCntyCode;
        return this;
    }
     ...
     */
    @JsonProperty("gtvzipcActivityDate")
    public Date getGtvzipcActivityDate() {
        return gtvzipcActivityDate;
    }
     ...
     */
    @JsonProperty("gtvzipcActivityDate")
    public void setGtvzipcActivityDate(Date gtvzipcActivityDate) {
        this.gtvzipcActivityDate = gtvzipcActivityDate;
    }

    public ZipPostalCodes100GetResponse withGtvzipcActivityDate(Date gtvzipcActivityDate) {
        this.gtvzipcActivityDate = gtvzipcActivityDate;
        return this;
    }
    ...
    public ZipPostalCodes100GetResponse withGtvzipcStatCode(String gtvzipcStatCode) {
        this.gtvzipcStatCode = gtvzipcStatCode;
        return this;
    }
    ...
    public ZipPostalCodes100GetResponse withGtvzipcCode(String gtvzipcCode) {
        this.gtvzipcCode = gtvzipcCode;
        return this;
    }
    ...
    public ZipPostalCodes100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ZipPostalCodes100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        ...
        sb.append(',');
        sb.append("gtvzipcActivityDate");
        sb.append('=');
        sb.append(((this.gtvzipcActivityDate == null)?"<null>":this.gtvzipcActivityDate));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.gtvzipcActivityDate == null)? 0 :this.gtvzipcActivityDate.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ZipPostalCodes100GetResponse) == false) {
            return false;
        }
        ZipPostalCodes100GetResponse rhs = ((ZipPostalCodes100GetResponse) other);
        return ((((((((this.gtvzipcCity == rhs.gtvzipcCity)||((this.gtvzipcCity!= null)&&this.gtvzipcCity.equals(rhs.gtvzipcCity)))&&((this.gtvzipcNatnCode == rhs.gtvzipcNatnCode)||((this.gtvzipcNatnCode!= null)&&this.gtvzipcNatnCode.equals(rhs.gtvzipcNatnCode))))&&((this.gtvzipcCntyCode == rhs.gtvzipcCntyCode)||((this.gtvzipcCntyCode!= null)&&this.gtvzipcCntyCode.equals(rhs.gtvzipcCntyCode))))&&((this.gtvzipcActivityDate == rhs.gtvzipcActivityDate)||((this.gtvzipcActivityDate!= null)&&this.gtvzipcActivityDate.equals(rhs.gtvzipcActivityDate))))&&((this.gtvzipcStatCode == rhs.gtvzipcStatCode)||((this.gtvzipcStatCode!= null)&&this.gtvzipcStatCode.equals(rhs.gtvzipcStatCode))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.gtvzipcCode == rhs.gtvzipcCode)||((this.gtvzipcCode!= null)&&this.gtvzipcCode.equals(rhs.gtvzipcCode))));
    }
