...
public class Scbcrse__1 {
    ...
    public Scbcrse__1 withPrereqChkMethodCde(String prereqChkMethodCde) {
        this.prereqChkMethodCde = prereqChkMethodCde;
        return this;
    }
    ...
    public Scbcrse__1 withMaint(String maint) {
        this.maint = maint;
        return this;
    }
    ...
    public Scbcrse__1 withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public Scbcrse__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scbcrse__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scbcrse__1) == false) {
            return false;
        }
        Scbcrse__1 rhs = ((Scbcrse__1) other);
