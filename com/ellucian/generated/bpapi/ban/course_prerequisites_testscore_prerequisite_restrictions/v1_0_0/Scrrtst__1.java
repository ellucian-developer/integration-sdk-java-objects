...
public class Scrrtst__1 {
    ...
    public Scrrtst__1 withTescCode(String tescCode) {
        this.tescCode = tescCode;
        return this;
    }
    ...
    public Scrrtst__1 withCrseNumbPreq(String crseNumbPreq) {
        this.crseNumbPreq = crseNumbPreq;
        return this;
    }
    ...
    public Scrrtst__1 withConnector(String connector) {
        this.connector = connector;
        return this;
    }
    ...
    public Scrrtst__1 withSubjCodePreq(String subjCodePreq) {
        this.subjCodePreq = subjCodePreq;
        return this;
    }
    ...
    public Scrrtst__1 withRparen(String rparen) {
        this.rparen = rparen;
        return this;
    }
    ...
    public Scrrtst__1 withTestScore(String testScore) {
        this.testScore = testScore;
        return this;
    }
    ...
    public Scrrtst__1 withEndcopy(String endcopy) {
        this.endcopy = endcopy;
        return this;
    }
    ...
    public Scrrtst__1 withMinGrde(String minGrde) {
        this.minGrde = minGrde;
        return this;
    }
    ...
    public Scrrtst__1 withConcurrencyInd(String concurrencyInd) {
        this.concurrencyInd = concurrencyInd;
        return this;
    }
    ...
    public Scrrtst__1 withLparen(String lparen) {
        this.lparen = lparen;
        return this;
    }
    ...
    public Scrrtst__1 withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public Scrrtst__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrtst__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tescCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrtst__1) == false) {
            return false;
        }
        Scrrtst__1 rhs = ((Scrrtst__1) other);
