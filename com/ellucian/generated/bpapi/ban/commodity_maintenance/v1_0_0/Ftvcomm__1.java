...
public class Ftvcomm__1 {
    ...
    public Ftvcomm__1 withStockInd(String stockInd) {
        this.stockInd = stockInd;
        return this;
    }
    ...
    public Ftvcomm__1 withTgrpCode(String tgrpCode) {
        this.tgrpCode = tgrpCode;
        return this;
    }
    ...
    public Ftvcomm__1 withDisplayTgrpTitle(String displayTgrpTitle) {
        this.displayTgrpTitle = displayTgrpTitle;
        return this;
    }
    ...
    public Ftvcomm__1 withEstLifeYears(Double estLifeYears) {
        this.estLifeYears = estLifeYears;
        return this;
    }
    ...
    public Ftvcomm__1 withDisplayUomsDesc(String displayUomsDesc) {
        this.displayUomsDesc = displayUomsDesc;
        return this;
    }
    ...
    public Ftvcomm__1 withTaxOverrideInd(String taxOverrideInd) {
        this.taxOverrideInd = taxOverrideInd;
        return this;
    }
    ...
    public Ftvcomm__1 withEffDate(Date effDate) {
        this.effDate = effDate;
        return this;
    }
    ...
    public Ftvcomm__1 withDisplayCommDesc(String displayCommDesc) {
        this.displayCommDesc = displayCommDesc;
        return this;
    }
    ...
    public Ftvcomm__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Ftvcomm__1 withTextNote(String textNote) {
        this.textNote = textNote;
        return this;
    }
    ...
    public Ftvcomm__1 withAmstInd(String amstInd) {
        this.amstInd = amstInd;
        return this;
    }
    ...
    public Ftvcomm__1 withCommCodePred(String commCodePred) {
        this.commCodePred = commCodePred;
        return this;
    }
    ...
    public Ftvcomm__1 withTermDate(Date termDate) {
        this.termDate = termDate;
        return this;
    }
    ...
    public Ftvcomm__1 withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public Ftvcomm__1 withUomsCode(String uomsCode) {
        this.uomsCode = uomsCode;
        return this;
    }
    ...
    public Ftvcomm__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ftvcomm__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("stockInd");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ftvcomm__1) == false) {
            return false;
        }
        Ftvcomm__1 rhs = ((Ftvcomm__1) other);
