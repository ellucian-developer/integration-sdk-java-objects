...
public class Ssrsylo {
    ...
    public Ssrsylo withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Ssrsylo withLearningObjectives(Object learningObjectives) {
        this.learningObjectives = learningObjectives;
        return this;
    }
    ...
    public Ssrsylo withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssrsylo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssrsylo) == false) {
            return false;
        }
        Ssrsylo rhs = ((Ssrsylo) other);
