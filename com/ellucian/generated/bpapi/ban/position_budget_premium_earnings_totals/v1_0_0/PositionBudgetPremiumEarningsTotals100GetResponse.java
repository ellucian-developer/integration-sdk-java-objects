...
public class PositionBudgetPremiumEarningsTotals100GetResponse {
    ...
    public PositionBudgetPremiumEarningsTotals100GetResponse withBudgetToPost(Double budgetToPost) {
        this.budgetToPost = budgetToPost;
        return this;
    }
    ...
    public PositionBudgetPremiumEarningsTotals100GetResponse withEarnDesc(String earnDesc) {
        this.earnDesc = earnDesc;
        return this;
    }
    ...
    public PositionBudgetPremiumEarningsTotals100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public PositionBudgetPremiumEarningsTotals100GetResponse withExpend(Double expend) {
        this.expend = expend;
        return this;
    }
    ...
    public PositionBudgetPremiumEarningsTotals100GetResponse withEarnCode(String earnCode) {
        this.earnCode = earnCode;
        return this;
    }
    ...
    public PositionBudgetPremiumEarningsTotals100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public PositionBudgetPremiumEarningsTotals100GetResponse withRemaining(Double remaining) {
        this.remaining = remaining;
        return this;
    }
    ...
    public PositionBudgetPremiumEarningsTotals100GetResponse withBudget(Double budget) {
        this.budget = budget;
        return this;
    }
    ...
    public PositionBudgetPremiumEarningsTotals100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PositionBudgetPremiumEarningsTotals100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PositionBudgetPremiumEarningsTotals100GetResponse) == false) {
            return false;
        }
        PositionBudgetPremiumEarningsTotals100GetResponse rhs = ((PositionBudgetPremiumEarningsTotals100GetResponse) other);
