...
public class PositionBudgetPremiumEarningsTotals100QapiPost {
    ...
    public PositionBudgetPremiumEarningsTotals100QapiPost withFiscCode(String fiscCode) {
        this.fiscCode = fiscCode;
        return this;
    }
    ...
    public PositionBudgetPremiumEarningsTotals100QapiPost withPosn(String posn) {
        this.posn = posn;
        return this;
    }
    ...
    public PositionBudgetPremiumEarningsTotals100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PositionBudgetPremiumEarningsTotals100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("fiscCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PositionBudgetPremiumEarningsTotals100QapiPost) == false) {
            return false;
        }
        PositionBudgetPremiumEarningsTotals100QapiPost rhs = ((PositionBudgetPremiumEarningsTotals100QapiPost) other);
