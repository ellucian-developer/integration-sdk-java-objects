...
public class Shrgrul {
    ...
    public Shrgrul withParmValue(String parmValue) {
        this.parmValue = parmValue;
        return this;
    }
    ...
    public Shrgrul withParm(String parm) {
        this.parm = parm;
        return this;
    }
    ...
    public Shrgrul withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Shrgrul.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("parmValue");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shrgrul) == false) {
            return false;
        }
        Shrgrul rhs = ((Shrgrul) other);
