...
public class Shbgrul__1 {
    ...
    public Shbgrul__1 withRuleTypeDesc(String ruleTypeDesc) {
        this.ruleTypeDesc = ruleTypeDesc;
        return this;
    }
    ...
    public Shbgrul__1 withRuleType(String ruleType) {
        this.ruleType = ruleType;
        return this;
    }
    ...
    public Shbgrul__1 withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public Shbgrul__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Shbgrul__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shbgrul__1) == false) {
            return false;
        }
        Shbgrul__1 rhs = ((Shbgrul__1) other);
