...
public class GeneralUserPreferencesMaintenance100GetResponse {
    ...
    public GeneralUserPreferencesMaintenance100GetResponse withDisplayOptions(List<DisplayOption> displayOptions) {
        this.displayOptions = displayOptions;
        return this;
    }

    @JsonProperty("guruprf_ui")
    public List<GuruprfUi> getGuruprfUi() {
        return guruprfUi;
    }

    @JsonProperty("guruprf_ui")
    public void setGuruprfUi(List<GuruprfUi> guruprfUi) {
        this.guruprfUi = guruprfUi;
    }

    public GeneralUserPreferencesMaintenance100GetResponse withGuruprfUi(List<GuruprfUi> guruprfUi) {
        this.guruprfUi = guruprfUi;
        return this;
    }
    ...
    public GeneralUserPreferencesMaintenance100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralUserPreferencesMaintenance100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralUserPreferencesMaintenance100GetResponse) == false) {
            return false;
        }
        GeneralUserPreferencesMaintenance100GetResponse rhs = ((GeneralUserPreferencesMaintenance100GetResponse) other);
