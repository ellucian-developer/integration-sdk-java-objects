...
public class GuruprfUi__1 {
    ...
    public GuruprfUi__1 withDefltValue(String defltValue) {
        this.defltValue = defltValue;
        return this;
    }
    ...
    public GuruprfUi__1 withGuruprfValue(String guruprfValue) {
        this.guruprfValue = guruprfValue;
        return this;
    }
    ...
    public GuruprfUi__1 withDefltKey(String defltKey) {
        this.defltKey = defltKey;
        return this;
    }
    ...
    public GuruprfUi__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GuruprfUi__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GuruprfUi__1) == false) {
            return false;
        }
        GuruprfUi__1 rhs = ((GuruprfUi__1) other);
