...
public class ElectronicPersonnelActionOtherInformationAndComments100PostRequest {
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100PostRequest withProxyForUserId(Object proxyForUserId) {
        this.proxyForUserId = proxyForUserId;
        return this;
    }
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100PostRequest withAcatCode(Object acatCode) {
        this.acatCode = acatCode;
        return this;
    }
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100PostRequest withComments(String comments) {
        this.comments = comments;
        return this;
    }
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100PostRequest withAptyCode(Object aptyCode) {
        this.aptyCode = aptyCode;
        return this;
    }
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100PostRequest withId(Object id) {
        this.id = id;
        return this;
    }
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100PostRequest withTransNo(Object transNo) {
        this.transNo = transNo;
        return this;
    }
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100PostRequest withEffectiveDate(Object effectiveDate) {
        this.effectiveDate = effectiveDate;
        return this;
    }
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ElectronicPersonnelActionOtherInformationAndComments100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElectronicPersonnelActionOtherInformationAndComments100PostRequest) == false) {
            return false;
        }
        ElectronicPersonnelActionOtherInformationAndComments100PostRequest rhs = ((ElectronicPersonnelActionOtherInformationAndComments100PostRequest) other);
        return (((((((((this.proxyForUserId == rhs.proxyForUserId)||((this.proxyForUserId!= null)&&this.proxyForUserId.equals(rhs.proxyForUserId)))&&((this.acatCode == rhs.acatCode)||((this.acatCode!= null)&&this.acatCode.equals(rhs.acatCode))))&&((this.comments == rhs.comments)||((this.comments!= null)&&this.comments.equals(rhs.comments))))&&((this.aptyCode == rhs.aptyCode)||((this.aptyCode!= null)&&this.aptyCode.equals(rhs.aptyCode))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.transNo == rhs.transNo)||((this.transNo!= null)&&this.transNo.equals(rhs.transNo))))&&((this.effectiveDate == rhs.effectiveDate)||((this.effectiveDate!= null)&&this.effectiveDate.equals(rhs.effectiveDate))));
    }
