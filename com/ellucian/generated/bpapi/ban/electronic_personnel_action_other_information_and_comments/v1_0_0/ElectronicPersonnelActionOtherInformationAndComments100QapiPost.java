...
public class ElectronicPersonnelActionOtherInformationAndComments100QapiPost {
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100QapiPost withTransNo(String transNo) {
        this.transNo = transNo;
        return this;
    }
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100QapiPost withEffectiveDate(String effectiveDate) {
        this.effectiveDate = effectiveDate;
        return this;
    }
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100QapiPost withAcatCode(String acatCode) {
        this.acatCode = acatCode;
        return this;
    }
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100QapiPost withAptyCode(String aptyCode) {
        this.aptyCode = aptyCode;
        return this;
    }
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100QapiPost withProxyForUserId(String proxyForUserId) {
        this.proxyForUserId = proxyForUserId;
        return this;
    }
    ...
    public ElectronicPersonnelActionOtherInformationAndComments100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ElectronicPersonnelActionOtherInformationAndComments100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ElectronicPersonnelActionOtherInformationAndComments100QapiPost) == false) {
            return false;
        }
        ElectronicPersonnelActionOtherInformationAndComments100QapiPost rhs = ((ElectronicPersonnelActionOtherInformationAndComments100QapiPost) other);
