...
public class AutomatedClearingHouseTransactionTypes100GetRequest {
    ...
    public AutomatedClearingHouseTransactionTypes100GetRequest withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public AutomatedClearingHouseTransactionTypes100GetRequest withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public AutomatedClearingHouseTransactionTypes100GetRequest withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public AutomatedClearingHouseTransactionTypes100GetRequest withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public AutomatedClearingHouseTransactionTypes100GetRequest withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public AutomatedClearingHouseTransactionTypes100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AutomatedClearingHouseTransactionTypes100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AutomatedClearingHouseTransactionTypes100GetRequest) == false) {
            return false;
        }
        AutomatedClearingHouseTransactionTypes100GetRequest rhs = ((AutomatedClearingHouseTransactionTypes100GetRequest) other);
