...
public class Sgvatpt {
    ...
    public Sgvatpt withStdnStstDesc(String stdnStstDesc) {
        this.stdnStstDesc = stdnStstDesc;
        return this;
    }
    ...
    public Sgvatpt withCtrlProspectInd(String ctrlProspectInd) {
        this.ctrlProspectInd = ctrlProspectInd;
        return this;
    }
    ...
    public Sgvatpt withCtrlApplInd(String ctrlApplInd) {
        this.ctrlApplInd = ctrlApplInd;
        return this;
    }
    ...
    public Sgvatpt withTermDesc(String termDesc) {
        this.termDesc = termDesc;
        return this;
    }
    ...
    public Sgvatpt withCtrlStudentInd(String ctrlStudentInd) {
        this.ctrlStudentInd = ctrlStudentInd;
        return this;
    }
    ...
    public Sgvatpt withTermCode(String termCode) {
        this.termCode = termCode;
        return this;
    }
    ...
    public Sgvatpt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sgvatpt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sgvatpt) == false) {
            return false;
        }
        Sgvatpt rhs = ((Sgvatpt) other);
