...
public class Sgrsprt__2 {
    ...
    public Sgrsprt__2 withDummy(String dummy) {
        this.dummy = dummy;
        return this;
    }
    ...
    public Sgrsprt__2 withActcDesc(String actcDesc) {
        this.actcDesc = actcDesc;
        return this;
    }
    ...
    public Sgrsprt__2 withEligCode(String eligCode) {
        this.eligCode = eligCode;
        return this;
    }
    ...
    public Sgrsprt__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sgrsprt__2 withEligDesc(String eligDesc) {
        this.eligDesc = eligDesc;
        return this;
    }
    ...
    public Sgrsprt__2 withAthlAidInd(String athlAidInd) {
        this.athlAidInd = athlAidInd;
        return this;
    }
    ...
    public Sgrsprt__2 withSaelDesc(String saelDesc) {
        this.saelDesc = saelDesc;
        return this;
    }
    ...
    public Sgrsprt__2 withSpstCode(String spstCode) {
        this.spstCode = spstCode;
        return this;
    }
    ...
    public Sgrsprt__2 withSaelCode(String saelCode) {
        this.saelCode = saelCode;
        return this;
    }
    ...
    public Sgrsprt__2 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sgrsprt__2 withActcCode(String actcCode) {
        this.actcCode = actcCode;
        return this;
    }
    ...
    public Sgrsprt__2 withSpstDesc(String spstDesc) {
        this.spstDesc = spstDesc;
        return this;
    }
    ...
    public Sgrsprt__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sgrsprt__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("dummy");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sgrsprt__2) == false) {
            return false;
        }
        Sgrsprt__2 rhs = ((Sgrsprt__2) other);
