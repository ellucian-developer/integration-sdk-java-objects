...
public class SatisfactoryAcademicProgressStatuses100GetRequest {
    ...
    public SatisfactoryAcademicProgressStatuses100GetRequest withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public SatisfactoryAcademicProgressStatuses100GetRequest withAidType(Double aidType) {
        this.aidType = aidType;
        return this;
    }
    ...
    public SatisfactoryAcademicProgressStatuses100GetRequest withDisbInd(String disbInd) {
        this.disbInd = disbInd;
        return this;
    }
    ...
    public SatisfactoryAcademicProgressStatuses100GetRequest withActiveInd(String activeInd) {
        this.activeInd = activeInd;
        return this;
    }
    ...
    public SatisfactoryAcademicProgressStatuses100GetRequest withLetrCode(String letrCode) {
        this.letrCode = letrCode;
        return this;
    }
    ...
    public SatisfactoryAcademicProgressStatuses100GetRequest withPriority(Double priority) {
        this.priority = priority;
        return this;
    }
    ...
    public SatisfactoryAcademicProgressStatuses100GetRequest withVrMsgNo(Double vrMsgNo) {
        this.vrMsgNo = vrMsgNo;
        return this;
    }
    ...
    public SatisfactoryAcademicProgressStatuses100GetRequest withPckgInd(String pckgInd) {
        this.pckgInd = pckgInd;
        return this;
    }
    ...
    public SatisfactoryAcademicProgressStatuses100GetRequest withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public SatisfactoryAcademicProgressStatuses100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SatisfactoryAcademicProgressStatuses100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("code");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SatisfactoryAcademicProgressStatuses100GetRequest) == false) {
            return false;
        }
        SatisfactoryAcademicProgressStatuses100GetRequest rhs = ((SatisfactoryAcademicProgressStatuses100GetRequest) other);
