...
public class ListOfSuspendedJournalVouchers100GetRequest {
    ...
    public ListOfSuspendedJournalVouchers100GetRequest withSubmissionNumber(Double submissionNumber) {
        this.submissionNumber = submissionNumber;
        return this;
    }
    ...
    public ListOfSuspendedJournalVouchers100GetRequest withDocNum(String docNum) {
        this.docNum = docNum;
        return this;
    }
    ...
    public ListOfSuspendedJournalVouchers100GetRequest withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public ListOfSuspendedJournalVouchers100GetRequest withTransDate(Date transDate) {
        this.transDate = transDate;
        return this;
    }
    ...
    public ListOfSuspendedJournalVouchers100GetRequest withDocAmt(Double docAmt) {
        this.docAmt = docAmt;
        return this;
    }
    ...
    public ListOfSuspendedJournalVouchers100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ListOfSuspendedJournalVouchers100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ListOfSuspendedJournalVouchers100GetRequest) == false) {
            return false;
        }
        ListOfSuspendedJournalVouchers100GetRequest rhs = ((ListOfSuspendedJournalVouchers100GetRequest) other);
