...
public class GradeCodeSubstitution100QapiPost {
    ...
    public GradeCodeSubstitution100QapiPost withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public GradeCodeSubstitution100QapiPost withAbbrev(String abbrev) {
        this.abbrev = abbrev;
        return this;
    }
    ...
    public GradeCodeSubstitution100QapiPost withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public GradeCodeSubstitution100QapiPost withTermCodeEffective(String termCodeEffective) {
        this.termCodeEffective = termCodeEffective;
        return this;
    }
    ...
    public GradeCodeSubstitution100QapiPost withGrdeStatusInd(String grdeStatusInd) {
        this.grdeStatusInd = grdeStatusInd;
        return this;
    }
    ...
    public GradeCodeSubstitution100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GradeCodeSubstitution100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("code");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GradeCodeSubstitution100QapiPost) == false) {
            return false;
        }
        GradeCodeSubstitution100QapiPost rhs = ((GradeCodeSubstitution100QapiPost) other);
