...
public class Shrgrd__1 {
    ...
    public Shrgrd__1 withGrdeCodeSubstitute(String grdeCodeSubstitute) {
        this.grdeCodeSubstitute = grdeCodeSubstitute;
        return this;
    }
    ...
    public Shrgrd__1 withStvgrdeAbbrevSubstitute(String stvgrdeAbbrevSubstitute) {
        this.stvgrdeAbbrevSubstitute = stvgrdeAbbrevSubstitute;
        return this;
    }
    ...
    public Shrgrd__1 withGmodCodeStudent(String gmodCodeStudent) {
        this.gmodCodeStudent = gmodCodeStudent;
        return this;
    }
    ...
    public Shrgrd__1 withStvgmodDesc(String stvgmodDesc) {
        this.stvgmodDesc = stvgmodDesc;
        return this;
    }
    ...
    public Shrgrd__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Shrgrd__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shrgrd__1) == false) {
            return false;
        }
        Shrgrd__1 rhs = ((Shrgrd__1) other);
