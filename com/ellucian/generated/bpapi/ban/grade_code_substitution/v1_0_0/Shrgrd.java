...
public class Shrgrd {
    ...
    public Shrgrd withGrdeCodeSubstitute(String grdeCodeSubstitute) {
        this.grdeCodeSubstitute = grdeCodeSubstitute;
        return this;
    }
    ...
    public Shrgrd withStvgrdeAbbrevSubstitute(String stvgrdeAbbrevSubstitute) {
        this.stvgrdeAbbrevSubstitute = stvgrdeAbbrevSubstitute;
        return this;
    }
    ...
    public Shrgrd withGmodCodeStudent(String gmodCodeStudent) {
        this.gmodCodeStudent = gmodCodeStudent;
        return this;
    }
    ...
    public Shrgrd withStvgmodDesc(String stvgmodDesc) {
        this.stvgmodDesc = stvgmodDesc;
        return this;
    }
    ...
    public Shrgrd withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Shrgrd.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shrgrd) == false) {
            return false;
        }
        Shrgrd rhs = ((Shrgrd) other);
