...
public class CourseRegistrationStudentAttributeAndCohortRestrictions100GetRequest {
    ...
    public CourseRegistrationStudentAttributeAndCohortRestrictions100GetRequest withScacrseCrseNumb(String scacrseCrseNumb) {
        this.scacrseCrseNumb = scacrseCrseNumb;
        return this;
    }
    ...
    public CourseRegistrationStudentAttributeAndCohortRestrictions100GetRequest withScacrseSubjCode(String scacrseSubjCode) {
        this.scacrseSubjCode = scacrseSubjCode;
        return this;
    }
    ...
    public CourseRegistrationStudentAttributeAndCohortRestrictions100GetRequest withScacrseTermCodeEff(String scacrseTermCodeEff) {
        this.scacrseTermCodeEff = scacrseTermCodeEff;
        return this;
    }
    ...
    public CourseRegistrationStudentAttributeAndCohortRestrictions100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CourseRegistrationStudentAttributeAndCohortRestrictions100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseRegistrationStudentAttributeAndCohortRestrictions100GetRequest) == false) {
            return false;
        }
        CourseRegistrationStudentAttributeAndCohortRestrictions100GetRequest rhs = ((CourseRegistrationStudentAttributeAndCohortRestrictions100GetRequest) other);
