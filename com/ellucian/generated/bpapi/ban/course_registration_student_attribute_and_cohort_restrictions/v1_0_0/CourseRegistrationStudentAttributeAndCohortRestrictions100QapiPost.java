...
public class CourseRegistrationStudentAttributeAndCohortRestrictions100QapiPost {
    ...
    public CourseRegistrationStudentAttributeAndCohortRestrictions100QapiPost withScacrseSubjCode(String scacrseSubjCode) {
        this.scacrseSubjCode = scacrseSubjCode;
        return this;
    }
    ...
    public CourseRegistrationStudentAttributeAndCohortRestrictions100QapiPost withScacrseCrseNumb(String scacrseCrseNumb) {
        this.scacrseCrseNumb = scacrseCrseNumb;
        return this;
    }
    ...
    public CourseRegistrationStudentAttributeAndCohortRestrictions100QapiPost withScacrseTermCodeEff(String scacrseTermCodeEff) {
        this.scacrseTermCodeEff = scacrseTermCodeEff;
        return this;
    }
    ...
    public CourseRegistrationStudentAttributeAndCohortRestrictions100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CourseRegistrationStudentAttributeAndCohortRestrictions100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseRegistrationStudentAttributeAndCohortRestrictions100QapiPost) == false) {
            return false;
        }
        CourseRegistrationStudentAttributeAndCohortRestrictions100QapiPost rhs = ((CourseRegistrationStudentAttributeAndCohortRestrictions100QapiPost) other);
