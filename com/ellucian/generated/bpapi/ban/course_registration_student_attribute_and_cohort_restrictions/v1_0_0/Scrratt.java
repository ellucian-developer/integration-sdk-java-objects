...
public class Scrratt {
    ...
    public Scrratt withAttsCode(String attsCode) {
        this.attsCode = attsCode;
        return this;
    }
    ...
    public Scrratt withAttsDesc(String attsDesc) {
        this.attsDesc = attsDesc;
        return this;
    }
    ...
    public Scrratt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrratt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attsCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrratt) == false) {
            return false;
        }
        Scrratt rhs = ((Scrratt) other);
