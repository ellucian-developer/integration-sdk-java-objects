...
public class Sorcont__2 {
    ...
    public Sorcont__2 withContDesc(String contDesc) {
        this.contDesc = contDesc;
        return this;
    }
    ...
    public Sorcont__2 withContactDate(Date contactDate) {
        this.contactDate = contactDate;
        return this;
    }
    ...
    public Sorcont__2 withCtypCode(String ctypCode) {
        this.ctypCode = ctypCode;
        return this;
    }
    ...
    public Sorcont__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorcont__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("contDesc");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorcont__2) == false) {
            return false;
        }
        Sorcont__2 rhs = ((Sorcont__2) other);
