...
public class Sorcont {
    ...
    public Sorcont withContDesc(String contDesc) {
        this.contDesc = contDesc;
        return this;
    }
    ...
    public Sorcont withContactDate(Date contactDate) {
        this.contactDate = contactDate;
        return this;
    }
    ...
    public Sorcont withCtypCode(String ctypCode) {
        this.ctypCode = ctypCode;
        return this;
    }
    ...
    public Sorcont withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorcont.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("contDesc");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorcont) == false) {
            return false;
        }
        Sorcont rhs = ((Sorcont) other);
