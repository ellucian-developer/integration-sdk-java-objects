...
public class Sarchrt {
    ...
    public Sarchrt withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sarchrt withChrtCode(String chrtCode) {
        this.chrtCode = chrtCode;
        return this;
    }
    ...
    public Sarchrt withChrtDesc(String chrtDesc) {
        this.chrtDesc = chrtDesc;
        return this;
    }
    ...
    public Sarchrt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sarchrt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sarchrt) == false) {
            return false;
        }
        Sarchrt rhs = ((Sarchrt) other);
