...
public class Saraatt__2 {
    ...
    public Saraatt__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Saraatt__2 withAttsCode(String attsCode) {
        this.attsCode = attsCode;
        return this;
    }
    ...
    public Saraatt__2 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Saraatt__2 withAttsDesc(String attsDesc) {
        this.attsDesc = attsDesc;
        return this;
    }
    ...
    public Saraatt__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Saraatt__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Saraatt__2) == false) {
            return false;
        }
        Saraatt__2 rhs = ((Saraatt__2) other);
