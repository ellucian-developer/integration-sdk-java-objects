...
public class CourseRegistrationDegreeAndProgramRestrictions100GetRequest {
    ...
    public CourseRegistrationDegreeAndProgramRestrictions100GetRequest withScacrseCrseNumb(String scacrseCrseNumb) {
        this.scacrseCrseNumb = scacrseCrseNumb;
        return this;
    }
    ...
    public CourseRegistrationDegreeAndProgramRestrictions100GetRequest withScacrseSubjCode(String scacrseSubjCode) {
        this.scacrseSubjCode = scacrseSubjCode;
        return this;
    }
    ...
    public CourseRegistrationDegreeAndProgramRestrictions100GetRequest withScacrseTermCodeEff(String scacrseTermCodeEff) {
        this.scacrseTermCodeEff = scacrseTermCodeEff;
        return this;
    }
    ...
    public CourseRegistrationDegreeAndProgramRestrictions100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CourseRegistrationDegreeAndProgramRestrictions100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseRegistrationDegreeAndProgramRestrictions100GetRequest) == false) {
            return false;
        }
        CourseRegistrationDegreeAndProgramRestrictions100GetRequest rhs = ((CourseRegistrationDegreeAndProgramRestrictions100GetRequest) other);
