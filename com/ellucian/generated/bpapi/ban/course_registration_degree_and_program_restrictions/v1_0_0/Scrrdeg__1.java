...
public class Scrrdeg__1 {
    ...
    public Scrrdeg__1 withDegcDescription(String degcDescription) {
        this.degcDescription = degcDescription;
        return this;
    }
    ...
    public Scrrdeg__1 withDegcCode(String degcCode) {
        this.degcCode = degcCode;
        return this;
    }
    ...
    public Scrrdeg__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrdeg__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrdeg__1) == false) {
            return false;
        }
        Scrrdeg__1 rhs = ((Scrrdeg__1) other);
