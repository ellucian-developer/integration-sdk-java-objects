...
public class Scrrdeg__2 {
    ...
    public Scrrdeg__2 withDegcDescription(String degcDescription) {
        this.degcDescription = degcDescription;
        return this;
    }
    ...
    public Scrrdeg__2 withDegcCode(String degcCode) {
        this.degcCode = degcCode;
        return this;
    }
    ...
    public Scrrdeg__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrdeg__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrdeg__2) == false) {
            return false;
        }
        Scrrdeg__2 rhs = ((Scrrdeg__2) other);
