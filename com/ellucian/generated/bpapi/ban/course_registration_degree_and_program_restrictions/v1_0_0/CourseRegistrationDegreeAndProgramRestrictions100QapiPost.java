...
public class CourseRegistrationDegreeAndProgramRestrictions100QapiPost {
    ...
    public CourseRegistrationDegreeAndProgramRestrictions100QapiPost withScacrseSubjCode(String scacrseSubjCode) {
        this.scacrseSubjCode = scacrseSubjCode;
        return this;
    }
    ...
    public CourseRegistrationDegreeAndProgramRestrictions100QapiPost withScacrseCrseNumb(String scacrseCrseNumb) {
        this.scacrseCrseNumb = scacrseCrseNumb;
        return this;
    }
    ...
    public CourseRegistrationDegreeAndProgramRestrictions100QapiPost withScacrseTermCodeEff(String scacrseTermCodeEff) {
        this.scacrseTermCodeEff = scacrseTermCodeEff;
        return this;
    }
    ...
    public CourseRegistrationDegreeAndProgramRestrictions100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CourseRegistrationDegreeAndProgramRestrictions100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseRegistrationDegreeAndProgramRestrictions100QapiPost) == false) {
            return false;
        }
        CourseRegistrationDegreeAndProgramRestrictions100QapiPost rhs = ((CourseRegistrationDegreeAndProgramRestrictions100QapiPost) other);
