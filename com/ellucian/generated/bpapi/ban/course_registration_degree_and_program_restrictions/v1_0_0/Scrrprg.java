...
public class Scrrprg {
    ...
    public Scrrprg withProgramDescription(String programDescription) {
        this.programDescription = programDescription;
        return this;
    }
    ...
    public Scrrprg withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public Scrrprg withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrrprg.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrrprg) == false) {
            return false;
        }
        Scrrprg rhs = ((Scrrprg) other);
