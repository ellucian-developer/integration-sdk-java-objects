...
public class TransferInstitutionCatalogEntry100QapiPost {
    ...
    public TransferInstitutionCatalogEntry100QapiPost withSbgiCode(String sbgiCode) {
        this.sbgiCode = sbgiCode;
        return this;
    }
    ...
    public TransferInstitutionCatalogEntry100QapiPost withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public TransferInstitutionCatalogEntry100QapiPost withSbgiCodeDef(String sbgiCodeDef) {
        this.sbgiCodeDef = sbgiCodeDef;
        return this;
    }
    ...
    public TransferInstitutionCatalogEntry100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TransferInstitutionCatalogEntry100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sbgiCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TransferInstitutionCatalogEntry100QapiPost) == false) {
            return false;
        }
        TransferInstitutionCatalogEntry100QapiPost rhs = ((TransferInstitutionCatalogEntry100QapiPost) other);
