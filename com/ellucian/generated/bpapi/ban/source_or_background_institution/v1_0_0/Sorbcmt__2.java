...
public class Sorbcmt__2 {
    ...
    public Sorbcmt__2 withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public Sorbcmt__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorbcmt__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("comment");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorbcmt__2) == false) {
            return false;
        }
        Sorbcmt__2 rhs = ((Sorbcmt__2) other);
