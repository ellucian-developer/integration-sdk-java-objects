...
public class SourceOrBackgroundInstitution100QapiPost {
    ...
    public SourceOrBackgroundInstitution100QapiPost withKeyblocSbgiCode(String keyblocSbgiCode) {
        this.keyblocSbgiCode = keyblocSbgiCode;
        return this;
    }
    ...
    public SourceOrBackgroundInstitution100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SourceOrBackgroundInstitution100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SourceOrBackgroundInstitution100QapiPost) == false) {
            return false;
        }
        SourceOrBackgroundInstitution100QapiPost rhs = ((SourceOrBackgroundInstitution100QapiPost) other);
