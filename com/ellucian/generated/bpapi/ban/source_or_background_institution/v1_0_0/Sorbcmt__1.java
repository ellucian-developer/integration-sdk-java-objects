...
public class Sorbcmt__1 {
    ...
    public Sorbcmt__1 withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public Sorbcmt__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorbcmt__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("comment");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorbcmt__1) == false) {
            return false;
        }
        Sorbcmt__1 rhs = ((Sorbcmt__1) other);
