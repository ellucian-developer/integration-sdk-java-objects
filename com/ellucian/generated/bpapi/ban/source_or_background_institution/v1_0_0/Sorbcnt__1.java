...
public class Sorbcnt__1 {
    ...
    public Sorbcnt__1 withPhoneExt(String phoneExt) {
        this.phoneExt = phoneExt;
        return this;
    }
    ...
    public Sorbcnt__1 withPtypDescription(String ptypDescription) {
        this.ptypDescription = ptypDescription;
        return this;
    }
    ...
    public Sorbcnt__1 withPhoneNumber(String phoneNumber) {
        this.phoneNumber = phoneNumber;
        return this;
    }
    ...
    public Sorbcnt__1 withPtypCode(String ptypCode) {
        this.ptypCode = ptypCode;
        return this;
    }
    ...
    public Sorbcnt__1 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Sorbcnt__1 withPhoneArea(String phoneArea) {
        this.phoneArea = phoneArea;
        return this;
    }
    ...
    public Sorbcnt__1 withCtryCodePhone(String ctryCodePhone) {
        this.ctryCodePhone = ctryCodePhone;
        return this;
    }
    ...
    public Sorbcnt__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorbcnt__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("phoneExt");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorbcnt__1) == false) {
            return false;
        }
        Sorbcnt__1 rhs = ((Sorbcnt__1) other);
