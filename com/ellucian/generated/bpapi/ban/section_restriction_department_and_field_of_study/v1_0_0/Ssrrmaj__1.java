...
public class Ssrrmaj__1 {
    ...
    public Ssrrmaj__1 withMajorDescription(String majorDescription) {
        this.majorDescription = majorDescription;
        return this;
    }
    ...
    public Ssrrmaj__1 withMajrCode(String majrCode) {
        this.majrCode = majrCode;
        return this;
    }
    ...
    public Ssrrmaj__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssrrmaj__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssrrmaj__1) == false) {
            return false;
        }
        Ssrrmaj__1 rhs = ((Ssrrmaj__1) other);
