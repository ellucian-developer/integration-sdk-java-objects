...
public class Ssrrmaj {
    ...
    public Ssrrmaj withMajorDescription(String majorDescription) {
        this.majorDescription = majorDescription;
        return this;
    }
    ...
    public Ssrrmaj withMajrCode(String majrCode) {
        this.majrCode = majrCode;
        return this;
    }
    ...
    public Ssrrmaj withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssrrmaj.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssrrmaj) == false) {
            return false;
        }
        Ssrrmaj rhs = ((Ssrrmaj) other);
