...
public class Ssrrdep {
    ...
    public Ssrrdep withDeptDesc(String deptDesc) {
        this.deptDesc = deptDesc;
        return this;
    }
    ...
    public Ssrrdep withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Ssrrdep withDeptCode(String deptCode) {
        this.deptCode = deptCode;
        return this;
    }
    ...
    public Ssrrdep withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssrrdep.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("deptDesc");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssrrdep) == false) {
            return false;
        }
        Ssrrdep rhs = ((Ssrrdep) other);
