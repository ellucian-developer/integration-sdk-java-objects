...
public class GraduationApplicationDisplayRuleCodes100GetRequest {
    ...
    public GraduationApplicationDisplayRuleCodes100GetRequest withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public GraduationApplicationDisplayRuleCodes100GetRequest withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public GraduationApplicationDisplayRuleCodes100GetRequest withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public GraduationApplicationDisplayRuleCodes100GetRequest withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public GraduationApplicationDisplayRuleCodes100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GraduationApplicationDisplayRuleCodes100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GraduationApplicationDisplayRuleCodes100GetRequest) == false) {
            return false;
        }
        GraduationApplicationDisplayRuleCodes100GetRequest rhs = ((GraduationApplicationDisplayRuleCodes100GetRequest) other);
