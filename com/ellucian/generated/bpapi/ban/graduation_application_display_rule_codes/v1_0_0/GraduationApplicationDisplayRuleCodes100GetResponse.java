...
public class GraduationApplicationDisplayRuleCodes100GetResponse {
    ...
    public GraduationApplicationDisplayRuleCodes100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public GraduationApplicationDisplayRuleCodes100GetResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public GraduationApplicationDisplayRuleCodes100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public GraduationApplicationDisplayRuleCodes100GetResponse withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public GraduationApplicationDisplayRuleCodes100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GraduationApplicationDisplayRuleCodes100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GraduationApplicationDisplayRuleCodes100GetResponse) == false) {
            return false;
        }
        GraduationApplicationDisplayRuleCodes100GetResponse rhs = ((GraduationApplicationDisplayRuleCodes100GetResponse) other);
