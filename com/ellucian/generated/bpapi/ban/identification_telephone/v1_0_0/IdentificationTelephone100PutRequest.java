...
package com.ellucian.generated.bpapi.ban.identification_telephone.v1_0_0;
...
public class IdentificationTelephone100PutRequest {
    ...
    public IdentificationTelephone100PutRequest withCriteriaAtypCode(String criteriaAtypCode) {
        this.criteriaAtypCode = criteriaAtypCode;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withCriteriaActivityDate(Date criteriaActivityDate) {
        this.criteriaActivityDate = criteriaActivityDate;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withCriteriaUserId(String criteriaUserId) {
        this.criteriaUserId = criteriaUserId;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withCriteriaStatusInd(String criteriaStatusInd) {
        this.criteriaStatusInd = criteriaStatusInd;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withCriteriaIntlAccess(String criteriaIntlAccess) {
        this.criteriaIntlAccess = criteriaIntlAccess;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withUnlistInd(String unlistInd) {
        this.unlistInd = unlistInd;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withCriteriaCtryCodePhone(String criteriaCtryCodePhone) {
        this.criteriaCtryCodePhone = criteriaCtryCodePhone;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withCriteriaPhoneArea(String criteriaPhoneArea) {
        this.criteriaPhoneArea = criteriaPhoneArea;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withCtryCodePhone(String ctryCodePhone) {
        this.ctryCodePhone = ctryCodePhone;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withCriteriaTeleCode(String criteriaTeleCode) {
        this.criteriaTeleCode = criteriaTeleCode;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withCriteriaPhoneExt(String criteriaPhoneExt) {
        this.criteriaPhoneExt = criteriaPhoneExt;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withCriteriaUnlistInd(String criteriaUnlistInd) {
        this.criteriaUnlistInd = criteriaUnlistInd;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withCriteriaComment(String criteriaComment) {
        this.criteriaComment = criteriaComment;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withCriteriaAddrSeqno(Double criteriaAddrSeqno) {
        this.criteriaAddrSeqno = criteriaAddrSeqno;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withIntlAccess(String intlAccess) {
        this.intlAccess = intlAccess;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withPhoneExt(String phoneExt) {
        this.phoneExt = phoneExt;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withTeleCode(String teleCode) {
        this.teleCode = teleCode;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withPhoneNumber(String phoneNumber) {
        this.phoneNumber = phoneNumber;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withAddrSeqno(Double addrSeqno) {
        this.addrSeqno = addrSeqno;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withCriteriaPrimaryInd(String criteriaPrimaryInd) {
        this.criteriaPrimaryInd = criteriaPrimaryInd;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withPhoneArea(String phoneArea) {
        this.phoneArea = phoneArea;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withCriteriaPhoneNumber(String criteriaPhoneNumber) {
        this.criteriaPhoneNumber = criteriaPhoneNumber;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withAtypCode(String atypCode) {
        this.atypCode = atypCode;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withPrimaryInd(String primaryInd) {
        this.primaryInd = primaryInd;
        return this;
    }
    ...
    public IdentificationTelephone100PutRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(IdentificationTelephone100PutRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IdentificationTelephone100PutRequest) == false) {
            return false;
        }
        IdentificationTelephone100PutRequest rhs = ((IdentificationTelephone100PutRequest) other);
        return (((((((((((((((((((((((((((((this.unlistInd == rhs.unlistInd)||((this.unlistInd!= null)&&this.unlistInd.equals(rhs.unlistInd)))&&((this.criteriaComment == rhs.criteriaComment)||((this.criteriaComment!= null)&&this.criteriaComment.equals(rhs.criteriaComment))))&&((this.ctryCodePhone == rhs.ctryCodePhone)||((this.ctryCodePhone!= null)&&this.ctryCodePhone.equals(rhs.ctryCodePhone))))&&((this.criteriaTeleCode == rhs.criteriaTeleCode)||((this.criteriaTeleCode!= null)&&this.criteriaTeleCode.equals(rhs.criteriaTeleCode))))&&((this.statusInd == rhs.statusInd)||((this.statusInd!= null)&&this.statusInd.equals(rhs.statusInd))))&&((this.criteriaPhoneArea == rhs.criteriaPhoneArea)||((this.criteriaPhoneArea!= null)&&this.criteriaPhoneArea.equals(rhs.criteriaPhoneArea))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.criteriaIntlAccess == rhs.criteriaIntlAccess)||((this.criteriaIntlAccess!= null)&&this.criteriaIntlAccess.equals(rhs.criteriaIntlAccess))))&&((this.intlAccess == rhs.intlAccess)||((this.intlAccess!= null)&&this.intlAccess.equals(rhs.intlAccess))))&&((this.criteriaActivityDate == rhs.criteriaActivityDate)||((this.criteriaActivityDate!= null)&&this.criteriaActivityDate.equals(rhs.criteriaActivityDate))))&&((this.phoneExt == rhs.phoneExt)||((this.phoneExt!= null)&&this.phoneExt.equals(rhs.phoneExt))))&&((this.criteriaAtypCode == rhs.criteriaAtypCode)||((this.criteriaAtypCode!= null)&&this.criteriaAtypCode.equals(rhs.criteriaAtypCode))))&&((this.criteriaUnlistInd == rhs.criteriaUnlistInd)||((this.criteriaUnlistInd!= null)&&this.criteriaUnlistInd.equals(rhs.criteriaUnlistInd))))&&((this.criteriaPhoneExt == rhs.criteriaPhoneExt)||((this.criteriaPhoneExt!= null)&&this.criteriaPhoneExt.equals(rhs.criteriaPhoneExt))))&&((this.teleCode == rhs.teleCode)||((this.teleCode!= null)&&this.teleCode.equals(rhs.teleCode))))&&((this.criteriaCtryCodePhone == rhs.criteriaCtryCodePhone)||((this.criteriaCtryCodePhone!= null)&&this.criteriaCtryCodePhone.equals(rhs.criteriaCtryCodePhone))))&&((this.criteriaAddrSeqno == rhs.criteriaAddrSeqno)||((this.criteriaAddrSeqno!= null)&&this.criteriaAddrSeqno.equals(rhs.criteriaAddrSeqno))))&&((this.criteriaStatusInd == rhs.criteriaStatusInd)||((this.criteriaStatusInd!= null)&&this.criteriaStatusInd.equals(rhs.criteriaStatusInd))))&&((this.criteriaUserId == rhs.criteriaUserId)||((this.criteriaUserId!= null)&&this.criteriaUserId.equals(rhs.criteriaUserId))))&&((this.phoneNumber == rhs.phoneNumber)||((this.phoneNumber!= null)&&this.phoneNumber.equals(rhs.phoneNumber))))&&((this.addrSeqno == rhs.addrSeqno)||((this.addrSeqno!= null)&&this.addrSeqno.equals(rhs.addrSeqno))))&&((this.criteriaPhoneNumber == rhs.criteriaPhoneNumber)||((this.criteriaPhoneNumber!= null)&&this.criteriaPhoneNumber.equals(rhs.criteriaPhoneNumber))))&&((this.phoneArea == rhs.phoneArea)||((this.phoneArea!= null)&&this.phoneArea.equals(rhs.phoneArea))))&&((this.comment == rhs.comment)||((this.comment!= null)&&this.comment.equals(rhs.comment))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.criteriaPrimaryInd == rhs.criteriaPrimaryInd)||((this.criteriaPrimaryInd!= null)&&this.criteriaPrimaryInd.equals(rhs.criteriaPrimaryInd))))&&((this.atypCode == rhs.atypCode)||((this.atypCode!= null)&&this.atypCode.equals(rhs.atypCode))))&&((this.primaryInd == rhs.primaryInd)||((this.primaryInd!= null)&&this.primaryInd.equals(rhs.primaryInd))));
    }
