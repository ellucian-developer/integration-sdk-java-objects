...
public class StoresInventoryCodes100QapiPost {
    ...
    public StoresInventoryCodes100QapiPost withDisplayFtvcommDesc(String displayFtvcommDesc) {
        this.displayFtvcommDesc = displayFtvcommDesc;
        return this;
    }
    ...
    public StoresInventoryCodes100QapiPost withCommCode(String commCode) {
        this.commCode = commCode;
        return this;
    }
    ...
    public StoresInventoryCodes100QapiPost withEffDate(Date effDate) {
        this.effDate = effDate;
        return this;
    }
    ...
    public StoresInventoryCodes100QapiPost withTermDate(Date termDate) {
        this.termDate = termDate;
        return this;
    }
    ...
    public StoresInventoryCodes100QapiPost withUomsCodeIssd(String uomsCodeIssd) {
        this.uomsCodeIssd = uomsCodeIssd;
        return this;
    }
    ...
    public StoresInventoryCodes100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StoresInventoryCodes100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StoresInventoryCodes100QapiPost) == false) {
            return false;
        }
        StoresInventoryCodes100QapiPost rhs = ((StoresInventoryCodes100QapiPost) other);
