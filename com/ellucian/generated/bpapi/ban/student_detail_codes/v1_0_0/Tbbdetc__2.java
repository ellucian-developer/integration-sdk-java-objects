...
public class Tbbdetc__2 {
    ...
    public Tbbdetc__2 withDetailCodeInd(String detailCodeInd) {
        this.detailCodeInd = detailCodeInd;
        return this;
    }
    ...
    public Tbbdetc__2 withTaxMethod(String taxMethod) {
        this.taxMethod = taxMethod;
        return this;
    }
    ...
    public Tbbdetc__2 withDetcActiveInd(String detcActiveInd) {
        this.detcActiveInd = detcActiveInd;
        return this;
    }
    ...
    public Tbbdetc__2 withPayhistInd(String payhistInd) {
        this.payhistInd = payhistInd;
        return this;
    }
    ...
    public Tbbdetc__2 withPrebillPrintInd(String prebillPrintInd) {
        this.prebillPrintInd = prebillPrintInd;
        return this;
    }
    ...
    public Tbbdetc__2 withTivInd(String tivInd) {
        this.tivInd = tivInd;
        return this;
    }
    ...
    public Tbbdetc__2 withTbdcInd(String tbdcInd) {
        this.tbdcInd = tbdcInd;
        return this;
    }
    ...
    public Tbbdetc__2 withLikeTermInd(String likeTermInd) {
        this.likeTermInd = likeTermInd;
        return this;
    }
    ...
    public Tbbdetc__2 withGlNosEnterable(String glNosEnterable) {
        this.glNosEnterable = glNosEnterable;
        return this;
    }
    ...
    public Tbbdetc__2 withLikeScpInd(String likeScpInd) {
        this.likeScpInd = likeScpInd;
        return this;
    }
    ...
    public Tbbdetc__2 withTbbdectNonAllowChgInd(String tbbdectNonAllowChgInd) {
        this.tbbdectNonAllowChgInd = tbbdectNonAllowChgInd;
        return this;
    }
    ...
    public Tbbdetc__2 withAmount(Double amount) {
        this.amount = amount;
        return this;
    }
    ...
    public Tbbdetc__2 withTypeInd(String typeInd) {
        this.typeInd = typeInd;
        return this;
    }
    ...
    public Tbbdetc__2 withPaytCode(String paytCode) {
        this.paytCode = paytCode;
        return this;
    }
    ...
    public Tbbdetc__2 withRefundInd(String refundInd) {
        this.refundInd = refundInd;
        return this;
    }
    ...
    public Tbbdetc__2 withLikeAidyInd(String likeAidyInd) {
        this.likeAidyInd = likeAidyInd;
        return this;
    }
    ...
    public Tbbdetc__2 withLikePeriodInd(String likePeriodInd) {
        this.likePeriodInd = likePeriodInd;
        return this;
    }
    ...
    public Tbbdetc__2 withPriority(String priority) {
        this.priority = priority;
        return this;
    }
    ...
    public Tbbdetc__2 withDetailCode(String detailCode) {
        this.detailCode = detailCode;
        return this;
    }
    ...
    public Tbbdetc__2 withReceiptInd(String receiptInd) {
        this.receiptInd = receiptInd;
        return this;
    }
    ...
    public Tbbdetc__2 withTaxProfile(String taxProfile) {
        this.taxProfile = taxProfile;
        return this;
    }
    ...
    public Tbbdetc__2 withDcatCode(String dcatCode) {
        this.dcatCode = dcatCode;
        return this;
    }
    ...
    public Tbbdetc__2 withAbdcInd(String abdcInd) {
        this.abdcInd = abdcInd;
        return this;
    }
    ...
    public Tbbdetc__2 withDirdInd(String dirdInd) {
        this.dirdInd = dirdInd;
        return this;
    }
    ...
    public Tbbdetc__2 withRefundableInd(String refundableInd) {
        this.refundableInd = refundableInd;
        return this;
    }
    ...
    public Tbbdetc__2 withTaxtCode(String taxtCode) {
        this.taxtCode = taxtCode;
        return this;
    }
    ...
    public Tbbdetc__2 withInstChgInd(String instChgInd) {
        this.instChgInd = instChgInd;
        return this;
    }
    ...
    public Tbbdetc__2 withEffectiveDate(Date effectiveDate) {
        this.effectiveDate = effectiveDate;
        return this;
    }
    ...
    public Tbbdetc__2 withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public Tbbdetc__2 withTermCode(String termCode) {
        this.termCode = termCode;
        return this;
    }
    ...
    public Tbbdetc__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Tbbdetc__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tbbdetc__2) == false) {
            return false;
        }
        Tbbdetc__2 rhs = ((Tbbdetc__2) other);
