...
public class StudentDetailCodes100PutResponse {

    @JsonProperty("tbbdetc")
    private List<Tbbdetc__2> tbbdetc = new ArrayList<Tbbdetc__2>();
    @JsonProperty("tbracct2")
    private List<Tbracct2__2> tbracct2 = new ArrayList<Tbracct2__2>();
    @JsonProperty("tbbeact")
    private List<Tbbeact__2> tbbeact = new ArrayList<Tbbeact__2>();
    @JsonIgnore
    ...
    public StudentDetailCodes100PutResponse withTbbdetc(List<Tbbdetc__2> tbbdetc) {
        this.tbbdetc = tbbdetc;
        return this;
    }

    @JsonProperty("tbracct2")
    public List<Tbracct2__2> getTbracct2() {
        return tbracct2;
    }

    @JsonProperty("tbracct2")
    public void setTbracct2(List<Tbracct2__2> tbracct2) {
        this.tbracct2 = tbracct2;
    }

    public StudentDetailCodes100PutResponse withTbracct2(List<Tbracct2__2> tbracct2) {
        this.tbracct2 = tbracct2;
        return this;
    }

    @JsonProperty("tbbeact")
    public List<Tbbeact__2> getTbbeact() {
        return tbbeact;
    }

    @JsonProperty("tbbeact")
    public void setTbbeact(List<Tbbeact__2> tbbeact) {
        this.tbbeact = tbbeact;
    }

    public StudentDetailCodes100PutResponse withTbbeact(List<Tbbeact__2> tbbeact) {
        this.tbbeact = tbbeact;
        return this;
    }
    ...
    public StudentDetailCodes100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StudentDetailCodes100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tbbdetc");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StudentDetailCodes100PutResponse) == false) {
            return false;
        }
        StudentDetailCodes100PutResponse rhs = ((StudentDetailCodes100PutResponse) other);
