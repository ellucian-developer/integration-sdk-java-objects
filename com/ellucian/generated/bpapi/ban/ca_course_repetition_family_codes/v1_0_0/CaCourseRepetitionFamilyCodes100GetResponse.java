...
public class CaCourseRepetitionFamilyCodes100GetResponse {
    ...
    public CaCourseRepetitionFamilyCodes100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CaCourseRepetitionFamilyCodes100GetResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CaCourseRepetitionFamilyCodes100GetResponse withRepeatLimit(Double repeatLimit) {
        this.repeatLimit = repeatLimit;
        return this;
    }
    ...
    public CaCourseRepetitionFamilyCodes100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public CaCourseRepetitionFamilyCodes100GetResponse withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public CaCourseRepetitionFamilyCodes100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CaCourseRepetitionFamilyCodes100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaCourseRepetitionFamilyCodes100GetResponse) == false) {
            return false;
        }
        CaCourseRepetitionFamilyCodes100GetResponse rhs = ((CaCourseRepetitionFamilyCodes100GetResponse) other);
