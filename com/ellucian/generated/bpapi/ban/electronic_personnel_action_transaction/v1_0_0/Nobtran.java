...
public class Nobtran {
    ...
    public Nobtran withOriginatorName(String originatorName) {
        this.originatorName = originatorName;
        return this;
    }
    ...
    public Nobtran withQueueStatus(String queueStatus) {
        this.queueStatus = queueStatus;
        return this;
    }
    ...
    public Nobtran withApproverAction(String approverAction) {
        this.approverAction = approverAction;
        return this;
    }
    ...
    public Nobtran withQueueOriginatorUserId(String queueOriginatorUserId) {
        this.queueOriginatorUserId = queueOriginatorUserId;
        return this;
    }
    ...
    public Nobtran withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Nobtran.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nobtran) == false) {
            return false;
        }
        Nobtran rhs = ((Nobtran) other);
