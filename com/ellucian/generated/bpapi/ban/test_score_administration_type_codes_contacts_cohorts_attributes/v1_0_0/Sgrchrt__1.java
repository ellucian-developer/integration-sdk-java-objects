...
public class Sgrchrt__1 {
    ...
    public Sgrchrt__1 withChrtCode(String chrtCode) {
        this.chrtCode = chrtCode;
        return this;
    }
    ...
    public Sgrchrt__1 withCreaCode(String creaCode) {
        this.creaCode = creaCode;
        return this;
    }
    ...
    public Sgrchrt__1 withStspKeySequence(Double stspKeySequence) {
        this.stspKeySequence = stspKeySequence;
        return this;
    }
    ...
    public Sgrchrt__1 withActiveInd(String activeInd) {
        this.activeInd = activeInd;
        return this;
    }
    ...
    public Sgrchrt__1 withSgvstspDesc(String sgvstspDesc) {
        this.sgvstspDesc = sgvstspDesc;
        return this;
    }
    ...
    public Sgrchrt__1 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sgrchrt__1 withChrtDescription(String chrtDescription) {
        this.chrtDescription = chrtDescription;
        return this;
    }
    ...
    public Sgrchrt__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sgrchrt__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("chrtCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sgrchrt__1) == false) {
            return false;
        }
        Sgrchrt__1 rhs = ((Sgrchrt__1) other);
