...
public class PurchaseBlanketOrderInquiry100QapiPost {
    ...
    public PurchaseBlanketOrderInquiry100QapiPost withDisplayPohdCode(String displayPohdCode) {
        this.displayPohdCode = displayPohdCode;
        return this;
    }
    ...
    public PurchaseBlanketOrderInquiry100QapiPost withDisplayChangeSeqNum(String displayChangeSeqNum) {
        this.displayChangeSeqNum = displayChangeSeqNum;
        return this;
    }
    ...
    public PurchaseBlanketOrderInquiry100QapiPost withDisplayBordCode(String displayBordCode) {
        this.displayBordCode = displayBordCode;
        return this;
    }
    ...
    public PurchaseBlanketOrderInquiry100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PurchaseBlanketOrderInquiry100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PurchaseBlanketOrderInquiry100QapiPost) == false) {
            return false;
        }
        PurchaseBlanketOrderInquiry100QapiPost rhs = ((PurchaseBlanketOrderInquiry100QapiPost) other);
