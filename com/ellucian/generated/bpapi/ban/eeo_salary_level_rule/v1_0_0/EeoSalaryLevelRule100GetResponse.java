...
public class EeoSalaryLevelRule100GetResponse {
    ...
    public EeoSalaryLevelRule100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public EeoSalaryLevelRule100GetResponse withEeogCode(String eeogCode) {
        this.eeogCode = eeogCode;
        return this;
    }
    ...
    public EeoSalaryLevelRule100GetResponse withSalaLevel(Double salaLevel) {
        this.salaLevel = salaLevel;
        return this;
    }
    ...
    public EeoSalaryLevelRule100GetResponse withEsklCode(String esklCode) {
        this.esklCode = esklCode;
        return this;
    }
    ...
    public EeoSalaryLevelRule100GetResponse withMaxSala(Double maxSala) {
        this.maxSala = maxSala;
        return this;
    }
    ...
    public EeoSalaryLevelRule100GetResponse withEsklDesc(String esklDesc) {
        this.esklDesc = esklDesc;
        return this;
    }
    ...
    public EeoSalaryLevelRule100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EeoSalaryLevelRule100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EeoSalaryLevelRule100GetResponse) == false) {
            return false;
        }
        EeoSalaryLevelRule100GetResponse rhs = ((EeoSalaryLevelRule100GetResponse) other);
        return ((((((((this.activityDate == rhs.activityDate)||((this.activityDate!= null)&&this.activityDate.equals(rhs.activityDate)))&&((this.eeogCode == rhs.eeogCode)||((this.eeogCode!= null)&&this.eeogCode.equals(rhs.eeogCode))))&&((this.salaLevel == rhs.salaLevel)||((this.salaLevel!= null)&&this.salaLevel.equals(rhs.salaLevel))))&&((this.esklCode == rhs.esklCode)||((this.esklCode!= null)&&this.esklCode.equals(rhs.esklCode))))&&((this.maxSala == rhs.maxSala)||((this.maxSala!= null)&&this.maxSala.equals(rhs.maxSala))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.esklDesc == rhs.esklDesc)||((this.esklDesc!= null)&&this.esklDesc.equals(rhs.esklDesc))));
    }
