...
public class GeneralPersonIdentificationAlternateIdentification100PostResponse {
    ...
    public GeneralPersonIdentificationAlternateIdentification100PostResponse withSpridenCurrent(List<SpridenCurrent> spridenCurrent) {
        this.spridenCurrent = spridenCurrent;
        return this;
    }
    ...
    public GeneralPersonIdentificationAlternateIdentification100PostResponse withSpridenPrevious(List<SpridenPreviou> spridenPrevious) {
        this.spridenPrevious = spridenPrevious;
        return this;
    }
    ...
    public GeneralPersonIdentificationAlternateIdentification100PostResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralPersonIdentificationAlternateIdentification100PostResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralPersonIdentificationAlternateIdentification100PostResponse) == false) {
            return false;
        }
        GeneralPersonIdentificationAlternateIdentification100PostResponse rhs = ((GeneralPersonIdentificationAlternateIdentification100PostResponse) other);
