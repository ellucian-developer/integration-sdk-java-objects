...
public class Pprcmnt {
    ...
    public Pprcmnt withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public Pprcmnt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Pprcmnt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("text");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pprcmnt) == false) {
            return false;
        }
        Pprcmnt rhs = ((Pprcmnt) other);
