...
public class Pprccmt {
    ...
    public Pprccmt withCmtyDesc(String cmtyDesc) {
        this.cmtyDesc = cmtyDesc;
        return this;
    }
    ...
    public Pprccmt withCmtyCode(String cmtyCode) {
        this.cmtyCode = cmtyCode;
        return this;
    }
    ...
    public Pprccmt withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public Pprccmt withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Pprccmt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cmtyDesc");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pprccmt) == false) {
            return false;
        }
        Pprccmt rhs = ((Pprccmt) other);
