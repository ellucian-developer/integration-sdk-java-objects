...
public class AdditionalStudentInformationCohortCopy100PostResponse {
    ...
    public AdditionalStudentInformationCohortCopy100PostResponse withSgrchrt(List<Sgrchrt> sgrchrt) {
        this.sgrchrt = sgrchrt;
        return this;
    }
    ...
    public AdditionalStudentInformationCohortCopy100PostResponse withChrtCtrlBlock(List<ChrtCtrlBlock> chrtCtrlBlock) {
        this.chrtCtrlBlock = chrtCtrlBlock;
        return this;
    }
    ...
    public AdditionalStudentInformationCohortCopy100PostResponse withSgastdnKeyBlock(List<SgastdnKeyBlock> sgastdnKeyBlock) {
        this.sgastdnKeyBlock = sgastdnKeyBlock;
        return this;
    }
    ...
    public AdditionalStudentInformationCohortCopy100PostResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AdditionalStudentInformationCohortCopy100PostResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sgrchrt");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AdditionalStudentInformationCohortCopy100PostResponse) == false) {
            return false;
        }
        AdditionalStudentInformationCohortCopy100PostResponse rhs = ((AdditionalStudentInformationCohortCopy100PostResponse) other);
