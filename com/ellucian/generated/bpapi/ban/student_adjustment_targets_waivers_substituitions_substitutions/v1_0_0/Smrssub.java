...
public class Smrssub {
    ...
    public Smrssub withArea(String area) {
        this.area = area;
        return this;
    }
    ...
    public Smrssub withSubjCodeReq(String subjCodeReq) {
        this.subjCodeReq = subjCodeReq;
        return this;
    }
    ...
    public Smrssub withAttrCodeSub(String attrCodeSub) {
        this.attrCodeSub = attrCodeSub;
        return this;
    }
    ...
    public Smrssub withActnCode(String actnCode) {
        this.actnCode = actnCode;
        return this;
    }
    ...
    public Smrssub withAttrCodeReq(String attrCodeReq) {
        this.attrCodeReq = attrCodeReq;
        return this;
    }
    ...
    public Smrssub withCredits(Double credits) {
        this.credits = credits;
        return this;
    }
    ...
    public Smrssub withCrseNumbReq(String crseNumbReq) {
        this.crseNumbReq = crseNumbReq;
        return this;
    }
    ...
    public Smrssub withMaint(String maint) {
        this.maint = maint;
        return this;
    }
    ...
    public Smrssub withCrseNumbSub(String crseNumbSub) {
        this.crseNumbSub = crseNumbSub;
        return this;
    }
    ...
    public Smrssub withSubjCodeSub(String subjCodeSub) {
        this.subjCodeSub = subjCodeSub;
        return this;
    }
    ...
    public Smrssub withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public Smrssub withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Smrssub.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("area");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Smrssub) == false) {
            return false;
        }
        Smrssub rhs = ((Smrssub) other);
