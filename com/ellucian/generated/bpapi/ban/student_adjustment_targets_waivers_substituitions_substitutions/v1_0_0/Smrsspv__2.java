...
public class Smrsspv__2 {
    ...
    public Smrsspv__2 withProgramDesc(String programDesc) {
        this.programDesc = programDesc;
        return this;
    }
    ...
    public Smrsspv__2 withMaint(String maint) {
        this.maint = maint;
        return this;
    }
    ...
    public Smrsspv__2 withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public Smrsspv__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Smrsspv__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Smrsspv__2) == false) {
            return false;
        }
        Smrsspv__2 rhs = ((Smrsspv__2) other);
