...
public class Smrsspv__1 {
    ...
    public Smrsspv__1 withProgramDesc(String programDesc) {
        this.programDesc = programDesc;
        return this;
    }
    ...
    public Smrsspv__1 withMaint(String maint) {
        this.maint = maint;
        return this;
    }
    ...
    public Smrsspv__1 withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public Smrsspv__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Smrsspv__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Smrsspv__1) == false) {
            return false;
        }
        Smrsspv__1 rhs = ((Smrsspv__1) other);
