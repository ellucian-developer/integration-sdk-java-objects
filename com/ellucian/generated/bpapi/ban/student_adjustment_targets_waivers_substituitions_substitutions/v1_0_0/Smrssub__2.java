...
public class Smrssub__2 {
    ...
    public Smrssub__2 withArea(String area) {
        this.area = area;
        return this;
    }
    ...
    public Smrssub__2 withSubjCodeReq(String subjCodeReq) {
        this.subjCodeReq = subjCodeReq;
        return this;
    }
    ...
    public Smrssub__2 withAttrCodeSub(String attrCodeSub) {
        this.attrCodeSub = attrCodeSub;
        return this;
    }
    ...
    public Smrssub__2 withActnCode(String actnCode) {
        this.actnCode = actnCode;
        return this;
    }
    ...
    public Smrssub__2 withAttrCodeReq(String attrCodeReq) {
        this.attrCodeReq = attrCodeReq;
        return this;
    }
    ...
    public Smrssub__2 withCredits(Double credits) {
        this.credits = credits;
        return this;
    }
    ...
    public Smrssub__2 withCrseNumbReq(String crseNumbReq) {
        this.crseNumbReq = crseNumbReq;
        return this;
    }
    ...
    public Smrssub__2 withMaint(String maint) {
        this.maint = maint;
        return this;
    }
    ...
    public Smrssub__2 withCrseNumbSub(String crseNumbSub) {
        this.crseNumbSub = crseNumbSub;
        return this;
    }
    ...
    public Smrssub__2 withSubjCodeSub(String subjCodeSub) {
        this.subjCodeSub = subjCodeSub;
        return this;
    }
    ...
    public Smrssub__2 withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public Smrssub__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Smrssub__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("area");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Smrssub__2) == false) {
            return false;
        }
        Smrssub__2 rhs = ((Smrssub__2) other);
