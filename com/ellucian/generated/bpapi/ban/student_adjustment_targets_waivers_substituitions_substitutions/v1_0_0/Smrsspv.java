...
public class Smrsspv {
    ...
    public Smrsspv withProgramDesc(String programDesc) {
        this.programDesc = programDesc;
        return this;
    }
    ...
    public Smrsspv withMaint(String maint) {
        this.maint = maint;
        return this;
    }
    ...
    public Smrsspv withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public Smrsspv withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Smrsspv.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Smrsspv) == false) {
            return false;
        }
        Smrsspv rhs = ((Smrsspv) other);
