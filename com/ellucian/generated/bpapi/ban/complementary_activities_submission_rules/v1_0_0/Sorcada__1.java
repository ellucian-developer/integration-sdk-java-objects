...
public class Sorcada__1 {
    ...
    public Sorcada__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sorcada__1 withCadtCode(String cadtCode) {
        this.cadtCode = cadtCode;
        return this;
    }
    ...
    public Sorcada__1 withCadtDesc(String cadtDesc) {
        this.cadtDesc = cadtDesc;
        return this;
    }
    ...
    public Sorcada__1 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sorcada__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorcada__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorcada__1) == false) {
            return false;
        }
        Sorcada__1 rhs = ((Sorcada__1) other);
