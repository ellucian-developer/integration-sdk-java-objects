...
public class Sobcasr__1 {
    ...
    public Sobcasr__1 withActcDesc(String actcDesc) {
        this.actcDesc = actcDesc;
        return this;
    }
    ...
    public Sobcasr__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sobcasr__1 withAccgCode(String accgCode) {
        this.accgCode = accgCode;
        return this;
    }
    ...
    public Sobcasr__1 withMaxHrs(Double maxHrs) {
        this.maxHrs = maxHrs;
        return this;
    }
    ...
    public Sobcasr__1 withMinHrs(Double minHrs) {
        this.minHrs = minHrs;
        return this;
    }
    ...
    public Sobcasr__1 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sobcasr__1 withActcCode(String actcCode) {
        this.actcCode = actcCode;
        return this;
    }
    ...
    public Sobcasr__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sobcasr__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("actcDesc");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sobcasr__1) == false) {
            return false;
        }
        Sobcasr__1 rhs = ((Sobcasr__1) other);
