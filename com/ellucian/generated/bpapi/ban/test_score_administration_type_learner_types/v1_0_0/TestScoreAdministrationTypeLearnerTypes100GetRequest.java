...
public class TestScoreAdministrationTypeLearnerTypes100GetRequest {
    ...
    public TestScoreAdministrationTypeLearnerTypes100GetRequest withId(Object id) {
        this.id = id;
        return this;
    }
    ...
    public TestScoreAdministrationTypeLearnerTypes100GetRequest withStvtermTermCode(Object stvtermTermCode) {
        this.stvtermTermCode = stvtermTermCode;
        return this;
    }
    ...
    public TestScoreAdministrationTypeLearnerTypes100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TestScoreAdministrationTypeLearnerTypes100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TestScoreAdministrationTypeLearnerTypes100GetRequest) == false) {
            return false;
        }
        TestScoreAdministrationTypeLearnerTypes100GetRequest rhs = ((TestScoreAdministrationTypeLearnerTypes100GetRequest) other);
