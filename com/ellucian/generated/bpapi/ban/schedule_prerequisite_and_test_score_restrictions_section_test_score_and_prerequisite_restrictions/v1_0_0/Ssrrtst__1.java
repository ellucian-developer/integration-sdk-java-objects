...
public class Ssrrtst__1 {
    ...
    public Ssrrtst__1 withTescCode(String tescCode) {
        this.tescCode = tescCode;
        return this;
    }
    ...
    public Ssrrtst__1 withCrseNumbPreq(String crseNumbPreq) {
        this.crseNumbPreq = crseNumbPreq;
        return this;
    }
    ...
    public Ssrrtst__1 withConnector(String connector) {
        this.connector = connector;
        return this;
    }
    ...
    public Ssrrtst__1 withSubjCodePreq(String subjCodePreq) {
        this.subjCodePreq = subjCodePreq;
        return this;
    }
    ...
    public Ssrrtst__1 withRparen(String rparen) {
        this.rparen = rparen;
        return this;
    }
    ...
    public Ssrrtst__1 withTestScore(String testScore) {
        this.testScore = testScore;
        return this;
    }
    ...
    public Ssrrtst__1 withMinGrde(String minGrde) {
        this.minGrde = minGrde;
        return this;
    }
    ...
    public Ssrrtst__1 withConcurrencyInd(String concurrencyInd) {
        this.concurrencyInd = concurrencyInd;
        return this;
    }
    ...
    public Ssrrtst__1 withLparen(String lparen) {
        this.lparen = lparen;
        return this;
    }
    ...
    public Ssrrtst__1 withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public Ssrrtst__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssrrtst__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tescCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssrrtst__1) == false) {
            return false;
        }
        Ssrrtst__1 rhs = ((Ssrrtst__1) other);
        return ((((((((((((this.tescCode == rhs.tescCode)||((this.tescCode!= null)&&this.tescCode.equals(rhs.tescCode)))&&((this.crseNumbPreq == rhs.crseNumbPreq)||((this.crseNumbPreq!= null)&&this.crseNumbPreq.equals(rhs.crseNumbPreq))))&&((this.connector == rhs.connector)||((this.connector!= null)&&this.connector.equals(rhs.connector))))&&((this.subjCodePreq == rhs.subjCodePreq)||((this.subjCodePreq!= null)&&this.subjCodePreq.equals(rhs.subjCodePreq))))&&((this.rparen == rhs.rparen)||((this.rparen!= null)&&this.rparen.equals(rhs.rparen))))&&((this.testScore == rhs.testScore)||((this.testScore!= null)&&this.testScore.equals(rhs.testScore))))&&((this.minGrde == rhs.minGrde)||((this.minGrde!= null)&&this.minGrde.equals(rhs.minGrde))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.concurrencyInd == rhs.concurrencyInd)||((this.concurrencyInd!= null)&&this.concurrencyInd.equals(rhs.concurrencyInd))))&&((this.lparen == rhs.lparen)||((this.lparen!= null)&&this.lparen.equals(rhs.lparen))))&&((this.levlCode == rhs.levlCode)||((this.levlCode!= null)&&this.levlCode.equals(rhs.levlCode))));
    }
