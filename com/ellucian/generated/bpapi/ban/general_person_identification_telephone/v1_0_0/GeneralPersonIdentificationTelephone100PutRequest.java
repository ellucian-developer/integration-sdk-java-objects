...
public class GeneralPersonIdentificationTelephone100PutRequest {
     ...
     * 
     */
    @JsonProperty("criteria.sprteleActivityDate")
    @JsonPropertyDescription("Lineage reference object : SPRTELE_ACTIVITY_DATE")
    private Date criteriaSprteleActivityDate;
    /**
     * Extension
     * <p>
     * Lineage reference object : SPRTELE_PHONE_EXT
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withCriteriaAtypCode(String criteriaAtypCode) {
        this.criteriaAtypCode = criteriaAtypCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withCriteriaStatusInd(String criteriaStatusInd) {
        this.criteriaStatusInd = criteriaStatusInd;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withCriteriaIntlAccess(String criteriaIntlAccess) {
        this.criteriaIntlAccess = criteriaIntlAccess;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withUnlistInd(String unlistInd) {
        this.unlistInd = unlistInd;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withCriteriaCtryCodePhone(String criteriaCtryCodePhone) {
        this.criteriaCtryCodePhone = criteriaCtryCodePhone;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withCriteriaPhoneArea(String criteriaPhoneArea) {
        this.criteriaPhoneArea = criteriaPhoneArea;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withCriteriaTeleCode(String criteriaTeleCode) {
        this.criteriaTeleCode = criteriaTeleCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withCriteriaPhoneExt(String criteriaPhoneExt) {
        this.criteriaPhoneExt = criteriaPhoneExt;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withCriteriaUnlistInd(String criteriaUnlistInd) {
        this.criteriaUnlistInd = criteriaUnlistInd;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withId(Object id) {
        this.id = id;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withCriteriaComment(String criteriaComment) {
        this.criteriaComment = criteriaComment;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withCriteriaAddrSeqno(Double criteriaAddrSeqno) {
        this.criteriaAddrSeqno = criteriaAddrSeqno;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withIntlAccess(String intlAccess) {
        this.intlAccess = intlAccess;
        return this;
    }
     ...
     */
    @JsonProperty("criteria.sprteleActivityDate")
    public Date getCriteriaSprteleActivityDate() {
        return criteriaSprteleActivityDate;
    }
     ...
     */
    @JsonProperty("criteria.sprteleActivityDate")
    public void setCriteriaSprteleActivityDate(Date criteriaSprteleActivityDate) {
        this.criteriaSprteleActivityDate = criteriaSprteleActivityDate;
    }

    public GeneralPersonIdentificationTelephone100PutRequest withCriteriaSprteleActivityDate(Date criteriaSprteleActivityDate) {
        this.criteriaSprteleActivityDate = criteriaSprteleActivityDate;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withPhoneExt(String phoneExt) {
        this.phoneExt = phoneExt;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withTeleCode(String teleCode) {
        this.teleCode = teleCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withPhoneNumber(String phoneNumber) {
        this.phoneNumber = phoneNumber;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withAddrSeqno(Double addrSeqno) {
        this.addrSeqno = addrSeqno;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withCriteriaPrimaryInd(String criteriaPrimaryInd) {
        this.criteriaPrimaryInd = criteriaPrimaryInd;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withPhoneArea(String phoneArea) {
        this.phoneArea = phoneArea;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withCriteriaPhoneNumber(String criteriaPhoneNumber) {
        this.criteriaPhoneNumber = criteriaPhoneNumber;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withAtypCode(String atypCode) {
        this.atypCode = atypCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withPrimaryInd(String primaryInd) {
        this.primaryInd = primaryInd;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100PutRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralPersonIdentificationTelephone100PutRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        ...
        sb.append(',');
        sb.append("criteriaSprteleActivityDate");
        sb.append('=');
        sb.append(((this.criteriaSprteleActivityDate == null)?"<null>":this.criteriaSprteleActivityDate));
        sb.append(',');
        sb.append("phoneExt");
        sb.append('=');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.criteriaSprteleActivityDate == null)? 0 :this.criteriaSprteleActivityDate.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralPersonIdentificationTelephone100PutRequest) == false) {
            return false;
        }
        GeneralPersonIdentificationTelephone100PutRequest rhs = ((GeneralPersonIdentificationTelephone100PutRequest) other);
        return (((((((((((((((((((((((((((this.unlistInd == rhs.unlistInd)||((this.unlistInd!= null)&&this.unlistInd.equals(rhs.unlistInd)))&&((this.criteriaComment == rhs.criteriaComment)||((this.criteriaComment!= null)&&this.criteriaComment.equals(rhs.criteriaComment))))&&((this.criteriaTeleCode == rhs.criteriaTeleCode)||((this.criteriaTeleCode!= null)&&this.criteriaTeleCode.equals(rhs.criteriaTeleCode))))&&((this.statusInd == rhs.statusInd)||((this.statusInd!= null)&&this.statusInd.equals(rhs.statusInd))))&&((this.criteriaPhoneArea == rhs.criteriaPhoneArea)||((this.criteriaPhoneArea!= null)&&this.criteriaPhoneArea.equals(rhs.criteriaPhoneArea))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.criteriaIntlAccess == rhs.criteriaIntlAccess)||((this.criteriaIntlAccess!= null)&&this.criteriaIntlAccess.equals(rhs.criteriaIntlAccess))))&&((this.intlAccess == rhs.intlAccess)||((this.intlAccess!= null)&&this.intlAccess.equals(rhs.intlAccess))))&&((this.phoneExt == rhs.phoneExt)||((this.phoneExt!= null)&&this.phoneExt.equals(rhs.phoneExt))))&&((this.criteriaAtypCode == rhs.criteriaAtypCode)||((this.criteriaAtypCode!= null)&&this.criteriaAtypCode.equals(rhs.criteriaAtypCode))))&&((this.criteriaUnlistInd == rhs.criteriaUnlistInd)||((this.criteriaUnlistInd!= null)&&this.criteriaUnlistInd.equals(rhs.criteriaUnlistInd))))&&((this.criteriaPhoneExt == rhs.criteriaPhoneExt)||((this.criteriaPhoneExt!= null)&&this.criteriaPhoneExt.equals(rhs.criteriaPhoneExt))))&&((this.teleCode == rhs.teleCode)||((this.teleCode!= null)&&this.teleCode.equals(rhs.teleCode))))&&((this.criteriaCtryCodePhone == rhs.criteriaCtryCodePhone)||((this.criteriaCtryCodePhone!= null)&&this.criteriaCtryCodePhone.equals(rhs.criteriaCtryCodePhone))))&&((this.criteriaAddrSeqno == rhs.criteriaAddrSeqno)||((this.criteriaAddrSeqno!= null)&&this.criteriaAddrSeqno.equals(rhs.criteriaAddrSeqno))))&&((this.criteriaSprteleActivityDate == rhs.criteriaSprteleActivityDate)||((this.criteriaSprteleActivityDate!= null)&&this.criteriaSprteleActivityDate.equals(rhs.criteriaSprteleActivityDate))))&&((this.criteriaStatusInd == rhs.criteriaStatusInd)||((this.criteriaStatusInd!= null)&&this.criteriaStatusInd.equals(rhs.criteriaStatusInd))))&&((this.phoneNumber == rhs.phoneNumber)||((this.phoneNumber!= null)&&this.phoneNumber.equals(rhs.phoneNumber))))&&((this.addrSeqno == rhs.addrSeqno)||((this.addrSeqno!= null)&&this.addrSeqno.equals(rhs.addrSeqno))))&&((this.criteriaPhoneNumber == rhs.criteriaPhoneNumber)||((this.criteriaPhoneNumber!= null)&&this.criteriaPhoneNumber.equals(rhs.criteriaPhoneNumber))))&&((this.phoneArea == rhs.phoneArea)||((this.phoneArea!= null)&&this.phoneArea.equals(rhs.phoneArea))))&&((this.comment == rhs.comment)||((this.comment!= null)&&this.comment.equals(rhs.comment))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.criteriaPrimaryInd == rhs.criteriaPrimaryInd)||((this.criteriaPrimaryInd!= null)&&this.criteriaPrimaryInd.equals(rhs.criteriaPrimaryInd))))&&((this.atypCode == rhs.atypCode)||((this.atypCode!= null)&&this.atypCode.equals(rhs.atypCode))))&&((this.primaryInd == rhs.primaryInd)||((this.primaryInd!= null)&&this.primaryInd.equals(rhs.primaryInd))));
    }
