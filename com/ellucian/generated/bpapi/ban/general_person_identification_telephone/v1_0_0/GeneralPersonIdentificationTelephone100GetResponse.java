...
public class GeneralPersonIdentificationTelephone100GetResponse {
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withPhoneExt(String phoneExt) {
        this.phoneExt = phoneExt;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withUnlistInd(String unlistInd) {
        this.unlistInd = unlistInd;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withCtryCodePhone(String ctryCodePhone) {
        this.ctryCodePhone = ctryCodePhone;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withTeleCode(String teleCode) {
        this.teleCode = teleCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withAddrSeqno(Double addrSeqno) {
        this.addrSeqno = addrSeqno;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withPhoneNumber(String phoneNumber) {
        this.phoneNumber = phoneNumber;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withPhoneArea(String phoneArea) {
        this.phoneArea = phoneArea;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withAtypDescription(String atypDescription) {
        this.atypDescription = atypDescription;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withTeleDescription(String teleDescription) {
        this.teleDescription = teleDescription;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withIntlAccess(String intlAccess) {
        this.intlAccess = intlAccess;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withAtypCode(String atypCode) {
        this.atypCode = atypCode;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withPrimaryInd(String primaryInd) {
        this.primaryInd = primaryInd;
        return this;
    }
    ...
    public GeneralPersonIdentificationTelephone100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralPersonIdentificationTelephone100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("phoneExt");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralPersonIdentificationTelephone100GetResponse) == false) {
            return false;
        }
        GeneralPersonIdentificationTelephone100GetResponse rhs = ((GeneralPersonIdentificationTelephone100GetResponse) other);
