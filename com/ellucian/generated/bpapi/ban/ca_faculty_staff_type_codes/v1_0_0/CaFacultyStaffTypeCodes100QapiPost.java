...
public class CaFacultyStaffTypeCodes100QapiPost {
    ...
    public CaFacultyStaffTypeCodes100QapiPost withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CaFacultyStaffTypeCodes100QapiPost withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public CaFacultyStaffTypeCodes100QapiPost withErrHandlingInd(String errHandlingInd) {
        this.errHandlingInd = errHandlingInd;
        return this;
    }
    ...
    public CaFacultyStaffTypeCodes100QapiPost withLoadActiveInd(String loadActiveInd) {
        this.loadActiveInd = loadActiveInd;
        return this;
    }
    ...
    public CaFacultyStaffTypeCodes100QapiPost withLoadLimit(Double loadLimit) {
        this.loadLimit = loadLimit;
        return this;
    }
    ...
    public CaFacultyStaffTypeCodes100QapiPost withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CaFacultyStaffTypeCodes100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CaFacultyStaffTypeCodes100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("code");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaFacultyStaffTypeCodes100QapiPost) == false) {
            return false;
        }
        CaFacultyStaffTypeCodes100QapiPost rhs = ((CaFacultyStaffTypeCodes100QapiPost) other);
