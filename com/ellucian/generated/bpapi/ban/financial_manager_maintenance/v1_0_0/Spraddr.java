...
public class Spraddr {
    ...
    public Spraddr withCntyCode(String cntyCode) {
        this.cntyCode = cntyCode;
        return this;
    }
    ...
    public Spraddr withStreetLine2(String streetLine2) {
        this.streetLine2 = streetLine2;
        return this;
    }
    ...
    public Spraddr withStreetLine1(String streetLine1) {
        this.streetLine1 = streetLine1;
        return this;
    }
    ...
    public Spraddr withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public Spraddr withStreetLine4(String streetLine4) {
        this.streetLine4 = streetLine4;
        return this;
    }
    ...
    public Spraddr withStreetLine3(String streetLine3) {
        this.streetLine3 = streetLine3;
        return this;
    }
    ...
    public Spraddr withCarrierRoute(String carrierRoute) {
        this.carrierRoute = carrierRoute;
        return this;
    }
    ...
    public Spraddr withHouseNumber(String houseNumber) {
        this.houseNumber = houseNumber;
        return this;
    }
    ...
    public Spraddr withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Spraddr withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public Spraddr withTeleDescription(String teleDescription) {
        this.teleDescription = teleDescription;
        return this;
    }
    ...
    public Spraddr withStatDescription(String statDescription) {
        this.statDescription = statDescription;
        return this;
    }
    ...
    public Spraddr withCorrectionDigit(Double correctionDigit) {
        this.correctionDigit = correctionDigit;
        return this;
    }
    ...
    public Spraddr withZip(String zip) {
        this.zip = zip;
        return this;
    }
    ...
    public Spraddr withPhoneExt(String phoneExt) {
        this.phoneExt = phoneExt;
        return this;
    }
    ...
    public Spraddr withDeliveryPoint(Double deliveryPoint) {
        this.deliveryPoint = deliveryPoint;
        return this;
    }
    ...
    public Spraddr withStatCode(String statCode) {
        this.statCode = statCode;
        return this;
    }
    ...
    public Spraddr withNatnCode(String natnCode) {
        this.natnCode = natnCode;
        return this;
    }
    ...
    public Spraddr withSeqno(Double seqno) {
        this.seqno = seqno;
        return this;
    }
    ...
    public Spraddr withPhoneCtry(String phoneCtry) {
        this.phoneCtry = phoneCtry;
        return this;
    }
    ...
    public Spraddr withAsrcCode(String asrcCode) {
        this.asrcCode = asrcCode;
        return this;
    }
    ...
    public Spraddr withNatnDescription(String natnDescription) {
        this.natnDescription = natnDescription;
        return this;
    }
    ...
    public Spraddr withTeleCode(String teleCode) {
        this.teleCode = teleCode;
        return this;
    }
    ...
    public Spraddr withCntyDescription(String cntyDescription) {
        this.cntyDescription = cntyDescription;
        return this;
    }
    ...
    public Spraddr withPhoneNumber(String phoneNumber) {
        this.phoneNumber = phoneNumber;
        return this;
    }
    ...
    public Spraddr withPhoneArea(String phoneArea) {
        this.phoneArea = phoneArea;
        return this;
    }
    ...
    public Spraddr withAtypDescription(String atypDescription) {
        this.atypDescription = atypDescription;
        return this;
    }
    ...
    public Spraddr withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public Spraddr withAtypCode(String atypCode) {
        this.atypCode = atypCode;
        return this;
    }
    ...
    public Spraddr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Spraddr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cntyCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Spraddr) == false) {
            return false;
        }
        Spraddr rhs = ((Spraddr) other);
