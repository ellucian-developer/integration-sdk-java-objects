...
public class UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100PostRequest {
    ...
    public UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100PostRequest withKeyblckAidyCode(Object keyblckAidyCode) {
        this.keyblckAidyCode = keyblckAidyCode;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100PostRequest withCssCollCde(String cssCollCde) {
        this.cssCollCde = cssCollCde;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100PostRequest) == false) {
            return false;
        }
        UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100PostRequest rhs = ((UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100PostRequest) other);
