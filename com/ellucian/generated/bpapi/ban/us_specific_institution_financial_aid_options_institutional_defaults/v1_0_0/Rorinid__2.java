...
public class Rorinid__2 {
    ...
    public Rorinid__2 withCssCollCde(String cssCollCde) {
        this.cssCollCde = cssCollCde;
        return this;
    }
    ...
    public Rorinid__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Rorinid__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Rorinid__2) == false) {
            return false;
        }
        Rorinid__2 rhs = ((Rorinid__2) other);
