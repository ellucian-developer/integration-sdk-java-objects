...
public class Rorinid {
    ...
    public Rorinid withCssCollCde(String cssCollCde) {
        this.cssCollCde = cssCollCde;
        return this;
    }
    ...
    public Rorinid withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Rorinid.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Rorinid) == false) {
            return false;
        }
        Rorinid rhs = ((Rorinid) other);
