...
public class UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100QapiPost {
    ...
    public UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100QapiPost withKeyblckAidyCode(String keyblckAidyCode) {
        this.keyblckAidyCode = keyblckAidyCode;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100QapiPost withCssCollCde(String cssCollCde) {
        this.cssCollCde = cssCollCde;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100QapiPost) == false) {
            return false;
        }
        UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100QapiPost rhs = ((UsSpecificInstitutionFinancialAidOptionsInstitutionalDefaults100QapiPost) other);
