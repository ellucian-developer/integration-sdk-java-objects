...
public class Tbrdepo__1 {
    ...
    public Tbrdepo__1 withRelAmount(Double relAmount) {
        this.relAmount = relAmount;
        return this;
    }
    ...
    public Tbrdepo__1 withMinAmount(Double minAmount) {
        this.minAmount = minAmount;
        return this;
    }
    ...
    public Tbrdepo__1 withAmount(Double amount) {
        this.amount = amount;
        return this;
    }
    ...
    public Tbrdepo__1 withEntryDate(Date entryDate) {
        this.entryDate = entryDate;
        return this;
    }
    ...
    public Tbrdepo__1 withReleaseDate(Date releaseDate) {
        this.releaseDate = releaseDate;
        return this;
    }
    ...
    public Tbrdepo__1 withDocumentNumber(String documentNumber) {
        this.documentNumber = documentNumber;
        return this;
    }
    ...
    public Tbrdepo__1 withDetailCodePayment(String detailCodePayment) {
        this.detailCodePayment = detailCodePayment;
        return this;
    }
    ...
    public Tbrdepo__1 withDepositBalance(Double depositBalance) {
        this.depositBalance = depositBalance;
        return this;
    }
    ...
    public Tbrdepo__1 withDetailCodeDeposit(String detailCodeDeposit) {
        this.detailCodeDeposit = detailCodeDeposit;
        return this;
    }
    ...
    public Tbrdepo__1 withCreateSource(String createSource) {
        this.createSource = createSource;
        return this;
    }
    ...
    public Tbrdepo__1 withAcctFeedInd(String acctFeedInd) {
        this.acctFeedInd = acctFeedInd;
        return this;
    }
    ...
    public Tbrdepo__1 withAtypCode(String atypCode) {
        this.atypCode = atypCode;
        return this;
    }
    ...
    public Tbrdepo__1 withAtypSeqno(Double atypSeqno) {
        this.atypSeqno = atypSeqno;
        return this;
    }
    ...
    public Tbrdepo__1 withEffectiveDate(Date effectiveDate) {
        this.effectiveDate = effectiveDate;
        return this;
    }
    ...
    public Tbrdepo__1 withReceiptNumber(Double receiptNumber) {
        this.receiptNumber = receiptNumber;
        return this;
    }
    ...
    public Tbrdepo__1 withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public Tbrdepo__1 withExpirationDate(Date expirationDate) {
        this.expirationDate = expirationDate;
        return this;
    }
    ...
    public Tbrdepo__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Tbrdepo__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("relAmount");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tbrdepo__1) == false) {
            return false;
        }
        Tbrdepo__1 rhs = ((Tbrdepo__1) other);
