...
public class Tbrdepo__2 {
    ...
    public Tbrdepo__2 withRelAmount(Double relAmount) {
        this.relAmount = relAmount;
        return this;
    }
    ...
    public Tbrdepo__2 withMinAmount(Double minAmount) {
        this.minAmount = minAmount;
        return this;
    }
    ...
    public Tbrdepo__2 withAmount(Double amount) {
        this.amount = amount;
        return this;
    }
    ...
    public Tbrdepo__2 withEntryDate(Date entryDate) {
        this.entryDate = entryDate;
        return this;
    }
    ...
    public Tbrdepo__2 withReleaseDate(Date releaseDate) {
        this.releaseDate = releaseDate;
        return this;
    }
    ...
    public Tbrdepo__2 withDocumentNumber(String documentNumber) {
        this.documentNumber = documentNumber;
        return this;
    }
    ...
    public Tbrdepo__2 withDetailCodePayment(String detailCodePayment) {
        this.detailCodePayment = detailCodePayment;
        return this;
    }
    ...
    public Tbrdepo__2 withDepositBalance(Double depositBalance) {
        this.depositBalance = depositBalance;
        return this;
    }
    ...
    public Tbrdepo__2 withDetailCodeDeposit(String detailCodeDeposit) {
        this.detailCodeDeposit = detailCodeDeposit;
        return this;
    }
    ...
    public Tbrdepo__2 withCreateSource(String createSource) {
        this.createSource = createSource;
        return this;
    }
    ...
    public Tbrdepo__2 withAcctFeedInd(String acctFeedInd) {
        this.acctFeedInd = acctFeedInd;
        return this;
    }
    ...
    public Tbrdepo__2 withAtypCode(String atypCode) {
        this.atypCode = atypCode;
        return this;
    }
    ...
    public Tbrdepo__2 withAtypSeqno(Double atypSeqno) {
        this.atypSeqno = atypSeqno;
        return this;
    }
    ...
    public Tbrdepo__2 withEffectiveDate(Date effectiveDate) {
        this.effectiveDate = effectiveDate;
        return this;
    }
    ...
    public Tbrdepo__2 withReceiptNumber(Double receiptNumber) {
        this.receiptNumber = receiptNumber;
        return this;
    }
    ...
    public Tbrdepo__2 withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public Tbrdepo__2 withExpirationDate(Date expirationDate) {
        this.expirationDate = expirationDate;
        return this;
    }
    ...
    public Tbrdepo__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Tbrdepo__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("relAmount");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tbrdepo__2) == false) {
            return false;
        }
        Tbrdepo__2 rhs = ((Tbrdepo__2) other);
        return (((((((((((((((((((this.relAmount == rhs.relAmount)||((this.relAmount!= null)&&this.relAmount.equals(rhs.relAmount)))&&((this.minAmount == rhs.minAmount)||((this.minAmount!= null)&&this.minAmount.equals(rhs.minAmount))))&&((this.amount == rhs.amount)||((this.amount!= null)&&this.amount.equals(rhs.amount))))&&((this.entryDate == rhs.entryDate)||((this.entryDate!= null)&&this.entryDate.equals(rhs.entryDate))))&&((this.releaseDate == rhs.releaseDate)||((this.releaseDate!= null)&&this.releaseDate.equals(rhs.releaseDate))))&&((this.documentNumber == rhs.documentNumber)||((this.documentNumber!= null)&&this.documentNumber.equals(rhs.documentNumber))))&&((this.detailCodePayment == rhs.detailCodePayment)||((this.detailCodePayment!= null)&&this.detailCodePayment.equals(rhs.detailCodePayment))))&&((this.depositBalance == rhs.depositBalance)||((this.depositBalance!= null)&&this.depositBalance.equals(rhs.depositBalance))))&&((this.detailCodeDeposit == rhs.detailCodeDeposit)||((this.detailCodeDeposit!= null)&&this.detailCodeDeposit.equals(rhs.detailCodeDeposit))))&&((this.createSource == rhs.createSource)||((this.createSource!= null)&&this.createSource.equals(rhs.createSource))))&&((this.acctFeedInd == rhs.acctFeedInd)||((this.acctFeedInd!= null)&&this.acctFeedInd.equals(rhs.acctFeedInd))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.atypCode == rhs.atypCode)||((this.atypCode!= null)&&this.atypCode.equals(rhs.atypCode))))&&((this.atypSeqno == rhs.atypSeqno)||((this.atypSeqno!= null)&&this.atypSeqno.equals(rhs.atypSeqno))))&&((this.effectiveDate == rhs.effectiveDate)||((this.effectiveDate!= null)&&this.effectiveDate.equals(rhs.effectiveDate))))&&((this.receiptNumber == rhs.receiptNumber)||((this.receiptNumber!= null)&&this.receiptNumber.equals(rhs.receiptNumber))))&&((this.desc == rhs.desc)||((this.desc!= null)&&this.desc.equals(rhs.desc))))&&((this.expirationDate == rhs.expirationDate)||((this.expirationDate!= null)&&this.expirationDate.equals(rhs.expirationDate))));
    }
