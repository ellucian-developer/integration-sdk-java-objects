...
public class GlobalInstitutionFinancialAidOptionsWebProcessingRules100QapiPost {
    ...
    public GlobalInstitutionFinancialAidOptionsWebProcessingRules100QapiPost withKeyblckAidyCode(String keyblckAidyCode) {
        this.keyblckAidyCode = keyblckAidyCode;
        return this;
    }
    ...
    public GlobalInstitutionFinancialAidOptionsWebProcessingRules100QapiPost withTreqCode(String treqCode) {
        this.treqCode = treqCode;
        return this;
    }
    ...
    public GlobalInstitutionFinancialAidOptionsWebProcessingRules100QapiPost withTrstCode(String trstCode) {
        this.trstCode = trstCode;
        return this;
    }
    ...
    public GlobalInstitutionFinancialAidOptionsWebProcessingRules100QapiPost withTypeCode(String typeCode) {
        this.typeCode = typeCode;
        return this;
    }
    ...
    public GlobalInstitutionFinancialAidOptionsWebProcessingRules100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GlobalInstitutionFinancialAidOptionsWebProcessingRules100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GlobalInstitutionFinancialAidOptionsWebProcessingRules100QapiPost) == false) {
            return false;
        }
        GlobalInstitutionFinancialAidOptionsWebProcessingRules100QapiPost rhs = ((GlobalInstitutionFinancialAidOptionsWebProcessingRules100QapiPost) other);
