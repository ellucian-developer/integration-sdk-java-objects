...
public class Ssrtext {
    ...
    public Ssrtext withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public Ssrtext withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssrtext.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("text");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssrtext) == false) {
            return false;
        }
        Ssrtext rhs = ((Ssrtext) other);
