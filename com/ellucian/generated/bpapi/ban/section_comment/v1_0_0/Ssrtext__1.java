...
public class Ssrtext__1 {
    ...
    public Ssrtext__1 withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public Ssrtext__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ssrtext__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("text");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ssrtext__1) == false) {
            return false;
        }
        Ssrtext__1 rhs = ((Ssrtext__1) other);
