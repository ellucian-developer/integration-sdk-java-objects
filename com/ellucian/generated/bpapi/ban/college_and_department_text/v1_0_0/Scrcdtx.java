...
public class Scrcdtx {
    ...
    public Scrcdtx withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public Scrcdtx withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scrcdtx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("text");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scrcdtx) == false) {
            return false;
        }
        Scrcdtx rhs = ((Scrcdtx) other);
