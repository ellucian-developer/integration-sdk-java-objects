...
public class CaTermCodes100GetResponse {
    ...
    public CaTermCodes100GetResponse withFaPeriod(Double faPeriod) {
        this.faPeriod = faPeriod;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withTermLenMult(Double termLenMult) {
        this.termLenMult = termLenMult;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withTrmtCode(String trmtCode) {
        this.trmtCode = trmtCode;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withSystemReqInd(String systemReqInd) {
        this.systemReqInd = systemReqInd;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withApportCde(String apportCde) {
        this.apportCde = apportCde;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withEndDate(Date endDate) {
        this.endDate = endDate;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withFaTerm(String faTerm) {
        this.faTerm = faTerm;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withTermLenMultIs(Double termLenMultIs) {
        this.termLenMultIs = termLenMultIs;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withFaSummerInd(String faSummerInd) {
        this.faSummerInd = faSummerInd;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withAcyrCode(String acyrCode) {
        this.acyrCode = acyrCode;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withHousingEndDate(Date housingEndDate) {
        this.housingEndDate = housingEndDate;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withFaProcYr(String faProcYr) {
        this.faProcYr = faProcYr;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withMisTermId(String misTermId) {
        this.misTermId = misTermId;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withFaEndPeriod(Double faEndPeriod) {
        this.faEndPeriod = faEndPeriod;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withStartDate(Date startDate) {
        this.startDate = startDate;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withHousingStartDate(Date housingStartDate) {
        this.housingStartDate = housingStartDate;
        return this;
    }
    ...
    public CaTermCodes100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CaTermCodes100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("faPeriod");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaTermCodes100GetResponse) == false) {
            return false;
        }
        CaTermCodes100GetResponse rhs = ((CaTermCodes100GetResponse) other);
        return (((((((((((((((((((((this.faPeriod == rhs.faPeriod)||((this.faPeriod!= null)&&this.faPeriod.equals(rhs.faPeriod)))&&((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code))))&&((this.termLenMult == rhs.termLenMult)||((this.termLenMult!= null)&&this.termLenMult.equals(rhs.termLenMult))))&&((this.trmtCode == rhs.trmtCode)||((this.trmtCode!= null)&&this.trmtCode.equals(rhs.trmtCode))))&&((this.systemReqInd == rhs.systemReqInd)||((this.systemReqInd!= null)&&this.systemReqInd.equals(rhs.systemReqInd))))&&((this.apportCde == rhs.apportCde)||((this.apportCde!= null)&&this.apportCde.equals(rhs.apportCde))))&&((this.endDate == rhs.endDate)||((this.endDate!= null)&&this.endDate.equals(rhs.endDate))))&&((this.faTerm == rhs.faTerm)||((this.faTerm!= null)&&this.faTerm.equals(rhs.faTerm))))&&((this.termLenMultIs == rhs.termLenMultIs)||((this.termLenMultIs!= null)&&this.termLenMultIs.equals(rhs.termLenMultIs))))&&((this.faSummerInd == rhs.faSummerInd)||((this.faSummerInd!= null)&&this.faSummerInd.equals(rhs.faSummerInd))))&&((this.activityDate == rhs.activityDate)||((this.activityDate!= null)&&this.activityDate.equals(rhs.activityDate))))&&((this.acyrCode == rhs.acyrCode)||((this.acyrCode!= null)&&this.acyrCode.equals(rhs.acyrCode))))&&((this.housingEndDate == rhs.housingEndDate)||((this.housingEndDate!= null)&&this.housingEndDate.equals(rhs.housingEndDate))))&&((this.faProcYr == rhs.faProcYr)||((this.faProcYr!= null)&&this.faProcYr.equals(rhs.faProcYr))))&&((this.misTermId == rhs.misTermId)||((this.misTermId!= null)&&this.misTermId.equals(rhs.misTermId))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.faEndPeriod == rhs.faEndPeriod)||((this.faEndPeriod!= null)&&this.faEndPeriod.equals(rhs.faEndPeriod))))&&((this.startDate == rhs.startDate)||((this.startDate!= null)&&this.startDate.equals(rhs.startDate))))&&((this.desc == rhs.desc)||((this.desc!= null)&&this.desc.equals(rhs.desc))))&&((this.housingStartDate == rhs.housingStartDate)||((this.housingStartDate!= null)&&this.housingStartDate.equals(rhs.housingStartDate))));
    }
