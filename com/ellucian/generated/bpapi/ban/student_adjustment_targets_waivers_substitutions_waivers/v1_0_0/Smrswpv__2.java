...
public class Smrswpv__2 {
    ...
    public Smrswpv__2 withProgramDesc(String programDesc) {
        this.programDesc = programDesc;
        return this;
    }
    ...
    public Smrswpv__2 withMaint(String maint) {
        this.maint = maint;
        return this;
    }
    ...
    public Smrswpv__2 withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public Smrswpv__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Smrswpv__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Smrswpv__2) == false) {
            return false;
        }
        Smrswpv__2 rhs = ((Smrswpv__2) other);
