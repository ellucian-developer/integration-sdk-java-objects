...
public class Smrswpv__1 {
    ...
    public Smrswpv__1 withProgramDesc(String programDesc) {
        this.programDesc = programDesc;
        return this;
    }
    ...
    public Smrswpv__1 withMaint(String maint) {
        this.maint = maint;
        return this;
    }
    ...
    public Smrswpv__1 withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public Smrswpv__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Smrswpv__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Smrswpv__1) == false) {
            return false;
        }
        Smrswpv__1 rhs = ((Smrswpv__1) other);
