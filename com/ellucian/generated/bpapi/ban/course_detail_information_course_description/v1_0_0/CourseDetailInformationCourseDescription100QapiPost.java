...
public class CourseDetailInformationCourseDescription100QapiPost {
    ...
    public CourseDetailInformationCourseDescription100QapiPost withScacrseSubjCode(String scacrseSubjCode) {
        this.scacrseSubjCode = scacrseSubjCode;
        return this;
    }
    ...
    public CourseDetailInformationCourseDescription100QapiPost withScacrseCrseNumb(String scacrseCrseNumb) {
        this.scacrseCrseNumb = scacrseCrseNumb;
        return this;
    }
    ...
    public CourseDetailInformationCourseDescription100QapiPost withScacrseTermCodeEff(String scacrseTermCodeEff) {
        this.scacrseTermCodeEff = scacrseTermCodeEff;
        return this;
    }
    ...
    public CourseDetailInformationCourseDescription100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CourseDetailInformationCourseDescription100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CourseDetailInformationCourseDescription100QapiPost) == false) {
            return false;
        }
        CourseDetailInformationCourseDescription100QapiPost rhs = ((CourseDetailInformationCourseDescription100QapiPost) other);
