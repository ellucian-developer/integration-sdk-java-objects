...
public class TaxIdSearch100QapiPost {
    ...
    public TaxIdSearch100QapiPost withKeyblckStudentId(String keyblckStudentId) {
        this.keyblckStudentId = keyblckStudentId;
        return this;
    }
    ...
    public TaxIdSearch100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TaxIdSearch100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TaxIdSearch100QapiPost) == false) {
            return false;
        }
        TaxIdSearch100QapiPost rhs = ((TaxIdSearch100QapiPost) other);
