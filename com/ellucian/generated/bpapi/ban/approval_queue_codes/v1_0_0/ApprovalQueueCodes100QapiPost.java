...
public class ApprovalQueueCodes100QapiPost {
    ...
    public ApprovalQueueCodes100QapiPost withApprovalReq(String approvalReq) {
        this.approvalReq = approvalReq;
        return this;
    }
    ...
    public ApprovalQueueCodes100QapiPost withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public ApprovalQueueCodes100QapiPost withNextQueueId(String nextQueueId) {
        this.nextQueueId = nextQueueId;
        return this;
    }
    ...
    public ApprovalQueueCodes100QapiPost withQueueId(String queueId) {
        this.queueId = queueId;
        return this;
    }
    ...
    public ApprovalQueueCodes100QapiPost withQueueLimit(Double queueLimit) {
        this.queueLimit = queueLimit;
        return this;
    }
    ...
    public ApprovalQueueCodes100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ApprovalQueueCodes100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ApprovalQueueCodes100QapiPost) == false) {
            return false;
        }
        ApprovalQueueCodes100QapiPost rhs = ((ApprovalQueueCodes100QapiPost) other);
