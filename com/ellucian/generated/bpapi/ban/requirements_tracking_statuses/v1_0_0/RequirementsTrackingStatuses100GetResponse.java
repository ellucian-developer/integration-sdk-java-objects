...
public class RequirementsTrackingStatuses100GetResponse {
    ...
    public RequirementsTrackingStatuses100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public RequirementsTrackingStatuses100GetResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public RequirementsTrackingStatuses100GetResponse withSatInd(String satInd) {
        this.satInd = satInd;
        return this;
    }
    ...
    public RequirementsTrackingStatuses100GetResponse withInfoAccessInd(String infoAccessInd) {
        this.infoAccessInd = infoAccessInd;
        return this;
    }
    ...
    public RequirementsTrackingStatuses100GetResponse withTrkLtrInd(String trkLtrInd) {
        this.trkLtrInd = trkLtrInd;
        return this;
    }
    ...
    public RequirementsTrackingStatuses100GetResponse withVrMsgNo(Double vrMsgNo) {
        this.vrMsgNo = vrMsgNo;
        return this;
    }
    ...
    public RequirementsTrackingStatuses100GetResponse withLongDesc(String longDesc) {
        this.longDesc = longDesc;
        return this;
    }
    ...
    public RequirementsTrackingStatuses100GetResponse withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public RequirementsTrackingStatuses100GetResponse withReqInstrInd(String reqInstrInd) {
        this.reqInstrInd = reqInstrInd;
        return this;
    }
    ...
    public RequirementsTrackingStatuses100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RequirementsTrackingStatuses100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequirementsTrackingStatuses100GetResponse) == false) {
            return false;
        }
        RequirementsTrackingStatuses100GetResponse rhs = ((RequirementsTrackingStatuses100GetResponse) other);
