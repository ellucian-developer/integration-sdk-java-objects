...
public class StudentAdjistmentTargetsWaiversSubstitutionsOtherAdjustmentsTracking100PutResponse {
    ...
    public StudentAdjistmentTargetsWaiversSubstitutionsOtherAdjustmentsTracking100PutResponse withSmrsotk(List<Smrsotk> smrsotk) {
        this.smrsotk = smrsotk;
        return this;
    }
    ...
    public StudentAdjistmentTargetsWaiversSubstitutionsOtherAdjustmentsTracking100PutResponse withSmbsotk(List<Smbsotk> smbsotk) {
        this.smbsotk = smbsotk;
        return this;
    }
    ...
    public StudentAdjistmentTargetsWaiversSubstitutionsOtherAdjustmentsTracking100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StudentAdjistmentTargetsWaiversSubstitutionsOtherAdjustmentsTracking100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("smrsotk");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StudentAdjistmentTargetsWaiversSubstitutionsOtherAdjustmentsTracking100PutResponse) == false) {
            return false;
        }
        StudentAdjistmentTargetsWaiversSubstitutionsOtherAdjustmentsTracking100PutResponse rhs = ((StudentAdjistmentTargetsWaiversSubstitutionsOtherAdjustmentsTracking100PutResponse) other);
