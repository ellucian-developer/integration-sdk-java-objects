...
public class AdmissionsApplicationFeesMailSubmissionWithdrawal100GetRequest {
    ...
    public AdmissionsApplicationFeesMailSubmissionWithdrawal100GetRequest withKbentryTermCode(Object kbentryTermCode) {
        this.kbentryTermCode = kbentryTermCode;
        return this;
    }
    ...
    public AdmissionsApplicationFeesMailSubmissionWithdrawal100GetRequest withId(Object id) {
        this.id = id;
        return this;
    }
    ...
    public AdmissionsApplicationFeesMailSubmissionWithdrawal100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AdmissionsApplicationFeesMailSubmissionWithdrawal100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AdmissionsApplicationFeesMailSubmissionWithdrawal100GetRequest) == false) {
            return false;
        }
        AdmissionsApplicationFeesMailSubmissionWithdrawal100GetRequest rhs = ((AdmissionsApplicationFeesMailSubmissionWithdrawal100GetRequest) other);
