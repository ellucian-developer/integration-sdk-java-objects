...
public class AdmissionsApplicationFeesMailSubmissionWithdrawal100QapiPost {
    ...
    public AdmissionsApplicationFeesMailSubmissionWithdrawal100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public AdmissionsApplicationFeesMailSubmissionWithdrawal100QapiPost withKbentryTermCode(String kbentryTermCode) {
        this.kbentryTermCode = kbentryTermCode;
        return this;
    }
    ...
    public AdmissionsApplicationFeesMailSubmissionWithdrawal100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AdmissionsApplicationFeesMailSubmissionWithdrawal100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AdmissionsApplicationFeesMailSubmissionWithdrawal100QapiPost) == false) {
            return false;
        }
        AdmissionsApplicationFeesMailSubmissionWithdrawal100QapiPost rhs = ((AdmissionsApplicationFeesMailSubmissionWithdrawal100QapiPost) other);
