...
public class Smrsotk__1 {
    ...
    public Smrsotk__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Smrsotk__1 withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public Smrsotk__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Smrsotk__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Smrsotk__1) == false) {
            return false;
        }
        Smrsotk__1 rhs = ((Smrsotk__1) other);
