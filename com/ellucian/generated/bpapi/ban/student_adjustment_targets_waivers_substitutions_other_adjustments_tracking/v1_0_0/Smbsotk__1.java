...
public class Smbsotk__1 {
    ...
    public Smbsotk__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Smbsotk__1 withTermCodeEff(String termCodeEff) {
        this.termCodeEff = termCodeEff;
        return this;
    }
    ...
    public Smbsotk__1 withTableNameDesc(String tableNameDesc) {
        this.tableNameDesc = tableNameDesc;
        return this;
    }
    ...
    public Smbsotk__1 withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public Smbsotk__1 withTableName(String tableName) {
        this.tableName = tableName;
        return this;
    }
    ...
    public Smbsotk__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Smbsotk__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Smbsotk__1) == false) {
            return false;
        }
        Smbsotk__1 rhs = ((Smbsotk__1) other);
