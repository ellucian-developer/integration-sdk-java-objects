...
public class Smrsotk__2 {
    ...
    public Smrsotk__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Smrsotk__2 withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public Smrsotk__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Smrsotk__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Smrsotk__2) == false) {
            return false;
        }
        Smrsotk__2 rhs = ((Smrsotk__2) other);
