...
public class Smbsotk__2 {
    ...
    public Smbsotk__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Smbsotk__2 withTermCodeEff(String termCodeEff) {
        this.termCodeEff = termCodeEff;
        return this;
    }
    ...
    public Smbsotk__2 withTableNameDesc(String tableNameDesc) {
        this.tableNameDesc = tableNameDesc;
        return this;
    }
    ...
    public Smbsotk__2 withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public Smbsotk__2 withTableName(String tableName) {
        this.tableName = tableName;
        return this;
    }
    ...
    public Smbsotk__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Smbsotk__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Smbsotk__2) == false) {
            return false;
        }
        Smbsotk__2 rhs = ((Smbsotk__2) other);
