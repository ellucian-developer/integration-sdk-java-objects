...
public class BlockScheduleQuery100GetRequest {
    ...
    public BlockScheduleQuery100GetRequest withCriteriaBlckCode(String criteriaBlckCode) {
        this.criteriaBlckCode = criteriaBlckCode;
        return this;
    }
    ...
    public BlockScheduleQuery100GetRequest withCriteriaBlckDescription(String criteriaBlckDescription) {
        this.criteriaBlckDescription = criteriaBlckDescription;
        return this;
    }
    ...
    public BlockScheduleQuery100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(BlockScheduleQuery100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BlockScheduleQuery100GetRequest) == false) {
            return false;
        }
        BlockScheduleQuery100GetRequest rhs = ((BlockScheduleQuery100GetRequest) other);
        return ((((((this.ssablkqTermCodeEff == rhs.ssablkqTermCodeEff)||((this.ssablkqTermCodeEff!= null)&&this.ssablkqTermCodeEff.equals(rhs.ssablkqTermCodeEff)))&&((this.criteriaBlckDescription == rhs.criteriaBlckDescription)||((this.criteriaBlckDescription!= null)&&this.criteriaBlckDescription.equals(rhs.criteriaBlckDescription))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.criteriaBlckCode == rhs.criteriaBlckCode)||((this.criteriaBlckCode!= null)&&this.criteriaBlckCode.equals(rhs.criteriaBlckCode))))&&((this.ssablkqKeyCrn == rhs.ssablkqKeyCrn)||((this.ssablkqKeyCrn!= null)&&this.ssablkqKeyCrn.equals(rhs.ssablkqKeyCrn))));
    }
