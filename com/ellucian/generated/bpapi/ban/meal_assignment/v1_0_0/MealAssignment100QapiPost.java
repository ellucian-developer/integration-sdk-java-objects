...
public class MealAssignment100QapiPost {
    ...
    public MealAssignment100QapiPost withKeyblocTermCode(String keyblocTermCode) {
        this.keyblocTermCode = keyblocTermCode;
        return this;
    }
    ...
    public MealAssignment100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public MealAssignment100QapiPost withStatusDate(String statusDate) {
        this.statusDate = statusDate;
        return this;
    }
    ...
    public MealAssignment100QapiPost withTermCode(String termCode) {
        this.termCode = termCode;
        return this;
    }
    ...
    public MealAssignment100QapiPost withRollInd(String rollInd) {
        this.rollInd = rollInd;
        return this;
    }
    ...
    public MealAssignment100QapiPost withMscdCode(String mscdCode) {
        this.mscdCode = mscdCode;
        return this;
    }
    ...
    public MealAssignment100QapiPost withMrcdCode(String mrcdCode) {
        this.mrcdCode = mrcdCode;
        return this;
    }
    ...
    public MealAssignment100QapiPost withArInd(String arInd) {
        this.arInd = arInd;
        return this;
    }
    ...
    public MealAssignment100QapiPost withAssessNeeded(String assessNeeded) {
        this.assessNeeded = assessNeeded;
        return this;
    }
    ...
    public MealAssignment100QapiPost withOnlOrBat(String onlOrBat) {
        this.onlOrBat = onlOrBat;
        return this;
    }
    ...
    public MealAssignment100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(MealAssignment100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MealAssignment100QapiPost) == false) {
            return false;
        }
        MealAssignment100QapiPost rhs = ((MealAssignment100QapiPost) other);
