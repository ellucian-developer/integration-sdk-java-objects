...
public class IdentificationBiographical100PostRequest {
    ...
    public IdentificationBiographical100PostRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public IdentificationBiographical100PostRequest withRaceCde(String raceCde) {
        this.raceCde = raceCde;
        return this;
    }
    ...
    public IdentificationBiographical100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(IdentificationBiographical100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IdentificationBiographical100PostRequest) == false) {
            return false;
        }
        IdentificationBiographical100PostRequest rhs = ((IdentificationBiographical100PostRequest) other);
