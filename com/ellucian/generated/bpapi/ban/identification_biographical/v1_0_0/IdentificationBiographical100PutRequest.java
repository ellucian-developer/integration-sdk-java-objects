...
package com.ellucian.generated.bpapi.ban.identification_biographical.v1_0_0;
...
public class IdentificationBiographical100PutRequest {
    ...
    public IdentificationBiographical100PutRequest withDeadDate(Date deadDate) {
        this.deadDate = deadDate;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withMrtlCode(String mrtlCode) {
        this.mrtlCode = mrtlCode;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withConfirmedReDate(Date confirmedReDate) {
        this.confirmedReDate = confirmedReDate;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withLgcyCode(String lgcyCode) {
        this.lgcyCode = lgcyCode;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withRelgCode(String relgCode) {
        this.relgCode = relgCode;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withConfidInd(String confidInd) {
        this.confidInd = confidInd;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withArmedServMedVetInd(String armedServMedVetInd) {
        this.armedServMedVetInd = armedServMedVetInd;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withBirthDate(Date birthDate) {
        this.birthDate = birthDate;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withVeraInd(String veraInd) {
        this.veraInd = veraInd;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withSsn(String ssn) {
        this.ssn = ssn;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withGndrCode(String gndrCode) {
        this.gndrCode = gndrCode;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withActiveDutySeprDate(Date activeDutySeprDate) {
        this.activeDutySeprDate = activeDutySeprDate;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withDeadInd(String deadInd) {
        this.deadInd = deadInd;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withCitzCode(String citzCode) {
        this.citzCode = citzCode;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withVetcFileNumber(String vetcFileNumber) {
        this.vetcFileNumber = vetcFileNumber;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withId(Object id) {
        this.id = id;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withEthnCde(String ethnCde) {
        this.ethnCde = ethnCde;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withConfirmedReCde(String confirmedReCde) {
        this.confirmedReCde = confirmedReCde;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withSdvetInd(String sdvetInd) {
        this.sdvetInd = sdvetInd;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withPprnCode(String pprnCode) {
        this.pprnCode = pprnCode;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withPersSex(String persSex) {
        this.persSex = persSex;
        return this;
    }
    ...
    public IdentificationBiographical100PutRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(IdentificationBiographical100PutRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("deadDate");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IdentificationBiographical100PutRequest) == false) {
            return false;
        }
        IdentificationBiographical100PutRequest rhs = ((IdentificationBiographical100PutRequest) other);
        return (((((((((((((((((((((((this.deadDate == rhs.deadDate)||((this.deadDate!= null)&&this.deadDate.equals(rhs.deadDate)))&&((this.mrtlCode == rhs.mrtlCode)||((this.mrtlCode!= null)&&this.mrtlCode.equals(rhs.mrtlCode))))&&((this.confirmedReDate == rhs.confirmedReDate)||((this.confirmedReDate!= null)&&this.confirmedReDate.equals(rhs.confirmedReDate))))&&((this.lgcyCode == rhs.lgcyCode)||((this.lgcyCode!= null)&&this.lgcyCode.equals(rhs.lgcyCode))))&&((this.relgCode == rhs.relgCode)||((this.relgCode!= null)&&this.relgCode.equals(rhs.relgCode))))&&((this.confidInd == rhs.confidInd)||((this.confidInd!= null)&&this.confidInd.equals(rhs.confidInd))))&&((this.armedServMedVetInd == rhs.armedServMedVetInd)||((this.armedServMedVetInd!= null)&&this.armedServMedVetInd.equals(rhs.armedServMedVetInd))))&&((this.birthDate == rhs.birthDate)||((this.birthDate!= null)&&this.birthDate.equals(rhs.birthDate))))&&((this.veraInd == rhs.veraInd)||((this.veraInd!= null)&&this.veraInd.equals(rhs.veraInd))))&&((this.ssn == rhs.ssn)||((this.ssn!= null)&&this.ssn.equals(rhs.ssn))))&&((this.gndrCode == rhs.gndrCode)||((this.gndrCode!= null)&&this.gndrCode.equals(rhs.gndrCode))))&&((this.activeDutySeprDate == rhs.activeDutySeprDate)||((this.activeDutySeprDate!= null)&&this.activeDutySeprDate.equals(rhs.activeDutySeprDate))))&&((this.deadInd == rhs.deadInd)||((this.deadInd!= null)&&this.deadInd.equals(rhs.deadInd))))&&((this.citzCode == rhs.citzCode)||((this.citzCode!= null)&&this.citzCode.equals(rhs.citzCode))))&&((this.vetcFileNumber == rhs.vetcFileNumber)||((this.vetcFileNumber!= null)&&this.vetcFileNumber.equals(rhs.vetcFileNumber))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.ethnCde == rhs.ethnCde)||((this.ethnCde!= null)&&this.ethnCde.equals(rhs.ethnCde))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.confirmedReCde == rhs.confirmedReCde)||((this.confirmedReCde!= null)&&this.confirmedReCde.equals(rhs.confirmedReCde))))&&((this.sdvetInd == rhs.sdvetInd)||((this.sdvetInd!= null)&&this.sdvetInd.equals(rhs.sdvetInd))))&&((this.pprnCode == rhs.pprnCode)||((this.pprnCode!= null)&&this.pprnCode.equals(rhs.pprnCode))))&&((this.persSex == rhs.persSex)||((this.persSex!= null)&&this.persSex.equals(rhs.persSex))));
    }
