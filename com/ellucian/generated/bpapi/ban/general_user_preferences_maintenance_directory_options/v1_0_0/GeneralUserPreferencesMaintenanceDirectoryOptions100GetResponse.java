...
package com.ellucian.generated.bpapi.ban.general_user_preferences_maintenance_directory_options.v1_0_0;
...
public class GeneralUserPreferencesMaintenanceDirectoryOptions100GetResponse {
    ...
    public GeneralUserPreferencesMaintenanceDirectoryOptions100GetResponse withDefltValue(String defltValue) {
        this.defltValue = defltValue;
        return this;
    }
    ...
    public GeneralUserPreferencesMaintenanceDirectoryOptions100GetResponse withGuruprfValue(String guruprfValue) {
        this.guruprfValue = guruprfValue;
        return this;
    }
    ...
    public GeneralUserPreferencesMaintenanceDirectoryOptions100GetResponse withDefltKey(String defltKey) {
        this.defltKey = defltKey;
        return this;
    }
    ...
    public GeneralUserPreferencesMaintenanceDirectoryOptions100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralUserPreferencesMaintenanceDirectoryOptions100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralUserPreferencesMaintenanceDirectoryOptions100GetResponse) == false) {
            return false;
        }
        GeneralUserPreferencesMaintenanceDirectoryOptions100GetResponse rhs = ((GeneralUserPreferencesMaintenanceDirectoryOptions100GetResponse) other);
