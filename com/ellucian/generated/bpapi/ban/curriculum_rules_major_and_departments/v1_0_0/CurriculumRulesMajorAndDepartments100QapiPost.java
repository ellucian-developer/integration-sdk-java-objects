...
public class CurriculumRulesMajorAndDepartments100QapiPost {
    ...
    public CurriculumRulesMajorAndDepartments100QapiPost withTermCode(String termCode) {
        this.termCode = termCode;
        return this;
    }
    ...
    public CurriculumRulesMajorAndDepartments100QapiPost withCurrRule(String currRule) {
        this.currRule = currRule;
        return this;
    }
    ...
    public CurriculumRulesMajorAndDepartments100QapiPost withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public CurriculumRulesMajorAndDepartments100QapiPost withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public CurriculumRulesMajorAndDepartments100QapiPost withCampCode(String campCode) {
        this.campCode = campCode;
        return this;
    }
    ...
    public CurriculumRulesMajorAndDepartments100QapiPost withTermCodeInit(String termCodeInit) {
        this.termCodeInit = termCodeInit;
        return this;
    }
    ...
    public CurriculumRulesMajorAndDepartments100QapiPost withCollCode(String collCode) {
        this.collCode = collCode;
        return this;
    }
    ...
    public CurriculumRulesMajorAndDepartments100QapiPost withDegcCode(String degcCode) {
        this.degcCode = degcCode;
        return this;
    }
    ...
    public CurriculumRulesMajorAndDepartments100QapiPost withPrimRollInd(String primRollInd) {
        this.primRollInd = primRollInd;
        return this;
    }
    ...
    public CurriculumRulesMajorAndDepartments100QapiPost withSecdRollInd(String secdRollInd) {
        this.secdRollInd = secdRollInd;
        return this;
    }
    ...
    public CurriculumRulesMajorAndDepartments100QapiPost withLockInd(String lockInd) {
        this.lockInd = lockInd;
        return this;
    }
    ...
    public CurriculumRulesMajorAndDepartments100QapiPost withStudyPathInd(String studyPathInd) {
        this.studyPathInd = studyPathInd;
        return this;
    }
    ...
    public CurriculumRulesMajorAndDepartments100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CurriculumRulesMajorAndDepartments100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("termCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CurriculumRulesMajorAndDepartments100QapiPost) == false) {
            return false;
        }
        CurriculumRulesMajorAndDepartments100QapiPost rhs = ((CurriculumRulesMajorAndDepartments100QapiPost) other);
