...
package com.ellucian.generated.bpapi.ban.holds_inquiry.v1_0_0;
...
public class HoldsInquiry100GetResponse {
    ...
    public HoldsInquiry100GetResponse withFromDate(Date fromDate) {
        this.fromDate = fromDate;
        return this;
    }
    ...
    public HoldsInquiry100GetResponse withHlddCode(String hlddCode) {
        this.hlddCode = hlddCode;
        return this;
    }
    ...
    public HoldsInquiry100GetResponse withReason(String reason) {
        this.reason = reason;
        return this;
    }
    ...
    public HoldsInquiry100GetResponse withOrigDescription(String origDescription) {
        this.origDescription = origDescription;
        return this;
    }
    ...
    public HoldsInquiry100GetResponse withToDate(Date toDate) {
        this.toDate = toDate;
        return this;
    }
    ...
    public HoldsInquiry100GetResponse withReleaseInd(String releaseInd) {
        this.releaseInd = releaseInd;
        return this;
    }
    ...
    public HoldsInquiry100GetResponse withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public HoldsInquiry100GetResponse withHlddDescription(String hlddDescription) {
        this.hlddDescription = hlddDescription;
        return this;
    }
    ...
    public HoldsInquiry100GetResponse withAmountOwed(Double amountOwed) {
        this.amountOwed = amountOwed;
        return this;
    }
    ...
    public HoldsInquiry100GetResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public HoldsInquiry100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(HoldsInquiry100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("fromDate");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HoldsInquiry100GetResponse) == false) {
            return false;
        }
        HoldsInquiry100GetResponse rhs = ((HoldsInquiry100GetResponse) other);
        return ((((((((((((this.fromDate == rhs.fromDate)||((this.fromDate!= null)&&this.fromDate.equals(rhs.fromDate)))&&((this.hlddCode == rhs.hlddCode)||((this.hlddCode!= null)&&this.hlddCode.equals(rhs.hlddCode))))&&((this.reason == rhs.reason)||((this.reason!= null)&&this.reason.equals(rhs.reason))))&&((this.origDescription == rhs.origDescription)||((this.origDescription!= null)&&this.origDescription.equals(rhs.origDescription))))&&((this.toDate == rhs.toDate)||((this.toDate!= null)&&this.toDate.equals(rhs.toDate))))&&((this.releaseInd == rhs.releaseInd)||((this.releaseInd!= null)&&this.releaseInd.equals(rhs.releaseInd))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.user == rhs.user)||((this.user!= null)&&this.user.equals(rhs.user))))&&((this.hlddDescription == rhs.hlddDescription)||((this.hlddDescription!= null)&&this.hlddDescription.equals(rhs.hlddDescription))))&&((this.amountOwed == rhs.amountOwed)||((this.amountOwed!= null)&&this.amountOwed.equals(rhs.amountOwed))))&&((this.origCode == rhs.origCode)||((this.origCode!= null)&&this.origCode.equals(rhs.origCode))));
    }
