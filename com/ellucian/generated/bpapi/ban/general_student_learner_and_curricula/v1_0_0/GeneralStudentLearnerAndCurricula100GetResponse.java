...
public class GeneralStudentLearnerAndCurricula100GetResponse {
    ...
    public GeneralStudentLearnerAndCurricula100GetResponse withSgbstdn(List<Sgbstdn> sgbstdn) {
        this.sgbstdn = sgbstdn;
        return this;
    }
    ...
    public GeneralStudentLearnerAndCurricula100GetResponse withSorlcur(List<Sorlcur> sorlcur) {
        this.sorlcur = sorlcur;
        return this;
    }
    ...
    public GeneralStudentLearnerAndCurricula100GetResponse withSorlfos(List<Sorlfo> sorlfos) {
        this.sorlfos = sorlfos;
        return this;
    }
    ...
    public GeneralStudentLearnerAndCurricula100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralStudentLearnerAndCurricula100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sgbstdn");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralStudentLearnerAndCurricula100GetResponse) == false) {
            return false;
        }
        GeneralStudentLearnerAndCurricula100GetResponse rhs = ((GeneralStudentLearnerAndCurricula100GetResponse) other);
