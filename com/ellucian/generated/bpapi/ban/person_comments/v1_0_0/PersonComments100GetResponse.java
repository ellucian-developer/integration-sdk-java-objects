...
public class PersonComments100GetResponse {
    ...
    public PersonComments100GetResponse withDate(Date date) {
        this.date = date;
        return this;
    }
    ...
    public PersonComments100GetResponse withContactDescription(String contactDescription) {
        this.contactDescription = contactDescription;
        return this;
    }
    ...
    public PersonComments100GetResponse withOrigDescription(String origDescription) {
        this.origDescription = origDescription;
        return this;
    }
    ...
    public PersonComments100GetResponse withContactDate(Date contactDate) {
        this.contactDate = contactDate;
        return this;
    }
    ...
    public PersonComments100GetResponse withContactToTime(Double contactToTime) {
        this.contactToTime = contactToTime;
        return this;
    }
    ...
    public PersonComments100GetResponse withCmttCode(String cmttCode) {
        this.cmttCode = cmttCode;
        return this;
    }
    ...
    public PersonComments100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public PersonComments100GetResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public PersonComments100GetResponse withTextNar(String textNar) {
        this.textNar = textNar;
        return this;
    }
    ...
    public PersonComments100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public PersonComments100GetResponse withCmttDescription(String cmttDescription) {
        this.cmttDescription = cmttDescription;
        return this;
    }
    ...
    public PersonComments100GetResponse withConfidentialInd(String confidentialInd) {
        this.confidentialInd = confidentialInd;
        return this;
    }
    ...
    public PersonComments100GetResponse withCtypCode(String ctypCode) {
        this.ctypCode = ctypCode;
        return this;
    }
    ...
    public PersonComments100GetResponse withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public PersonComments100GetResponse withContactFromTime(Double contactFromTime) {
        this.contactFromTime = contactFromTime;
        return this;
    }
    ...
    public PersonComments100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PersonComments100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("date");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PersonComments100GetResponse) == false) {
            return false;
        }
        PersonComments100GetResponse rhs = ((PersonComments100GetResponse) other);
