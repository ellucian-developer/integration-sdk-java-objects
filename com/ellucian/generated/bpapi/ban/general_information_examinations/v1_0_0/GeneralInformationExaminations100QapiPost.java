...
public class GeneralInformationExaminations100QapiPost {
    ...
    public GeneralInformationExaminations100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GeneralInformationExaminations100QapiPost withSbgiCode(String sbgiCode) {
        this.sbgiCode = sbgiCode;
        return this;
    }
    ...
    public GeneralInformationExaminations100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralInformationExaminations100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralInformationExaminations100QapiPost) == false) {
            return false;
        }
        GeneralInformationExaminations100QapiPost rhs = ((GeneralInformationExaminations100QapiPost) other);
