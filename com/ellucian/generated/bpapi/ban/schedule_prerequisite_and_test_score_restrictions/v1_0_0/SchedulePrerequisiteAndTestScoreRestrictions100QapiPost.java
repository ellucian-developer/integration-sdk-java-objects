...
public class SchedulePrerequisiteAndTestScoreRestrictions100QapiPost {
    ...
    public SchedulePrerequisiteAndTestScoreRestrictions100QapiPost withSsasectTermCode(String ssasectTermCode) {
        this.ssasectTermCode = ssasectTermCode;
        return this;
    }
    ...
    public SchedulePrerequisiteAndTestScoreRestrictions100QapiPost withSsasectCrn(String ssasectCrn) {
        this.ssasectCrn = ssasectCrn;
        return this;
    }
    ...
    public SchedulePrerequisiteAndTestScoreRestrictions100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SchedulePrerequisiteAndTestScoreRestrictions100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SchedulePrerequisiteAndTestScoreRestrictions100QapiPost) == false) {
            return false;
        }
        SchedulePrerequisiteAndTestScoreRestrictions100QapiPost rhs = ((SchedulePrerequisiteAndTestScoreRestrictions100QapiPost) other);
