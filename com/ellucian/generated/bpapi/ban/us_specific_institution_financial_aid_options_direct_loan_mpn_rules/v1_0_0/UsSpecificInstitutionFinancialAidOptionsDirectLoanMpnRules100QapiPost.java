...
public class UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost {
    ...
    public UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost withKeyblckAidyCode(String keyblckAidyCode) {
        this.keyblckAidyCode = keyblckAidyCode;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost withMpnType(String mpnType) {
        this.mpnType = mpnType;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost withDisplayPnInd(String displayPnInd) {
        this.displayPnInd = displayPnInd;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost withCreateReqOption(String createReqOption) {
        this.createReqOption = createReqOption;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost withReqStatus(String reqStatus) {
        this.reqStatus = reqStatus;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost withReqStatusWebDesc(String reqStatusWebDesc) {
        this.reqStatusWebDesc = reqStatusWebDesc;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost withMpnReqDesc(String mpnReqDesc) {
        this.mpnReqDesc = mpnReqDesc;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost withMpnReqUrl(String mpnReqUrl) {
        this.mpnReqUrl = mpnReqUrl;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost withMpnReqInstructions(String mpnReqInstructions) {
        this.mpnReqInstructions = mpnReqInstructions;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost withSatInd(String satInd) {
        this.satInd = satInd;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost withTrkLtrInd(String trkLtrInd) {
        this.trkLtrInd = trkLtrInd;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost withReqInstrInd(String reqInstrInd) {
        this.reqInstrInd = reqInstrInd;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost withInfoAccessInd(String infoAccessInd) {
        this.infoAccessInd = infoAccessInd;
        return this;
    }
    ...
    public UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost) == false) {
            return false;
        }
        UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost rhs = ((UsSpecificInstitutionFinancialAidOptionsDirectLoanMpnRules100QapiPost) other);
