...
public class Sorcaar__1 {
    ...
    public Sorcaar__1 withReqHrsActivity(Double reqHrsActivity) {
        this.reqHrsActivity = reqHrsActivity;
        return this;
    }
    ...
    public Sorcaar__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sorcaar__1 withReqCreditsActivity(Double reqCreditsActivity) {
        this.reqCreditsActivity = reqCreditsActivity;
        return this;
    }
    ...
    public Sorcaar__1 withActvDesc(String actvDesc) {
        this.actvDesc = actvDesc;
        return this;
    }
    ...
    public Sorcaar__1 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sorcaar__1 withActcCode(String actcCode) {
        this.actcCode = actcCode;
        return this;
    }
    ...
    public Sorcaar__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorcaar__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorcaar__1) == false) {
            return false;
        }
        Sorcaar__1 rhs = ((Sorcaar__1) other);
