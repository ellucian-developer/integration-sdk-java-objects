...
public class Sobcarp__2 {
    ...
    public Sobcarp__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sobcarp__2 withReqCreditsProgram(Double reqCreditsProgram) {
        this.reqCreditsProgram = reqCreditsProgram;
        return this;
    }
    ...
    public Sobcarp__2 withCreditEquivalent(Double creditEquivalent) {
        this.creditEquivalent = creditEquivalent;
        return this;
    }
    ...
    public Sobcarp__2 withReqHrsProgram(Double reqHrsProgram) {
        this.reqHrsProgram = reqHrsProgram;
        return this;
    }
    ...
    public Sobcarp__2 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sobcarp__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sobcarp__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sobcarp__2) == false) {
            return false;
        }
        Sobcarp__2 rhs = ((Sobcarp__2) other);
