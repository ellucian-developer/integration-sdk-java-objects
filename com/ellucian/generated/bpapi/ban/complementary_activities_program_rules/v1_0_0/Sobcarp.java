...
public class Sobcarp {
    ...
    public Sobcarp withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sobcarp withReqCreditsProgram(Double reqCreditsProgram) {
        this.reqCreditsProgram = reqCreditsProgram;
        return this;
    }
    ...
    public Sobcarp withCreditEquivalent(Double creditEquivalent) {
        this.creditEquivalent = creditEquivalent;
        return this;
    }
    ...
    public Sobcarp withReqHrsProgram(Double reqHrsProgram) {
        this.reqHrsProgram = reqHrsProgram;
        return this;
    }
    ...
    public Sobcarp withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sobcarp withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sobcarp.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sobcarp) == false) {
            return false;
        }
        Sobcarp rhs = ((Sobcarp) other);
