...
public class Sorcacr__2 {
    ...
    public Sorcacr__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sorcacr__2 withAccgCode(String accgCode) {
        this.accgCode = accgCode;
        return this;
    }
    ...
    public Sorcacr__2 withReqHrsCategory(Double reqHrsCategory) {
        this.reqHrsCategory = reqHrsCategory;
        return this;
    }
    ...
    public Sorcacr__2 withStvaccgDesc(String stvaccgDesc) {
        this.stvaccgDesc = stvaccgDesc;
        return this;
    }
    ...
    public Sorcacr__2 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sorcacr__2 withReqCreditsCategory(Double reqCreditsCategory) {
        this.reqCreditsCategory = reqCreditsCategory;
        return this;
    }
    ...
    public Sorcacr__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorcacr__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorcacr__2) == false) {
            return false;
        }
        Sorcacr__2 rhs = ((Sorcacr__2) other);
