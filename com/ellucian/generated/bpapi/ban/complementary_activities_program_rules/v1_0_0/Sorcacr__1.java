...
public class Sorcacr__1 {
    ...
    public Sorcacr__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sorcacr__1 withAccgCode(String accgCode) {
        this.accgCode = accgCode;
        return this;
    }
    ...
    public Sorcacr__1 withReqHrsCategory(Double reqHrsCategory) {
        this.reqHrsCategory = reqHrsCategory;
        return this;
    }
    ...
    public Sorcacr__1 withStvaccgDesc(String stvaccgDesc) {
        this.stvaccgDesc = stvaccgDesc;
        return this;
    }
    ...
    public Sorcacr__1 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sorcacr__1 withReqCreditsCategory(Double reqCreditsCategory) {
        this.reqCreditsCategory = reqCreditsCategory;
        return this;
    }
    ...
    public Sorcacr__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorcacr__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorcacr__1) == false) {
            return false;
        }
        Sorcacr__1 rhs = ((Sorcacr__1) other);
