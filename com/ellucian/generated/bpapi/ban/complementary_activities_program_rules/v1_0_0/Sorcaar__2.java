...
public class Sorcaar__2 {
    ...
    public Sorcaar__2 withReqHrsActivity(Double reqHrsActivity) {
        this.reqHrsActivity = reqHrsActivity;
        return this;
    }
    ...
    public Sorcaar__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sorcaar__2 withReqCreditsActivity(Double reqCreditsActivity) {
        this.reqCreditsActivity = reqCreditsActivity;
        return this;
    }
    ...
    public Sorcaar__2 withActvDesc(String actvDesc) {
        this.actvDesc = actvDesc;
        return this;
    }
    ...
    public Sorcaar__2 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sorcaar__2 withActcCode(String actcCode) {
        this.actcCode = actcCode;
        return this;
    }
    ...
    public Sorcaar__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorcaar__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorcaar__2) == false) {
            return false;
        }
        Sorcaar__2 rhs = ((Sorcaar__2) other);
