...
public class EmployeeStatusChangeJobs100QapiPost {
    ...
    public EmployeeStatusChangeJobs100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public EmployeeStatusChangeJobs100QapiPost withActionList(String actionList) {
        this.actionList = actionList;
        return this;
    }
    ...
    public EmployeeStatusChangeJobs100QapiPost withAllCbox(String allCbox) {
        this.allCbox = allCbox;
        return this;
    }
    ...
    public EmployeeStatusChangeJobs100QapiPost withActionDate(String actionDate) {
        this.actionDate = actionDate;
        return this;
    }
    ...
    public EmployeeStatusChangeJobs100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EmployeeStatusChangeJobs100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EmployeeStatusChangeJobs100QapiPost) == false) {
            return false;
        }
        EmployeeStatusChangeJobs100QapiPost rhs = ((EmployeeStatusChangeJobs100QapiPost) other);
