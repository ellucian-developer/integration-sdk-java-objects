...
public class Sorlfo__1 {
    ...
    public Sorlfo__1 withTermCodeCtlg(String termCodeCtlg) {
        this.termCodeCtlg = termCodeCtlg;
        return this;
    }
    ...
    public Sorlfo__1 withMajrCodeAttach(String majrCodeAttach) {
        this.majrCodeAttach = majrCodeAttach;
        return this;
    }
    ...
    public Sorlfo__1 withSeqno(Double seqno) {
        this.seqno = seqno;
        return this;
    }
    ...
    public Sorlfo__1 withTmstDesc(String tmstDesc) {
        this.tmstDesc = tmstDesc;
        return this;
    }
    ...
    public Sorlfo__1 withEndDate(Date endDate) {
        this.endDate = endDate;
        return this;
    }
    ...
    public Sorlfo__1 withMajrDesc(String majrDesc) {
        this.majrDesc = majrDesc;
        return this;
    }
    ...
    public Sorlfo__1 withTmstCode(String tmstCode) {
        this.tmstCode = tmstCode;
        return this;
    }
    ...
    public Sorlfo__1 withLfosRolledInd(String lfosRolledInd) {
        this.lfosRolledInd = lfosRolledInd;
        return this;
    }
    ...
    public Sorlfo__1 withMajrCode(String majrCode) {
        this.majrCode = majrCode;
        return this;
    }
    ...
    public Sorlfo__1 withTermCodeEnd(String termCodeEnd) {
        this.termCodeEnd = termCodeEnd;
        return this;
    }
    ...
    public Sorlfo__1 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public Sorlfo__1 withCurrentInd(String currentInd) {
        this.currentInd = currentInd;
        return this;
    }
    ...
    public Sorlfo__1 withLfstCode(String lfstCode) {
        this.lfstCode = lfstCode;
        return this;
    }
    ...
    public Sorlfo__1 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Sorlfo__1 withPriorityNo(Double priorityNo) {
        this.priorityNo = priorityNo;
        return this;
    }
    ...
    public Sorlfo__1 withAttachConcDesc(String attachConcDesc) {
        this.attachConcDesc = attachConcDesc;
        return this;
    }
    ...
    public Sorlfo__1 withDeptDesc(String deptDesc) {
        this.deptDesc = deptDesc;
        return this;
    }
    ...
    public Sorlfo__1 withCstsCode(String cstsCode) {
        this.cstsCode = cstsCode;
        return this;
    }
    ...
    public Sorlfo__1 withDeptCode(String deptCode) {
        this.deptCode = deptCode;
        return this;
    }
    ...
    public Sorlfo__1 withLfstCodeDesc(String lfstCodeDesc) {
        this.lfstCodeDesc = lfstCodeDesc;
        return this;
    }
    ...
    public Sorlfo__1 withStartDate(Date startDate) {
        this.startDate = startDate;
        return this;
    }
    ...
    public Sorlfo__1 withCactCode(String cactCode) {
        this.cactCode = cactCode;
        return this;
    }
    ...
    public Sorlfo__1 withTermCode(String termCode) {
        this.termCode = termCode;
        return this;
    }
    ...
    public Sorlfo__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sorlfo__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sorlfo__1) == false) {
            return false;
        }
        Sorlfo__1 rhs = ((Sorlfo__1) other);
