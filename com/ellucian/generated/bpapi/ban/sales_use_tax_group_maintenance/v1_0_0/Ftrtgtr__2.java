...
public class Ftrtgtr__2 {
    ...
    public Ftrtgtr__2 withTaxRatePriorityCode(String taxRatePriorityCode) {
        this.taxRatePriorityCode = taxRatePriorityCode;
        return this;
    }
    ...
    public Ftrtgtr__2 withTaxRatePercent(Double taxRatePercent) {
        this.taxRatePercent = taxRatePercent;
        return this;
    }
    ...
    public Ftrtgtr__2 withTaxRateTitle(String taxRateTitle) {
        this.taxRateTitle = taxRateTitle;
        return this;
    }
    ...
    public Ftrtgtr__2 withTratCode(String tratCode) {
        this.tratCode = tratCode;
        return this;
    }
    ...
    public Ftrtgtr__2 withTaxRateExemptPercent(String taxRateExemptPercent) {
        this.taxRateExemptPercent = taxRateExemptPercent;
        return this;
    }
    ...
    public Ftrtgtr__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ftrtgtr__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ftrtgtr__2) == false) {
            return false;
        }
        Ftrtgtr__2 rhs = ((Ftrtgtr__2) other);
