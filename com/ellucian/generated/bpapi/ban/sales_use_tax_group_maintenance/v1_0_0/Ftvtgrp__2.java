...
public class Ftvtgrp__2 {
    ...
    public Ftvtgrp__2 withEffDate(Date effDate) {
        this.effDate = effDate;
        return this;
    }
    ...
    public Ftvtgrp__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Ftvtgrp__2 withTgrpCode(String tgrpCode) {
        this.tgrpCode = tgrpCode;
        return this;
    }
    ...
    public Ftvtgrp__2 withCoasCodeValid(String coasCodeValid) {
        this.coasCodeValid = coasCodeValid;
        return this;
    }
    ...
    public Ftvtgrp__2 withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public Ftvtgrp__2 withNchgDate(Date nchgDate) {
        this.nchgDate = nchgDate;
        return this;
    }
    ...
    public Ftvtgrp__2 withTermDate(Date termDate) {
        this.termDate = termDate;
        return this;
    }
    ...
    public Ftvtgrp__2 withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public Ftvtgrp__2 withCoasTitle(String coasTitle) {
        this.coasTitle = coasTitle;
        return this;
    }
    ...
    public Ftvtgrp__2 withNonTaxable(String nonTaxable) {
        this.nonTaxable = nonTaxable;
        return this;
    }
    ...
    public Ftvtgrp__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ftvtgrp__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("effDate");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ftvtgrp__2) == false) {
            return false;
        }
        Ftvtgrp__2 rhs = ((Ftvtgrp__2) other);
