...
public class Ftrtgtr__1 {
    ...
    public Ftrtgtr__1 withTaxRatePriorityCode(String taxRatePriorityCode) {
        this.taxRatePriorityCode = taxRatePriorityCode;
        return this;
    }
    ...
    public Ftrtgtr__1 withTaxRatePercent(Double taxRatePercent) {
        this.taxRatePercent = taxRatePercent;
        return this;
    }
    ...
    public Ftrtgtr__1 withTaxRateTitle(String taxRateTitle) {
        this.taxRateTitle = taxRateTitle;
        return this;
    }
    ...
    public Ftrtgtr__1 withTratCode(String tratCode) {
        this.tratCode = tratCode;
        return this;
    }
    ...
    public Ftrtgtr__1 withTaxRateExemptPercent(String taxRateExemptPercent) {
        this.taxRateExemptPercent = taxRateExemptPercent;
        return this;
    }
    ...
    public Ftrtgtr__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ftrtgtr__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ftrtgtr__1) == false) {
            return false;
        }
        Ftrtgtr__1 rhs = ((Ftrtgtr__1) other);
