...
public class CurriculumRulesRuleBasedConcentrations100QapiPost {
    ...
    public CurriculumRulesRuleBasedConcentrations100QapiPost withTermCode(String termCode) {
        this.termCode = termCode;
        return this;
    }
    ...
    public CurriculumRulesRuleBasedConcentrations100QapiPost withCurrRule(String currRule) {
        this.currRule = currRule;
        return this;
    }
    ...
    public CurriculumRulesRuleBasedConcentrations100QapiPost withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public CurriculumRulesRuleBasedConcentrations100QapiPost withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public CurriculumRulesRuleBasedConcentrations100QapiPost withCampCode(String campCode) {
        this.campCode = campCode;
        return this;
    }
    ...
    public CurriculumRulesRuleBasedConcentrations100QapiPost withTermCodeInit(String termCodeInit) {
        this.termCodeInit = termCodeInit;
        return this;
    }
    ...
    public CurriculumRulesRuleBasedConcentrations100QapiPost withCollCode(String collCode) {
        this.collCode = collCode;
        return this;
    }
    ...
    public CurriculumRulesRuleBasedConcentrations100QapiPost withDegcCode(String degcCode) {
        this.degcCode = degcCode;
        return this;
    }
    ...
    public CurriculumRulesRuleBasedConcentrations100QapiPost withPrimRollInd(String primRollInd) {
        this.primRollInd = primRollInd;
        return this;
    }
    ...
    public CurriculumRulesRuleBasedConcentrations100QapiPost withSecdRollInd(String secdRollInd) {
        this.secdRollInd = secdRollInd;
        return this;
    }
    ...
    public CurriculumRulesRuleBasedConcentrations100QapiPost withLockInd(String lockInd) {
        this.lockInd = lockInd;
        return this;
    }
    ...
    public CurriculumRulesRuleBasedConcentrations100QapiPost withStudyPathInd(String studyPathInd) {
        this.studyPathInd = studyPathInd;
        return this;
    }
    ...
    public CurriculumRulesRuleBasedConcentrations100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CurriculumRulesRuleBasedConcentrations100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("termCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CurriculumRulesRuleBasedConcentrations100QapiPost) == false) {
            return false;
        }
        CurriculumRulesRuleBasedConcentrations100QapiPost rhs = ((CurriculumRulesRuleBasedConcentrations100QapiPost) other);
