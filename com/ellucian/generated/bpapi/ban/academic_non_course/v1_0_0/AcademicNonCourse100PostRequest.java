...
public class AcademicNonCourse100PostRequest {
    ...
    public AcademicNonCourse100PostRequest withAdvrId(String advrId) {
        this.advrId = advrId;
        return this;
    }
    ...
    public AcademicNonCourse100PostRequest withQpnmSeqNo(String qpnmSeqNo) {
        this.qpnmSeqNo = qpnmSeqNo;
        return this;
    }
    ...
    public AcademicNonCourse100PostRequest withNcstCode(String ncstCode) {
        this.ncstCode = ncstCode;
        return this;
    }
    ...
    public AcademicNonCourse100PostRequest withEvenCode(String evenCode) {
        this.evenCode = evenCode;
        return this;
    }
    ...
    public AcademicNonCourse100PostRequest withNcrqCode(String ncrqCode) {
        this.ncrqCode = ncrqCode;
        return this;
    }
    ...
    public AcademicNonCourse100PostRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public AcademicNonCourse100PostRequest withComtCode(String comtCode) {
        this.comtCode = comtCode;
        return this;
    }
    ...
    public AcademicNonCourse100PostRequest withDgmrSeqNo(Double dgmrSeqNo) {
        this.dgmrSeqNo = dgmrSeqNo;
        return this;
    }
    ...
    public AcademicNonCourse100PostRequest withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public AcademicNonCourse100PostRequest withNcstDate(Date ncstDate) {
        this.ncstDate = ncstDate;
        return this;
    }
    ...
    public AcademicNonCourse100PostRequest withCompleteDate(Date completeDate) {
        this.completeDate = completeDate;
        return this;
    }
    ...
    public AcademicNonCourse100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AcademicNonCourse100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("advrId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AcademicNonCourse100PostRequest) == false) {
            return false;
        }
        AcademicNonCourse100PostRequest rhs = ((AcademicNonCourse100PostRequest) other);
        return (((((((((((((this.advrId == rhs.advrId)||((this.advrId!= null)&&this.advrId.equals(rhs.advrId)))&&((this.qpnmSeqNo == rhs.qpnmSeqNo)||((this.qpnmSeqNo!= null)&&this.qpnmSeqNo.equals(rhs.qpnmSeqNo))))&&((this.ncstCode == rhs.ncstCode)||((this.ncstCode!= null)&&this.ncstCode.equals(rhs.ncstCode))))&&((this.ncrqCode == rhs.ncrqCode)||((this.ncrqCode!= null)&&this.ncrqCode.equals(rhs.ncrqCode))))&&((this.comtCode == rhs.comtCode)||((this.comtCode!= null)&&this.comtCode.equals(rhs.comtCode))))&&((this.ncstDate == rhs.ncstDate)||((this.ncstDate!= null)&&this.ncstDate.equals(rhs.ncstDate))))&&((this.completeDate == rhs.completeDate)||((this.completeDate!= null)&&this.completeDate.equals(rhs.completeDate))))&&((this.evenCode == rhs.evenCode)||((this.evenCode!= null)&&this.evenCode.equals(rhs.evenCode))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.dgmrSeqNo == rhs.dgmrSeqNo)||((this.dgmrSeqNo!= null)&&this.dgmrSeqNo.equals(rhs.dgmrSeqNo))))&&((this.levlCode == rhs.levlCode)||((this.levlCode!= null)&&this.levlCode.equals(rhs.levlCode))));
    }
