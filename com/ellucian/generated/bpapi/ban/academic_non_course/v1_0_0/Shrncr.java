...
public class Shrncr {
    ...
    public Shrncr withSatInd(String satInd) {
        this.satInd = satInd;
        return this;
    }
    ...
    public Shrncr withAdvrId(String advrId) {
        this.advrId = advrId;
        return this;
    }
    ...
    public Shrncr withQpnmSeqNo(String qpnmSeqNo) {
        this.qpnmSeqNo = qpnmSeqNo;
        return this;
    }
    ...
    public Shrncr withNcstCode(String ncstCode) {
        this.ncstCode = ncstCode;
        return this;
    }
    ...
    public Shrncr withEvenCode(String evenCode) {
        this.evenCode = evenCode;
        return this;
    }
    ...
    public Shrncr withNcrqCode(String ncrqCode) {
        this.ncrqCode = ncrqCode;
        return this;
    }
    ...
    public Shrncr withComtCode(String comtCode) {
        this.comtCode = comtCode;
        return this;
    }
    ...
    public Shrncr withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public Shrncr withNcstDate(Date ncstDate) {
        this.ncstDate = ncstDate;
        return this;
    }
    ...
    public Shrncr withCompleteDate(Date completeDate) {
        this.completeDate = completeDate;
        return this;
    }
    ...
    public Shrncr withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Shrncr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("satInd");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shrncr) == false) {
            return false;
        }
        Shrncr rhs = ((Shrncr) other);
