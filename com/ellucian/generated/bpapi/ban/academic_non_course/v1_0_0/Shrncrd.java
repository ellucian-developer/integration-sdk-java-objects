...
public class Shrncrd {
    ...
    public Shrncrd withDegcCode(String degcCode) {
        this.degcCode = degcCode;
        return this;
    }
    ...
    public Shrncrd withDgmrSeqNo(Double dgmrSeqNo) {
        this.dgmrSeqNo = dgmrSeqNo;
        return this;
    }
    ...
    public Shrncrd withDegcDesc(String degcDesc) {
        this.degcDesc = degcDesc;
        return this;
    }
    ...
    public Shrncrd withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Shrncrd.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("degcCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shrncrd) == false) {
            return false;
        }
        Shrncrd rhs = ((Shrncrd) other);
