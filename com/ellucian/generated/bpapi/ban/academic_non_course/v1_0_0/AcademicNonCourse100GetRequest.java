...
public class AcademicNonCourse100GetRequest {
    ...
    public AcademicNonCourse100GetRequest withQpnmSeqNo(String qpnmSeqNo) {
        this.qpnmSeqNo = qpnmSeqNo;
        return this;
    }
    ...
    public AcademicNonCourse100GetRequest withNcstCode(String ncstCode) {
        this.ncstCode = ncstCode;
        return this;
    }
    ...
    public AcademicNonCourse100GetRequest withEvenCode(String evenCode) {
        this.evenCode = evenCode;
        return this;
    }
    ...
    public AcademicNonCourse100GetRequest withNcrqCode(String ncrqCode) {
        this.ncrqCode = ncrqCode;
        return this;
    }
    ...
    public AcademicNonCourse100GetRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public AcademicNonCourse100GetRequest withComtCode(String comtCode) {
        this.comtCode = comtCode;
        return this;
    }
    ...
    public AcademicNonCourse100GetRequest withDgmrSeqNo(Double dgmrSeqNo) {
        this.dgmrSeqNo = dgmrSeqNo;
        return this;
    }
    ...
    public AcademicNonCourse100GetRequest withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public AcademicNonCourse100GetRequest withNcstDate(Date ncstDate) {
        this.ncstDate = ncstDate;
        return this;
    }
    ...
    public AcademicNonCourse100GetRequest withCompleteDate(Date completeDate) {
        this.completeDate = completeDate;
        return this;
    }
    ...
    public AcademicNonCourse100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AcademicNonCourse100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("qpnmSeqNo");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AcademicNonCourse100GetRequest) == false) {
            return false;
        }
        AcademicNonCourse100GetRequest rhs = ((AcademicNonCourse100GetRequest) other);
