...
public class JournalVoucherQuick100PutResponse {
    ...
    public JournalVoucherQuick100PutResponse withEditDeferInd(String editDeferInd) {
        this.editDeferInd = editDeferInd;
        return this;
    }
    ...
    public JournalVoucherQuick100PutResponse withTransDate(Date transDate) {
        this.transDate = transDate;
        return this;
    }
    ...
    public JournalVoucherQuick100PutResponse withNsfOnOffInd(String nsfOnOffInd) {
        this.nsfOnOffInd = nsfOnOffInd;
        return this;
    }
    ...
    public JournalVoucherQuick100PutResponse withDocAmt(Double docAmt) {
        this.docAmt = docAmt;
        return this;
    }
    ...
    public JournalVoucherQuick100PutResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(JournalVoucherQuick100PutResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof JournalVoucherQuick100PutResponse) == false) {
            return false;
        }
        JournalVoucherQuick100PutResponse rhs = ((JournalVoucherQuick100PutResponse) other);
        return ((((((this.transDate == rhs.transDate)||((this.transDate!= null)&&this.transDate.equals(rhs.transDate)))&&((this.editDeferInd == rhs.editDeferInd)||((this.editDeferInd!= null)&&this.editDeferInd.equals(rhs.editDeferInd))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.nsfOnOffInd == rhs.nsfOnOffInd)||((this.nsfOnOffInd!= null)&&this.nsfOnOffInd.equals(rhs.nsfOnOffInd))))&&((this.docAmt == rhs.docAmt)||((this.docAmt!= null)&&this.docAmt.equals(rhs.docAmt))));
    }
