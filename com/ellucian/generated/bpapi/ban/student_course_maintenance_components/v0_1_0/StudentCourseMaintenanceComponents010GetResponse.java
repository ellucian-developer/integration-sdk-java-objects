...
public class StudentCourseMaintenanceComponents010GetResponse {
    ...
    private List<Shrcmrk> shrcmrk = new ArrayList<Shrcmrk>();
    @JsonIgnore
    ...
    public StudentCourseMaintenanceComponents010GetResponse withShrtckl(List<Shrtckl> shrtckl) {
        this.shrtckl = shrtckl;
        return this;
    }
    ...
    public StudentCourseMaintenanceComponents010GetResponse withShrtckg(List<Shrtckg> shrtckg) {
        this.shrtckg = shrtckg;
        return this;
    }
    ...
    public StudentCourseMaintenanceComponents010GetResponse withShrtckn(List<Shrtckn> shrtckn) {
        this.shrtckn = shrtckn;
        return this;
    }
    ...
    public StudentCourseMaintenanceComponents010GetResponse withShrgcom(List<Shrgcom> shrgcom) {
        this.shrgcom = shrgcom;
        return this;
    }

    @JsonProperty("shrcmrk")
    public List<Shrcmrk> getShrcmrk() {
        return shrcmrk;
    }

    @JsonProperty("shrcmrk")
    public void setShrcmrk(List<Shrcmrk> shrcmrk) {
        this.shrcmrk = shrcmrk;
    }

    public StudentCourseMaintenanceComponents010GetResponse withShrcmrk(List<Shrcmrk> shrcmrk) {
        this.shrcmrk = shrcmrk;
        return this;
    }
    ...
    public StudentCourseMaintenanceComponents010GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StudentCourseMaintenanceComponents010GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("shrtckl");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StudentCourseMaintenanceComponents010GetResponse) == false) {
            return false;
        }
        StudentCourseMaintenanceComponents010GetResponse rhs = ((StudentCourseMaintenanceComponents010GetResponse) other);
