...
public class FinancePersonSearch100GetResponse {
    ...
    public FinancePersonSearch100GetResponse withFirstName(String firstName) {
        this.firstName = firstName;
        return this;
    }
    ...
    public FinancePersonSearch100GetResponse withLastName(String lastName) {
        this.lastName = lastName;
        return this;
    }
    ...
    public FinancePersonSearch100GetResponse withChangeInd(String changeInd) {
        this.changeInd = changeInd;
        return this;
    }
    ...
    public FinancePersonSearch100GetResponse withNtypCode(String ntypCode) {
        this.ntypCode = ntypCode;
        return this;
    }
    ...
    public FinancePersonSearch100GetResponse withSurnamePrefix(String surnamePrefix) {
        this.surnamePrefix = surnamePrefix;
        return this;
    }
    ...
    public FinancePersonSearch100GetResponse withBirthdate(Date birthdate) {
        this.birthdate = birthdate;
        return this;
    }
    ...
    public FinancePersonSearch100GetResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public FinancePersonSearch100GetResponse withMi(String mi) {
        this.mi = mi;
        return this;
    }
    ...
    public FinancePersonSearch100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(FinancePersonSearch100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("firstName");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FinancePersonSearch100GetResponse) == false) {
            return false;
        }
        FinancePersonSearch100GetResponse rhs = ((FinancePersonSearch100GetResponse) other);
        return ((((((((((this.firstName == rhs.firstName)||((this.firstName!= null)&&this.firstName.equals(rhs.firstName)))&&((this.lastName == rhs.lastName)||((this.lastName!= null)&&this.lastName.equals(rhs.lastName))))&&((this.changeInd == rhs.changeInd)||((this.changeInd!= null)&&this.changeInd.equals(rhs.changeInd))))&&((this.ntypCode == rhs.ntypCode)||((this.ntypCode!= null)&&this.ntypCode.equals(rhs.ntypCode))))&&((this.surnamePrefix == rhs.surnamePrefix)||((this.surnamePrefix!= null)&&this.surnamePrefix.equals(rhs.surnamePrefix))))&&((this.birthdate == rhs.birthdate)||((this.birthdate!= null)&&this.birthdate.equals(rhs.birthdate))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.mi == rhs.mi)||((this.mi!= null)&&this.mi.equals(rhs.mi))));
    }
