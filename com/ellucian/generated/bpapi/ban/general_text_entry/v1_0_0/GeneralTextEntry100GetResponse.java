...
public class GeneralTextEntry100GetResponse {
    ...
    public GeneralTextEntry100GetResponse withPrtInd(String prtInd) {
        this.prtInd = prtInd;
        return this;
    }
    ...
    public GeneralTextEntry100GetResponse withSeqNum(Double seqNum) {
        this.seqNum = seqNum;
        return this;
    }
    ...
    public GeneralTextEntry100GetResponse withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public GeneralTextEntry100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralTextEntry100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("prtInd");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralTextEntry100GetResponse) == false) {
            return false;
        }
        GeneralTextEntry100GetResponse rhs = ((GeneralTextEntry100GetResponse) other);
