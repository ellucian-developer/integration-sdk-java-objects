...
public class GeneralTextEntry100PostRequest {
    ...
    public GeneralTextEntry100PostRequest withPrtInd(String prtInd) {
        this.prtInd = prtInd;
        return this;
    }
    ...
    public GeneralTextEntry100PostRequest withSeqNum(Double seqNum) {
        this.seqNum = seqNum;
        return this;
    }
    ...
    public GeneralTextEntry100PostRequest withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public GeneralTextEntry100PostRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralTextEntry100PostRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralTextEntry100PostRequest) == false) {
            return false;
        }
        GeneralTextEntry100PostRequest rhs = ((GeneralTextEntry100PostRequest) other);
