...
public class DiscountTermsMaintenance100GetRequest {
    ...
    public DiscountTermsMaintenance100GetRequest withPct(Double pct) {
        this.pct = pct;
        return this;
    }
    ...
    public DiscountTermsMaintenance100GetRequest withEndOfMonthInd(String endOfMonthInd) {
        this.endOfMonthInd = endOfMonthInd;
        return this;
    }
    ...
    public DiscountTermsMaintenance100GetRequest withEffDate(Date effDate) {
        this.effDate = effDate;
        return this;
    }
    ...
    public DiscountTermsMaintenance100GetRequest withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public DiscountTermsMaintenance100GetRequest withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public DiscountTermsMaintenance100GetRequest withDays(Double days) {
        this.days = days;
        return this;
    }
    ...
    public DiscountTermsMaintenance100GetRequest withTermDate(Date termDate) {
        this.termDate = termDate;
        return this;
    }
    ...
    public DiscountTermsMaintenance100GetRequest withNchgDate(Date nchgDate) {
        this.nchgDate = nchgDate;
        return this;
    }
    ...
    public DiscountTermsMaintenance100GetRequest withNetDays(Double netDays) {
        this.netDays = netDays;
        return this;
    }
    ...
    public DiscountTermsMaintenance100GetRequest withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public DiscountTermsMaintenance100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(DiscountTermsMaintenance100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("pct");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DiscountTermsMaintenance100GetRequest) == false) {
            return false;
        }
        DiscountTermsMaintenance100GetRequest rhs = ((DiscountTermsMaintenance100GetRequest) other);
        return ((((((((((((this.pct == rhs.pct)||((this.pct!= null)&&this.pct.equals(rhs.pct)))&&((this.endOfMonthInd == rhs.endOfMonthInd)||((this.endOfMonthInd!= null)&&this.endOfMonthInd.equals(rhs.endOfMonthInd))))&&((this.effDate == rhs.effDate)||((this.effDate!= null)&&this.effDate.equals(rhs.effDate))))&&((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code))))&&((this.activityDate == rhs.activityDate)||((this.activityDate!= null)&&this.activityDate.equals(rhs.activityDate))))&&((this.days == rhs.days)||((this.days!= null)&&this.days.equals(rhs.days))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.termDate == rhs.termDate)||((this.termDate!= null)&&this.termDate.equals(rhs.termDate))))&&((this.nchgDate == rhs.nchgDate)||((this.nchgDate!= null)&&this.nchgDate.equals(rhs.nchgDate))))&&((this.netDays == rhs.netDays)||((this.netDays!= null)&&this.netDays.equals(rhs.netDays))))&&((this.desc == rhs.desc)||((this.desc!= null)&&this.desc.equals(rhs.desc))));
    }
