...
public class ProcessControlCodes100QapiPost {
    ...
    public ProcessControlCodes100QapiPost withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public ProcessControlCodes100QapiPost withChkOrder(String chkOrder) {
        this.chkOrder = chkOrder;
        return this;
    }
    ...
    public ProcessControlCodes100QapiPost withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public ProcessControlCodes100QapiPost withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public ProcessControlCodes100QapiPost withEnforceChkordrInd(String enforceChkordrInd) {
        this.enforceChkordrInd = enforceChkordrInd;
        return this;
    }
    ...
    public ProcessControlCodes100QapiPost withPinAllowed(String pinAllowed) {
        this.pinAllowed = pinAllowed;
        return this;
    }
    ...
    public ProcessControlCodes100QapiPost withSysreqInd(String sysreqInd) {
        this.sysreqInd = sysreqInd;
        return this;
    }
    ...
    public ProcessControlCodes100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ProcessControlCodes100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProcessControlCodes100QapiPost) == false) {
            return false;
        }
        ProcessControlCodes100QapiPost rhs = ((ProcessControlCodes100QapiPost) other);
