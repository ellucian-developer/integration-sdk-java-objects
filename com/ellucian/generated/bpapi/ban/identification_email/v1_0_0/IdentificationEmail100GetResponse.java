...
public class IdentificationEmail100GetResponse {
    ...
    public IdentificationEmail100GetResponse withEmailAddress(String emailAddress) {
        this.emailAddress = emailAddress;
        return this;
    }
    ...
    public IdentificationEmail100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public IdentificationEmail100GetResponse withEmailDesc(String emailDesc) {
        this.emailDesc = emailDesc;
        return this;
    }
    ...
    public IdentificationEmail100GetResponse withEmalCode(String emalCode) {
        this.emalCode = emalCode;
        return this;
    }
    ...
    public IdentificationEmail100GetResponse withStatusInd(String statusInd) {
        this.statusInd = statusInd;
        return this;
    }
    ...
    public IdentificationEmail100GetResponse withDispWebInd(String dispWebInd) {
        this.dispWebInd = dispWebInd;
        return this;
    }
    ...
    public IdentificationEmail100GetResponse withComment(String comment) {
        this.comment = comment;
        return this;
    }
    ...
    public IdentificationEmail100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public IdentificationEmail100GetResponse withPreferredInd(String preferredInd) {
        this.preferredInd = preferredInd;
        return this;
    }
    ...
    public IdentificationEmail100GetResponse withUrlInd(String urlInd) {
        this.urlInd = urlInd;
        return this;
    }
    ...
    public IdentificationEmail100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(IdentificationEmail100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IdentificationEmail100GetResponse) == false) {
            return false;
        }
        IdentificationEmail100GetResponse rhs = ((IdentificationEmail100GetResponse) other);
