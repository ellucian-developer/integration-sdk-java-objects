...
public class FinancialAidHoldTypeCodes100GetRequest {
    ...
    public FinancialAidHoldTypeCodes100GetRequest withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public FinancialAidHoldTypeCodes100GetRequest withStateAidInd(String stateAidInd) {
        this.stateAidInd = stateAidInd;
        return this;
    }
    ...
    public FinancialAidHoldTypeCodes100GetRequest withTitleIvAidInd(String titleIvAidInd) {
        this.titleIvAidInd = titleIvAidInd;
        return this;
    }
    ...
    public FinancialAidHoldTypeCodes100GetRequest withFederalAidInd(String federalAidInd) {
        this.federalAidInd = federalAidInd;
        return this;
    }
    ...
    public FinancialAidHoldTypeCodes100GetRequest withInfoAccessInd(String infoAccessInd) {
        this.infoAccessInd = infoAccessInd;
        return this;
    }
    ...
    public FinancialAidHoldTypeCodes100GetRequest withAllAidInd(String allAidInd) {
        this.allAidInd = allAidInd;
        return this;
    }
    ...
    public FinancialAidHoldTypeCodes100GetRequest withInstAidInd(String instAidInd) {
        this.instAidInd = instAidInd;
        return this;
    }
    ...
    public FinancialAidHoldTypeCodes100GetRequest withPckgInd(String pckgInd) {
        this.pckgInd = pckgInd;
        return this;
    }
    ...
    public FinancialAidHoldTypeCodes100GetRequest withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public FinancialAidHoldTypeCodes100GetRequest withMemoInd(String memoInd) {
        this.memoInd = memoInd;
        return this;
    }
    ...
    public FinancialAidHoldTypeCodes100GetRequest withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public FinancialAidHoldTypeCodes100GetRequest withDisbInd(String disbInd) {
        this.disbInd = disbInd;
        return this;
    }
    ...
    public FinancialAidHoldTypeCodes100GetRequest withVrMsgNo(Double vrMsgNo) {
        this.vrMsgNo = vrMsgNo;
        return this;
    }
    ...
    public FinancialAidHoldTypeCodes100GetRequest withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public FinancialAidHoldTypeCodes100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(FinancialAidHoldTypeCodes100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("code");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FinancialAidHoldTypeCodes100GetRequest) == false) {
            return false;
        }
        FinancialAidHoldTypeCodes100GetRequest rhs = ((FinancialAidHoldTypeCodes100GetRequest) other);
