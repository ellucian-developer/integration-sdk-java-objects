...
public class CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse {
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withCintCode(String cintCode) {
        this.cintCode = cintCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withSeqNo(Double seqNo) {
        this.seqNo = seqNo;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withServiceDate(Date serviceDate) {
        this.serviceDate = serviceDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withSsstDesc(String ssstDesc) {
        this.ssstDesc = ssstDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withCintDesc(String cintDesc) {
        this.cintDesc = cintDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withOrigDesc(String origDesc) {
        this.origDesc = origDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withSsgpCode(String ssgpCode) {
        this.ssgpCode = ssgpCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withRwname(String rwname) {
        this.rwname = rwname;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withSvvcintNoncreditServiceInd(String svvcintNoncreditServiceInd) {
        this.svvcintNoncreditServiceInd = svvcintNoncreditServiceInd;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withDataOrigin(String dataOrigin) {
        this.dataOrigin = dataOrigin;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withSsgpDesc(String ssgpDesc) {
        this.ssgpDesc = ssgpDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withSsstCode(String ssstCode) {
        this.ssstCode = ssstCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cintCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse) == false) {
            return false;
        }
        CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse rhs = ((CaMisSuccessAndSupportServicesTermDataCareerInterest100GetResponse) other);
