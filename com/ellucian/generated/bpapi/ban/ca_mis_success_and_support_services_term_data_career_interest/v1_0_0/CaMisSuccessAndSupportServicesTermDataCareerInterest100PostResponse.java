...
public class CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse {
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withCintCode(String cintCode) {
        this.cintCode = cintCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withSeqNo(Double seqNo) {
        this.seqNo = seqNo;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withServiceDate(Date serviceDate) {
        this.serviceDate = serviceDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withSsstDesc(String ssstDesc) {
        this.ssstDesc = ssstDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withCintDesc(String cintDesc) {
        this.cintDesc = cintDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withOrigDesc(String origDesc) {
        this.origDesc = origDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withSsgpCode(String ssgpCode) {
        this.ssgpCode = ssgpCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withRwname(String rwname) {
        this.rwname = rwname;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withSvvcintNoncreditServiceInd(String svvcintNoncreditServiceInd) {
        this.svvcintNoncreditServiceInd = svvcintNoncreditServiceInd;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withDataOrigin(String dataOrigin) {
        this.dataOrigin = dataOrigin;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withSsgpDesc(String ssgpDesc) {
        this.ssgpDesc = ssgpDesc;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withSsstCode(String ssstCode) {
        this.ssstCode = ssstCode;
        return this;
    }
    ...
    public CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cintCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse) == false) {
            return false;
        }
        CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse rhs = ((CaMisSuccessAndSupportServicesTermDataCareerInterest100PostResponse) other);
