...
public class Tbredet {
    ...
    public Tbredet withMinAmount(Double minAmount) {
        this.minAmount = minAmount;
        return this;
    }
    ...
    public Tbredet withTbbdetcDesc(String tbbdetcDesc) {
        this.tbbdetcDesc = tbbdetcDesc;
        return this;
    }
    ...
    public Tbredet withiESourceInd(String iESourceInd) {
        this.iESourceInd = iESourceInd;
        return this;
    }
    ...
    public Tbredet withDetailPriority(Double detailPriority) {
        this.detailPriority = detailPriority;
        return this;
    }
    ...
    public Tbredet withMaxAmount(Double maxAmount) {
        this.maxAmount = maxAmount;
        return this;
    }
    ...
    public Tbredet withDetailCode(String detailCode) {
        this.detailCode = detailCode;
        return this;
    }
    ...
    public Tbredet withPercent(Double percent) {
        this.percent = percent;
        return this;
    }
    ...
    public Tbredet withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Tbredet.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("minAmount");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tbredet) == false) {
            return false;
        }
        Tbredet rhs = ((Tbredet) other);
        return (((((((((this.minAmount == rhs.minAmount)||((this.minAmount!= null)&&this.minAmount.equals(rhs.minAmount)))&&((this.tbbdetcDesc == rhs.tbbdetcDesc)||((this.tbbdetcDesc!= null)&&this.tbbdetcDesc.equals(rhs.tbbdetcDesc))))&&((this.iESourceInd == rhs.iESourceInd)||((this.iESourceInd!= null)&&this.iESourceInd.equals(rhs.iESourceInd))))&&((this.detailPriority == rhs.detailPriority)||((this.detailPriority!= null)&&this.detailPriority.equals(rhs.detailPriority))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.maxAmount == rhs.maxAmount)||((this.maxAmount!= null)&&this.maxAmount.equals(rhs.maxAmount))))&&((this.detailCode == rhs.detailCode)||((this.detailCode!= null)&&this.detailCode.equals(rhs.detailCode))))&&((this.percent == rhs.percent)||((this.percent!= null)&&this.percent.equals(rhs.percent))));
    }
