...
@JsonPropertyOrder({
    ...
    "rcrapp4CombatPay",
    "atRiskHomeless",
    "rcrapp3ParIntIncomeFlag",
    "rcrapp4ParTxRetFiledInd",
    "rcrapp3IraPaymentFlag",
    ...
    "driverLicNo",
    "rcrapp3IntIncomeFlag",
    "rcrapp4MothBirthDate",
    "rcrapp3ParTeIntInc",
    "emancipatedMinor",
    "lastName",
    "unaccompYouthHud",
    "rcrapp3FilingStatusFlag",
    "city",
    "degreeByJuly",
    "wardOfCourt",
    "parOthUntaxInc",
...
public class Rcrapp1 {
    ...
    @JsonProperty("rcrapp3EduCredFlag")
    private String rcrapp3EduCredFlag;
    /**
    ...
    @JsonProperty("rcrapp3ParIraPaymentFlag")
    private String rcrapp3ParIraPaymentFlag;
    /**
    ...
    @JsonProperty("rcrapp3ParIntIncomeFlag")
    private String rcrapp3ParIntIncomeFlag;
    /**
     * Tax Return Filed
     * <p>
     * 
    ...
    @JsonProperty("rcrapp3IraPaymentFlag")
    private String rcrapp3IraPaymentFlag;
    /**
    ...
    @JsonProperty("rcrapp3IntIncomeFlag")
    private String rcrapp3IntIncomeFlag;
    ...
    @JsonProperty("rcrapp3FilingStatusFlag")
    private String rcrapp3FilingStatusFlag;
    /**
     * City
     * <p>
    ...
    private String city;
    /**
     *  1st Bachelor's Degree by 01-JUL-2020
     * <p>
     ...
     * 
     */
    @JsonProperty("rcrapp3IraPnsDistFlag")
    private String rcrapp3IraPnsDistFlag;
    /**
    ...
    @JsonProperty("rcrapp3ParEduCredFlag")
    private String rcrapp3ParEduCredFlag;
    /**
     * Child Support Paid
     * <p>
     * 
    ...
    @JsonProperty("rcrapp3TypeOfTaxRetFlag")
    private String rcrapp3TypeOfTaxRetFlag;
    /**
     * Parents' E-mail
     * <p>
     * 
    ...
    @JsonProperty("rcrapp3ParFilingStatusFlag")
    private String rcrapp3ParFilingStatusFlag;
    /**
    ...
    @JsonProperty("rcrapp3ParIraPnsDistFlag")
    private String rcrapp3ParIraPnsDistFlag;
    /**
     * Date of Birth
     * <p>
     * 
    ...
    @JsonProperty("rcrapp3ParTypeOfTaxRetFlag")
    private String rcrapp3ParTypeOfTaxRetFlag;
    /**
    ...
    @JsonProperty("rcrapp3EduCredFlag")
    public String getRcrapp3EduCredFlag() {
        return rcrapp3EduCredFlag;
    }

    @JsonProperty("rcrapp3EduCredFlag")
    public void setRcrapp3EduCredFlag(String rcrapp3EduCredFlag) {
        this.rcrapp3EduCredFlag = rcrapp3EduCredFlag;
    }

    public Rcrapp1 withRcrapp3EduCredFlag(String rcrapp3EduCredFlag) {
        this.rcrapp3EduCredFlag = rcrapp3EduCredFlag;
        return this;
    }
    ...
    public Rcrapp1 withRcrapp3ParIrsFitFlag(String rcrapp3ParIrsFitFlag) {
        this.rcrapp3ParIrsFitFlag = rcrapp3ParIrsFitFlag;
        return this;
    }
    ...
    @JsonProperty("rcrapp3ParIraPaymentFlag")
    public String getRcrapp3ParIraPaymentFlag() {
        return rcrapp3ParIraPaymentFlag;
    }

    @JsonProperty("rcrapp3ParIraPaymentFlag")
    public void setRcrapp3ParIraPaymentFlag(String rcrapp3ParIraPaymentFlag) {
        this.rcrapp3ParIraPaymentFlag = rcrapp3ParIraPaymentFlag;
    }

    public Rcrapp1 withRcrapp3ParIraPaymentFlag(String rcrapp3ParIraPaymentFlag) {
        this.rcrapp3ParIraPaymentFlag = rcrapp3ParIraPaymentFlag;
        return this;
    }
    ...
    @JsonProperty("rcrapp3ParIntIncomeFlag")
    public String getRcrapp3ParIntIncomeFlag() {
        return rcrapp3ParIntIncomeFlag;
    }

    @JsonProperty("rcrapp3ParIntIncomeFlag")
    public void setRcrapp3ParIntIncomeFlag(String rcrapp3ParIntIncomeFlag) {
        this.rcrapp3ParIntIncomeFlag = rcrapp3ParIntIncomeFlag;
    }

    public Rcrapp1 withRcrapp3ParIntIncomeFlag(String rcrapp3ParIntIncomeFlag) {
        this.rcrapp3ParIntIncomeFlag = rcrapp3ParIntIncomeFlag;
        return this;
    }
    ...
    @JsonProperty("rcrapp3IraPaymentFlag")
    public String getRcrapp3IraPaymentFlag() {
        return rcrapp3IraPaymentFlag;
    }

    @JsonProperty("rcrapp3IraPaymentFlag")
    public void setRcrapp3IraPaymentFlag(String rcrapp3IraPaymentFlag) {
        this.rcrapp3IraPaymentFlag = rcrapp3IraPaymentFlag;
    }

    public Rcrapp1 withRcrapp3IraPaymentFlag(String rcrapp3IraPaymentFlag) {
        this.rcrapp3IraPaymentFlag = rcrapp3IraPaymentFlag;
        return this;
    }
    ...
    @JsonProperty("rcrapp3IntIncomeFlag")
    public String getRcrapp3IntIncomeFlag() {
        return rcrapp3IntIncomeFlag;
    }

    @JsonProperty("rcrapp3IntIncomeFlag")
    public void setRcrapp3IntIncomeFlag(String rcrapp3IntIncomeFlag) {
        this.rcrapp3IntIncomeFlag = rcrapp3IntIncomeFlag;
    }

    public Rcrapp1 withRcrapp3IntIncomeFlag(String rcrapp3IntIncomeFlag) {
        this.rcrapp3IntIncomeFlag = rcrapp3IntIncomeFlag;
        return this;
    }
    ...
    @JsonProperty("rcrapp3FilingStatusFlag")
    public String getRcrapp3FilingStatusFlag() {
        return rcrapp3FilingStatusFlag;
    }

    @JsonProperty("rcrapp3FilingStatusFlag")
    public void setRcrapp3FilingStatusFlag(String rcrapp3FilingStatusFlag) {
        this.rcrapp3FilingStatusFlag = rcrapp3FilingStatusFlag;
    }

    public Rcrapp1 withRcrapp3FilingStatusFlag(String rcrapp3FilingStatusFlag) {
        this.rcrapp3FilingStatusFlag = rcrapp3FilingStatusFlag;
        return this;
    }
    ...
    public Rcrapp1 withRcrapp3IrsFitFlag(String rcrapp3IrsFitFlag) {
        this.rcrapp3IrsFitFlag = rcrapp3IrsFitFlag;
        return this;
    }
     ...
     */
    @JsonProperty("rcrapp3IraPnsDistFlag")
    public String getRcrapp3IraPnsDistFlag() {
        return rcrapp3IraPnsDistFlag;
    }
     ...
     */
    @JsonProperty("rcrapp3IraPnsDistFlag")
    public void setRcrapp3IraPnsDistFlag(String rcrapp3IraPnsDistFlag) {
        this.rcrapp3IraPnsDistFlag = rcrapp3IraPnsDistFlag;
    }

    public Rcrapp1 withRcrapp3IraPnsDistFlag(String rcrapp3IraPnsDistFlag) {
        this.rcrapp3IraPnsDistFlag = rcrapp3IraPnsDistFlag;
        return this;
    }
    ...
    public Rcrapp1 withRcrapp3ParIrsDisplayFlag(String rcrapp3ParIrsDisplayFlag) {
        this.rcrapp3ParIrsDisplayFlag = rcrapp3ParIrsDisplayFlag;
        return this;
    }
    ...
    public Rcrapp1 withRcrapp3ParIrsAgiFlag(String rcrapp3ParIrsAgiFlag) {
        this.rcrapp3ParIrsAgiFlag = rcrapp3ParIrsAgiFlag;
        return this;
    }
    ...
    @JsonProperty("rcrapp3ParEduCredFlag")
    public String getRcrapp3ParEduCredFlag() {
        return rcrapp3ParEduCredFlag;
    }

    @JsonProperty("rcrapp3ParEduCredFlag")
    public void setRcrapp3ParEduCredFlag(String rcrapp3ParEduCredFlag) {
        this.rcrapp3ParEduCredFlag = rcrapp3ParEduCredFlag;
    }

    public Rcrapp1 withRcrapp3ParEduCredFlag(String rcrapp3ParEduCredFlag) {
        this.rcrapp3ParEduCredFlag = rcrapp3ParEduCredFlag;
        return this;
    }
    ...
    @JsonProperty("rcrapp3TypeOfTaxRetFlag")
    public String getRcrapp3TypeOfTaxRetFlag() {
        return rcrapp3TypeOfTaxRetFlag;
    }

    @JsonProperty("rcrapp3TypeOfTaxRetFlag")
    public void setRcrapp3TypeOfTaxRetFlag(String rcrapp3TypeOfTaxRetFlag) {
        this.rcrapp3TypeOfTaxRetFlag = rcrapp3TypeOfTaxRetFlag;
    }

    public Rcrapp1 withRcrapp3TypeOfTaxRetFlag(String rcrapp3TypeOfTaxRetFlag) {
        this.rcrapp3TypeOfTaxRetFlag = rcrapp3TypeOfTaxRetFlag;
        return this;
    }
    ...
    public Rcrapp1 withRcrapp3IrsAgiFlag(String rcrapp3IrsAgiFlag) {
        this.rcrapp3IrsAgiFlag = rcrapp3IrsAgiFlag;
        return this;
    }
    ...
    @JsonProperty("rcrapp3ParFilingStatusFlag")
    public String getRcrapp3ParFilingStatusFlag() {
        return rcrapp3ParFilingStatusFlag;
    }

    @JsonProperty("rcrapp3ParFilingStatusFlag")
    public void setRcrapp3ParFilingStatusFlag(String rcrapp3ParFilingStatusFlag) {
        this.rcrapp3ParFilingStatusFlag = rcrapp3ParFilingStatusFlag;
    }

    public Rcrapp1 withRcrapp3ParFilingStatusFlag(String rcrapp3ParFilingStatusFlag) {
        this.rcrapp3ParFilingStatusFlag = rcrapp3ParFilingStatusFlag;
        return this;
    }
    ...
    @JsonProperty("rcrapp3ParIraPnsDistFlag")
    public String getRcrapp3ParIraPnsDistFlag() {
        return rcrapp3ParIraPnsDistFlag;
    }

    @JsonProperty("rcrapp3ParIraPnsDistFlag")
    public void setRcrapp3ParIraPnsDistFlag(String rcrapp3ParIraPnsDistFlag) {
        this.rcrapp3ParIraPnsDistFlag = rcrapp3ParIraPnsDistFlag;
    }

    public Rcrapp1 withRcrapp3ParIraPnsDistFlag(String rcrapp3ParIraPnsDistFlag) {
        this.rcrapp3ParIraPnsDistFlag = rcrapp3ParIraPnsDistFlag;
        return this;
    }
    ...
    public Rcrapp1 withRcrapp3IrsRequestFlag(String rcrapp3IrsRequestFlag) {
        this.rcrapp3IrsRequestFlag = rcrapp3IrsRequestFlag;
        return this;
    }
    ...
    public Rcrapp1 withRcrapp3ParIrsRequestFlag(String rcrapp3ParIrsRequestFlag) {
        this.rcrapp3ParIrsRequestFlag = rcrapp3ParIrsRequestFlag;
        return this;
    }
    ...
    public Rcrapp1 withRcrapp3IrsDisplayFlag(String rcrapp3IrsDisplayFlag) {
        this.rcrapp3IrsDisplayFlag = rcrapp3IrsDisplayFlag;
        return this;
    }
    ...
    @JsonProperty("rcrapp3ParTypeOfTaxRetFlag")
    public String getRcrapp3ParTypeOfTaxRetFlag() {
        return rcrapp3ParTypeOfTaxRetFlag;
    }

    @JsonProperty("rcrapp3ParTypeOfTaxRetFlag")
    public void setRcrapp3ParTypeOfTaxRetFlag(String rcrapp3ParTypeOfTaxRetFlag) {
        this.rcrapp3ParTypeOfTaxRetFlag = rcrapp3ParTypeOfTaxRetFlag;
    }

    public Rcrapp1 withRcrapp3ParTypeOfTaxRetFlag(String rcrapp3ParTypeOfTaxRetFlag) {
        this.rcrapp3ParTypeOfTaxRetFlag = rcrapp3ParTypeOfTaxRetFlag;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("rcrapp3EduCredFlag");
        sb.append('=');
        sb.append(((this.rcrapp3EduCredFlag == null)?"<null>":this.rcrapp3EduCredFlag));
        sb.append(',');
        ...
        sb.append(',');
        sb.append("rcrapp3ParIraPaymentFlag");
        sb.append('=');
        sb.append(((this.rcrapp3ParIraPaymentFlag == null)?"<null>":this.rcrapp3ParIraPaymentFlag));
        sb.append(',');
        ...
        sb.append(',');
        sb.append("rcrapp3ParIntIncomeFlag");
        sb.append('=');
        sb.append(((this.rcrapp3ParIntIncomeFlag == null)?"<null>":this.rcrapp3ParIntIncomeFlag));
        sb.append(',');
        sb.append("rcrapp4ParTxRetFiledInd");
        sb.append('=');
        sb.append(((this.rcrapp4ParTxRetFiledInd == null)?"<null>":this.rcrapp4ParTxRetFiledInd));
        sb.append(',');
        sb.append("rcrapp3IraPaymentFlag");
        sb.append('=');
        sb.append(((this.rcrapp3IraPaymentFlag == null)?"<null>":this.rcrapp3IraPaymentFlag));
        sb.append(',');
        ...
        sb.append(',');
        sb.append("rcrapp3IntIncomeFlag");
        sb.append('=');
        sb.append(((this.rcrapp3IntIncomeFlag == null)?"<null>":this.rcrapp3IntIncomeFlag));
        sb.append(',');
        ...
        sb.append(',');
        sb.append("rcrapp3FilingStatusFlag");
        sb.append('=');
        sb.append(((this.rcrapp3FilingStatusFlag == null)?"<null>":this.rcrapp3FilingStatusFlag));
        sb.append(',');
        sb.append("city");
        sb.append('=');
        ...
        sb.append(',');
        sb.append("rcrapp3IraPnsDistFlag");
        sb.append('=');
        sb.append(((this.rcrapp3IraPnsDistFlag == null)?"<null>":this.rcrapp3IraPnsDistFlag));
        sb.append(',');
        ...
        sb.append(',');
        sb.append("rcrapp3ParEduCredFlag");
        sb.append('=');
        sb.append(((this.rcrapp3ParEduCredFlag == null)?"<null>":this.rcrapp3ParEduCredFlag));
        sb.append(',');
        ...
        sb.append(',');
        sb.append("rcrapp3TypeOfTaxRetFlag");
        sb.append('=');
        sb.append(((this.rcrapp3TypeOfTaxRetFlag == null)?"<null>":this.rcrapp3TypeOfTaxRetFlag));
        sb.append(',');
        ...
        sb.append(',');
        sb.append("rcrapp3ParFilingStatusFlag");
        sb.append('=');
        sb.append(((this.rcrapp3ParFilingStatusFlag == null)?"<null>":this.rcrapp3ParFilingStatusFlag));
        sb.append(',');
        ...
        sb.append(',');
        sb.append("rcrapp3ParIraPnsDistFlag");
        sb.append('=');
        sb.append(((this.rcrapp3ParIraPnsDistFlag == null)?"<null>":this.rcrapp3ParIraPnsDistFlag));
        sb.append(',');
        ...
        sb.append(',');
        sb.append("rcrapp3ParTypeOfTaxRetFlag");
        sb.append('=');
        sb.append(((this.rcrapp3ParTypeOfTaxRetFlag == null)?"<null>":this.rcrapp3ParTypeOfTaxRetFlag));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.rcrapp3EduCredFlag == null)? 0 :this.rcrapp3EduCredFlag.hashCode()));
        ...
        result = ((result* 31)+((this.rcrapp3ParIraPaymentFlag == null)? 0 :this.rcrapp3ParIraPaymentFlag.hashCode()));
        ...
        result = ((result* 31)+((this.rcrapp3ParIntIncomeFlag == null)? 0 :this.rcrapp3ParIntIncomeFlag.hashCode()));
        result = ((result* 31)+((this.rcrapp4ParTxRetFiledInd == null)? 0 :this.rcrapp4ParTxRetFiledInd.hashCode()));
        result = ((result* 31)+((this.rcrapp3IraPaymentFlag == null)? 0 :this.rcrapp3IraPaymentFlag.hashCode()));
        ...
        result = ((result* 31)+((this.rcrapp3IntIncomeFlag == null)? 0 :this.rcrapp3IntIncomeFlag.hashCode()));
        ...
        result = ((result* 31)+((this.rcrapp3FilingStatusFlag == null)? 0 :this.rcrapp3FilingStatusFlag.hashCode()));
        ...
        result = ((result* 31)+((this.rcrapp3IraPnsDistFlag == null)? 0 :this.rcrapp3IraPnsDistFlag.hashCode()));
        ...
        result = ((result* 31)+((this.rcrapp3ParEduCredFlag == null)? 0 :this.rcrapp3ParEduCredFlag.hashCode()));
        ...
        result = ((result* 31)+((this.rcrapp3TypeOfTaxRetFlag == null)? 0 :this.rcrapp3TypeOfTaxRetFlag.hashCode()));
        ...
        result = ((result* 31)+((this.rcrapp3ParFilingStatusFlag == null)? 0 :this.rcrapp3ParFilingStatusFlag.hashCode()));
        ...
        result = ((result* 31)+((this.rcrapp3ParIraPnsDistFlag == null)? 0 :this.rcrapp3ParIraPnsDistFlag.hashCode()));
        ...
        result = ((result* 31)+((this.rcrapp3ParTypeOfTaxRetFlag == null)? 0 :this.rcrapp3ParTypeOfTaxRetFlag.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((this.schoolLunch == rhs.schoolLunch)||((this.schoolLunch!= null)&&this.schoolLunch.equals(rhs.schoolLunch)))&&((this.citzInd == rhs.citzInd)||((this.citzInd!= null)&&this.citzInd.equals(rhs.citzInd))))&&((this.parVetsNonEdBen == rhs.parVetsNonEdBen)||((this.parVetsNonEdBen!= null)&&this.parVetsNonEdBen.equals(rhs.parVetsNonEdBen))))&&((this.rcrapp4FathLastName == rhs.rcrapp4FathLastName)||((this.rcrapp4FathLastName!= null)&&this.rcrapp4FathLastName.equals(rhs.rcrapp4FathLastName))))&&((this.rcrapp3ParEducCredits == rhs.rcrapp3ParEducCredits)||((this.rcrapp3ParEducCredits!= null)&&this.rcrapp3ParEducCredits.equals(rhs.rcrapp3ParEducCredits))))&&((this.rcrapp3PreparerSsn == rhs.rcrapp3PreparerSsn)||((this.rcrapp3PreparerSsn!= null)&&this.rcrapp3PreparerSsn.equals(rhs.rcrapp3PreparerSsn))))&&((this.rcrapp4BusNetWorth == rhs.rcrapp4BusNetWorth)||((this.rcrapp4BusNetWorth!= null)&&this.rcrapp4BusNetWorth.equals(rhs.rcrapp4BusNetWorth))))&&((this.incFrWrk == rhs.incFrWrk)||((this.incFrWrk!= null)&&this.incFrWrk.equals(rhs.incFrWrk))))&&((this.ssn == rhs.ssn)||((this.ssn!= null)&&this.ssn.equals(rhs.ssn))))&&((this.displayNeedDate == rhs.displayNeedDate)||((this.displayNeedDate!= null)&&this.displayNeedDate.equals(rhs.displayNeedDate))))&&((this.parUsInc == rhs.parUsInc)||((this.parUsInc!= null)&&this.parUsInc.equals(rhs.parUsInc))))&&((this.recdSsi == rhs.recdSsi)||((this.recdSsi!= null)&&this.recdSsi.equals(rhs.recdSsi))))&&((this.parCashAmt == rhs.parCashAmt)||((this.parCashAmt!= null)&&this.parCashAmt.equals(rhs.parCashAmt))))&&((this.rcrapp3EduCredFlag == rhs.rcrapp3EduCredFlag)||((this.rcrapp3EduCredFlag!= null)&&this.rcrapp3EduCredFlag.equals(rhs.rcrapp3EduCredFlag))))&&((this.parNoInColl == rhs.parNoInColl)||((this.parNoInColl!= null)&&this.parNoInColl.equals(rhs.parNoInColl))))&&((this.rcrapp3ParIrsFitFlag == rhs.rcrapp3ParIrsFitFlag)||((this.rcrapp3ParIrsFitFlag!= null)&&this.rcrapp3ParIrsFitFlag.equals(rhs.rcrapp3ParIrsFitFlag))))&&((this.rcrapp3HouseFoodOth == rhs.rcrapp3HouseFoodOth)||((this.rcrapp3HouseFoodOth!= null)&&this.rcrapp3HouseFoodOth.equals(rhs.rcrapp3HouseFoodOth))))&&((this.rcrapp3ParIraPaymentFlag == rhs.rcrapp3ParIraPaymentFlag)||((this.rcrapp3ParIraPaymentFlag!= null)&&this.rcrapp3ParIraPaymentFlag.equals(rhs.rcrapp3ParIraPaymentFlag))))&&((this.rcrapp3ParNeedBasedEmploy == rhs.rcrapp3ParNeedBasedEmploy)||((this.rcrapp3ParNeedBasedEmploy!= null)&&this.rcrapp3ParNeedBasedEmploy.equals(rhs.rcrapp3ParNeedBasedEmploy))))&&((this.othUntaxInc == rhs.othUntaxInc)||((this.othUntaxInc!= null)&&this.othUntaxInc.equals(rhs.othUntaxInc))))&&((this.zip == rhs.zip)||((this.zip!= null)&&this.zip.equals(rhs.zip))))&&((this.rcrapp3NeedBasedEmploy == rhs.rcrapp3NeedBasedEmploy)||((this.rcrapp3NeedBasedEmploy!= null)&&this.rcrapp3NeedBasedEmploy.equals(rhs.rcrapp3NeedBasedEmploy))))&&((this.rcrapp4EmailAddress == rhs.rcrapp4EmailAddress)||((this.rcrapp4EmailAddress!= null)&&this.rcrapp4EmailAddress.equals(rhs.rcrapp4EmailAddress))))&&((this.rcrapp4ParLegalResInd == rhs.rcrapp4ParLegalResInd)||((this.rcrapp4ParLegalResInd!= null)&&this.rcrapp4ParLegalResInd.equals(rhs.rcrapp4ParLegalResInd))))&&((this.rcrapp4CombatPay == rhs.rcrapp4CombatPay)||((this.rcrapp4CombatPay!= null)&&this.rcrapp4CombatPay.equals(rhs.rcrapp4CombatPay))))&&((this.atRiskHomeless == rhs.atRiskHomeless)||((this.atRiskHomeless!= null)&&this.atRiskHomeless.equals(rhs.atRiskHomeless))))&&((this.rcrapp3ParIntIncomeFlag == rhs.rcrapp3ParIntIncomeFlag)||((this.rcrapp3ParIntIncomeFlag!= null)&&this.rcrapp3ParIntIncomeFlag.equals(rhs.rcrapp3ParIntIncomeFlag))))&&((this.rcrapp4ParTxRetFiledInd == rhs.rcrapp4ParTxRetFiledInd)||((this.rcrapp4ParTxRetFiledInd!= null)&&this.rcrapp4ParTxRetFiledInd.equals(rhs.rcrapp4ParTxRetFiledInd))))&&((this.rcrapp3IraPaymentFlag == rhs.rcrapp3IraPaymentFlag)||((this.rcrapp3IraPaymentFlag!= null)&&this.rcrapp3IraPaymentFlag.equals(rhs.rcrapp3IraPaymentFlag))))&&((this.rcrapp4ParBusNetWorth == rhs.rcrapp4ParBusNetWorth)||((this.rcrapp4ParBusNetWorth!= null)&&this.rcrapp4ParBusNetWorth.equals(rhs.rcrapp4ParBusNetWorth))))&&((this.signed == rhs.signed)||((this.signed!= null)&&this.signed.equals(rhs.signed))))&&((this.statCodeRes == rhs.statCodeRes)||((this.statCodeRes!= null)&&this.statCodeRes.equals(rhs.statCodeRes))))&&((this.instHousCde == rhs.instHousCde)||((this.instHousCde!= null)&&this.instHousCde.equals(rhs.instHousCde))))&&((this.origCompDate == rhs.origCompDate)||((this.origCompDate!= null)&&this.origCompDate.equals(rhs.origCompDate))))&&((this.rcrapp4HighSchoolFlg == rhs.rcrapp4HighSchoolFlg)||((this.rcrapp4HighSchoolFlg!= null)&&this.rcrapp4HighSchoolFlg.equals(rhs.rcrapp4HighSchoolFlg))))&&((this.rcrapp4StatCodeHighSch == rhs.rcrapp4StatCodeHighSch)||((this.rcrapp4StatCodeHighSch!= null)&&this.rcrapp4StatCodeHighSch.equals(rhs.rcrapp4StatCodeHighSch))))&&((this.statCodeLic == rhs.statCodeLic)||((this.statCodeLic!= null)&&this.statCodeLic.equals(rhs.statCodeLic))))&&((this.activeDuty == rhs.activeDuty)||((this.activeDuty!= null)&&this.activeDuty.equals(rhs.activeDuty))))&&((this.taxFilingStatus == rhs.taxFilingStatus)||((this.taxFilingStatus!= null)&&this.taxFilingStatus.equals(rhs.taxFilingStatus))))&&((this.rcrapp3GrantScholarAid == rhs.rcrapp3GrantScholarAid)||((this.rcrapp3GrantScholarAid!= null)&&this.rcrapp3GrantScholarAid.equals(rhs.rcrapp3GrantScholarAid))))&&((this.parUntaxIraPnsDist == rhs.parUntaxIraPnsDist)||((this.parUntaxIraPnsDist!= null)&&this.parUntaxIraPnsDist.equals(rhs.parUntaxIraPnsDist))))&&((this.parTaxFormInd == rhs.parTaxFormInd)||((this.parTaxFormInd!= null)&&this.parTaxFormInd.equals(rhs.parTaxFormInd))))&&((this.rcrapp3FatherHiGrade == rhs.rcrapp3FatherHiGrade)||((this.rcrapp3FatherHiGrade!= null)&&this.rcrapp3FatherHiGrade.equals(rhs.rcrapp3FatherHiGrade))))&&((this.mrtlStatus == rhs.mrtlStatus)||((this.mrtlStatus!= null)&&this.mrtlStatus.equals(rhs.mrtlStatus))))&&((this.rcrapp4LegalResInd == rhs.rcrapp4LegalResInd)||((this.rcrapp4LegalResInd!= null)&&this.rcrapp4LegalResInd.equals(rhs.rcrapp4LegalResInd))))&&((this.famMemb == rhs.famMemb)||((this.famMemb!= null)&&this.famMemb.equals(rhs.famMemb))))&&((this.rcrapp3ParHouseFoodOth == rhs.rcrapp3ParHouseFoodOth)||((this.rcrapp3ParHouseFoodOth!= null)&&this.rcrapp3ParHouseFoodOth.equals(rhs.rcrapp3ParHouseFoodOth))))&&((this.driverLicNo == rhs.driverLicNo)||((this.driverLicNo!= null)&&this.driverLicNo.equals(rhs.driverLicNo))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.rcrapp3IntIncomeFlag == rhs.rcrapp3IntIncomeFlag)||((this.rcrapp3IntIncomeFlag!= null)&&this.rcrapp3IntIncomeFlag.equals(rhs.rcrapp3IntIncomeFlag))))&&((this.rcrapp4MothBirthDate == rhs.rcrapp4MothBirthDate)||((this.rcrapp4MothBirthDate!= null)&&this.rcrapp4MothBirthDate.equals(rhs.rcrapp4MothBirthDate))))&&((this.rcrapp3ParTeIntInc == rhs.rcrapp3ParTeIntInc)||((this.rcrapp3ParTeIntInc!= null)&&this.rcrapp3ParTeIntInc.equals(rhs.rcrapp3ParTeIntInc))))&&((this.emancipatedMinor == rhs.emancipatedMinor)||((this.emancipatedMinor!= null)&&this.emancipatedMinor.equals(rhs.emancipatedMinor))))&&((this.lastName == rhs.lastName)||((this.lastName!= null)&&this.lastName.equals(rhs.lastName))))&&((this.unaccompYouthHud == rhs.unaccompYouthHud)||((this.unaccompYouthHud!= null)&&this.unaccompYouthHud.equals(rhs.unaccompYouthHud))))&&((this.rcrapp3FilingStatusFlag == rhs.rcrapp3FilingStatusFlag)||((this.rcrapp3FilingStatusFlag!= null)&&this.rcrapp3FilingStatusFlag.equals(rhs.rcrapp3FilingStatusFlag))))&&((this.city == rhs.city)||((this.city!= null)&&this.city.equals(rhs.city))))&&((this.degreeByJuly == rhs.degreeByJuly)||((this.degreeByJuly!= null)&&this.degreeByJuly.equals(rhs.degreeByJuly))))&&((this.wardOfCourt == rhs.wardOfCourt)||((this.wardOfCourt!= null)&&this.wardOfCourt.equals(rhs.wardOfCourt))))&&((this.parOthUntaxInc == rhs.parOthUntaxInc)||((this.parOthUntaxInc!= null)&&this.parOthUntaxInc.equals(rhs.parOthUntaxInc))))&&((this.childSupp == rhs.childSupp)||((this.childSupp!= null)&&this.childSupp.equals(rhs.childSupp))))&&((this.phoneNo == rhs.phoneNo)||((this.phoneNo!= null)&&this.phoneNo.equals(rhs.phoneNo))))&&((this.rcrapp3MothSsnMatch == rhs.rcrapp3MothSsnMatch)||((this.rcrapp3MothSsnMatch!= null)&&this.rcrapp3MothSsnMatch.equals(rhs.rcrapp3MothSsnMatch))))&&((this.usIncTaxPd == rhs.usIncTaxPd)||((this.usIncTaxPd!= null)&&this.usIncTaxPd.equals(rhs.usIncTaxPd))))&&((this.activityDate == rhs.activityDate)||((this.activityDate!= null)&&this.activityDate.equals(rhs.activityDate))))&&((this.fedCollChoice1 == rhs.fedCollChoice1)||((this.fedCollChoice1 != null)&&this.fedCollChoice1 .equals(rhs.fedCollChoice1))))&&((this.rcrapp3ParGrantScholarAid == rhs.rcrapp3ParGrantScholarAid)||((this.rcrapp3ParGrantScholarAid!= null)&&this.rcrapp3ParGrantScholarAid.equals(rhs.rcrapp3ParGrantScholarAid))))&&((this.displayVerificationPrtyDesc == rhs.displayVerificationPrtyDesc)||((this.displayVerificationPrtyDesc!= null)&&this.displayVerificationPrtyDesc.equals(rhs.displayVerificationPrtyDesc))))&&((this.rcrapp3IrsFitFlag == rhs.rcrapp3IrsFitFlag)||((this.rcrapp3IrsFitFlag!= null)&&this.rcrapp3IrsFitFlag.equals(rhs.rcrapp3IrsFitFlag))))&&((this.untaxIraPnsDist == rhs.untaxIraPnsDist)||((this.untaxIraPnsDist!= null)&&this.untaxIraPnsDist.equals(rhs.untaxIraPnsDist))))&&((this.rcrapp3PreparerEin == rhs.rcrapp3PreparerEin)||((this.rcrapp3PreparerEin!= null)&&this.rcrapp3PreparerEin.equals(rhs.rcrapp3PreparerEin))))&&((this.rcrapp3ChildSuppPaid == rhs.rcrapp3ChildSuppPaid)||((this.rcrapp3ChildSuppPaid!= null)&&this.rcrapp3ChildSuppPaid.equals(rhs.rcrapp3ChildSuppPaid))))&&((this.displaySResDateYr == rhs.displaySResDateYr)||((this.displaySResDateYr!= null)&&this.displaySResDateYr.equals(rhs.displaySResDateYr))))&&((this.rcrapp4FathFirstNameIni == rhs.rcrapp4FathFirstNameIni)||((this.rcrapp4FathFirstNameIni!= null)&&this.rcrapp4FathFirstNameIni.equals(rhs.rcrapp4FathFirstNameIni))))&&((this.rcrapp3IraPnsDistFlag == rhs.rcrapp3IraPnsDistFlag)||((this.rcrapp3IraPnsDistFlag!= null)&&this.rcrapp3IraPnsDistFlag.equals(rhs.rcrapp3IraPnsDistFlag))))&&((this.rcrapp3SpecCircumFlg == rhs.rcrapp3SpecCircumFlg)||((this.rcrapp3SpecCircumFlg!= null)&&this.rcrapp3SpecCircumFlg.equals(rhs.rcrapp3SpecCircumFlg))))&&((this.createDate == rhs.createDate)||((this.createDate!= null)&&this.createDate.equals(rhs.createDate))))&&((this.rcrapp3SMarMthYr == rhs.rcrapp3SMarMthYr)||((this.rcrapp3SMarMthYr!= null)&&this.rcrapp3SMarMthYr.equals(rhs.rcrapp3SMarMthYr))))&&((this.rcrapp3PreparerSign == rhs.rcrapp3PreparerSign)||((this.rcrapp3PreparerSign!= null)&&this.rcrapp3PreparerSign.equals(rhs.rcrapp3PreparerSign))))&&((this.rcrapp3ParIrsDisplayFlag == rhs.rcrapp3ParIrsDisplayFlag)||((this.rcrapp3ParIrsDisplayFlag!= null)&&this.rcrapp3ParIrsDisplayFlag.equals(rhs.rcrapp3ParIrsDisplayFlag))))&&((this.rcrapp4FathSsn == rhs.rcrapp4FathSsn)||((this.rcrapp4FathSsn!= null)&&this.rcrapp4FathSsn.equals(rhs.rcrapp4FathSsn))))&&((this.rcrapp3ParIrsAgiFlag == rhs.rcrapp3ParIrsAgiFlag)||((this.rcrapp3ParIrsAgiFlag!= null)&&this.rcrapp3ParIrsAgiFlag.equals(rhs.rcrapp3ParIrsAgiFlag))))&&((this.permitDraftReg == rhs.permitDraftReg)||((this.permitDraftReg!= null)&&this.permitDraftReg.equals(rhs.permitDraftReg))))&&((this.rcrapp4DrugOffenseConvic == rhs.rcrapp4DrugOffenseConvic)||((this.rcrapp4DrugOffenseConvic!= null)&&this.rcrapp4DrugOffenseConvic.equals(rhs.rcrapp4DrugOffenseConvic))))&&((this.recdTanf == rhs.recdTanf)||((this.recdTanf!= null)&&this.recdTanf.equals(rhs.recdTanf))))&&((this.rcrapp4SAssetThreshExcd == rhs.rcrapp4SAssetThreshExcd)||((this.rcrapp4SAssetThreshExcd!= null)&&this.rcrapp4SAssetThreshExcd.equals(rhs.rcrapp4SAssetThreshExcd))))&&((this.rcrapp4HighSchoolCity == rhs.rcrapp4HighSchoolCity)||((this.rcrapp4HighSchoolCity!= null)&&this.rcrapp4HighSchoolCity.equals(rhs.rcrapp4HighSchoolCity))))&&((this.vetsNonEdBen == rhs.vetsNonEdBen)||((this.vetsNonEdBen!= null)&&this.vetsNonEdBen.equals(rhs.vetsNonEdBen))))&&((this.userId == rhs.userId)||((this.userId!= null)&&this.userId.equals(rhs.userId))))&&((this.parTaxFilingStatus == rhs.parTaxFilingStatus)||((this.parTaxFilingStatus!= null)&&this.parTaxFilingStatus.equals(rhs.parTaxFilingStatus))))&&((this.parFoodStamps == rhs.parFoodStamps)||((this.parFoodStamps!= null)&&this.parFoodStamps.equals(rhs.parFoodStamps))))&&((this.fathIncFrWrk == rhs.fathIncFrWrk)||((this.fathIncFrWrk!= null)&&this.fathIncFrWrk.equals(rhs.fathIncFrWrk))))&&((this.parRecdTanf == rhs.parRecdTanf)||((this.parRecdTanf!= null)&&this.parRecdTanf.equals(rhs.parRecdTanf))))&&((this.parRecdWic == rhs.parRecdWic)||((this.parRecdWic!= null)&&this.parRecdWic.equals(rhs.parRecdWic))))&&((this.rcrapp4MothLastName == rhs.rcrapp4MothLastName)||((this.rcrapp4MothLastName!= null)&&this.rcrapp4MothLastName.equals(rhs.rcrapp4MothLastName))))&&((this.rcrapp4WrkStdyLoansInt == rhs.rcrapp4WrkStdyLoansInt)||((this.rcrapp4WrkStdyLoansInt!= null)&&this.rcrapp4WrkStdyLoansInt.equals(rhs.rcrapp4WrkStdyLoansInt))))&&((this.parUsIncTaxPd == rhs.parUsIncTaxPd)||((this.parUsIncTaxPd!= null)&&this.parUsIncTaxPd.equals(rhs.parUsIncTaxPd))))&&((this.rcrapp3DegreeType == rhs.rcrapp3DegreeType)||((this.rcrapp3DegreeType!= null)&&this.rcrapp3DegreeType.equals(rhs.rcrapp3DegreeType))))&&((this.usVet == rhs.usVet)||((this.usVet!= null)&&this.usVet.equals(rhs.usVet))))&&((this.rcrapp3Married == rhs.rcrapp3Married)||((this.rcrapp3Married!= null)&&this.rcrapp3Married.equals(rhs.rcrapp3Married))))&&((this.rcrapp3YrInColl2 == rhs.rcrapp3YrInColl2)||((this.rcrapp3YrInColl2 != null)&&this.rcrapp3YrInColl2 .equals(rhs.rcrapp3YrInColl2))))&&((this.rcrapp4ParFiledSched1 == rhs.rcrapp4ParFiledSched1)||((this.rcrapp4ParFiledSched1 != null)&&this.rcrapp4ParFiledSched1 .equals(rhs.rcrapp4ParFiledSched1))))&&((this.cashAmt == rhs.cashAmt)||((this.cashAmt!= null)&&this.cashAmt.equals(rhs.cashAmt))))&&((this.noInColl == rhs.noInColl)||((this.noInColl!= null)&&this.noInColl.equals(rhs.noInColl))))&&((this.rcrapp3GradOrProf == rhs.rcrapp3GradOrProf)||((this.rcrapp3GradOrProf!= null)&&this.rcrapp3GradOrProf.equals(rhs.rcrapp3GradOrProf))))&&((this.parFamMemb == rhs.parFamMemb)||((this.parFamMemb!= null)&&this.parFamMemb.equals(rhs.parFamMemb))))&&((this.rcrapp3ParEduCredFlag == rhs.rcrapp3ParEduCredFlag)||((this.rcrapp3ParEduCredFlag!= null)&&this.rcrapp3ParEduCredFlag.equals(rhs.rcrapp3ParEduCredFlag))))&&((this.rcrapp3ParChildSuppPaid == rhs.rcrapp3ParChildSuppPaid)||((this.rcrapp3ParChildSuppPaid!= null)&&this.rcrapp3ParChildSuppPaid.equals(rhs.rcrapp3ParChildSuppPaid))))&&((this.verificationPrty == rhs.verificationPrty)||((this.verificationPrty!= null)&&this.verificationPrty.equals(rhs.verificationPrty))))&&((this.parStatCodeRes == rhs.parStatCodeRes)||((this.parStatCodeRes!= null)&&this.parStatCodeRes.equals(rhs.parStatCodeRes))))&&((this.rcrapp3ParCoOpEarnings == rhs.rcrapp3ParCoOpEarnings)||((this.rcrapp3ParCoOpEarnings!= null)&&this.rcrapp3ParCoOpEarnings.equals(rhs.rcrapp3ParCoOpEarnings))))&&((this.rcrapp3TypeOfTaxRetFlag == rhs.rcrapp3TypeOfTaxRetFlag)||((this.rcrapp3TypeOfTaxRetFlag!= null)&&this.rcrapp3TypeOfTaxRetFlag.equals(rhs.rcrapp3TypeOfTaxRetFlag))))&&((this.rcrapp4PEmailAddress == rhs.rcrapp4PEmailAddress)||((this.rcrapp4PEmailAddress!= null)&&this.rcrapp4PEmailAddress.equals(rhs.rcrapp4PEmailAddress))))&&((this.rcrapp4ParInvNetWorth == rhs.rcrapp4ParInvNetWorth)||((this.rcrapp4ParInvNetWorth!= null)&&this.rcrapp4ParInvNetWorth.equals(rhs.rcrapp4ParInvNetWorth))))&&((this.mi == rhs.mi)||((this.mi!= null)&&this.mi.equals(rhs.mi))))&&((this.yrInColl == rhs.yrInColl)||((this.yrInColl!= null)&&this.yrInColl.equals(rhs.yrInColl))))&&((this.rcrapp3ParTaxDefPension == rhs.rcrapp3ParTaxDefPension)||((this.rcrapp3ParTaxDefPension!= null)&&this.rcrapp3ParTaxDefPension.equals(rhs.rcrapp3ParTaxDefPension))))&&((this.parDislWrk == rhs.parDislWrk)||((this.parDislWrk!= null)&&this.parDislWrk.equals(rhs.parDislWrk))))&&((this.spsIncFrWrk == rhs.spsIncFrWrk)||((this.spsIncFrWrk!= null)&&this.spsIncFrWrk.equals(rhs.spsIncFrWrk))))&&((this.rcrapp3IrsAgiFlag == rhs.rcrapp3IrsAgiFlag)||((this.rcrapp3IrsAgiFlag!= null)&&this.rcrapp3IrsAgiFlag.equals(rhs.rcrapp3IrsAgiFlag))))&&((this.alienRegNo == rhs.alienRegNo)||((this.alienRegNo!= null)&&this.alienRegNo.equals(rhs.alienRegNo))))&&((this.rcrapp3CoOpEarnings == rhs.rcrapp3CoOpEarnings)||((this.rcrapp3CoOpEarnings!= null)&&this.rcrapp3CoOpEarnings.equals(rhs.rcrapp3CoOpEarnings))))&&((this.rcrapp3ParFilingStatusFlag == rhs.rcrapp3ParFilingStatusFlag)||((this.rcrapp3ParFilingStatusFlag!= null)&&this.rcrapp3ParFilingStatusFlag.equals(rhs.rcrapp3ParFilingStatusFlag))))&&((this.parChildSupp == rhs.parChildSupp)||((this.parChildSupp!= null)&&this.parChildSupp.equals(rhs.parChildSupp))))&&((this.bornBefore11Xx == rhs.bornBefore11Xx)||((this.bornBefore11Xx!= null)&&this.bornBefore11Xx.equals(rhs.bornBefore11Xx))))&&((this.rcrapp4IraKeoghAmt == rhs.rcrapp4IraKeoghAmt)||((this.rcrapp4IraKeoghAmt!= null)&&this.rcrapp4IraKeoghAmt.equals(rhs.rcrapp4IraKeoghAmt))))&&((this.rcrapp3FathSsnMatch == rhs.rcrapp3FathSsnMatch)||((this.rcrapp3FathSsnMatch!= null)&&this.rcrapp3FathSsnMatch.equals(rhs.rcrapp3FathSsnMatch))))&&((this.rcrapp4InvNetWorth == rhs.rcrapp4InvNetWorth)||((this.rcrapp4InvNetWorth!= null)&&this.rcrapp4InvNetWorth.equals(rhs.rcrapp4InvNetWorth))))&&((this.displayPResDateMo == rhs.displayPResDateMo)||((this.displayPResDateMo!= null)&&this.displayPResDateMo.equals(rhs.displayPResDateMo))))&&((this.rcrapp4HaveChildren == rhs.rcrapp4HaveChildren)||((this.rcrapp4HaveChildren!= null)&&this.rcrapp4HaveChildren.equals(rhs.rcrapp4HaveChildren))))&&((this.othNonReportMoney == rhs.othNonReportMoney)||((this.othNonReportMoney!= null)&&this.othNonReportMoney.equals(rhs.othNonReportMoney))))&&((this.firstName == rhs.firstName)||((this.firstName!= null)&&this.firstName.equals(rhs.firstName))))&&((this.rcptDate == rhs.rcptDate)||((this.rcptDate!= null)&&this.rcptDate.equals(rhs.rcptDate))))&&((this.rcrapp4ParCombatPay == rhs.rcrapp4ParCombatPay)||((this.rcrapp4ParCombatPay!= null)&&this.rcrapp4ParCombatPay.equals(rhs.rcrapp4ParCombatPay))))&&((this.rcrapp4HighSchoolName == rhs.rcrapp4HighSchoolName)||((this.rcrapp4HighSchoolName!= null)&&this.rcrapp4HighSchoolName.equals(rhs.rcrapp4HighSchoolName))))&&((this.rcrapp3ParIraPnsDistFlag == rhs.rcrapp3ParIraPnsDistFlag)||((this.rcrapp3ParIraPnsDistFlag!= null)&&this.rcrapp3ParIraPnsDistFlag.equals(rhs.rcrapp3ParIraPnsDistFlag))))&&((this.rcrapp4FathBirthDate == rhs.rcrapp4FathBirthDate)||((this.rcrapp4FathBirthDate!= null)&&this.rcrapp4FathBirthDate.equals(rhs.rcrapp4FathBirthDate))))&&((this.phoneArea == rhs.phoneArea)||((this.phoneArea!= null)&&this.phoneArea.equals(rhs.phoneArea))))&&((this.parRecdSsi == rhs.parRecdSsi)||((this.parRecdSsi!= null)&&this.parRecdSsi.equals(rhs.parRecdSsi))))&&((this.rcrapp3ParMarMthYr == rhs.rcrapp3ParMarMthYr)||((this.rcrapp3ParMarMthYr!= null)&&this.rcrapp3ParMarMthYr.equals(rhs.rcrapp3ParMarMthYr))))&&((this.foodStamps == rhs.foodStamps)||((this.foodStamps!= null)&&this.foodStamps.equals(rhs.foodStamps))))&&((this.hasLegalDepend == rhs.hasLegalDepend)||((this.hasLegalDepend!= null)&&this.hasLegalDepend.equals(rhs.hasLegalDepend))))&&((this.rcrapp3MotherHiGrade == rhs.rcrapp3MotherHiGrade)||((this.rcrapp3MotherHiGrade!= null)&&this.rcrapp3MotherHiGrade.equals(rhs.rcrapp3MotherHiGrade))))&&((this.rcrapp3IrsRequestFlag == rhs.rcrapp3IrsRequestFlag)||((this.rcrapp3IrsRequestFlag!= null)&&this.rcrapp3IrsRequestFlag.equals(rhs.rcrapp3IrsRequestFlag))))&&((this.usInc == rhs.usInc)||((this.usInc!= null)&&this.usInc.equals(rhs.usInc))))&&((this.creatorId == rhs.creatorId)||((this.creatorId!= null)&&this.creatorId.equals(rhs.creatorId))))&&((this.taxFormInd == rhs.taxFormInd)||((this.taxFormInd!= null)&&this.taxFormInd.equals(rhs.taxFormInd))))&&((this.verificationMsg == rhs.verificationMsg)||((this.verificationMsg!= null)&&this.verificationMsg.equals(rhs.verificationMsg))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this.dislWrk == rhs.dislWrk)||((this.dislWrk!= null)&&this.dislWrk.equals(rhs.dislWrk))))&&((this.rcrapp3ParIrsRequestFlag == rhs.rcrapp3ParIrsRequestFlag)||((this.rcrapp3ParIrsRequestFlag!= null)&&this.rcrapp3ParIrsRequestFlag.equals(rhs.rcrapp3ParIrsRequestFlag))))&&((this.legalGuardian == rhs.legalGuardian)||((this.legalGuardian!= null)&&this.legalGuardian.equals(rhs.legalGuardian))))&&((this.rcrapp4PAssetThreshExcd == rhs.rcrapp4PAssetThreshExcd)||((this.rcrapp4PAssetThreshExcd!= null)&&this.rcrapp4PAssetThreshExcd.equals(rhs.rcrapp4PAssetThreshExcd))))&&((this.rcrapp3ParIraKeough == rhs.rcrapp3ParIraKeough)||((this.rcrapp3ParIraKeough!= null)&&this.rcrapp3ParIraKeough.equals(rhs.rcrapp3ParIraKeough))))&&((this.rcrapp3TaxDefPension == rhs.rcrapp3TaxDefPension)||((this.rcrapp3TaxDefPension!= null)&&this.rcrapp3TaxDefPension.equals(rhs.rcrapp3TaxDefPension))))&&((this.displaySResDateMo == rhs.displaySResDateMo)||((this.displaySResDateMo!= null)&&this.displaySResDateMo.equals(rhs.displaySResDateMo))))&&((this.displayPResDateYr == rhs.displayPResDateYr)||((this.displayPResDateYr!= null)&&this.displayPResDateYr.equals(rhs.displayPResDateYr))))&&((this.parMrtlStatus == rhs.parMrtlStatus)||((this.parMrtlStatus!= null)&&this.parMrtlStatus.equals(rhs.parMrtlStatus))))&&((this.rcrapp4MothSsn == rhs.rcrapp4MothSsn)||((this.rcrapp4MothSsn!= null)&&this.rcrapp4MothSsn.equals(rhs.rcrapp4MothSsn))))&&((this.addr == rhs.addr)||((this.addr!= null)&&this.addr.equals(rhs.addr))))&&((this.recdWic == rhs.recdWic)||((this.recdWic!= null)&&this.recdWic.equals(rhs.recdWic))))&&((this.rcrapp3IrsDisplayFlag == rhs.rcrapp3IrsDisplayFlag)||((this.rcrapp3IrsDisplayFlag!= null)&&this.rcrapp3IrsDisplayFlag.equals(rhs.rcrapp3IrsDisplayFlag))))&&((this.rcrapp4HighSchoolCde == rhs.rcrapp4HighSchoolCde)||((this.rcrapp4HighSchoolCde!= null)&&this.rcrapp4HighSchoolCde.equals(rhs.rcrapp4HighSchoolCde))))&&((this.statCode == rhs.statCode)||((this.statCode!= null)&&this.statCode.equals(rhs.statCode))))&&((this.unaccompYouthSchool == rhs.unaccompYouthSchool)||((this.unaccompYouthSchool!= null)&&this.unaccompYouthSchool.equals(rhs.unaccompYouthSchool))))&&((this.rcrapp3EducCredits == rhs.rcrapp3EducCredits)||((this.rcrapp3EducCredits!= null)&&this.rcrapp3EducCredits.equals(rhs.rcrapp3EducCredits))))&&((this.birthDate == rhs.birthDate)||((this.birthDate!= null)&&this.birthDate.equals(rhs.birthDate))))&&((this.rcrapp4FiledSched1 == rhs.rcrapp4FiledSched1)||((this.rcrapp4FiledSched1 != null)&&this.rcrapp4FiledSched1 .equals(rhs.rcrapp4FiledSched1))))&&((this.rcrapp4HsGedRcvd == rhs.rcrapp4HsGedRcvd)||((this.rcrapp4HsGedRcvd!= null)&&this.rcrapp4HsGedRcvd.equals(rhs.rcrapp4HsGedRcvd))))&&((this.rcrapp4TxRetFiledInd == rhs.rcrapp4TxRetFiledInd)||((this.rcrapp4TxRetFiledInd!= null)&&this.rcrapp4TxRetFiledInd.equals(rhs.rcrapp4TxRetFiledInd))))&&((this.rcrapp3TeIntInc == rhs.rcrapp3TeIntInc)||((this.rcrapp3TeIntInc!= null)&&this.rcrapp3TeIntInc.equals(rhs.rcrapp3TeIntInc))))&&((this.rcrapp3ParTypeOfTaxRetFlag == rhs.rcrapp3ParTypeOfTaxRetFlag)||((this.rcrapp3ParTypeOfTaxRetFlag!= null)&&this.rcrapp3ParTypeOfTaxRetFlag.equals(rhs.rcrapp3ParTypeOfTaxRetFlag))))&&((this.completionDate == rhs.completionDate)||((this.completionDate!= null)&&this.completionDate.equals(rhs.completionDate))))&&((this.rcrapp3EfcRecalcCorrReq == rhs.rcrapp3EfcRecalcCorrReq)||((this.rcrapp3EfcRecalcCorrReq!= null)&&this.rcrapp3EfcRecalcCorrReq.equals(rhs.rcrapp3EfcRecalcCorrReq))))&&((this.rcrapp4MothFirstNameIni == rhs.rcrapp4MothFirstNameIni)||((this.rcrapp4MothFirstNameIni!= null)&&this.rcrapp4MothFirstNameIni.equals(rhs.rcrapp4MothFirstNameIni))))&&((this.mothIncFrWrk == rhs.mothIncFrWrk)||((this.mothIncFrWrk!= null)&&this.mothIncFrWrk.equals(rhs.mothIncFrWrk))))&&((this.parSchoolLunch == rhs.parSchoolLunch)||((this.parSchoolLunch!= null)&&this.parSchoolLunch.equals(rhs.parSchoolLunch))));
    }
