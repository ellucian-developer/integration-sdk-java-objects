...
public class Shrgrde__2 {
    ...
    public Shrgrde__2 withCompletedInd(String completedInd) {
        this.completedInd = completedInd;
        return this;
    }
    ...
    public Shrgrde__2 withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public Shrgrde__2 withPassedInd(String passedInd) {
        this.passedInd = passedInd;
        return this;
    }
    ...
    public Shrgrde__2 withQualityPoints(Double qualityPoints) {
        this.qualityPoints = qualityPoints;
        return this;
    }
    ...
    public Shrgrde__2 withRepeatIncludeInd(String repeatIncludeInd) {
        this.repeatIncludeInd = repeatIncludeInd;
        return this;
    }
    ...
    public Shrgrde__2 withLastDateAttendInd(String lastDateAttendInd) {
        this.lastDateAttendInd = lastDateAttendInd;
        return this;
    }
    ...
    public Shrgrde__2 withNumericValue(Double numericValue) {
        this.numericValue = numericValue;
        return this;
    }
    ...
    public Shrgrde__2 withImpcmpInd(String impcmpInd) {
        this.impcmpInd = impcmpInd;
        return this;
    }
    ...
    public Shrgrde__2 withWebEntryInd(String webEntryInd) {
        this.webEntryInd = webEntryInd;
        return this;
    }
    ...
    public Shrgrde__2 withGrdeStatusInd(String grdeStatusInd) {
        this.grdeStatusInd = grdeStatusInd;
        return this;
    }
    ...
    public Shrgrde__2 withAttemptedInd(String attemptedInd) {
        this.attemptedInd = attemptedInd;
        return this;
    }
    ...
    public Shrgrde__2 withGrdeCodeIncmpFinal(String grdeCodeIncmpFinal) {
        this.grdeCodeIncmpFinal = grdeCodeIncmpFinal;
        return this;
    }
    ...
    public Shrgrde__2 withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public Shrgrde__2 withTraditionalInd(String traditionalInd) {
        this.traditionalInd = traditionalInd;
        return this;
    }
    ...
    public Shrgrde__2 withAbbrev(String abbrev) {
        this.abbrev = abbrev;
        return this;
    }
    ...
    public Shrgrde__2 withTermCodeEffective(String termCodeEffective) {
        this.termCodeEffective = termCodeEffective;
        return this;
    }
    ...
    public Shrgrde__2 withGpaInd(String gpaInd) {
        this.gpaInd = gpaInd;
        return this;
    }
    ...
    public Shrgrde__2 withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public Shrgrde__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Shrgrde__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shrgrde__2) == false) {
            return false;
        }
        Shrgrde__2 rhs = ((Shrgrde__2) other);
