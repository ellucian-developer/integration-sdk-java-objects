...
public class AccountCommentTypeCodes100PostResponse {
    ...
    public AccountCommentTypeCodes100PostResponse withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public AccountCommentTypeCodes100PostResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public AccountCommentTypeCodes100PostResponse withEnddateReqInd(String enddateReqInd) {
        this.enddateReqInd = enddateReqInd;
        return this;
    }
    ...
    public AccountCommentTypeCodes100PostResponse withActiveInd(String activeInd) {
        this.activeInd = activeInd;
        return this;
    }
    ...
    public AccountCommentTypeCodes100PostResponse withRestrictUpdateInd(String restrictUpdateInd) {
        this.restrictUpdateInd = restrictUpdateInd;
        return this;
    }
    ...
    public AccountCommentTypeCodes100PostResponse withTermReqInd(String termReqInd) {
        this.termReqInd = termReqInd;
        return this;
    }
    ...
    public AccountCommentTypeCodes100PostResponse withPurgeInd(String purgeInd) {
        this.purgeInd = purgeInd;
        return this;
    }
    ...
    public AccountCommentTypeCodes100PostResponse withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public AccountCommentTypeCodes100PostResponse withOrigCode(String origCode) {
        this.origCode = origCode;
        return this;
    }
    ...
    public AccountCommentTypeCodes100PostResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AccountCommentTypeCodes100PostResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AccountCommentTypeCodes100PostResponse) == false) {
            return false;
        }
        AccountCommentTypeCodes100PostResponse rhs = ((AccountCommentTypeCodes100PostResponse) other);
        return (((((((((((this.activityDate == rhs.activityDate)||((this.activityDate!= null)&&this.activityDate.equals(rhs.activityDate)))&&((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code))))&&((this.enddateReqInd == rhs.enddateReqInd)||((this.enddateReqInd!= null)&&this.enddateReqInd.equals(rhs.enddateReqInd))))&&((this.activeInd == rhs.activeInd)||((this.activeInd!= null)&&this.activeInd.equals(rhs.activeInd))))&&((this.restrictUpdateInd == rhs.restrictUpdateInd)||((this.restrictUpdateInd!= null)&&this.restrictUpdateInd.equals(rhs.restrictUpdateInd))))&&((this.termReqInd == rhs.termReqInd)||((this.termReqInd!= null)&&this.termReqInd.equals(rhs.termReqInd))))&&((this.purgeInd == rhs.purgeInd)||((this.purgeInd!= null)&&this.purgeInd.equals(rhs.purgeInd))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.desc == rhs.desc)||((this.desc!= null)&&this.desc.equals(rhs.desc))))&&((this.origCode == rhs.origCode)||((this.origCode!= null)&&this.origCode.equals(rhs.origCode))));
    }
