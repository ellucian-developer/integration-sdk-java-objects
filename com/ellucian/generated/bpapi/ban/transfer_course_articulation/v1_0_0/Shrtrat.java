...
public class Shrtrat {
    ...
    @JsonPropertyDescription("Lineage reference object : SHRTRAT_ATTR_CODE, Lookup lineage reference object : stvattr")
    ...
    public Shrtrat withAttrCode(String attrCode) {
        this.attrCode = attrCode;
        return this;
    }
    ...
    public Shrtrat withAttrDescription(String attrDescription) {
        this.attrDescription = attrDescription;
        return this;
    }
    ...
    public Shrtrat withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Shrtrat.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attrCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shrtrat) == false) {
            return false;
        }
        Shrtrat rhs = ((Shrtrat) other);
