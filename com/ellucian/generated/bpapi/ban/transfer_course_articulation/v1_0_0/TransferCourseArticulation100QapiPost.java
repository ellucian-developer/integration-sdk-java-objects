...
public class TransferCourseArticulation100QapiPost {
    ...
    public TransferCourseArticulation100QapiPost withSbgiCode(String sbgiCode) {
        this.sbgiCode = sbgiCode;
        return this;
    }
    ...
    public TransferCourseArticulation100QapiPost withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public TransferCourseArticulation100QapiPost withSbgiCodeDef(String sbgiCodeDef) {
        this.sbgiCodeDef = sbgiCodeDef;
        return this;
    }
    ...
    public TransferCourseArticulation100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TransferCourseArticulation100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sbgiCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TransferCourseArticulation100QapiPost) == false) {
            return false;
        }
        TransferCourseArticulation100QapiPost rhs = ((TransferCourseArticulation100QapiPost) other);
