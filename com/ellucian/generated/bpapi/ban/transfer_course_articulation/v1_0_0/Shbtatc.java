...
public class Shbtatc {
    ...
    @JsonPropertyDescription("Lineage reference object : SHBTATC_TLVL_CODE, Lookup lineage reference object : sorbtal,sorbtal")
    ...
    @JsonProperty("convHighHrs")
    private Double convHighHrs;
    /**
     * Minimum Grade
     * <p>
     ...
     * 
     */
    @JsonProperty("convLowHrs")
    private Double convLowHrs;
    /**
     * Subject
     * <p>
    ...
    @JsonProperty("convHighHrs")
    public Double getConvHighHrs() {
        return convHighHrs;
    }

    @JsonProperty("convHighHrs")
    public void setConvHighHrs(Double convHighHrs) {
        this.convHighHrs = convHighHrs;
    }

    public Shbtatc withConvHighHrs(Double convHighHrs) {
        this.convHighHrs = convHighHrs;
        return this;
    }
     ...
     */
    @JsonProperty("convLowHrs")
    public void setConvLowHrs(Double convLowHrs) {
        this.convLowHrs = convLowHrs;
    }

    public Shbtatc withConvLowHrs(Double convLowHrs) {
        this.convLowHrs = convLowHrs;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("convHighHrs");
        sb.append('=');
        sb.append(((this.convHighHrs == null)?"<null>":this.convHighHrs));
        sb.append(',');
        sb.append("tgrdCodeMin");
        sb.append('=');
        sb.append(((this.tgrdCodeMin == null)?"<null>":this.tgrdCodeMin));
        sb.append(',');
        sb.append("convLowHrs");
        sb.append('=');
        sb.append(((this.convLowHrs == null)?"<null>":this.convLowHrs));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.convHighHrs == null)? 0 :this.convHighHrs.hashCode()));
        result = ((result* 31)+((this.tgrdCodeMin == null)? 0 :this.tgrdCodeMin.hashCode()));
        result = ((result* 31)+((this.additionalProperties == null)? 0 :this.additionalProperties.hashCode()));
        result = ((result* 31)+((this.convLowHrs == null)? 0 :this.convLowHrs.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((((((this.termCodeEffTrns == rhs.termCodeEffTrns)||((this.termCodeEffTrns!= null)&&this.termCodeEffTrns.equals(rhs.termCodeEffTrns)))&&((this.protectInd == rhs.protectInd)||((this.protectInd!= null)&&this.protectInd.equals(rhs.protectInd))))&&((this.trnsHighHrs == rhs.trnsHighHrs)||((this.trnsHighHrs!= null)&&this.trnsHighHrs.equals(rhs.trnsHighHrs))))&&((this.crseNumbTrns == rhs.crseNumbTrns)||((this.crseNumbTrns!= null)&&this.crseNumbTrns.equals(rhs.crseNumbTrns))))&&((this.trnsCatalog == rhs.trnsCatalog)||((this.trnsCatalog!= null)&&this.trnsCatalog.equals(rhs.trnsCatalog))))&&((this.trnsLowHrs == rhs.trnsLowHrs)||((this.trnsLowHrs!= null)&&this.trnsLowHrs.equals(rhs.trnsLowHrs))))&&((this.tlvlCode == rhs.tlvlCode)||((this.tlvlCode!= null)&&this.tlvlCode.equals(rhs.tlvlCode))))&&((this.trnsTitle == rhs.trnsTitle)||((this.trnsTitle!= null)&&this.trnsTitle.equals(rhs.trnsTitle))))&&((this.groupPrimaryInd == rhs.groupPrimaryInd)||((this.groupPrimaryInd!= null)&&this.groupPrimaryInd.equals(rhs.groupPrimaryInd))))&&((this.crseDesc == rhs.crseDesc)||((this.crseDesc!= null)&&this.crseDesc.equals(rhs.crseDesc))))&&((this.trnsReviewInd == rhs.trnsReviewInd)||((this.trnsReviewInd!= null)&&this.trnsReviewInd.equals(rhs.trnsReviewInd))))&&((this.convHighHrs == rhs.convHighHrs)||((this.convHighHrs!= null)&&this.convHighHrs.equals(rhs.convHighHrs))))&&((this.tgrdCodeMin == rhs.tgrdCodeMin)||((this.tgrdCodeMin!= null)&&this.tgrdCodeMin.equals(rhs.tgrdCodeMin))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.convLowHrs == rhs.convLowHrs)||((this.convLowHrs!= null)&&this.convLowHrs.equals(rhs.convLowHrs))))&&((this.subjCodeTrns == rhs.subjCodeTrns)||((this.subjCodeTrns!= null)&&this.subjCodeTrns.equals(rhs.subjCodeTrns))))&&((this.group == rhs.group)||((this.group!= null)&&this.group.equals(rhs.group))))&&((this.tastCode == rhs.tastCode)||((this.tastCode!= null)&&this.tastCode.equals(rhs.tastCode))));
    }
