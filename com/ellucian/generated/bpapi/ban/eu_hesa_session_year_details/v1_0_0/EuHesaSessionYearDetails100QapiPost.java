...
public class EuHesaSessionYearDetails100QapiPost {
    ...
    public EuHesaSessionYearDetails100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public EuHesaSessionYearDetails100QapiPost withOwnSessionYrId(String ownSessionYrId) {
        this.ownSessionYrId = ownSessionYrId;
        return this;
    }
    ...
    public EuHesaSessionYearDetails100QapiPost withStartDate(Date startDate) {
        this.startDate = startDate;
        return this;
    }
    ...
    public EuHesaSessionYearDetails100QapiPost withEndDate(Date endDate) {
        this.endDate = endDate;
        return this;
    }
    ...
    public EuHesaSessionYearDetails100QapiPost withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public EuHesaSessionYearDetails100QapiPost withActivityDate(Date activityDate) {
        this.activityDate = activityDate;
        return this;
    }
    ...
    public EuHesaSessionYearDetails100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EuHesaSessionYearDetails100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EuHesaSessionYearDetails100QapiPost) == false) {
            return false;
        }
        EuHesaSessionYearDetails100QapiPost rhs = ((EuHesaSessionYearDetails100QapiPost) other);
