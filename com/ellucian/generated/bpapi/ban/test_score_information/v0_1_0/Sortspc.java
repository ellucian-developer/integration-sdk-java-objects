...
public class Sortspc {
    ...
    public Sortspc withPercentileDate(Date percentileDate) {
        this.percentileDate = percentileDate;
        return this;
    }
    ...
    public Sortspc withPercentile(String percentile) {
        this.percentile = percentile;
        return this;
    }
    ...
    public Sortspc withTsptCode(String tsptCode) {
        this.tsptCode = tsptCode;
        return this;
    }
    ...
    public Sortspc withStvtsptDesc(String stvtsptDesc) {
        this.stvtsptDesc = stvtsptDesc;
        return this;
    }
    ...
    public Sortspc withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sortspc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sortspc) == false) {
            return false;
        }
        Sortspc rhs = ((Sortspc) other);
