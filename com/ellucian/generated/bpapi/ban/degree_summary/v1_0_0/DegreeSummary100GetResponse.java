...
public class DegreeSummary100GetResponse {
    ...
    public DegreeSummary100GetResponse withShrdgmr(List<Shrdgmr> shrdgmr) {
        this.shrdgmr = shrdgmr;
        return this;
    }
    ...
    public DegreeSummary100GetResponse withSorlfos(List<Sorlfo> sorlfos) {
        this.sorlfos = sorlfos;
        return this;
    }
    ...
    public DegreeSummary100GetResponse withSorlcur(List<Sorlcur> sorlcur) {
        this.sorlcur = sorlcur;
        return this;
    }
    ...
    public DegreeSummary100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(DegreeSummary100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("shrdgmr");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DegreeSummary100GetResponse) == false) {
            return false;
        }
        DegreeSummary100GetResponse rhs = ((DegreeSummary100GetResponse) other);
