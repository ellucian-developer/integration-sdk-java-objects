...
public class CurriculumRulesBaseCurriculumRules100GetResponse {
    ...
    public CurriculumRulesBaseCurriculumRules100GetResponse withSecdRollInd(String secdRollInd) {
        this.secdRollInd = secdRollInd;
        return this;
    }
    ...
    public CurriculumRulesBaseCurriculumRules100GetResponse withTermCodeInit(String termCodeInit) {
        this.termCodeInit = termCodeInit;
        return this;
    }
    ...
    public CurriculumRulesBaseCurriculumRules100GetResponse withCurrRecInd(String currRecInd) {
        this.currRecInd = currRecInd;
        return this;
    }
    ...
    public CurriculumRulesBaseCurriculumRules100GetResponse withCampCode(String campCode) {
        this.campCode = campCode;
        return this;
    }
    ...
    public CurriculumRulesBaseCurriculumRules100GetResponse withStudyPathInd(String studyPathInd) {
        this.studyPathInd = studyPathInd;
        return this;
    }
    ...
    public CurriculumRulesBaseCurriculumRules100GetResponse withDegcCode(String degcCode) {
        this.degcCode = degcCode;
        return this;
    }
    ...
    public CurriculumRulesBaseCurriculumRules100GetResponse withLockInd(String lockInd) {
        this.lockInd = lockInd;
        return this;
    }
    ...
    public CurriculumRulesBaseCurriculumRules100GetResponse withProgram(String program) {
        this.program = program;
        return this;
    }
    ...
    public CurriculumRulesBaseCurriculumRules100GetResponse withCollCode(String collCode) {
        this.collCode = collCode;
        return this;
    }
    ...
    public CurriculumRulesBaseCurriculumRules100GetResponse withCurrRule(Double currRule) {
        this.currRule = currRule;
        return this;
    }
    ...
    public CurriculumRulesBaseCurriculumRules100GetResponse withPrimRollInd(String primRollInd) {
        this.primRollInd = primRollInd;
        return this;
    }
    ...
    public CurriculumRulesBaseCurriculumRules100GetResponse withLevlCode(String levlCode) {
        this.levlCode = levlCode;
        return this;
    }
    ...
    public CurriculumRulesBaseCurriculumRules100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CurriculumRulesBaseCurriculumRules100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CurriculumRulesBaseCurriculumRules100GetResponse) == false) {
            return false;
        }
        CurriculumRulesBaseCurriculumRules100GetResponse rhs = ((CurriculumRulesBaseCurriculumRules100GetResponse) other);
