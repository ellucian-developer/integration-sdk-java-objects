...
public class Tbrcsum {
    ...
    public Tbrcsum withMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public Tbrcsum withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Tbrcsum.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("message");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tbrcsum) == false) {
            return false;
        }
        Tbrcsum rhs = ((Tbrcsum) other);
