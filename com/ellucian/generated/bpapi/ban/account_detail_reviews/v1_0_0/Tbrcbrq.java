...
public class Tbrcbrq {
    ...
    public Tbrcbrq withMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public Tbrcbrq withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Tbrcbrq.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("message");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tbrcbrq) == false) {
            return false;
        }
        Tbrcbrq rhs = ((Tbrcbrq) other);
