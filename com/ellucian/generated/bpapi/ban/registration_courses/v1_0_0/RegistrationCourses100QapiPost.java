...
public class RegistrationCourses100QapiPost {
    ...
    public RegistrationCourses100QapiPost withSsasectTermCode(String ssasectTermCode) {
        this.ssasectTermCode = ssasectTermCode;
        return this;
    }
    ...
    public RegistrationCourses100QapiPost withSsasectCrn(String ssasectCrn) {
        this.ssasectCrn = ssasectCrn;
        return this;
    }
    ...
    public RegistrationCourses100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RegistrationCourses100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegistrationCourses100QapiPost) == false) {
            return false;
        }
        RegistrationCourses100QapiPost rhs = ((RegistrationCourses100QapiPost) other);
