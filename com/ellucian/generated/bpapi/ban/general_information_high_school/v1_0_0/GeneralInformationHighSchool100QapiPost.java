...
public class GeneralInformationHighSchool100QapiPost {
    ...
    public GeneralInformationHighSchool100QapiPost withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GeneralInformationHighSchool100QapiPost withSbgiCode(String sbgiCode) {
        this.sbgiCode = sbgiCode;
        return this;
    }
    ...
    public GeneralInformationHighSchool100QapiPost withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralInformationHighSchool100QapiPost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralInformationHighSchool100QapiPost) == false) {
            return false;
        }
        GeneralInformationHighSchool100QapiPost rhs = ((GeneralInformationHighSchool100QapiPost) other);
