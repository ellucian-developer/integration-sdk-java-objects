...
public class GeneralInformationHighSchool100GetRequest {
    ...
    public GeneralInformationHighSchool100GetRequest withSbgiCode(String sbgiCode) {
        this.sbgiCode = sbgiCode;
        return this;
    }
    ...
    public GeneralInformationHighSchool100GetRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GeneralInformationHighSchool100GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralInformationHighSchool100GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sbgiCode");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralInformationHighSchool100GetRequest) == false) {
            return false;
        }
        GeneralInformationHighSchool100GetRequest rhs = ((GeneralInformationHighSchool100GetRequest) other);
