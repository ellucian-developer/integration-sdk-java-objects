...
public class StudentAdjustmentsQuery010GetRequest {
    ...
    public StudentAdjustmentsQuery010GetRequest withAdjGroupInd(String adjGroupInd) {
        this.adjGroupInd = adjGroupInd;
        return this;
    }
    ...
    public StudentAdjustmentsQuery010GetRequest withAdjTargetInd(String adjTargetInd) {
        this.adjTargetInd = adjTargetInd;
        return this;
    }
    ...
    public StudentAdjustmentsQuery010GetRequest withAdjWaiverInd(String adjWaiverInd) {
        this.adjWaiverInd = adjWaiverInd;
        return this;
    }
    ...
    public StudentAdjustmentsQuery010GetRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public StudentAdjustmentsQuery010GetRequest withAdjSubstInd(String adjSubstInd) {
        this.adjSubstInd = adjSubstInd;
        return this;
    }
    ...
    public StudentAdjustmentsQuery010GetRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public StudentAdjustmentsQuery010GetRequest withAdjProgramInd(String adjProgramInd) {
        this.adjProgramInd = adjProgramInd;
        return this;
    }
    ...
    public StudentAdjustmentsQuery010GetRequest withAdjAreaInd(String adjAreaInd) {
        this.adjAreaInd = adjAreaInd;
        return this;
    }
    ...
    public StudentAdjustmentsQuery010GetRequest withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StudentAdjustmentsQuery010GetRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StudentAdjustmentsQuery010GetRequest) == false) {
            return false;
        }
        StudentAdjustmentsQuery010GetRequest rhs = ((StudentAdjustmentsQuery010GetRequest) other);
