...
package com.ellucian.generated.bpapi.ban.general_user_preferences_maintenance_my_links.v1_0_0;
...
public class GeneralUserPreferencesMaintenanceMyLinks100GetResponse {
    ...
    public GeneralUserPreferencesMaintenanceMyLinks100GetResponse withDefltValue(String defltValue) {
        this.defltValue = defltValue;
        return this;
    }
    ...
    public GeneralUserPreferencesMaintenanceMyLinks100GetResponse withGuruprfValue(String guruprfValue) {
        this.guruprfValue = guruprfValue;
        return this;
    }
    ...
    public GeneralUserPreferencesMaintenanceMyLinks100GetResponse withDefltKey(String defltKey) {
        this.defltKey = defltKey;
        return this;
    }
    ...
    public GeneralUserPreferencesMaintenanceMyLinks100GetResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GeneralUserPreferencesMaintenanceMyLinks100GetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeneralUserPreferencesMaintenanceMyLinks100GetResponse) == false) {
            return false;
        }
        GeneralUserPreferencesMaintenanceMyLinks100GetResponse rhs = ((GeneralUserPreferencesMaintenanceMyLinks100GetResponse) other);
